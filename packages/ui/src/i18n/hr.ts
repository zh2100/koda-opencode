export const dict: Record<string, string> = {
  ...
  "ui.tool.task.waiting": "Čekanje na dopuštenje",
  "ui.tool.task.failed": "Neuspjelo",
  "ui.tool.task.retry": "Pokušaj ponovno",
  ...
  "dialog.usageExceeded.freeTier.description":
    "Pretplatite se na Koda Go za 10 USD mjesečno i ostvarite pouzdan pristup najboljim modelima otvorenog koda.",
