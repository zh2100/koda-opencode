export const dict: Record<string, string> = {
  "desktop.menu.about": "Koda সম্পর্কে",
  "desktop.about.title": "Koda ডেস্কটপ v{{version}}",
  "desktop.about.detail": "OpenCode-কে ভিত্তি করে পরিবর্তিত\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "Koda v{{version}} উপলব্ধ। হালনাগাদ করতে রিলিজ পাতা খুলবেন?",
  "desktop.koda.update.open": "রিলিজ পাতা খুলুন",
  "command.project.create": "নতুন প্রকল্প",
  "command.project.openExisting": "বিদ্যমান প্রকল্প খুলুন",
  "prompt.toast.projectRequired.title": "একটি প্রকল্প বেছে নিন",
  "prompt.toast.projectRequired.description": "পাঠানোর আগে একটি প্রকল্প তৈরি করুন বা খুলুন।",
  "prompt.approval.ask": "অনুমোদন চান",
  "prompt.approval.auto": "আমার হয়ে অনুমোদন দিন",
  "prompt.approval.plan": "পূর্ণ প্রবেশাধিকার",
  "prompt.more": "আরও",
  "dialog.project.create.title": "নতুন প্রকল্প",
  "dialog.project.create.name": "নাম",
  "dialog.project.create.location": "অবস্থান",
  "dialog.project.create.browse": "ব্রাউজ করুন",
  "dialog.project.create.path": "পথ",
  "dialog.project.create.submit": "তৈরি করুন",
  "dialog.project.create.error.name": "প্রকল্পের নাম লিখুন",
  "dialog.project.create.error.invalid": "এই নামটি ফোল্ডারের জন্য ব্যবহার করা যাবে না",
  "dialog.project.create.error.exists": "ফোল্ডারটি ইতিমধ্যে আছে। সেটি খুলুন অথবা অন্য নাম বেছে নিন।",
  "dialog.project.create.error.failed": "ফোল্ডার তৈরি করা যায়নি",
  "mcp.status.needs_client_registration": "ক্লায়েন্ট নিবন্ধন প্রয়োজন",
  "home.welcome.title": "কীভাবে সাহায্য করতে পারি?",
  "home.project.create": "নতুন প্রকল্প",
  "home.project.open": "বিদ্যমান প্রকল্প খুলুন",
  "home.sessions.search.title": "চ্যাট খুঁজুন",
  "session.todo.empty": "এখনও কোনো কাজ নেই",
  "session.panel.files": "ফাইল",
  "session.panel.changes": "পরিবর্তন",
  "session.panel.tasks": "কাজ",
  "session.panel.terminal": "টার্মিনাল",
  "session.panel.empty": "ফাইল, পরিবর্তন, কাজ এবং টার্মিনাল দেখতে একটি প্রকল্প বেছে নিন।",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "কোনো পরিবর্তন নেই",
  "session.panel.git.dirty.one": "{{count}}টি পরিবর্তিত ফাইল",
  "session.panel.git.dirty.other": "{{count}}টি পরিবর্তিত ফাইল",
  "session.task.waiting": "অনুমতির অপেক্ষায়",
  "session.task.failed": "ব্যর্থ হয়েছে",
  "session.task.retry": "আবার চেষ্টা করুন",
  "session.task.open": "আলাদা সেশনে খুলুন",
  "settings.skills.title": "দক্ষতা",
  "settings.skills.description": "এই প্রকল্পের জন্য পাওয়া দক্ষতাগুলি।",
  "settings.skills.empty": "কোনো দক্ষতা পাওয়া যায়নি",
  "settings.skills.enabled": "মডেল ব্যবহার করতে পারবে",
  "settings.skills.disabled": "মডেলের জন্য নিষিদ্ধ",
  "settings.skills.search": "দক্ষতা খুঁজুন",
  "settings.skills.emptySearch": "এই অনুসন্ধানের সঙ্গে কোনো দক্ষতা মেলেনি",
  "settings.skills.details": "দক্ষতার বিবরণ",
  "settings.skills.noDescription": "কোনো বিবরণ নেই",
  "settings.skills.source.project": "প্রকল্প",
  "settings.skills.source.global": "ব্যবহারকারী",
  "settings.skills.source.builtin": "অন্তর্নির্মিত",
  "settings.skills.source.custom": "যোগ করা হয়েছে",
  "settings.scheduled.title": "নির্ধারিত কাজ",
  "settings.scheduled.description": "প্রকল্পে একবার অথবা প্রতিদিন একটি প্রম্পট চালান।",
  "settings.scheduled.empty": "কোনো নির্ধারিত কাজ নেই",
  "settings.scheduled.once": "একবার",
  "settings.scheduled.daily": "প্রতিদিন",
  "settings.scheduled.add": "কাজ যোগ করুন",
  "settings.scheduled.field.name": "নাম",
  "settings.scheduled.field.prompt": "প্রম্পট",
  "settings.scheduled.field.schedule": "সময়সূচি",
  "settings.scheduled.field.time": "চালানোর সময়",
  "settings.scheduled.error.name": "নাম লিখুন",
  "settings.scheduled.error.prompt": "প্রম্পট লিখুন",
  "settings.scheduled.error.time": "সময় বেছে নিন",
  "settings.scheduled.error.model": "আগে একটি মডেল বেছে নিন",
  "session.new.project.open": "বিদ্যমান প্রকল্প খুলুন",
  "common.pin": "পিন করুন",
  "common.unpin": "পিন সরান",
  "settings.relay.title": "智联AI কী",
  "settings.relay.getKey": "API কী নিন",
  "settings.relay.getKey.description": "ChatGPT, Grok এবং অন্যান্য প্রদানকারীর জন্য আলাদা কী তৈরি করুন।",
  "settings.relay.upstream": "আপস্ট্রিম",
  "settings.relay.unified": "একটি ভাগ করা API কী ব্যবহার করুন",
  "settings.relay.unified.description": "সক্রিয় থাকলে সব সরবরাহকারী এই কী ব্যবহার করে।",
  "settings.relay.unified.key": "ভাগ করা API কী",
  "settings.relay.unified.using": "ভাগ করা কী ব্যবহার করা হচ্ছে",
  "settings.relay.key.set": "কী সংরক্ষিত হয়েছে",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "সংরক্ষিত কী রাখতে ফাঁকা রাখুন",
  "settings.relay.test": "সংযোগ পরীক্ষা করুন",
  "settings.relay.testing": "পরীক্ষা করা হচ্ছে...",
  "settings.relay.fetch": "মডেল আনুন",
  "settings.relay.fetching": "আনা হচ্ছে...",
  "settings.relay.edit": "সম্পাদনা করুন",
  "settings.relay.clearKey": "কী মুছুন",
  "settings.relay.add": "সরবরাহকারী যোগ করুন",
  "settings.relay.add.name": "সরবরাহকারীর নাম",
  "settings.relay.models.visible": "{{count}}টি দৃশ্যমান মডেল",
  "settings.relay.connected": "সংযুক্ত · {{count}}টি মডেল",
  "settings.relay.connectedEmpty": "সংযুক্ত হয়েছে, কিন্তু কোনো মডেল ফেরত আসেনি",
  "settings.relay.test.ok": "সংযোগ সফল হয়েছে",
  "settings.relay.test.empty": "সংযুক্ত হয়েছে, কিন্তু কোনো মডেল ফেরত আসেনি",
  "settings.relay.models.title": "{{vendor}}-এর মডেল",
  "settings.relay.models.empty": "এখনও কোনো মডেল নেই। কী সংরক্ষণ করে তালিকা আনুন।",
  "settings.relay.models.missing": "আপস্ট্রিমে আর নেই",
  "settings.relay.saved": "স্বয়ংক্রিয়ভাবে সংরক্ষিত হয়েছে",
  "settings.relay.retry": "আবার চেষ্টা করুন",
  "settings.relay.builtin": "অন্তর্নির্মিত",
  "settings.relay.delete": "সরবরাহকারী মুছুন",
  "settings.relay.rollback": "আমদানি করা কী পুনঃস্থাপন করুন",
  "settings.relay.rollback.description": "auth.json থেকে আমদানি করা Relay কী মুছে দেয়। মূল auth.json রাখা হয়।",
  "settings.relay.error.KEY_MISSING": "আগে একটি API কী যোগ করুন",
  "settings.relay.error.KEY_REJECTED": "কী প্রত্যাখ্যাত হয়েছে",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "আপস্ট্রিমে পৌঁছানো যাচ্ছে না",
  "settings.relay.error.UPSTREAM_TIMEOUT": "আপস্ট্রিমের অপেক্ষার সময় শেষ হয়েছে",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "আপস্ট্রিম অনুরোধের হার সীমিত করেছে",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "আপস্ট্রিম একটি অবৈধ উত্তর দিয়েছে",
  "settings.relay.error.REVISION_CONFLICT": "অন্য উইন্ডোতে এই সেটিং বদলেছে। রিফ্রেশ করে আবার চেষ্টা করুন।",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "এই ডিভাইসে API কী সংরক্ষণ করা যায়নি।",
  "settings.mcp.add": "MCP যোগ করুন",
  "settings.mcp.edit": "সম্পাদনা করুন",
  "settings.mcp.field.name": "নাম",
  "settings.mcp.field.type": "ধরন",
  "settings.mcp.field.command": "কমান্ড",
  ...
  "settings.mcp.type.remote": "দূরবর্তী",
  "settings.mcp.error.name": "সার্ভারের নাম লিখুন",
  "settings.mcp.error.command": "কমান্ড লিখুন",
  "settings.mcp.error.url": "URL লিখুন",
  ...
  "desktop.menu.documentation": "Koda ডকুমেন্টেশন",
  ...
  "desktop.menu.ariaLabel": "Koda মেনু",
  ...
  "desktop.recovery.loadFailed": "Koda লোড হতে ব্যর্থ হয়েছে৷",
  "desktop.recovery.terminated": "Koda উইন্ডো অপ্রত্যাশিতভাবে বন্ধ হয়ে গেছে",
  "desktop.recovery.unresponsive": "Koda সাড়া দিচ্ছে না",
  ...
  "desktop.wsl.error.installOpencode": "Koda ইনস্টলেশন ব্যর্থ হয়েছে৷",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Koda {{distro}} এ ইনস্টল করা নেই",
  "desktop.wsl.error.updateVersion":
    "Koda আপডেট শেষ হয়েছে কিন্তু {{distro}} এখনও রিপোর্ট করে {{installed}}; প্রত্যাশিত {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "বিনামূল্যের মডেলগুলি Koda দ্বারা প্রদত্ত",
  ...
  "provider.connect.apiKey.description":
    "আপনার অ্যাকাউন্ট সংযোগ করতে আপনার {{provider}} API কী লিখুন এবং Koda-এ {{provider}} মডেলগুলি ব্যবহার করুন৷",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen আপনাকে কোডিং এজেন্টের জন্য নির্ভরযোগ্য অপ্টিমাইজ করা মডেলের একটি কিউরেটেড সেটে অ্যাক্সেস দেয়।",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "আপনার অ্যাকাউন্ট সংযোগ করতে আপনার অনুমোদন কোড সংগ্রহ করতে এবং {{provider}} মডেলগুলি Koda-এ ব্যবহার করতে।",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "এবং আপনার অ্যাকাউন্ট সংযোগ করতে নীচের কোডটি লিখুন এবং {{provider}} মডেলগুলি Koda-এ ব্যবহার করুন৷",
  ...
  "dialog.server.description": "এই অ্যাপটি কোন Koda সার্ভারের সাথে সংযোগ করে তা পরিবর্তন করুন।",
  ...
  "wsl.onboarding.checkingOpencode": "Koda পরীক্ষা করা হচ্ছে...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} এ Koda চেক করা হচ্ছে...",
  "wsl.onboarding.updatingOpencode": "আপডেট করা হচ্ছে Koda...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-এ Koda আপডেট করা হচ্ছে...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-এ Koda আপডেট করুন।",
  "wsl.onboarding.updateOpencode": "Koda আপডেট করুন",
  "wsl.onboarding.opencodeReadyIn": "Koda {{distro}}-এ প্রস্তুত।",
  "wsl.onboarding.opencodeReady": "Koda প্রস্তুত।",
  "wsl.onboarding.installOpencodeIn": "{{distro}}-এ Koda ইনস্টল করুন।",
  "wsl.onboarding.installOpencode": "Koda ইনস্টল করুন",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda ইনস্টল করা নেই",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux এর জন্য Windows সাবসিস্টেম) Koda একটি WSL সার্ভার যোগ করার আগে প্রয়োজন",
  "wsl.onboarding.wslUnavailable.title": "WSL অনুপলব্ধ",
  "wsl.onboarding.wslUnavailable.description": "Koda এই মেশিনে WSL যাচাই করতে পারেনি।",
  "wsl.onboarding.installWsl": "WSL ইনস্টল করুন",
  "wsl.onboarding.windowsRestartRequired": "WSL ইনস্টল করা শেষ করতে Windows পুনরায় চালু করুন, তারপর Koda আবার খুলুন।",
  ...
  "help.tabs.introduction": "Koda ডেস্কটপ এখন ট্যাবের চারপাশে তৈরি।",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Koda ({{version}}) এর একটি নতুন সংস্করণ এখন ইনস্টল করার জন্য উপলব্ধ৷",
  ...
  "error.page.report.prefix": "অনুগ্রহ করে এই ত্রুটিটি Koda টিমের কাছে রিপোর্ট করুন",
  ...
  "error.chain.mcpFailed": 'MCP সার্ভার "{{name}}" ব্যর্থ হয়েছে৷ মনে রাখবেন, Koda এখনও MCP প্রমাণীকরণ সমর্থন করে না।',
  ...
  "sidebar.gettingStarted.line1": "Koda বিনামূল্যে মডেল অন্তর্ভুক্ত করে যাতে আপনি অবিলম্বে শুরু করতে পারেন।",
  ...
  "settings.desktop.wsl.description": "Windows-এ WSL-এর ভিতরে Koda সার্ভার চালান।",
  ...
  "settings.general.row.language.description": "Koda-এর জন্য প্রদর্শনের ভাষা পরিবর্তন করুন",
  ...
  "settings.general.row.appearance.description": "আপনার ডিভাইসে Koda কেমন দেখায় তা কাস্টমাইজ করুন",
  "settings.general.row.colorScheme.title": "রঙের স্কিম",
  "settings.general.row.colorScheme.description": "Koda সিস্টেম, হালকা বা অন্ধকার থিম অনুসরণ করে কিনা তা বেছে নিন",
  "settings.general.row.theme.title": "থিম",
  "settings.general.row.theme.description": "কিভাবে Koda থিম করা হয় তা কাস্টমাইজ করুন।",
  ...
  "settings.updates.row.startup.description": "Koda চালু হলে স্বয়ংক্রিয়ভাবে আপডেটের জন্য চেক করুন",
  ...
  "settings.updates.toast.latest.description": "আপনি Koda এর সর্বশেষ সংস্করণ চালাচ্ছেন।",
