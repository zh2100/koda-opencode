export const dict = {
  "desktop.menu.about": "Um Koda",
  "desktop.about.title": "Koda Desktop v{{version}}",
  "desktop.about.detail":
    "Tillagað við OpenCode sum grundarlagi\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "Koda v{{version}} er tøkt. Vilt tú lata útgávusíðuna upp fyri at dagføra?",
  "desktop.koda.update.open": "Lat útgávusíðuna upp",
  "command.project.create": "Nýggj verkætlan",
  "command.project.openExisting": "Lat verandi verkætlan upp",
  "prompt.toast.projectRequired.title": "Vel eina verkætlan",
  "prompt.toast.projectRequired.description": "Stovna ella lat eina verkætlan upp, áðrenn tú sendir.",
  "prompt.approval.ask": "Bið um góðkenning",
  "prompt.approval.auto": "Góðkenn fyri meg",
  "prompt.approval.plan": "Full atgongd",
  "prompt.more": "Meira",
  "dialog.project.create.title": "Nýggj verkætlan",
  "dialog.project.create.name": "Navn",
  "dialog.project.create.location": "Staðseting",
  "dialog.project.create.browse": "Leita",
  "dialog.project.create.path": "Leið",
  "dialog.project.create.submit": "Stovna",
  "dialog.project.create.error.name": "Skriva eitt navn á verkætlanina",
  "dialog.project.create.error.invalid": "Hetta navnið kann ikki brúkast til eina mappu",
  "dialog.project.create.error.exists": "Mappan er longu til. Lat hana upp í staðin, ella vel eitt annað navn.",
  "dialog.project.create.error.failed": "Tað bar ikki til at stovna mappuna",
  "mcp.status.needs_client_registration": "krevur skráseting av klienti",
  "home.welcome.title": "Hvat kann eg hjálpa við?",
  "home.project.create": "Nýggj verkætlan",
  "home.project.open": "Lat verandi verkætlan upp",
  "home.sessions.search.title": "Leita í samrøðum",
  "session.todo.empty": "Ongar uppgávur enn",
  "session.panel.files": "Fílur",
  "session.panel.changes": "Broytingar",
  "session.panel.tasks": "Uppgávur",
  "session.panel.terminal": "Terminalur",
  "session.panel.empty": "Vel eina verkætlan fyri at síggja fílur, broytingar, uppgávur og terminalin.",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "Ongar broytingar",
  "session.panel.git.dirty.one": "{{count}} broytt fíla",
  "session.panel.git.dirty.other": "{{count}} broyttar fílur",
  "session.task.waiting": "Bíðar eftir loyvi",
  "session.task.failed": "Miseydnaðist",
  "session.task.retry": "Royn aftur",
  "session.task.open": "Lat upp í egnari setu",
  "settings.skills.title": "Dugnaskapur",
  "settings.skills.description": "Dugnaskapur funnin til hesa verkætlanina.",
  "settings.skills.empty": "Eingin dugnaskapur funnin",
  "settings.skills.enabled": "Tøkur hjá modellinum",
  "settings.skills.disabled": "Noktaður hjá modellinum",
  "settings.skills.search": "Leita eftir dugnaskapi",
  "settings.skills.emptySearch": "Eingin dugnaskapur samsvarar við leitingina",
  "settings.skills.details": "Upplýsingar um dugnaskap",
  "settings.skills.noDescription": "Eingin lýsing",
  "settings.skills.source.project": "Verkætlan",
  "settings.skills.source.global": "Brúkari",
  "settings.skills.source.builtin": "Innbygdur",
  "settings.skills.source.custom": "Lagdur afturat",
  "settings.scheduled.title": "Tíðarsettar uppgávur",
  "settings.scheduled.description": "Koyr eini boð eina ferð ella hvønn dag í einari verkætlan.",
  "settings.scheduled.empty": "Ongar tíðarsettar uppgávur",
  "settings.scheduled.once": "Eina ferð",
  "settings.scheduled.daily": "Hvønn dag",
  "settings.scheduled.add": "Legg uppgávu afturat",
  "settings.scheduled.field.name": "Navn",
  "settings.scheduled.field.prompt": "Boð",
  "settings.scheduled.field.schedule": "Tíðarætlan",
  "settings.scheduled.field.time": "Koyr klokkan",
  "settings.scheduled.error.name": "Skriva eitt navn",
  "settings.scheduled.error.prompt": "Skriva eini boð",
  "settings.scheduled.error.time": "Vel eina tíð",
  "settings.scheduled.error.model": "Vel fyrst eitt modell",
  "session.new.project.open": "Lat verandi verkætlan upp",
  "common.pin": "Fest",
  "common.unpin": "Loys",
  "settings.relay.title": "智联AI-lyklar",
  "settings.relay.getKey": "Fá API-lykil",
  "settings.relay.getKey.description": "Stovna serstakar lyklar til ChatGPT, Grok og aðrar veitarar.",
  "settings.relay.upstream": "Bakendatænasta",
  "settings.relay.unified": "Brúka ein felags API-lykil",
  "settings.relay.unified.description": "Tá hetta er virkjað, brúka allir veitarar henda lykilin.",
  "settings.relay.unified.key": "Felags API-lykill",
  "settings.relay.unified.using": "Brúkar felags lykilin",
  "settings.relay.key.set": "Lykil goymdur",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "Lat teigin vera tóman fyri at varðveita goymda lykilin",
  "settings.relay.test": "Royn sambandið",
  "settings.relay.testing": "Roynir...",
  "settings.relay.fetch": "Heinta modell",
  "settings.relay.fetching": "Heintar...",
  "settings.relay.edit": "Broyt",
  "settings.relay.clearKey": "Strika lykil",
  "settings.relay.add": "Legg veitara afturat",
  "settings.relay.add.name": "Navn á veitara",
  "settings.relay.models.visible": "{{count}} sjónlig modell",
  "settings.relay.connected": "Samband fingið · {{count}} modell",
  "settings.relay.connectedEmpty": "Samband fingið, men eingi modell vórðu send aftur",
  "settings.relay.test.ok": "Sambandið eydnaðist",
  "settings.relay.test.empty": "Samband fingið, men eingi modell vórðu send aftur",
  "settings.relay.models.title": "Modell frá {{vendor}}",
  "settings.relay.models.empty": "Eingi modell enn. Heinta listan, eftir at tú hevur goymt ein lykil.",
  "settings.relay.models.missing": "Ikki longur hjá bakendatænastuni",
  "settings.relay.saved": "Goymt sjálvvirkandi",
  "settings.relay.retry": "Royn aftur",
  "settings.relay.builtin": "Innbygt",
  "settings.relay.delete": "Strika veitara",
  "settings.relay.rollback": "Nullstilla innfluttar lyklar",
  "settings.relay.rollback.description":
    "Strikar Relay-lyklar innfluttar úr auth.json. Upprunaliga auth.json verður varðveitt.",
  "settings.relay.error.KEY_MISSING": "Legg fyrst ein API-lykil afturat",
  "settings.relay.error.KEY_REJECTED": "Lykilin varð avvístur",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "Samband fæst ikki við bakendatænastuna",
  "settings.relay.error.UPSTREAM_TIMEOUT": "Tíðarfreistin hjá bakendatænastuni rann út",
  "settings.relay.error.UPSTREAM_RATE_LIMITED":
    "Bakendatænastan avmarkaði fyrispurningin vegna ov nógvar fyrispurningar",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "Bakendatænastan sendi eitt ógilt svar",
  "settings.relay.error.REVISION_CONFLICT":
    "Henda stillingin varð broytt í einum øðrum vindeyga. Dagfør og royn aftur.",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "Tað bar ikki til at goyma API-lykilin á hesum tólinum.",
  "settings.mcp.add": "Legg MCP afturat",
  "settings.mcp.edit": "Broyt",
  "settings.mcp.field.name": "Navn",
  "settings.mcp.field.type": "Slag",
  "settings.mcp.field.command": "Skipan",
  ...
  "settings.mcp.type.remote": "Fjart",
  "settings.mcp.error.name": "Skriva eitt navn á ambætaran",
  "settings.mcp.error.command": "Skriva eina skipan",
  "settings.mcp.error.url": "Skriva eina URL",
  ...
  "desktop.menu.documentation": "Koda Skjøl",
  ...
  "desktop.menu.ariaLabel": "Koda valmynd",
  ...
  "desktop.recovery.loadFailed": "Koda miseydnaðist at heinta",
  "desktop.recovery.terminated": "Koda vindeygað endað óvæntað",
  "desktop.recovery.unresponsive": "Koda svarar ikki",
  ...
  "desktop.wsl.error.installOpencode": "Koda uppsetingin miseydnaðist",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Koda er ikki sett upp í {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Koda dagføring liðug men {{distro}} greiðir enn frá {{installed}}; væntað {{expected}}.",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis modellir veitt av Koda",
  ...
  "provider.connect.apiKey.description":
    "Skriva {{provider}} API-lykilin fyri at knýta kontuna saman og brúka {{provider}}-modell í Koda.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen gevur tær atgongd til eitt kuraterað sett av álítandi optimeraðum modellum til kodingaragentar.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " at savna inn tína heimildarkotu til at knýta tína kontu saman og brúka {{provider}} modellir í Koda.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriva kotuna niðanfyri fyri at knýta tína kontu saman og brúka {{provider}} modellir í Koda.",
  ...
  "dialog.server.description": "Skift hvønn Koda ambætara henda appin hevur samband við.",
  ...
  "wsl.onboarding.checkingOpencode": "Kanna Koda...",
  "wsl.onboarding.checkingOpencodeIn": "Kanna Koda í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Dagføring Koda...",
  "wsl.onboarding.updatingOpencodeIn": "Dagføring Koda í {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Dagfør Koda í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Dagfør Koda",
  "wsl.onboarding.opencodeReadyIn": "Koda er klárt í {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koda er klárt.",
  "wsl.onboarding.installOpencodeIn": "Set Koda upp í {{distro}}.",
  "wsl.onboarding.installOpencode": "Set upp Koda",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda ikki innstillað",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Undirskipan til Linux) er kravd áðrenn Koda kann leggja ein WSL ambætara til",
  "wsl.onboarding.wslUnavailable.title": "WSL ikki tøkt",
  "wsl.onboarding.wslUnavailable.description": "Koda kundi ikki staðfesta WSL á hesi maskinuni.",
  "wsl.onboarding.installWsl": "Set upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurbyrja Windows fyri at klára at seta upp WSL, og opna síðani Koda aftur.",
  ...
  "help.tabs.introduction": "Koda Skrivaraborð er nú bygt rundan um flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ein nýggj útgáva av Koda ({{version}}) er nú tøk at seta upp.",
  ...
  "error.page.report.prefix": "Vinarliga melda hendan feilin til Koda toymið",
  ...
  "error.chain.mcpFailed": 'MCP ambætarin "{{name}}" miseydnaðist. Viðmæli, Koda stuðlar ikki MCP sannroynd enn.',
  ...
  "sidebar.gettingStarted.line1": "Koda inniheldur ókeypis modellir so tú kanst byrja beinanvegin.",
  ...
  "app.name.desktop": "Koda Skrivaraborð",
  ...
  "settings.desktop.wsl.description": "Koyr Koda ambætaran inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Broyt sýnismálið fyri Koda",
  ...
  "settings.general.row.appearance.description": "Tillaga hvussu Koda sær út á tínari eind",
  "settings.general.row.colorScheme.title": "Litskipan",
  "settings.general.row.colorScheme.description": "Vel um Koda fylgir skipanini, ljósa ella myrka temanum",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tillaga hvussu Koda er tema.",
  ...
  "settings.updates.row.startup.description": "Kanna sjálvvirkandi fyri dagføringum, tá Koda byrjar",
  ...
  "settings.updates.toast.latest.description": "Tú koyrir nýggjastu útgávuna av Koda.",
