export const dict = {
  "desktop.menu.about": "Over Koda",
  "desktop.about.title": "Koda Desktop v{{version}}",
  "desktop.about.detail": "Aangepast met OpenCode als basis\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "Koda v{{version}} is beschikbaar. De releasepagina openen om bij te werken?",
  "desktop.koda.update.open": "Releasepagina openen",
  "command.project.create": "Nieuw project",
  "command.project.openExisting": "Bestaand project openen",
  "prompt.toast.projectRequired.title": "Kies een project",
  "prompt.toast.projectRequired.description": "Maak of open een project voordat je iets verstuurt.",
  "prompt.approval.ask": "Goedkeuring vragen",
  "prompt.approval.auto": "Voor mij goedkeuren",
  "prompt.approval.plan": "Volledige toegang",
  "prompt.more": "Meer",
  "dialog.project.create.title": "Nieuw project",
  "dialog.project.create.name": "Naam",
  "dialog.project.create.location": "Locatie",
  "dialog.project.create.browse": "Bladeren",
  "dialog.project.create.path": "Pad",
  "dialog.project.create.submit": "Aanmaken",
  "dialog.project.create.error.name": "Voer een projectnaam in",
  "dialog.project.create.error.invalid": "Deze naam kan niet voor een map worden gebruikt",
  "dialog.project.create.error.exists": "Die map bestaat al. Open deze of kies een andere naam.",
  "dialog.project.create.error.failed": "Kan de map niet aanmaken",
  "mcp.status.needs_client_registration": "clientregistratie vereist",
  "home.welcome.title": "Waarmee kan ik helpen?",
  "home.project.create": "Nieuw project",
  "home.project.open": "Bestaand project openen",
  "home.sessions.search.title": "Chats doorzoeken",
  "session.todo.empty": "Nog geen taken",
  "session.panel.files": "Bestanden",
  "session.panel.changes": "Wijzigingen",
  "session.panel.tasks": "Taken",
  "session.panel.terminal": "Terminal",
  "session.panel.empty": "Selecteer een project om bestanden, wijzigingen, taken en de terminal te bekijken.",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "Geen wijzigingen",
  "session.panel.git.dirty.one": "{{count}} gewijzigd bestand",
  "session.panel.git.dirty.other": "{{count}} gewijzigde bestanden",
  "session.task.waiting": "Wachten op toestemming",
  "session.task.failed": "Mislukt",
  "session.task.retry": "Opnieuw proberen",
  "session.task.open": "In een eigen sessie openen",
  "settings.skills.title": "Vaardigheden",
  "settings.skills.description": "Vaardigheden gevonden voor dit project.",
  "settings.skills.empty": "Geen vaardigheden gevonden",
  "settings.skills.enabled": "Beschikbaar voor het model",
  "settings.skills.disabled": "Niet toegestaan voor het model",
  "settings.skills.search": "Vaardigheden zoeken",
  "settings.skills.emptySearch": "Geen vaardigheden komen overeen met deze zoekopdracht",
  "settings.skills.details": "Vaardigheidsdetails",
  "settings.skills.noDescription": "Geen beschrijving",
  "settings.skills.source.project": "Project",
  "settings.skills.source.global": "Gebruiker",
  "settings.skills.source.builtin": "Ingebouwd",
  "settings.skills.source.custom": "Toegevoegd",
  "settings.scheduled.title": "Geplande taken",
  "settings.scheduled.description": "Voer een prompt eenmalig of dagelijks uit in een project.",
  "settings.scheduled.empty": "Geen geplande taken",
  "settings.scheduled.once": "Eenmalig",
  "settings.scheduled.daily": "Elke dag",
  "settings.scheduled.add": "Taak toevoegen",
  "settings.scheduled.field.name": "Naam",
  "settings.scheduled.field.prompt": "Prompt",
  "settings.scheduled.field.schedule": "Planning",
  "settings.scheduled.field.time": "Uitvoeren om",
  "settings.scheduled.error.name": "Voer een naam in",
  "settings.scheduled.error.prompt": "Voer een prompt in",
  "settings.scheduled.error.time": "Kies een tijdstip",
  "settings.scheduled.error.model": "Selecteer eerst een model",
  "session.new.project.open": "Bestaand project openen",
  "common.pin": "Vastmaken",
  "common.unpin": "Losmaken",
  "settings.relay.title": "智联AI-sleutels",
  "settings.relay.getKey": "API-sleutel verkrijgen",
  "settings.relay.getKey.description": "Maak afzonderlijke sleutels voor ChatGPT, Grok en andere aanbieders.",
  "settings.relay.upstream": "Achterliggende dienst",
  "settings.relay.unified": "Een gedeelde API-sleutel gebruiken",
  "settings.relay.unified.description": "Als dit is ingeschakeld, gebruikt elke aanbieder deze sleutel.",
  "settings.relay.unified.key": "Gedeelde API-sleutel",
  "settings.relay.unified.using": "Gedeelde sleutel wordt gebruikt",
  "settings.relay.key.set": "Sleutel opgeslagen",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "Laat leeg om de opgeslagen sleutel te behouden",
  "settings.relay.test": "Verbinding testen",
  "settings.relay.testing": "Bezig met testen...",
  "settings.relay.fetch": "Modellen ophalen",
  "settings.relay.fetching": "Bezig met ophalen...",
  "settings.relay.edit": "Bewerken",
  "settings.relay.clearKey": "Sleutel wissen",
  "settings.relay.add": "Aanbieder toevoegen",
  "settings.relay.add.name": "Naam van aanbieder",
  "settings.relay.models.visible": "{{count}} zichtbare modellen",
  "settings.relay.connected": "Verbonden · {{count}} modellen",
  "settings.relay.connectedEmpty": "Verbonden, maar er zijn geen modellen teruggestuurd",
  "settings.relay.test.ok": "Verbinding geslaagd",
  "settings.relay.test.empty": "Verbonden, maar er zijn geen modellen teruggestuurd",
  "settings.relay.models.title": "Modellen van {{vendor}}",
  "settings.relay.models.empty": "Nog geen modellen. Haal de lijst op nadat je een sleutel hebt opgeslagen.",
  "settings.relay.models.missing": "Niet meer beschikbaar bij de achterliggende dienst",
  "settings.relay.saved": "Automatisch opgeslagen",
  "settings.relay.retry": "Opnieuw proberen",
  "settings.relay.builtin": "Ingebouwd",
  "settings.relay.delete": "Aanbieder verwijderen",
  "settings.relay.rollback": "Geïmporteerde sleutels resetten",
  "settings.relay.rollback.description":
    "Wist Relay-sleutels die uit auth.json zijn geïmporteerd. Het oorspronkelijke bestand auth.json blijft behouden.",
  "settings.relay.error.KEY_MISSING": "Voeg eerst een API-sleutel toe",
  "settings.relay.error.KEY_REJECTED": "De sleutel is geweigerd",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "De achterliggende dienst is niet bereikbaar",
  "settings.relay.error.UPSTREAM_TIMEOUT": "Time-out bij de achterliggende dienst",
  "settings.relay.error.UPSTREAM_RATE_LIMITED":
    "De achterliggende dienst heeft het verzoek beperkt wegens te veel verzoeken",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "De achterliggende dienst gaf een ongeldig antwoord",
  "settings.relay.error.REVISION_CONFLICT":
    "Deze instelling is in een ander venster gewijzigd. Vernieuw en probeer het opnieuw.",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "Kan de API-sleutel niet op dit apparaat opslaan.",
  "settings.mcp.add": "MCP toevoegen",
  "settings.mcp.edit": "Bewerken",
  "settings.mcp.field.name": "Naam",
  "settings.mcp.field.type": "Type",
  "settings.mcp.field.command": "Opdracht",
  ...
  "settings.mcp.type.remote": "Op afstand",
  "settings.mcp.error.name": "Voer een servernaam in",
  "settings.mcp.error.command": "Voer een opdracht in",
  "settings.mcp.error.url": "Voer een URL in",
  ...
  "desktop.menu.documentation": "Koda-documentatie",
  ...
  "desktop.recovery.loadFailed": "Koda kan niet worden geladen",
  "desktop.recovery.terminated": "Het Koda-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "Koda reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van Koda is mislukt",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Koda is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De Koda-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door Koda",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in Koda te gebruiken.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in Koda te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in Koda te gebruiken.",
  ...
  "dialog.server.description": "Wijzig met welke Koda-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "Koda controleren...",
  "wsl.onboarding.checkingOpencodeIn": "Koda controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Koda bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "Koda bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk Koda bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Koda bijwerken",
  "wsl.onboarding.opencodeReadyIn": "Koda is gereed in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koda is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer Koda in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer Koda",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat Koda een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "Koda kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens Koda opnieuw.",
  ...
  "help.tabs.introduction": "Koda Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van Koda ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het Koda-team",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: Koda ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "Koda bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de Koda-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor Koda",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe Koda eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of Koda het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van Koda aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer Koda wordt gestart",
  ...
  "settings.updates.toast.latest.title": "Koda is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van Koda.",
