export const dict = {
  "desktop.menu.about": "Tietoja Kodasta",
  "desktop.about.title": "Koda Desktop v{{version}}",
  "desktop.about.detail": "Muokattu OpenCoden pohjalta\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "Koda v{{version}} on saatavilla. Avataanko julkaisusivu päivitystä varten?",
  "desktop.koda.update.open": "Avaa julkaisusivu",
  "command.project.create": "Uusi projekti",
  "command.project.openExisting": "Avaa olemassa oleva projekti",
  "prompt.toast.projectRequired.title": "Valitse projekti",
  "prompt.toast.projectRequired.description": "Luo tai avaa projekti ennen lähettämistä.",
  "prompt.approval.ask": "Pyydä hyväksyntää",
  "prompt.approval.auto": "Hyväksy puolestani",
  "prompt.approval.plan": "Täydet käyttöoikeudet",
  "prompt.more": "Lisää",
  "dialog.project.create.title": "Uusi projekti",
  "dialog.project.create.name": "Nimi",
  "dialog.project.create.location": "Sijainti",
  "dialog.project.create.browse": "Selaa",
  "dialog.project.create.path": "Polku",
  "dialog.project.create.submit": "Luo",
  "dialog.project.create.error.name": "Anna projektin nimi",
  "dialog.project.create.error.invalid": "Tätä nimeä ei voi käyttää kansion nimenä",
  "dialog.project.create.error.exists": "Kansio on jo olemassa. Avaa se tai valitse toinen nimi.",
  "dialog.project.create.error.failed": "Kansion luominen epäonnistui",
  "mcp.status.needs_client_registration": "edellyttää asiakkaan rekisteröintiä",
  "home.welcome.title": "Miten voin auttaa?",
  "home.project.create": "Uusi projekti",
  "home.project.open": "Avaa olemassa oleva projekti",
  "home.sessions.search.title": "Hae keskusteluista",
  "session.todo.empty": "Ei vielä tehtäviä",
  "session.panel.files": "Tiedostot",
  "session.panel.changes": "Muutokset",
  "session.panel.tasks": "Tehtävät",
  "session.panel.terminal": "Pääte",
  "session.panel.empty": "Valitse projekti, jotta voit selata tiedostoja, muutoksia ja tehtäviä sekä käyttää päätettä.",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "Ei muutoksia",
  "session.panel.git.dirty.one": "{{count}} muutettu tiedosto",
  "session.panel.git.dirty.other": "{{count}} muutettua tiedostoa",
  "session.task.waiting": "Odotetaan lupaa",
  "session.task.failed": "Epäonnistui",
  "session.task.retry": "Yritä uudelleen",
  "session.task.open": "Avaa omassa istunnossa",
  "settings.skills.title": "Taidot",
  "settings.skills.description": "Tähän projektiin löydetyt taidot.",
  "settings.skills.empty": "Taitoja ei löytynyt",
  "settings.skills.enabled": "Mallin käytettävissä",
  "settings.skills.disabled": "Kielletty mallilta",
  "settings.skills.search": "Hae taitoja",
  "settings.skills.emptySearch": "Hakua vastaavia taitoja ei ole",
  "settings.skills.details": "Taidon tiedot",
  "settings.skills.noDescription": "Ei kuvausta",
  "settings.skills.source.project": "Projekti",
  "settings.skills.source.global": "Käyttäjä",
  "settings.skills.source.builtin": "Sisäänrakennettu",
  "settings.skills.source.custom": "Lisätty",
  "settings.scheduled.title": "Ajastetut tehtävät",
  "settings.scheduled.description": "Suorita kehote kerran tai päivittäin projektissa.",
  "settings.scheduled.empty": "Ei ajastettuja tehtäviä",
  "settings.scheduled.once": "Kerran",
  "settings.scheduled.daily": "Päivittäin",
  "settings.scheduled.add": "Lisää tehtävä",
  "settings.scheduled.field.name": "Nimi",
  "settings.scheduled.field.prompt": "Kehote",
  "settings.scheduled.field.schedule": "Ajastus",
  "settings.scheduled.field.time": "Suoritusaika",
  "settings.scheduled.error.name": "Anna nimi",
  "settings.scheduled.error.prompt": "Anna kehote",
  "settings.scheduled.error.time": "Valitse aika",
  "settings.scheduled.error.model": "Valitse ensin malli",
  "session.new.project.open": "Avaa olemassa oleva projekti",
  "common.pin": "Kiinnitä",
  "common.unpin": "Irrota",
  "settings.relay.title": "智联AI-avaimet",
  "settings.relay.getKey": "Hanki API-avain",
  "settings.relay.getKey.description": "Luo erilliset avaimet ChatGPT:lle, Grokille ja muille palveluntarjoajille.",
  "settings.relay.upstream": "Taustapalvelu",
  "settings.relay.unified": "Käytä yhteistä API-avainta",
  "settings.relay.unified.description": "Kun asetus on käytössä, kaikki palveluntarjoajat käyttävät tätä avainta.",
  "settings.relay.unified.key": "Yhteinen API-avain",
  "settings.relay.unified.using": "Yhteinen avain käytössä",
  "settings.relay.key.set": "Avain tallennettu",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "Jätä tyhjäksi, jos haluat säilyttää tallennetun avaimen",
  "settings.relay.test": "Testaa yhteys",
  "settings.relay.testing": "Testataan...",
  "settings.relay.fetch": "Hae mallit",
  "settings.relay.fetching": "Haetaan...",
  "settings.relay.edit": "Muokkaa",
  "settings.relay.clearKey": "Tyhjennä avain",
  "settings.relay.add": "Lisää palveluntarjoaja",
  "settings.relay.add.name": "Palveluntarjoajan nimi",
  "settings.relay.models.visible": "{{count}} näkyvää mallia",
  "settings.relay.connected": "Yhdistetty · {{count}} mallia",
  "settings.relay.connectedEmpty": "Yhdistetty, mutta malleja ei palautettu",
  "settings.relay.test.ok": "Yhteys onnistui",
  "settings.relay.test.empty": "Yhdistetty, mutta malleja ei palautettu",
  "settings.relay.models.title": "Palveluntarjoajan {{vendor}} mallit",
  "settings.relay.models.empty": "Ei vielä malleja. Hae luettelo avaimen tallentamisen jälkeen.",
  "settings.relay.models.missing": "Ei enää saatavilla taustapalvelussa",
  "settings.relay.saved": "Tallennettu automaattisesti",
  "settings.relay.retry": "Yritä uudelleen",
  "settings.relay.builtin": "Sisäänrakennettu",
  "settings.relay.delete": "Poista palveluntarjoaja",
  "settings.relay.rollback": "Nollaa tuodut avaimet",
  "settings.relay.rollback.description":
    "Poistaa auth.json-tiedostosta tuodut Relay-avaimet. Alkuperäinen auth.json säilytetään.",
  "settings.relay.error.KEY_MISSING": "Lisää ensin API-avain",
  "settings.relay.error.KEY_REJECTED": "Avain hylättiin",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "Taustapalveluun ei saada yhteyttä",
  "settings.relay.error.UPSTREAM_TIMEOUT": "Taustapalvelun aikakatkaisu",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "Taustapalvelu rajoitti pyyntöä liian suuren pyyntömäärän vuoksi",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "Taustapalvelu palautti virheellisen vastauksen",
  "settings.relay.error.REVISION_CONFLICT": "Tämä asetus muuttui toisessa ikkunassa. Päivitä ja yritä uudelleen.",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "API-avainta ei voitu tallentaa tälle laitteelle.",
  "settings.mcp.add": "Lisää MCP",
  "settings.mcp.edit": "Muokkaa",
  "settings.mcp.field.name": "Nimi",
  "settings.mcp.field.type": "Tyyppi",
  "settings.mcp.field.command": "Komento",
  ...
  "settings.mcp.error.name": "Anna palvelimen nimi",
  "settings.mcp.error.command": "Anna komento",
  "settings.mcp.error.url": "Anna URL-osoite",
  ...
  "dialog.model.unpaid.freeModels.title": "Kodan tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Kodassa.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen antaa sinulle pääsyn kuratoituun joukkoon luotettavia optimoituja malleja koodausagenteille.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja Kodassa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Kodassa.",
  ...
  "dialog.server.description": "Vaihda Koda-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan Kodaa...",
  "wsl.onboarding.checkingOpencodeIn": "Tarkistetaan Kodaa kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Päivitetään Kodaa...",
  "wsl.onboarding.updatingOpencodeIn": "Päivitetään Kodaa kohteessa {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Päivitä Koda jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä Koda",
  "wsl.onboarding.opencodeReadyIn": "Koda on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koda on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna Koda jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna Koda",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kodaa ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin Koda voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "Koda ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten Koda uudelleen.",
  ...
  "toast.update.description": "Kodan uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä Koda-tiimille",
  ...
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että Koda ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "Koda sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita Koda-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda Kodan näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä Koda näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö Koda järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta Kodan teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun Koda käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät Kodan uusinta versiota.",
  ...
  "desktop.menu.documentation": "Koda-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "Koda-valikko",
  ...
  "desktop.recovery.loadFailed": "Kodan lataaminen epäonnistui",
  "desktop.recovery.terminated": "Koda-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "Koda ei vastaa",
  ...
  "desktop.wsl.error.installOpencode": "Kodan asennus epäonnistui",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Kodaa ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kodan päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "Koda Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
