export const dict = {
  "desktop.menu.about": "Koda-ს შესახებ",
  "desktop.about.title": "Koda-ს სამუშაო მაგიდის პროგრამა v{{version}}",
  "desktop.about.detail": "შეცვლილია OpenCode-ის საფუძველზე\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "ხელმისაწვდომია Koda v{{version}}. გაიხსნას გამოშვების გვერდი განახლებისთვის?",
  "desktop.koda.update.open": "გამოშვების გვერდის გახსნა",
  "command.project.create": "ახალი პროექტი",
  "command.project.openExisting": "არსებული პროექტის გახსნა",
  "prompt.toast.projectRequired.title": "აირჩიეთ პროექტი",
  "prompt.toast.projectRequired.description": "გაგზავნამდე შექმენით ან გახსენით პროექტი.",
  "prompt.approval.ask": "დადასტურების მოთხოვნა",
  "prompt.approval.auto": "ჩემ ნაცვლად დადასტურება",
  "prompt.approval.plan": "სრული წვდომა",
  "prompt.more": "მეტი",
  "dialog.project.create.title": "ახალი პროექტი",
  "dialog.project.create.name": "სახელი",
  "dialog.project.create.location": "მდებარეობა",
  "dialog.project.create.browse": "მოძიება",
  "dialog.project.create.path": "მისამართი",
  "dialog.project.create.submit": "შექმნა",
  "dialog.project.create.error.name": "შეიყვანეთ პროექტის სახელი",
  "dialog.project.create.error.invalid": "ამ სახელის საქაღალდისთვის გამოყენება შეუძლებელია",
  "dialog.project.create.error.exists": "ეს საქაღალდე უკვე არსებობს. გახსენით ან აირჩიეთ სხვა სახელი.",
  "dialog.project.create.error.failed": "საქაღალდის შექმნა ვერ მოხერხდა",
  "mcp.status.needs_client_registration": "საჭიროებს კლიენტის რეგისტრაციას",
  "home.welcome.title": "რაში დაგეხმაროთ?",
  "home.project.create": "ახალი პროექტი",
  "home.project.open": "არსებული პროექტის გახსნა",
  "home.sessions.search.title": "საუბრების ძიება",
  "session.todo.empty": "ჯერ დავალებები არ არის",
  "session.panel.files": "ფაილები",
  "session.panel.changes": "ცვლილებები",
  "session.panel.tasks": "დავალებები",
  "session.panel.terminal": "ტერმინალი",
  "session.panel.empty": "აირჩიეთ პროექტი ფაილების, ცვლილებების, დავალებებისა და ტერმინალის სანახავად.",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "ცვლილებების გარეშე",
  "session.panel.git.dirty.one": "{{count}} შეცვლილი ფაილი",
  "session.panel.git.dirty.other": "{{count}} შეცვლილი ფაილი",
  "session.task.waiting": "ნებართვის მოლოდინში",
  "session.task.failed": "ვერ შესრულდა",
  "session.task.retry": "ხელახლა ცდა",
  "session.task.open": "ცალკე სესიაში გახსნა",
  "settings.skills.title": "უნარები",
  "settings.skills.description": "ამ პროექტისთვის ნაპოვნი უნარები.",
  "settings.skills.empty": "უნარები ვერ მოიძებნა",
  "settings.skills.enabled": "ხელმისაწვდომია მოდელისთვის",
  "settings.skills.disabled": "აკრძალულია მოდელისთვის",
  "settings.skills.search": "უნარების ძიება",
  "settings.skills.emptySearch": "ძიების შესაბამისი უნარები არ არის",
  "settings.skills.details": "უნარის დეტალები",
  "settings.skills.noDescription": "აღწერა არ არის",
  "settings.skills.source.project": "პროექტი",
  "settings.skills.source.global": "მომხმარებელი",
  "settings.skills.source.builtin": "ჩაშენებული",
  "settings.skills.source.custom": "დამატებული",
  "settings.scheduled.title": "დაგეგმილი დავალებები",
  "settings.scheduled.description": "პროექტში მოთხოვნის გაშვება ერთხელ ან ყოველდღე.",
  "settings.scheduled.empty": "დაგეგმილი დავალებები არ არის",
  "settings.scheduled.once": "ერთხელ",
  "settings.scheduled.daily": "ყოველდღე",
  "settings.scheduled.add": "დავალების დამატება",
  "settings.scheduled.field.name": "სახელი",
  "settings.scheduled.field.prompt": "მოთხოვნა",
  "settings.scheduled.field.schedule": "განრიგი",
  "settings.scheduled.field.time": "გაშვების დრო",
  "settings.scheduled.error.name": "შეიყვანეთ სახელი",
  "settings.scheduled.error.prompt": "შეიყვანეთ მოთხოვნა",
  "settings.scheduled.error.time": "აირჩიეთ დრო",
  "settings.scheduled.error.model": "ჯერ აირჩიეთ მოდელი",
  "session.new.project.open": "არსებული პროექტის გახსნა",
  "common.pin": "მიმაგრება",
  "common.unpin": "მოხსნა",
  "settings.relay.title": "智联AI გასაღებები",
  "settings.relay.getKey": "API გასაღების მიღება",
  "settings.relay.getKey.description":
    "შექმენით ცალკე გასაღებები ChatGPT-ისთვის, Grok-ისთვის და სხვა მომწოდებლებისთვის.",
  "settings.relay.upstream": "ზედა დონის სერვერი",
  "settings.relay.unified": "საერთო API გასაღების გამოყენება",
  "settings.relay.unified.description": "ჩართვისას ყველა მომწოდებელი ამ გასაღებს იყენებს.",
  "settings.relay.unified.key": "საერთო API გასაღები",
  "settings.relay.unified.using": "გამოიყენება საერთო გასაღები",
  "settings.relay.key.set": "გასაღები შენახულია",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "შენახული გასაღების დასატოვებლად ცარიელი დატოვეთ",
  "settings.relay.test": "კავშირის შემოწმება",
  "settings.relay.testing": "მოწმდება...",
  "settings.relay.fetch": "მოდელების მიღება",
  "settings.relay.fetching": "იტვირთება...",
  "settings.relay.edit": "ჩასწორება",
  "settings.relay.clearKey": "გასაღების გასუფთავება",
  "settings.relay.add": "მომწოდებლის დამატება",
  "settings.relay.add.name": "მომწოდებლის სახელი",
  "settings.relay.models.visible": "{{count}} ხილული მოდელი",
  "settings.relay.connected": "დაკავშირებულია · {{count}} მოდელი",
  "settings.relay.connectedEmpty": "დაკავშირებულია, მაგრამ მოდელები არ დაბრუნებულა",
  "settings.relay.test.ok": "კავშირი წარმატებულია",
  "settings.relay.test.empty": "დაკავშირებულია, მაგრამ მოდელები არ დაბრუნებულა",
  "settings.relay.models.title": "{{vendor}} მოდელები",
  "settings.relay.models.empty": "ჯერ მოდელები არ არის. გასაღების შენახვის შემდეგ მიიღეთ სია.",
  "settings.relay.models.missing": "ზედა დონის სერვერზე აღარ არის",
  "settings.relay.saved": "ავტომატურად შენახულია",
  "settings.relay.retry": "ხელახლა ცდა",
  "settings.relay.builtin": "ჩაშენებული",
  "settings.relay.delete": "მომწოდებლის წაშლა",
  "settings.relay.rollback": "შემოტანილი გასაღებების განულება",
  "settings.relay.rollback.description":
    "შლის auth.json-იდან შემოტანილ Relay გასაღებებს. საწყისი auth.json შენარჩუნდება.",
  "settings.relay.error.KEY_MISSING": "ჯერ დაამატეთ API გასაღები",
  "settings.relay.error.KEY_REJECTED": "გასაღები უარყოფილია",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "ზედა დონის სერვერი მიუწვდომელია",
  "settings.relay.error.UPSTREAM_TIMEOUT": "ზედა დონის სერვერის ლოდინის დრო ამოიწურა",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "ზედა დონის სერვერმა მოთხოვნების სიხშირე შეზღუდა",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "ზედა დონის სერვერმა არასწორი პასუხი დააბრუნა",
  "settings.relay.error.REVISION_CONFLICT": "ეს პარამეტრი სხვა ფანჯარაში შეიცვალა. განაახლეთ და ხელახლა სცადეთ.",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "ამ მოწყობილობაზე API გასაღების შენახვა ვერ მოხერხდა.",
  "settings.mcp.add": "MCP-ის დამატება",
  "settings.mcp.edit": "ჩასწორება",
  "settings.mcp.field.name": "სახელი",
  "settings.mcp.field.type": "ტიპი",
  "settings.mcp.field.command": "ბრძანება",
  ...
  "settings.mcp.type.local": "ადგილობრივი",
  "settings.mcp.type.remote": "დაშორებული",
  "settings.mcp.error.name": "შეიყვანეთ სერვერის სახელი",
  "settings.mcp.error.command": "შეიყვანეთ ბრძანება",
  "settings.mcp.error.url": "შეიყვანეთ URL",
  ...
  "desktop.menu.documentation": "Koda დოკუმენტაცია",
  ...
  "desktop.menu.ariaLabel": "Koda მენიუ",
  ...
  "desktop.recovery.loadFailed": "Koda ვერ ჩაიტვირთა",
  "desktop.recovery.terminated": "Koda ფანჯარა მოულოდნელად შეწყდა",
  "desktop.recovery.unresponsive": "Koda არ პასუხობს",
  ...
  "desktop.wsl.error.installOpencode": "Koda ინსტალაცია ვერ მოხერხდა",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Koda არ არის დაინსტალირებული {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Koda განახლება დასრულდა, მაგრამ {{distro}} კვლავ იუწყება {{installed}}; მოსალოდნელია {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "უფასო მოდელები მოწოდებულია Koda",
  ...
  "provider.connect.apiKey.description":
    "შეიყვანეთ თქვენი {{provider}} API გასაღები თქვენი ანგარიშის დასაკავშირებლად და გამოიყენეთ {{provider}} მოდელები Koda-ში.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen გაძლევთ წვდომას კოდირების აგენტებისთვის საიმედო ოპტიმიზირებული მოდელების კურირებულ კომპლექტზე.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " შეაგროვეთ თქვენი ავტორიზაციის კოდი თქვენი ანგარიშის დასაკავშირებლად და გამოიყენოთ {{provider}} მოდელები Koda-ში.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " და შეიყვანეთ ქვემოთ კოდი თქვენი ანგარიშის დასაკავშირებლად და გამოიყენეთ {{provider}} მოდელები Koda-ში.",
  ...
  "dialog.server.description": "გადართეთ რომელ Koda სერვერს უკავშირდება ეს აპი.",
  ...
  "wsl.onboarding.checkingOpencode": "შემოწმებულია Koda...",
  "wsl.onboarding.checkingOpencodeIn": "შემოწმებულია Koda-ში {{distro}}...",
  "wsl.onboarding.updatingOpencode": "განახლება Koda...",
  "wsl.onboarding.updatingOpencodeIn": "Koda განახლება ხდება {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "განახლება Koda {{distro}}-ში.",
  "wsl.onboarding.updateOpencode": "განახლება Koda",
  "wsl.onboarding.opencodeReadyIn": "Koda მზად არის {{distro}}-ში.",
  "wsl.onboarding.opencodeReady": "Koda მზად არის.",
  "wsl.onboarding.installOpencodeIn": "დააინსტალირეთ Koda {{distro}}-ში.",
  "wsl.onboarding.installOpencode": "დააინსტალირეთ Koda",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda არ არის დაინსტალირებული",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows ქვესისტემა Linux-ისთვის) საჭიროა, სანამ Koda შეძლებს WSL სერვერის დამატებას",
  "wsl.onboarding.wslUnavailable.title": "WSL მიუწვდომელია",
  "wsl.onboarding.wslUnavailable.description": "Koda ვერ დაადასტურა WSL ამ მოწყობილობაზე.",
  "wsl.onboarding.installWsl": "დააინსტალირეთ WSL",
  "wsl.onboarding.windowsRestartRequired":
    "გადატვირთეთ Windows WSL-ის ინსტალაციის დასასრულებლად, შემდეგ ხელახლა გახსენით Koda.",
  ...
  "help.tabs.introduction": "Koda სამუშაო მაგიდა ახლა აგებულია ჩანართების გარშემო.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Koda-ის ({{version}}) ახალი ვერსია ახლა ხელმისაწვდომია დასაინსტალირებლად.",
  ...
  "error.page.report.prefix": "გთხოვთ, შეატყობინოთ ეს შეცდომა Koda გუნდს",
  ...
  "error.chain.mcpFailed":
    'MCP სერვერი "{{name}}" ვერ მოხერხდა. შენიშვნა, Koda ჯერ არ უჭერს მხარს MCP ავთენტიფიკაციას.',
  ...
  "sidebar.gettingStarted.line1": "Koda მოიცავს უფასო მოდელებს, ასე რომ თქვენ შეგიძლიათ დაუყოვნებლივ დაიწყოთ.",
  ...
  "app.name.desktop": "Koda სამუშაო მაგიდა",
  ...
  "settings.desktop.wsl.description": "გაუშვით Koda სერვერი WSL-ში Windows-ზე.",
  ...
  "settings.general.row.language.description": "შეცვალეთ ჩვენების ენა Koda",
  ...
  "settings.general.row.appearance.description": "მორგეთ, როგორ გამოიყურება Koda თქვენს მოწყობილობაზე",
  "settings.general.row.colorScheme.title": "ფერთა სქემა",
  "settings.general.row.colorScheme.description": "აირჩიეთ, მიჰყვება თუ არა Koda სისტემას, ღია თუ ბნელ თემას",
  "settings.general.row.theme.title": "თემა",
  "settings.general.row.theme.description": "მორგება, თუ როგორ არის Koda თემატური.",
  ...
  "settings.updates.row.startup.description": "ავტომატურად შეამოწმეთ განახლებები, როდესაც Koda გაშვება",
  ...
  "settings.updates.toast.latest.description": "თქვენ იყენებთ Koda-ის უახლეს ვერსიას.",
