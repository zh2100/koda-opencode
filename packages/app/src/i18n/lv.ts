export const dict = {
  "desktop.menu.about": "Par Koda",
  "desktop.about.title": "Koda darbvirsmas lietotne v{{version}}",
  "desktop.about.detail":
    "Pārveidots, izmantojot OpenCode kā pamatu\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "Pieejama Koda v{{version}}. Atvērt laidiena lapu, lai atjauninātu?",
  "desktop.koda.update.open": "Atvērt laidiena lapu",
  "command.project.create": "Jauns projekts",
  "command.project.openExisting": "Atvērt esošu projektu",
  "prompt.toast.projectRequired.title": "Izvēlieties projektu",
  "prompt.toast.projectRequired.description": "Pirms nosūtīšanas izveidojiet vai atveriet projektu.",
  "prompt.approval.ask": "Pieprasīt apstiprinājumu",
  "prompt.approval.auto": "Apstiprināt manā vietā",
  "prompt.approval.plan": "Pilna piekļuve",
  "prompt.more": "Vairāk",
  "dialog.project.create.title": "Jauns projekts",
  "dialog.project.create.name": "Nosaukums",
  "dialog.project.create.location": "Atrašanās vieta",
  "dialog.project.create.browse": "Pārlūkot",
  "dialog.project.create.path": "Ceļš",
  "dialog.project.create.submit": "Izveidot",
  "dialog.project.create.error.name": "Ievadiet projekta nosaukumu",
  "dialog.project.create.error.invalid": "Šo nosaukumu nevar izmantot mapei",
  "dialog.project.create.error.exists": "Šāda mape jau pastāv. Atveriet to vai izvēlieties citu nosaukumu.",
  "dialog.project.create.error.failed": "Neizdevās izveidot mapi",
  "mcp.status.needs_client_registration": "nepieciešama klienta reģistrācija",
  "home.welcome.title": "Kā varu palīdzēt?",
  "home.project.create": "Jauns projekts",
  "home.project.open": "Atvērt esošu projektu",
  "home.sessions.search.title": "Meklēt sarunas",
  "session.todo.empty": "Vēl nav uzdevumu",
  "session.panel.files": "Faili",
  "session.panel.changes": "Izmaiņas",
  "session.panel.tasks": "Uzdevumi",
  "session.panel.terminal": "Terminālis",
  "session.panel.empty": "Izvēlieties projektu, lai pārlūkotu failus, izmaiņas, uzdevumus un termināli.",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "Bez izmaiņām",
  "session.panel.git.dirty.one": "{{count}} mainīts fails",
  "session.panel.git.dirty.other": "{{count}} mainīti faili",
  "session.panel.git.dirty.zero": "{{count}} mainītu failu",
  "session.task.waiting": "Gaida atļauju",
  "session.task.failed": "Neizdevās",
  "session.task.retry": "Mēģināt vēlreiz",
  "session.task.open": "Atvērt atsevišķā sesijā",
  "settings.skills.title": "Prasmes",
  "settings.skills.description": "Šim projektam atrastās prasmes.",
  "settings.skills.empty": "Prasmes nav atrastas",
  "settings.skills.enabled": "Pieejama modelim",
  "settings.skills.disabled": "Modelim liegta",
  "settings.skills.search": "Meklēt prasmes",
  "settings.skills.emptySearch": "Nav meklējumam atbilstošu prasmju",
  "settings.skills.details": "Prasmes informācija",
  "settings.skills.noDescription": "Nav apraksta",
  "settings.skills.source.project": "Projekts",
  "settings.skills.source.global": "Lietotājs",
  "settings.skills.source.builtin": "Iebūvēta",
  "settings.skills.source.custom": "Pievienota",
  "settings.scheduled.title": "Ieplānotie uzdevumi",
  "settings.scheduled.description": "Izpildiet uzvedni projektā vienreiz vai katru dienu.",
  "settings.scheduled.empty": "Nav ieplānotu uzdevumu",
  "settings.scheduled.once": "Vienreiz",
  "settings.scheduled.daily": "Katru dienu",
  "settings.scheduled.add": "Pievienot uzdevumu",
  "settings.scheduled.field.name": "Nosaukums",
  "settings.scheduled.field.prompt": "Uzvedne",
  "settings.scheduled.field.schedule": "Grafiks",
  "settings.scheduled.field.time": "Izpildes laiks",
  "settings.scheduled.error.name": "Ievadiet nosaukumu",
  "settings.scheduled.error.prompt": "Ievadiet uzvedni",
  "settings.scheduled.error.time": "Izvēlieties laiku",
  "settings.scheduled.error.model": "Vispirms izvēlieties modeli",
  "session.new.project.open": "Atvērt esošu projektu",
  "common.pin": "Piespraust",
  "common.unpin": "Atspraust",
  "settings.relay.title": "智联AI atslēgas",
  "settings.relay.getKey": "Iegūt API atslēgu",
  "settings.relay.getKey.description":
    "Izveidojiet atsevišķas atslēgas ChatGPT, Grok un citiem pakalpojumu sniedzējiem.",
  "settings.relay.upstream": "Augšupējais serveris",
  "settings.relay.unified": "Izmantot kopīgu API atslēgu",
  "settings.relay.unified.description": "Ja iespējots, visi piegādātāji izmanto šo atslēgu.",
  "settings.relay.unified.key": "Kopīga API atslēga",
  "settings.relay.unified.using": "Tiek izmantota kopīgā atslēga",
  "settings.relay.key.set": "Atslēga saglabāta",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "Atstājiet tukšu, lai paturētu saglabāto atslēgu",
  "settings.relay.test": "Pārbaudīt savienojumu",
  "settings.relay.testing": "Pārbauda...",
  "settings.relay.fetch": "Iegūt modeļus",
  "settings.relay.fetching": "Iegūst...",
  "settings.relay.edit": "Rediģēt",
  "settings.relay.clearKey": "Notīrīt atslēgu",
  "settings.relay.add": "Pievienot piegādātāju",
  "settings.relay.add.name": "Piegādātāja nosaukums",
  "settings.relay.models.visible": "Redzamo modeļu skaits: {{count}}",
  "settings.relay.connected": "Savienots · modeļu skaits: {{count}}",
  "settings.relay.connectedEmpty": "Savienots, bet netika atgriezts neviens modelis",
  "settings.relay.test.ok": "Savienojums izdevās",
  "settings.relay.test.empty": "Savienots, bet netika atgriezts neviens modelis",
  "settings.relay.models.title": "{{vendor}} modeļi",
  "settings.relay.models.empty": "Modeļu vēl nav. Pēc atslēgas saglabāšanas iegūstiet sarakstu.",
  "settings.relay.models.missing": "Vairs nav augšupējā serverī",
  "settings.relay.saved": "Saglabāts automātiski",
  "settings.relay.retry": "Mēģināt vēlreiz",
  "settings.relay.builtin": "Iebūvēts",
  "settings.relay.delete": "Dzēst piegādātāju",
  "settings.relay.rollback": "Atiestatīt importētās atslēgas",
  "settings.relay.rollback.description":
    "Notīra no auth.json importētās Relay atslēgas. Sākotnējais auth.json tiek paturēts.",
  "settings.relay.error.KEY_MISSING": "Vispirms pievienojiet API atslēgu",
  "settings.relay.error.KEY_REJECTED": "Atslēga tika noraidīta",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "Augšupējais serveris nav sasniedzams",
  "settings.relay.error.UPSTREAM_TIMEOUT": "Augšupējā servera gaidīšanas laiks beidzās",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "Augšupējais serveris ierobežoja pieprasījumu biežumu",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "Augšupējais serveris atgrieza nederīgu atbildi",
  "settings.relay.error.REVISION_CONFLICT": "Šis iestatījums mainīts citā logā. Atsvaidziniet un mēģiniet vēlreiz.",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "Neizdevās saglabāt API atslēgu šajā ierīcē.",
  "settings.mcp.add": "Pievienot MCP",
  "settings.mcp.edit": "Rediģēt",
  "settings.mcp.field.name": "Nosaukums",
  "settings.mcp.field.type": "Tips",
  ...
  "settings.mcp.type.local": "Vietējs",
  "settings.mcp.type.remote": "Attālināts",
  "settings.mcp.error.name": "Ievadiet servera nosaukumu",
  "settings.mcp.error.command": "Ievadiet komandu",
  "settings.mcp.error.url": "Ievadiet URL",
  ...
  "desktop.menu.documentation": "Koda dokumentācija",
  ...
  "desktop.menu.ariaLabel": "Koda izvēlne",
  ...
  "desktop.recovery.loadFailed": "Neizdevās ielādēt Koda",
  "desktop.recovery.terminated": "Koda logs negaidīti aizvērts",
  "desktop.recovery.unresponsive": "Koda neatbild",
  ...
  "desktop.wsl.error.installOpencode": "Koda instalēšana neizdevās",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Koda nav instalēts {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Koda atjaunināšana pabeigta, bet {{distro}} joprojām rāda {{installed}}; gaidīts {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Bezmaksas modeļi no Koda",
  ...
  "provider.connect.apiKey.description":
    "Ievadiet savu {{provider}} API atslēgu, lai savienotu kontu un izmantotu {{provider}} modeļus Koda.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen nodrošina piekļuvi atlasītiem uzticamiem optimizētiem modeļiem kodēšanas aģentiem.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", lai saņemtu autorizācijas kodu, savienotu kontu un izmantotu {{provider}} modeļus Koda.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " un ievadiet zemāk redzamo kodu, lai savienotu kontu un izmantotu {{provider}} modeļus Koda.",
  ...
  "dialog.server.description": "Mainiet, pie kura Koda servera šī lietotne pieslēdzas.",
  ...
  "wsl.onboarding.checkingOpencode": "Pārbaudu Koda...",
  "wsl.onboarding.checkingOpencodeIn": "Pārbaudu Koda distribūcijā {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atjauninu Koda...",
  "wsl.onboarding.updatingOpencodeIn": "Atjauninu Koda distribūcijā {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atjauniniet Koda distribūcijā {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atjauniniet Koda",
  "wsl.onboarding.opencodeReadyIn": "Koda ir gatavs distribūcijā {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koda ir gatavs.",
  "wsl.onboarding.installOpencodeIn": "Instalējiet Koda distribūcijā {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalējiet Koda",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda nav instalēts",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Pirms Koda var pievienot WSL serveri, nepieciešams WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nav pieejams",
  "wsl.onboarding.wslUnavailable.description": "Koda neizdevās pārbaudīt WSL šajā datorā.",
  "wsl.onboarding.installWsl": "Instalēt WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartējiet Windows, lai pabeigtu WSL instalēšanu, pēc tam atveriet Koda no jauna.",
  ...
  "help.tabs.introduction": "Koda Desktop tagad balstās uz cilnēm.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Pieejama jauna Koda versija ({{version}}) instalēšanai.",
  ...
  "error.page.report.prefix": "Lūdzu, ziņojiet par šo kļūdu Koda komandai",
  ...
  "error.chain.mcpFailed": 'MCP serveris "{{name}}" neizdevās. Ņemiet vērā, Koda vēl neatbalsta MCP autentifikāciju.',
  ...
  "sidebar.gettingStarted.line1": "Koda ietver bezmaksas modeļus, lai varētu sākt uzreiz.",
  ...
  "app.name.desktop": "Koda darbvirsma",
  ...
  "settings.desktop.wsl.description": "Palaist Koda serveri WSL vidē uz Windows.",
  ...
  "settings.general.row.language.description": "Mainīt Koda saskarnes valodu",
  ...
  "settings.general.row.appearance.description": "Pielāgojiet, kā Koda izskatās jūsu ierīcē",
  "settings.general.row.colorScheme.title": "Krāsu shēma",
  "settings.general.row.colorScheme.description": "Izvēlieties, vai Koda sekos sistēmas, gaišajai vai tumšajai tēmai",
  "settings.general.row.theme.title": "Tēma",
  "settings.general.row.theme.description": "Pielāgojiet Koda tēmu.",
  ...
  "settings.updates.row.startup.description": "Automātiski pārbaudīt atjauninājumus, palaižot Koda",
  ...
  "settings.updates.toast.latest.description": "Jūs izmantojat jaunāko Koda versiju.",
