export const dict = {
  "desktop.menu.about": "Giới thiệu Koda",
  "desktop.about.title": "Koda Desktop v{{version}}",
  "desktop.about.detail":
    "Được chỉnh sửa dựa trên lõi OpenCode\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "Đã có Koda v{{version}}. Mở trang phát hành để nâng cấp?",
  "desktop.koda.update.open": "Mở trang phát hành",
  "command.project.create": "Dự án mới",
  "command.project.openExisting": "Mở dự án hiện có",
  "prompt.toast.projectRequired.title": "Chọn dự án",
  "prompt.toast.projectRequired.description": "Tạo hoặc mở dự án trước khi gửi.",
  "prompt.approval.ask": "Yêu cầu phê duyệt",
  "prompt.approval.auto": "Phê duyệt thay tôi",
  "prompt.approval.plan": "Toàn quyền truy cập",
  "prompt.more": "Thêm",
  "dialog.project.create.title": "Dự án mới",
  "dialog.project.create.name": "Tên",
  "dialog.project.create.location": "Vị trí",
  "dialog.project.create.browse": "Duyệt",
  "dialog.project.create.path": "Đường dẫn",
  "dialog.project.create.submit": "Tạo",
  "dialog.project.create.error.name": "Nhập tên dự án",
  "dialog.project.create.error.invalid": "Không thể dùng tên này cho thư mục",
  "dialog.project.create.error.exists": "Thư mục đó đã tồn tại. Hãy mở thư mục đó hoặc chọn tên khác.",
  "dialog.project.create.error.failed": "Không thể tạo thư mục",
  "mcp.status.needs_client_registration": "cần đăng ký máy khách",
  "home.welcome.title": "Tôi có thể giúp gì cho bạn?",
  "home.project.create": "Dự án mới",
  "home.project.open": "Mở dự án hiện có",
  "home.sessions.search.title": "Tìm kiếm cuộc trò chuyện",
  "session.todo.empty": "Chưa có tác vụ",
  "session.panel.files": "Tệp",
  "session.panel.changes": "Thay đổi",
  "session.panel.tasks": "Tác vụ",
  "session.panel.terminal": "Terminal",
  "session.panel.empty": "Chọn dự án để duyệt tệp, thay đổi, tác vụ và terminal.",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "Không có thay đổi",
  "session.panel.git.dirty.one": "{{count}} tệp đã thay đổi",
  "session.panel.git.dirty.other": "{{count}} tệp đã thay đổi",
  "session.task.waiting": "Đang chờ cấp quyền",
  "session.task.failed": "Thất bại",
  "session.task.retry": "Thử lại",
  "session.task.open": "Mở trong phiên riêng",
  "settings.skills.title": "Kỹ năng",
  "settings.skills.description": "Các kỹ năng được tìm thấy cho dự án này.",
  "settings.skills.empty": "Không tìm thấy kỹ năng",
  "settings.skills.enabled": "Cho phép mô hình sử dụng",
  "settings.skills.disabled": "Không cho phép mô hình sử dụng",
  "settings.skills.search": "Tìm kiếm kỹ năng",
  "settings.skills.emptySearch": "Không có kỹ năng phù hợp với tìm kiếm này",
  "settings.skills.details": "Chi tiết kỹ năng",
  "settings.skills.noDescription": "Không có mô tả",
  "settings.skills.source.project": "Dự án",
  "settings.skills.source.global": "Người dùng",
  "settings.skills.source.builtin": "Tích hợp sẵn",
  "settings.skills.source.custom": "Đã thêm",
  "settings.scheduled.title": "Tác vụ đã lên lịch",
  "settings.scheduled.description": "Chạy lời nhắc một lần hoặc hằng ngày trong dự án.",
  "settings.scheduled.empty": "Không có tác vụ đã lên lịch",
  "settings.scheduled.once": "Một lần",
  "settings.scheduled.daily": "Hằng ngày",
  "settings.scheduled.add": "Thêm tác vụ",
  "settings.scheduled.field.name": "Tên",
  "settings.scheduled.field.prompt": "Lời nhắc",
  "settings.scheduled.field.schedule": "Lịch chạy",
  "settings.scheduled.field.time": "Chạy lúc",
  "settings.scheduled.error.name": "Nhập tên",
  "settings.scheduled.error.prompt": "Nhập lời nhắc",
  "settings.scheduled.error.time": "Chọn thời gian",
  "settings.scheduled.error.model": "Chọn mô hình trước",
  "session.new.project.open": "Mở dự án hiện có",
  "common.pin": "Ghim",
  "common.unpin": "Bỏ ghim",
  "settings.relay.title": "Khóa 智联AI",
  "settings.relay.getKey": "Lấy khóa API",
  "settings.relay.getKey.description": "Tạo khóa riêng cho ChatGPT, Grok và các nhà cung cấp khác.",
  "settings.relay.upstream": "Dịch vụ thượng nguồn",
  "settings.relay.unified": "Dùng khóa API chung",
  "settings.relay.unified.description": "Khi bật, mọi nhà cung cấp đều dùng khóa này.",
  "settings.relay.unified.key": "Khóa API chung",
  "settings.relay.unified.using": "Đang dùng khóa chung",
  "settings.relay.key.set": "Đã lưu khóa",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "Để trống để giữ khóa đã lưu",
  "settings.relay.test": "Kiểm tra kết nối",
  "settings.relay.testing": "Đang kiểm tra...",
  "settings.relay.fetch": "Lấy mô hình",
  "settings.relay.fetching": "Đang lấy...",
  "settings.relay.edit": "Chỉnh sửa",
  "settings.relay.clearKey": "Xóa khóa",
  "settings.relay.add": "Thêm nhà cung cấp",
  "settings.relay.add.name": "Tên nhà cung cấp",
  "settings.relay.models.visible": "{{count}} mô hình hiển thị",
  "settings.relay.connected": "Đã kết nối · {{count}} mô hình",
  "settings.relay.connectedEmpty": "Đã kết nối nhưng không có mô hình nào được trả về",
  "settings.relay.test.ok": "Kết nối thành công",
  "settings.relay.test.empty": "Đã kết nối nhưng không có mô hình nào được trả về",
  "settings.relay.models.title": "Mô hình của {{vendor}}",
  "settings.relay.models.empty": "Chưa có mô hình. Hãy lấy danh sách sau khi lưu khóa.",
  "settings.relay.models.missing": "Không còn trên dịch vụ thượng nguồn",
  "settings.relay.saved": "Đã lưu tự động",
  "settings.relay.retry": "Thử lại",
  "settings.relay.builtin": "Tích hợp sẵn",
  "settings.relay.delete": "Xóa nhà cung cấp",
  "settings.relay.rollback": "Đặt lại khóa đã nhập",
  "settings.relay.rollback.description": "Xóa khóa Relay đã nhập từ auth.json. Tệp auth.json gốc được giữ lại.",
  "settings.relay.error.KEY_MISSING": "Thêm khóa API trước",
  "settings.relay.error.KEY_REJECTED": "Khóa bị từ chối",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "Không thể truy cập dịch vụ thượng nguồn",
  "settings.relay.error.UPSTREAM_TIMEOUT": "Dịch vụ thượng nguồn đã hết thời gian chờ",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "Dịch vụ thượng nguồn đã giới hạn tần suất yêu cầu",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "Dịch vụ thượng nguồn trả về phản hồi không hợp lệ",
  "settings.relay.error.REVISION_CONFLICT": "Cài đặt này đã thay đổi trong cửa sổ khác. Hãy làm mới và thử lại.",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "Không thể lưu khóa API trên thiết bị này.",
  "settings.mcp.add": "Thêm MCP",
  "settings.mcp.edit": "Chỉnh sửa",
  "settings.mcp.field.name": "Tên",
  "settings.mcp.field.type": "Loại",
  "settings.mcp.field.command": "Lệnh",
  ...
  "settings.mcp.error.name": "Nhập tên máy chủ",
  "settings.mcp.error.command": "Nhập lệnh",
  "settings.mcp.error.url": "Nhập URL",
  ...
  "desktop.menu.documentation": "Tài liệu Koda",
  ...
  "desktop.recovery.loadFailed": "Không tải được Koda",
  "desktop.recovery.terminated": "Cửa sổ Koda đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "Koda không phản hồi",
  ...
  "desktop.wsl.error.installOpencode": "Không cài đặt được Koda",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Koda chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật Koda nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do Koda cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong Koda.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen cho phép bạn truy cập một bộ mô hình được tuyển chọn, tối ưu hóa và đáng tin cậy dành cho tác nhân lập trình.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong Koda.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong Koda.",
  ...
  "dialog.server.description": "Chuyển máy chủ Koda mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingOpencode": "Đang kiểm tra Koda...",
  "wsl.onboarding.checkingOpencodeIn": "Đang kiểm tra Koda trong {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Đang cập nhật Koda...",
  "wsl.onboarding.updatingOpencodeIn": "Đang cập nhật Koda trong {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Cập nhật Koda trong {{distro}}.",
  "wsl.onboarding.updateOpencode": "Cập nhật Koda",
  "wsl.onboarding.opencodeReadyIn": "Koda đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koda đã sẵn sàng.",
  "wsl.onboarding.installOpencodeIn": "Cài đặt Koda trong {{distro}}.",
  "wsl.onboarding.installOpencode": "Cài đặt Koda",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi Koda có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "Koda không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại Koda.",
  ...
  "help.tabs.introduction": "Koda Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của Koda ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm Koda",
  ...
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: Koda chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "Koda bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ Koda bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho Koda",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của Koda trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem Koda tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của Koda.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi Koda khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của Koda.",
