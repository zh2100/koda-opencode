export const dict = {
  "desktop.menu.about": "Σχετικά με το Koda",
  "desktop.about.title": "Koda Desktop v{{version}}",
  "desktop.about.detail":
    "Τροποποιημένη έκδοση με βάση το OpenCode\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available":
    "Το Koda v{{version}} είναι διαθέσιμο. Να ανοίξει η σελίδα της έκδοσης για αναβάθμιση;",
  "desktop.koda.update.open": "Άνοιγμα σελίδας έκδοσης",
  "command.project.create": "Νέο έργο",
  "command.project.openExisting": "Άνοιγμα υπάρχοντος έργου",
  "prompt.toast.projectRequired.title": "Επιλέξτε ένα έργο",
  "prompt.toast.projectRequired.description": "Δημιουργήστε ή ανοίξτε ένα έργο πριν από την αποστολή.",
  "prompt.approval.ask": "Αίτημα έγκρισης",
  "prompt.approval.auto": "Έγκριση εκ μέρους μου",
  "prompt.approval.plan": "Πλήρης πρόσβαση",
  "prompt.more": "Περισσότερα",
  "dialog.project.create.title": "Νέο έργο",
  "dialog.project.create.name": "Όνομα",
  "dialog.project.create.location": "Τοποθεσία",
  "dialog.project.create.browse": "Περιήγηση",
  "dialog.project.create.path": "Διαδρομή",
  "dialog.project.create.submit": "Δημιουργία",
  "dialog.project.create.error.name": "Εισαγάγετε ένα όνομα έργου",
  "dialog.project.create.error.invalid": "Αυτό το όνομα δεν μπορεί να χρησιμοποιηθεί για φάκελο",
  "dialog.project.create.error.exists": "Αυτός ο φάκελος υπάρχει ήδη. Ανοίξτε τον ή επιλέξτε άλλο όνομα.",
  "dialog.project.create.error.failed": "Δεν ήταν δυνατή η δημιουργία του φακέλου",
  "mcp.status.needs_client_registration": "απαιτείται εγγραφή πελάτη",
  "home.welcome.title": "Πώς μπορώ να βοηθήσω;",
  "home.project.create": "Νέο έργο",
  "home.project.open": "Άνοιγμα υπάρχοντος έργου",
  "home.sessions.search.title": "Αναζήτηση συνομιλιών",
  "session.todo.empty": "Δεν υπάρχουν ακόμη εργασίες",
  "session.panel.files": "Αρχεία",
  "session.panel.changes": "Αλλαγές",
  "session.panel.tasks": "Εργασίες",
  "session.panel.terminal": "Τερματικό",
  "session.panel.empty": "Επιλέξτε ένα έργο για περιήγηση στα αρχεία, τις αλλαγές, τις εργασίες και το τερματικό.",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "Χωρίς αλλαγές",
  "session.panel.git.dirty.one": "{{count}} τροποποιημένο αρχείο",
  "session.panel.git.dirty.other": "{{count}} τροποποιημένα αρχεία",
  "session.task.waiting": "Αναμονή για άδεια",
  "session.task.failed": "Αποτυχία",
  "session.task.retry": "Επανάληψη προσπάθειας",
  "session.task.open": "Άνοιγμα σε ξεχωριστή συνεδρία",
  "settings.skills.title": "Δεξιότητες",
  "settings.skills.description": "Δεξιότητες που εντοπίστηκαν για αυτό το έργο.",
  "settings.skills.empty": "Δεν βρέθηκαν δεξιότητες",
  "settings.skills.enabled": "Διαθέσιμη στο μοντέλο",
  "settings.skills.disabled": "Απαγορευμένη για το μοντέλο",
  "settings.skills.search": "Αναζήτηση δεξιοτήτων",
  "settings.skills.emptySearch": "Καμία δεξιότητα δεν ταιριάζει με την αναζήτηση",
  "settings.skills.details": "Λεπτομέρειες δεξιότητας",
  "settings.skills.noDescription": "Χωρίς περιγραφή",
  "settings.skills.source.project": "Έργο",
  "settings.skills.source.global": "Χρήστης",
  "settings.skills.source.builtin": "Ενσωματωμένη",
  "settings.skills.source.custom": "Προστέθηκε",
  "settings.scheduled.title": "Προγραμματισμένες εργασίες",
  "settings.scheduled.description": "Εκτελέστε μια προτροπή μία φορά ή καθημερινά σε ένα έργο.",
  "settings.scheduled.empty": "Δεν υπάρχουν προγραμματισμένες εργασίες",
  "settings.scheduled.once": "Μία φορά",
  "settings.scheduled.daily": "Κάθε μέρα",
  "settings.scheduled.add": "Προσθήκη εργασίας",
  "settings.scheduled.field.name": "Όνομα",
  "settings.scheduled.field.prompt": "Προτροπή",
  "settings.scheduled.field.schedule": "Πρόγραμμα",
  "settings.scheduled.field.time": "Ώρα εκτέλεσης",
  "settings.scheduled.error.name": "Εισαγάγετε ένα όνομα",
  "settings.scheduled.error.prompt": "Εισαγάγετε μια προτροπή",
  "settings.scheduled.error.time": "Επιλέξτε μια ώρα",
  "settings.scheduled.error.model": "Επιλέξτε πρώτα ένα μοντέλο",
  "session.new.project.open": "Άνοιγμα υπάρχοντος έργου",
  "common.pin": "Καρφίτσωμα",
  "common.unpin": "Ξεκαρφίτσωμα",
  "settings.relay.title": "Κλειδιά 智联AI",
  "settings.relay.getKey": "Λήψη κλειδιού API",
  "settings.relay.getKey.description": "Δημιουργήστε ξεχωριστά κλειδιά για το ChatGPT, το Grok και άλλους παρόχους.",
  "settings.relay.upstream": "Διακομιστής παρόχου",
  "settings.relay.unified": "Χρήση κοινού κλειδιού API",
  "settings.relay.unified.description": "Όταν είναι ενεργό, όλοι οι πάροχοι χρησιμοποιούν αυτό το κλειδί.",
  "settings.relay.unified.key": "Κοινό κλειδί API",
  "settings.relay.unified.using": "Χρησιμοποιείται το κοινό κλειδί",
  "settings.relay.key.set": "Το κλειδί αποθηκεύτηκε",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "Αφήστε το κενό για να διατηρηθεί το αποθηκευμένο κλειδί",
  "settings.relay.test": "Δοκιμή σύνδεσης",
  "settings.relay.testing": "Γίνεται δοκιμή...",
  "settings.relay.fetch": "Λήψη μοντέλων",
  "settings.relay.fetching": "Γίνεται λήψη...",
  "settings.relay.edit": "Επεξεργασία",
  "settings.relay.clearKey": "Εκκαθάριση κλειδιού",
  "settings.relay.add": "Προσθήκη παρόχου",
  "settings.relay.add.name": "Όνομα παρόχου",
  "settings.relay.models.visible": "Ορατά μοντέλα: {{count}}",
  "settings.relay.connected": "Συνδέθηκε · Μοντέλα: {{count}}",
  "settings.relay.connectedEmpty": "Συνδέθηκε, αλλά δεν επιστράφηκαν μοντέλα",
  "settings.relay.test.ok": "Η σύνδεση ήταν επιτυχής",
  "settings.relay.test.empty": "Συνδέθηκε, αλλά δεν επιστράφηκαν μοντέλα",
  "settings.relay.models.title": "Μοντέλα {{vendor}}",
  "settings.relay.models.empty": "Δεν υπάρχουν ακόμη μοντέλα. Ανακτήστε τη λίστα αφού αποθηκεύσετε ένα κλειδί.",
  "settings.relay.models.missing": "Δεν υπάρχει πλέον στον διακομιστή του παρόχου",
  "settings.relay.saved": "Αποθηκεύτηκε αυτόματα",
  "settings.relay.retry": "Επανάληψη προσπάθειας",
  "settings.relay.builtin": "Ενσωματωμένος",
  "settings.relay.delete": "Διαγραφή παρόχου",
  "settings.relay.rollback": "Επαναφορά εισαγόμενων κλειδιών",
  "settings.relay.rollback.description":
    "Διαγράφει τα κλειδιά Relay που εισήχθησαν από το auth.json. Το αρχικό auth.json διατηρείται.",
  "settings.relay.error.KEY_MISSING": "Προσθέστε πρώτα ένα κλειδί API",
  "settings.relay.error.KEY_REJECTED": "Το κλειδί απορρίφθηκε",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "Ο διακομιστής του παρόχου δεν είναι προσβάσιμος",
  "settings.relay.error.UPSTREAM_TIMEOUT": "Έληξε το χρονικό όριο του διακομιστή του παρόχου",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "Ο διακομιστής του παρόχου περιόρισε τη συχνότητα των αιτημάτων",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "Ο διακομιστής του παρόχου επέστρεψε μη έγκυρη απάντηση",
  "settings.relay.error.REVISION_CONFLICT": "Αυτή η ρύθμιση άλλαξε σε άλλο παράθυρο. Ανανεώστε και δοκιμάστε ξανά.",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "Δεν ήταν δυνατή η αποθήκευση του κλειδιού API σε αυτή τη συσκευή.",
  "settings.mcp.add": "Προσθήκη MCP",
  "settings.mcp.edit": "Επεξεργασία",
  "settings.mcp.field.name": "Όνομα",
  "settings.mcp.field.type": "Τύπος",
  "settings.mcp.field.command": "Εντολή",
  ...
  "settings.mcp.error.name": "Εισαγάγετε ένα όνομα διακομιστή",
  "settings.mcp.error.command": "Εισαγάγετε μια εντολή",
  "settings.mcp.error.url": "Εισαγάγετε ένα URL",
  ...
  "desktop.menu.documentation": "Koda Τεκμηρίωση",
  ...
  "desktop.menu.ariaLabel": "Koda μενού",
  ...
  "desktop.recovery.loadFailed": "Koda απέτυχε η φόρτωση",
  "desktop.recovery.terminated": "Koda το παράθυρο τερματίστηκε απροσδόκητα",
  "desktop.recovery.unresponsive": "Koda δεν αποκρίνεται",
  ...
  "desktop.wsl.error.installOpencode": "Koda η εγκατάσταση απέτυχε",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Koda δεν είναι εγκατεστημένο στο {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Koda η ενημέρωση ολοκληρώθηκε αλλά το {{distro}} εξακολουθεί να αναφέρει {{installed}}; αναμενόμενο {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Δωρεάν μοντέλα παρέχονται από Koda",
  ...
  "provider.connect.apiKey.description":
    "Εισαγάγετε το κλειδί {{provider}} API για να συνδέσετε τον λογαριασμό σας και χρησιμοποιήστε μοντέλα {{provider}} στο Koda.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Το Zen σάς δίνει πρόσβαση σε ένα επιμελημένο σύνολο αξιόπιστων βελτιστοποιημένων μοντέλων για πράκτορες κωδικοποίησης.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " για να συλλέξετε τον κωδικό εξουσιοδότησης για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο Koda.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " και εισαγάγετε τον παρακάτω κωδικό για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο Koda.",
  ...
  "dialog.server.description": "Αλλαγή σε ποιον διακομιστή Koda συνδέεται αυτή η εφαρμογή.",
  ...
  "wsl.onboarding.checkingOpencode": "Έλεγχος Koda...",
  "wsl.onboarding.checkingOpencodeIn": "Έλεγχος Koda σε {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ενημέρωση Koda...",
  "wsl.onboarding.updatingOpencodeIn": "Ενημέρωση Koda σε {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ενημέρωση Koda σε {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ενημέρωση Koda",
  "wsl.onboarding.opencodeReadyIn": "Koda είναι έτοιμο στο {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koda είναι έτοιμο.",
  "wsl.onboarding.installOpencodeIn": "Εγκατάσταση του Koda στο {{distro}}.",
  "wsl.onboarding.installOpencode": "Εγκατάσταση Koda",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda δεν έχει εγκατασταθεί",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Υποσύστημα για Linux) απαιτείται για να μπορέσει ο Koda να προσθέσει έναν διακομιστή WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL μη διαθέσιμο",
  "wsl.onboarding.wslUnavailable.description": "Koda δεν μπόρεσε να επαληθεύσει το WSL σε αυτό το μηχάνημα.",
  "wsl.onboarding.installWsl": "Εγκατάσταση WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Επανεκκινήστε το Windows για να ολοκληρώσετε την εγκατάσταση του WSL και μετά ανοίξτε ξανά το Koda.",
  ...
  "help.tabs.introduction": "Koda Η επιφάνεια εργασίας είναι πλέον χτισμένη γύρω από καρτέλες.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Μια νέα έκδοση του Koda ({{version}}) είναι τώρα διαθέσιμη για εγκατάσταση.",
  ...
  "error.page.report.prefix": "Αναφέρετε αυτό το σφάλμα στην ομάδα Koda",
  ...
  "error.chain.mcpFailed":
    'MCP διακομιστής "{{name}}" απέτυχε. Σημείωση, το Koda δεν υποστηρίζει ακόμη έλεγχο ταυτότητας MCP.',
  ...
  "sidebar.gettingStarted.line1": "Koda περιλαμβάνει δωρεάν μοντέλα, ώστε να μπορείτε να ξεκινήσετε αμέσως.",
  ...
  "app.name.desktop": "Koda Επιτραπέζιος υπολογιστής",
  ...
  "settings.desktop.wsl.description": "Εκτέλεση του διακομιστή Koda μέσα στο WSL στο Windows.",
  ...
  "settings.general.row.language.description": "Αλλαγή της γλώσσας εμφάνισης για το Koda",
  ...
  "settings.general.row.appearance.description": "Προσαρμογή της εμφάνισης του Koda στη συσκευή σας",
  "settings.general.row.colorScheme.title": "Χρωματικός συνδυασμός",
  "settings.general.row.colorScheme.description":
    "Επιλέξτε εάν το Koda ακολουθεί το σύστημα, το ανοιχτό ή το σκοτεινό θέμα",
  "settings.general.row.theme.title": "Θέμα",
  "settings.general.row.theme.description": "Προσαρμογή του τρόπου με τον οποίο έχει θέμα το Koda.",
  ...
  "settings.updates.row.startup.description": "Αυτόματος έλεγχος για ενημερώσεις κατά την εκκίνηση του Koda",
  ...
  "settings.updates.toast.latest.description": "Εκτελείτε την πιο πρόσφατη έκδοση του Koda.",
