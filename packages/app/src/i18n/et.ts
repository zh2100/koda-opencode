export const dict = {
  "desktop.menu.about": "Teave Koda kohta",
  "desktop.about.title": "Koda töölauarakendus v{{version}}",
  "desktop.about.detail": "Muudetud OpenCode'i põhjal\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "Koda v{{version}} on saadaval. Kas avada uuendamiseks väljalaske leht?",
  "desktop.koda.update.open": "Ava väljalaske leht",
  "command.project.create": "Uus projekt",
  "command.project.openExisting": "Ava olemasolev projekt",
  "prompt.toast.projectRequired.title": "Vali projekt",
  "prompt.toast.projectRequired.description": "Enne saatmist loo või ava projekt.",
  "prompt.approval.ask": "Küsi kinnitust",
  "prompt.approval.auto": "Kinnita minu eest",
  "prompt.approval.plan": "Täielik juurdepääs",
  "prompt.more": "Veel",
  "dialog.project.create.title": "Uus projekt",
  "dialog.project.create.name": "Nimi",
  "dialog.project.create.location": "Asukoht",
  "dialog.project.create.browse": "Sirvi",
  "dialog.project.create.path": "Asukoht failisüsteemis",
  "dialog.project.create.submit": "Loo",
  "dialog.project.create.error.name": "Sisesta projekti nimi",
  "dialog.project.create.error.invalid": "Seda nime ei saa kausta jaoks kasutada",
  "dialog.project.create.error.exists": "See kaust on juba olemas. Ava see või vali teine nimi.",
  "dialog.project.create.error.failed": "Kausta ei saanud luua",
  "mcp.status.needs_client_registration": "vajab kliendi registreerimist",
  "home.welcome.title": "Millega saan aidata?",
  "home.project.create": "Uus projekt",
  "home.project.open": "Ava olemasolev projekt",
  "home.sessions.search.title": "Otsi vestlusi",
  "session.todo.empty": "Ülesandeid veel pole",
  "session.panel.files": "Failid",
  "session.panel.changes": "Muudatused",
  "session.panel.tasks": "Ülesanded",
  "session.panel.terminal": "Terminal",
  "session.panel.empty": "Failide, muudatuste, ülesannete ja terminali vaatamiseks vali projekt.",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "Muudatusteta",
  "session.panel.git.dirty.one": "{{count}} muudetud fail",
  "session.panel.git.dirty.other": "{{count}} muudetud faili",
  "session.task.waiting": "Loa ootel",
  "session.task.failed": "Ebaõnnestus",
  "session.task.retry": "Proovi uuesti",
  "session.task.open": "Ava eraldi seansis",
  "settings.skills.title": "Oskused",
  "settings.skills.description": "Selle projekti jaoks leitud oskused.",
  "settings.skills.empty": "Oskusi ei leitud",
  "settings.skills.enabled": "Mudelile lubatud",
  "settings.skills.disabled": "Mudelile keelatud",
  "settings.skills.search": "Otsi oskusi",
  "settings.skills.emptySearch": "Otsingule vastavaid oskusi pole",
  "settings.skills.details": "Oskuse üksikasjad",
  "settings.skills.noDescription": "Kirjeldus puudub",
  "settings.skills.source.project": "Projekt",
  "settings.skills.source.global": "Kasutaja",
  "settings.skills.source.builtin": "Sisseehitatud",
  "settings.skills.source.custom": "Lisatud",
  "settings.scheduled.title": "Ajastatud ülesanded",
  "settings.scheduled.description": "Käivita projektis viip üks kord või iga päev.",
  "settings.scheduled.empty": "Ajastatud ülesandeid pole",
  "settings.scheduled.once": "Üks kord",
  "settings.scheduled.daily": "Iga päev",
  "settings.scheduled.add": "Lisa ülesanne",
  "settings.scheduled.field.name": "Nimi",
  "settings.scheduled.field.prompt": "Viip",
  "settings.scheduled.field.schedule": "Ajakava",
  "settings.scheduled.field.time": "Käivitamise aeg",
  "settings.scheduled.error.name": "Sisesta nimi",
  "settings.scheduled.error.prompt": "Sisesta viip",
  "settings.scheduled.error.time": "Vali aeg",
  "settings.scheduled.error.model": "Vali esmalt mudel",
  "session.new.project.open": "Ava olemasolev projekt",
  "common.pin": "Kinnita",
  "common.unpin": "Eemalda kinnitus",
  "settings.relay.title": "智联AI võtmed",
  "settings.relay.getKey": "Hangi API võti",
  "settings.relay.getKey.description": "Loo ChatGPT, Groki ja teiste pakkujate jaoks eraldi võtmed.",
  "settings.relay.upstream": "Ülemserver",
  "settings.relay.unified": "Kasuta ühist API võtit",
  "settings.relay.unified.description": "Kui see on lubatud, kasutavad kõik pakkujad seda võtit.",
  "settings.relay.unified.key": "Ühine API võti",
  "settings.relay.unified.using": "Kasutusel on ühine võti",
  "settings.relay.key.set": "Võti salvestatud",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "Salvestatud võtme säilitamiseks jäta tühjaks",
  "settings.relay.test": "Testi ühendust",
  "settings.relay.testing": "Testimine...",
  "settings.relay.fetch": "Hangi mudelid",
  "settings.relay.fetching": "Hankimine...",
  "settings.relay.edit": "Muuda",
  "settings.relay.clearKey": "Kustuta võti",
  "settings.relay.add": "Lisa pakkuja",
  "settings.relay.add.name": "Pakkuja nimi",
  "settings.relay.models.visible": "{{count}} nähtavat mudelit",
  "settings.relay.connected": "Ühendatud · {{count}} mudelit",
  "settings.relay.connectedEmpty": "Ühendatud, kuid mudeleid ei tagastatud",
  "settings.relay.test.ok": "Ühendus õnnestus",
  "settings.relay.test.empty": "Ühendatud, kuid mudeleid ei tagastatud",
  "settings.relay.models.title": "{{vendor}} mudelid",
  "settings.relay.models.empty": "Mudeleid veel pole. Pärast võtme salvestamist hangi loend.",
  "settings.relay.models.missing": "Pole enam ülemserveris",
  "settings.relay.saved": "Automaatselt salvestatud",
  "settings.relay.retry": "Proovi uuesti",
  "settings.relay.builtin": "Sisseehitatud",
  "settings.relay.delete": "Kustuta pakkuja",
  "settings.relay.rollback": "Lähtesta imporditud võtmed",
  "settings.relay.rollback.description":
    "Kustutab failist auth.json imporditud Relay võtmed. Algne auth.json säilitatakse.",
  "settings.relay.error.KEY_MISSING": "Lisa esmalt API võti",
  "settings.relay.error.KEY_REJECTED": "Võti lükati tagasi",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "Ülemserver pole kättesaadav",
  "settings.relay.error.UPSTREAM_TIMEOUT": "Ülemserveri vastuse ooteaeg sai läbi",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "Ülemserver piiras päringute sagedust",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "Ülemserver tagastas vigase vastuse",
  "settings.relay.error.REVISION_CONFLICT": "Seda sätet muudeti teises aknas. Värskenda ja proovi uuesti.",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "API võtit ei saanud sellesse seadmesse salvestada.",
  "settings.mcp.add": "Lisa MCP",
  "settings.mcp.edit": "Muuda",
  "settings.mcp.field.name": "Nimi",
  "settings.mcp.field.type": "Tüüp",
  "settings.mcp.field.command": "Käsk",
  ...
  "settings.mcp.type.remote": "Kaugühendus",
  "settings.mcp.error.name": "Sisesta serveri nimi",
  "settings.mcp.error.command": "Sisesta käsk",
  "settings.mcp.error.url": "Sisesta URL",
  ...
  "desktop.recovery.loadFailed": "Koda laadimine ebaõnnestus",
  "desktop.recovery.terminated": "Koda aken suleti ootamatult",
  "desktop.recovery.unresponsive": "Koda ei vasta",
  ...
  "desktop.wsl.error.installOpencode": "Koda installimine ebaõnnestus",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Koda pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Koda värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub Koda",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid Koda'is.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen annab teile juurdepääsu kodeerimisagentide usaldusväärsete optimeeritud mudelite kureeritud komplektile.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises Koda.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises Koda.",
  ...
  "dialog.server.description": "Lülitage, millise Koda serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpencode": "Koda kontrollimine...",
  "wsl.onboarding.checkingOpencodeIn": "Koda kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Koda värskendamine...",
  "wsl.onboarding.updatingOpencodeIn": "Koda värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Värskenda Koda jaotises {{distro}}.",
  "wsl.onboarding.updateOpencode": "Värskenda Koda",
  "wsl.onboarding.opencodeReadyIn": "Koda on valmis {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koda on valmis.",
  "wsl.onboarding.installOpencodeIn": "Installige Koda asukohta {{distro}}.",
  "wsl.onboarding.installOpencode": "Installige Koda",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui Koda saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "Koda ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti Koda.",
  ...
  "help.tabs.introduction": "Koda Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse Koda ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast Koda meeskonnale",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, Koda ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "Koda sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "settings.desktop.wsl.description": "Käivitage Koda server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke Koda kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas Koda teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas Koda järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas Koda on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui Koda käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse Koda uusimat versiooni.",
