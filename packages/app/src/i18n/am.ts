export const dict = {
  "desktop.menu.about": "ስለ Koda",
  "desktop.about.title": "Koda ዴስክቶፕ v{{version}}",
  "desktop.about.detail": "OpenCodeን እንደ መሠረት በመጠቀም የተሻሻለ\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "Koda v{{version}} ይገኛል። ለማዘመን የልቀት ገጹ ይከፈት?",
  "desktop.koda.update.open": "የልቀት ገጹን ክፈት",
  "command.project.create": "አዲስ ፕሮጀክት",
  "command.project.openExisting": "ያለ ፕሮጀክት ክፈት",
  "prompt.toast.projectRequired.title": "ፕሮጀክት ምረጥ",
  "prompt.toast.projectRequired.description": "ከመላክዎ በፊት ፕሮጀክት ይፍጠሩ ወይም ይክፈቱ።",
  "prompt.approval.ask": "ፈቃድ ጠይቅ",
  "prompt.approval.auto": "በእኔ ፈንታ ፍቀድ",
  "prompt.approval.plan": "ሙሉ መዳረሻ",
  "prompt.more": "ተጨማሪ",
  "dialog.project.create.title": "አዲስ ፕሮጀክት",
  "dialog.project.create.name": "ስም",
  "dialog.project.create.location": "ቦታ",
  "dialog.project.create.browse": "አስስ",
  "dialog.project.create.path": "ዱካ",
  "dialog.project.create.submit": "ፍጠር",
  "dialog.project.create.error.name": "የፕሮጀክት ስም ያስገቡ",
  "dialog.project.create.error.invalid": "ይህ ስም ለአቃፊ መጠቀም አይቻልም",
  "dialog.project.create.error.exists": "ያ አቃፊ አስቀድሞ አለ። ይክፈቱት ወይም ሌላ ስም ይምረጡ።",
  "dialog.project.create.error.failed": "አቃፊውን መፍጠር አልተቻለም",
  "mcp.status.needs_client_registration": "የደንበኛ ምዝገባ ያስፈልጋል",
  "home.welcome.title": "በምን ልርዳዎ?",
  "home.project.create": "አዲስ ፕሮጀክት",
  "home.project.open": "ያለ ፕሮጀክት ክፈት",
  "home.sessions.search.title": "ውይይቶችን ፈልግ",
  "session.todo.empty": "እስካሁን ሥራዎች የሉም",
  "session.panel.files": "ፋይሎች",
  "session.panel.changes": "ለውጦች",
  "session.panel.tasks": "ሥራዎች",
  "session.panel.terminal": "ተርሚናል",
  "session.panel.empty": "ፋይሎችን፣ ለውጦችን፣ ሥራዎችን እና ተርሚናሉን ለማየት ፕሮጀክት ይምረጡ።",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "ለውጥ የለም",
  "session.panel.git.dirty.one": "{{count}} የተለወጠ ፋይል",
  "session.panel.git.dirty.other": "{{count}} የተለወጡ ፋይሎች",
  "session.task.waiting": "ፈቃድ በመጠባበቅ ላይ",
  "session.task.failed": "አልተሳካም",
  "session.task.retry": "እንደገና ሞክር",
  "session.task.open": "በራሱ ክፍለ ጊዜ ክፈት",
  "settings.skills.title": "ክህሎቶች",
  "settings.skills.description": "ለዚህ ፕሮጀክት የተገኙ ክህሎቶች።",
  "settings.skills.empty": "ምንም ክህሎቶች አልተገኙም",
  "settings.skills.enabled": "ሞዴሉ ሊጠቀምበት ይችላል",
  "settings.skills.disabled": "ለሞዴሉ አልተፈቀደም",
  "settings.skills.search": "ክህሎቶችን ፈልግ",
  "settings.skills.emptySearch": "ከዚህ ፍለጋ ጋር የሚዛመዱ ክህሎቶች የሉም",
  "settings.skills.details": "የክህሎት ዝርዝሮች",
  "settings.skills.noDescription": "መግለጫ የለም",
  "settings.skills.source.project": "ፕሮጀክት",
  "settings.skills.source.global": "ተጠቃሚ",
  "settings.skills.source.builtin": "አብሮ የተካተተ",
  "settings.skills.source.custom": "የተጨመረ",
  "settings.scheduled.title": "የታቀዱ ሥራዎች",
  "settings.scheduled.description": "በፕሮጀክት ውስጥ ጥያቄን አንድ ጊዜ ወይም በየቀኑ ያስኪዱ።",
  "settings.scheduled.empty": "የታቀዱ ሥራዎች የሉም",
  "settings.scheduled.once": "አንድ ጊዜ",
  "settings.scheduled.daily": "በየቀኑ",
  "settings.scheduled.add": "ሥራ ጨምር",
  "settings.scheduled.field.name": "ስም",
  "settings.scheduled.field.prompt": "ጥያቄ",
  "settings.scheduled.field.schedule": "መርሐ ግብር",
  "settings.scheduled.field.time": "የማስኬጃ ሰዓት",
  "settings.scheduled.error.name": "ስም ያስገቡ",
  "settings.scheduled.error.prompt": "ጥያቄ ያስገቡ",
  "settings.scheduled.error.time": "ሰዓት ይምረጡ",
  "settings.scheduled.error.model": "መጀመሪያ ሞዴል ይምረጡ",
  "session.new.project.open": "ያለ ፕሮጀክት ክፈት",
  "common.pin": "አያይዝ",
  "common.unpin": "አላቅቅ",
  "settings.relay.title": "የ智联AI ቁልፎች",
  "settings.relay.getKey": "የAPI ቁልፍ አግኝ",
  "settings.relay.getKey.description": "ለChatGPT፣ Grok እና ሌሎች አቅራቢዎች የተለያዩ ቁልፎችን ይፍጠሩ።",
  "settings.relay.upstream": "የላይኛው አገልጋይ",
  "settings.relay.unified": "የጋራ የAPI ቁልፍ ተጠቀም",
  "settings.relay.unified.description": "ሲነቃ ሁሉም አቅራቢዎች ይህን ቁልፍ ይጠቀማሉ።",
  "settings.relay.unified.key": "የጋራ የAPI ቁልፍ",
  "settings.relay.unified.using": "የጋራውን ቁልፍ በመጠቀም ላይ",
  "settings.relay.key.set": "ቁልፉ ተቀምጧል",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "የተቀመጠውን ቁልፍ ለማቆየት ባዶ ይተዉት",
  "settings.relay.test": "ግንኙነት ፈትሽ",
  "settings.relay.testing": "በመፈተሽ ላይ...",
  "settings.relay.fetch": "ሞዴሎችን አምጣ",
  "settings.relay.fetching": "በማምጣት ላይ...",
  "settings.relay.edit": "አርትዕ",
  "settings.relay.clearKey": "ቁልፉን አጽዳ",
  "settings.relay.add": "አቅራቢ ጨምር",
  "settings.relay.add.name": "የአቅራቢ ስም",
  "settings.relay.models.visible": "{{count}} የሚታዩ ሞዴሎች",
  "settings.relay.connected": "ተገናኝቷል · {{count}} ሞዴሎች",
  "settings.relay.connectedEmpty": "ተገናኝቷል፣ ግን ሞዴሎች አልተመለሱም",
  "settings.relay.test.ok": "ግንኙነቱ ተሳክቷል",
  "settings.relay.test.empty": "ተገናኝቷል፣ ግን ሞዴሎች አልተመለሱም",
  "settings.relay.models.title": "የ{{vendor}} ሞዴሎች",
  "settings.relay.models.empty": "እስካሁን ሞዴሎች የሉም። ቁልፍ ካስቀመጡ በኋላ ዝርዝሩን ያምጡ።",
  "settings.relay.models.missing": "በላይኛው አገልጋይ ላይ ከእንግዲህ የለም",
  "settings.relay.saved": "በራስ-ሰር ተቀምጧል",
  "settings.relay.retry": "እንደገና ሞክር",
  "settings.relay.builtin": "አብሮ የተካተተ",
  "settings.relay.delete": "አቅራቢውን ሰርዝ",
  "settings.relay.rollback": "የገቡ ቁልፎችን ዳግም አስጀምር",
  "settings.relay.rollback.description": "ከauth.json የገቡ የRelay ቁልፎችን ያጸዳል። ዋናው auth.json ይቀመጣል።",
  "settings.relay.error.KEY_MISSING": "መጀመሪያ የAPI ቁልፍ ያክሉ",
  "settings.relay.error.KEY_REJECTED": "ቁልፉ ተቀባይነት አላገኘም",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "የላይኛው አገልጋይ አይደረስበትም",
  "settings.relay.error.UPSTREAM_TIMEOUT": "የላይኛው አገልጋይ የጥበቃ ጊዜ አልፏል",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "የላይኛው አገልጋይ የጥያቄዎችን ፍጥነት ገድቧል",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "የላይኛው አገልጋይ ልክ ያልሆነ ምላሽ መልሷል",
  "settings.relay.error.REVISION_CONFLICT": "ይህ ቅንብር በሌላ መስኮት ተለውጧል። ያድሱና እንደገና ይሞክሩ።",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "በዚህ መሣሪያ ላይ የAPI ቁልፉን ማስቀመጥ አልተቻለም።",
  "settings.mcp.add": "MCP ጨምር",
  "settings.mcp.edit": "አርትዕ",
  "settings.mcp.field.name": "ስም",
  "settings.mcp.field.type": "ዓይነት",
  "settings.mcp.field.command": "ትእዛዝ",
  ...
  "settings.mcp.type.local": "አካባቢያዊ",
  "settings.mcp.type.remote": "የርቀት",
  "settings.mcp.error.name": "የአገልጋይ ስም ያስገቡ",
  "settings.mcp.error.command": "ትእዛዝ ያስገቡ",
  "settings.mcp.error.url": "URL ያስገቡ",
  ...
  "desktop.recovery.loadFailed": "Koda መጫን አልቻለም",
  "desktop.recovery.terminated": "Koda መስኮት በድንገት ተቋርጧል",
  "desktop.recovery.unresponsive": "Koda ምላሽ እየሰጠ አይደለም",
  ...
  "desktop.wsl.error.installOpencode": "Kodaመጫኑ አልተሳካም",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Koda በ{{distro}}] ውስጥ አልተጫነም",
  "desktop.wsl.error.updateVersion": "Koda ዝማኔ አልቋል ግን {{distro}} አሁንም ሪፖርት ያደርጋል {{installed}}; የሚጠበቀው {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "ነጻ ሞዴሎች በKoda",
  ...
  "provider.connect.apiKey.description": "መለያዎን ለማገናኘት የ{{provider}} API ቁልፍዎን ያስገቡ እና {{provider}} ሞዴሎችን በKoda ይጠቀሙ።",
  ...
  "provider.connect.opencodeZen.line1": "Koda ዜን ለኮድ ወኪሎች የተመቻቹ አስተማማኝ ሞዴሎች ስብስብ መዳረሻ ይሰጥዎታል።",
  ...
  "provider.connect.oauth.code.visit.suffix": " መለያዎን ለማገናኘት የፈቀዳ ኮድዎን ለመሰብሰብ እና {{provider}} ሞዴሎችን በKoda ውስጥ ይጠቀሙ።",
  ...
  "provider.connect.oauth.auto.visit.suffix": " እና መለያዎን ለማገናኘት ከታች ያለውን ኮድ ያስገቡ እና {{provider}} ሞዴሎችን በKoda ይጠቀሙ።",
  ...
  "dialog.server.description": "ይህ መተግበሪያ ከየትኛው Koda አገልጋይ ጋር እንደሚገናኝ ይቀይሩ።",
  ...
  "wsl.onboarding.checkingOpencode": "መፈተሽ Koda...",
  "wsl.onboarding.checkingOpencodeIn": "Kodaን በ{{distro}} ውስጥ በመፈተሽ ላይ...",
  "wsl.onboarding.updatingOpencode": "በማዘመን ላይ Koda...",
  "wsl.onboarding.updatingOpencodeIn": "በማዘመን ላይ Koda በ{{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "አዘምን Koda በ{{distro}}።",
  "wsl.onboarding.updateOpencode": "አዘምን Koda",
  "wsl.onboarding.opencodeReadyIn": "Koda በ{{distro}} ውስጥ ዝግጁ ነው።",
  "wsl.onboarding.opencodeReady": "Koda ዝግጁ ነው።",
  "wsl.onboarding.installOpencodeIn": "መጫን Koda በ{{distro}} ውስጥ።",
  "wsl.onboarding.installOpencode": "ጫን Koda",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kodaአልተጫነም",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windowsንዑስ ስርዓት ለLinux) Koda WSL አገልጋይ ከመጨመራቸው በፊት ያስፈልጋል",
  "wsl.onboarding.wslUnavailable.title": "WSL አይገኝም",
  "wsl.onboarding.wslUnavailable.description": "Koda በዚህ ማሽን ላይ WSLን ማረጋገጥ አልቻለም።",
  "wsl.onboarding.installWsl": "ጫን WSL",
  "wsl.onboarding.windowsRestartRequired": "WSLን መጫኑን ለመጨረስ Windows እንደገና ያስጀምሩ እና ከዚያ እንደገና ይክፈቱ Koda።",
  ...
  "help.tabs.introduction": "Koda ዴስክቶፕ አሁን በትሮች ዙሪያ ነው የተሰራው።",
  "help.tabs.sessions":
  ...
  "toast.update.description": "አዲሱ የKoda ({{version}}) ስሪት አሁን ለመጫን አለ።",
  ...
  "error.page.report.prefix": "እባክዎ ይህንን ስህተት ለKoda ቡድን ያሳውቁ",
  ...
  "error.chain.mcpFailed": 'MCP አገልጋይ "{{name}}" አልተሳካም። ማስታወሻ፣ Koda እስካሁን MCP ማረጋገጫን አይደግፍም።',
  ...
  "sidebar.gettingStarted.line1": "Koda ነፃ ሞዴሎችን ያካትታል ስለዚህ ወዲያውኑ መጀመር ይችላሉ።",
  ...
  "settings.desktop.wsl.description": "የKoda አገልጋዩን በWSL ውስጥ በWindows ላይ ያሂዱ።",
  ...
  "settings.general.row.language.description": "የማሳያ ቋንቋውን ለKoda",
  ...
  "settings.general.row.appearance.description": "Kodaበመሣሪያዎ ላይ እንዴት እንደሚታይ ብጁ ያድርጉ",
  "settings.general.row.colorScheme.title": "የቀለም ንድፍ",
  "settings.general.row.colorScheme.description": "Koda ስርዓቱን፣ ብርሃንን ወይም ጨለማውን ገጽታ የሚከተል እንደሆነ ምረጥ",
  "settings.general.row.theme.title": "ገጽታ",
  "settings.general.row.theme.description": "Koda ገጽታ እንዴት እንደሆነ አብጅ።",
  ...
  "settings.updates.row.startup.description": "Koda ሲጀመር ዝማኔዎችን በራስ-ሰር ያረጋግጡ",
  ...
  "settings.updates.toast.latest.description": "የቅርብ ጊዜውን የKoda እትም እያሄዱ ነው።",
