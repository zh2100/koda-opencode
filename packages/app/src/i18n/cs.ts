export const dict = {
  "desktop.menu.about": "O aplikaci Koda",
  "desktop.about.title": "Koda Desktop v{{version}}",
  "desktop.about.detail": "Upraveno na základě OpenCode\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "Je k dispozici Koda v{{version}}. Otevřít stránku vydání pro aktualizaci?",
  "desktop.koda.update.open": "Otevřít stránku vydání",
  "command.project.create": "Nový projekt",
  "command.project.openExisting": "Otevřít existující projekt",
  "prompt.toast.projectRequired.title": "Vyberte projekt",
  "prompt.toast.projectRequired.description": "Před odesláním vytvořte nebo otevřete projekt.",
  "prompt.approval.ask": "Vyžadovat schválení",
  "prompt.approval.auto": "Schvalovat za mě",
  "prompt.approval.plan": "Plný přístup",
  "prompt.more": "Více",
  "dialog.project.create.title": "Nový projekt",
  "dialog.project.create.name": "Název",
  "dialog.project.create.location": "Umístění",
  "dialog.project.create.browse": "Procházet",
  "dialog.project.create.path": "Cesta",
  "dialog.project.create.submit": "Vytvořit",
  "dialog.project.create.error.name": "Zadejte název projektu",
  "dialog.project.create.error.invalid": "Tento název nelze použít pro složku",
  "dialog.project.create.error.exists": "Tato složka již existuje. Otevřete ji nebo zvolte jiný název.",
  "dialog.project.create.error.failed": "Složku se nepodařilo vytvořit",
  "mcp.status.needs_client_registration": "vyžaduje registraci klienta",
  "home.welcome.title": "S čím mohu pomoci?",
  "home.project.create": "Nový projekt",
  "home.project.open": "Otevřít existující projekt",
  "home.sessions.search.title": "Hledat konverzace",
  "session.todo.empty": "Zatím žádné úkoly",
  "session.panel.files": "Soubory",
  "session.panel.changes": "Změny",
  "session.panel.tasks": "Úkoly",
  "session.panel.terminal": "Terminál",
  "session.panel.empty": "Vyberte projekt pro procházení souborů, změn, úkolů a terminálu.",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "Beze změn",
  "session.panel.git.dirty.one": "{{count}} změněný soubor",
  "session.panel.git.dirty.few": "{{count}} změněné soubory",
  "session.panel.git.dirty.many": "{{count}} změněného souboru",
  "session.panel.git.dirty.other": "{{count}} změněných souborů",
  "session.task.waiting": "Čekání na oprávnění",
  "session.task.failed": "Selhalo",
  "session.task.retry": "Zkusit znovu",
  "session.task.open": "Otevřít v samostatné relaci",
  "settings.skills.title": "Dovednosti",
  "settings.skills.description": "Dovednosti nalezené pro tento projekt.",
  "settings.skills.empty": "Nebyly nalezeny žádné dovednosti",
  "settings.skills.enabled": "Dostupná pro model",
  "settings.skills.disabled": "Zakázaná pro model",
  "settings.skills.search": "Hledat dovednosti",
  "settings.skills.emptySearch": "Hledání neodpovídají žádné dovednosti",
  "settings.skills.details": "Podrobnosti dovednosti",
  "settings.skills.noDescription": "Bez popisu",
  "settings.skills.source.project": "Projekt",
  "settings.skills.source.global": "Uživatel",
  "settings.skills.source.builtin": "Vestavěná",
  "settings.skills.source.custom": "Přidaná",
  "settings.scheduled.title": "Naplánované úkoly",
  "settings.scheduled.description": "Spusťte zadání v projektu jednorázově nebo každý den.",
  "settings.scheduled.empty": "Žádné naplánované úkoly",
  "settings.scheduled.once": "Jednorázově",
  "settings.scheduled.daily": "Každý den",
  "settings.scheduled.add": "Přidat úkol",
  "settings.scheduled.field.name": "Název",
  "settings.scheduled.field.prompt": "Zadání",
  "settings.scheduled.field.schedule": "Plán",
  "settings.scheduled.field.time": "Čas spuštění",
  "settings.scheduled.error.name": "Zadejte název",
  "settings.scheduled.error.prompt": "Zadejte zadání",
  "settings.scheduled.error.time": "Vyberte čas",
  "settings.scheduled.error.model": "Nejprve vyberte model",
  "session.new.project.open": "Otevřít existující projekt",
  "common.pin": "Připnout",
  "common.unpin": "Odepnout",
  "settings.relay.title": "Klíče 智联AI",
  "settings.relay.getKey": "Získat klíč API",
  "settings.relay.getKey.description": "Vytvořte samostatné klíče pro ChatGPT, Grok a další poskytovatele.",
  "settings.relay.upstream": "Nadřazený server",
  "settings.relay.unified": "Používat sdílený klíč API",
  "settings.relay.unified.description": "Po zapnutí používají tento klíč všichni poskytovatelé.",
  "settings.relay.unified.key": "Sdílený klíč API",
  "settings.relay.unified.using": "Používá se sdílený klíč",
  "settings.relay.key.set": "Klíč uložen",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "Ponechte prázdné pro zachování uloženého klíče",
  "settings.relay.test": "Otestovat připojení",
  "settings.relay.testing": "Testování...",
  "settings.relay.fetch": "Načíst modely",
  "settings.relay.fetching": "Načítání...",
  "settings.relay.edit": "Upravit",
  "settings.relay.clearKey": "Odstranit klíč",
  "settings.relay.add": "Přidat poskytovatele",
  "settings.relay.add.name": "Název poskytovatele",
  "settings.relay.models.visible": "Viditelné modely: {{count}}",
  "settings.relay.connected": "Připojeno · Modely: {{count}}",
  "settings.relay.connectedEmpty": "Připojeno, ale nebyly vráceny žádné modely",
  "settings.relay.test.ok": "Připojení bylo úspěšné",
  "settings.relay.test.empty": "Připojeno, ale nebyly vráceny žádné modely",
  "settings.relay.models.title": "Modely {{vendor}}",
  "settings.relay.models.empty": "Zatím žádné modely. Po uložení klíče načtěte seznam.",
  "settings.relay.models.missing": "Již není na nadřazeném serveru",
  "settings.relay.saved": "Automaticky uloženo",
  "settings.relay.retry": "Zkusit znovu",
  "settings.relay.builtin": "Vestavěný",
  "settings.relay.delete": "Odstranit poskytovatele",
  "settings.relay.rollback": "Resetovat importované klíče",
  "settings.relay.rollback.description":
    "Odstraní klíče Relay importované z auth.json. Původní auth.json zůstane zachován.",
  "settings.relay.error.KEY_MISSING": "Nejprve přidejte klíč API",
  "settings.relay.error.KEY_REJECTED": "Klíč byl odmítnut",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "Nadřazený server je nedostupný",
  "settings.relay.error.UPSTREAM_TIMEOUT": "Vypršel časový limit nadřazeného serveru",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "Nadřazený server omezil četnost požadavků",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "Nadřazený server vrátil neplatnou odpověď",
  "settings.relay.error.REVISION_CONFLICT":
    "Toto nastavení se změnilo v jiném okně. Obnovte stránku a zkuste to znovu.",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "Klíč API se na tomto zařízení nepodařilo uložit.",
  "settings.mcp.add": "Přidat MCP",
  "settings.mcp.edit": "Upravit",
  "settings.mcp.field.name": "Název",
  "settings.mcp.field.type": "Typ",
  "settings.mcp.field.command": "Příkaz",
  ...
  "settings.mcp.type.local": "Místní",
  "settings.mcp.type.remote": "Vzdálený",
  "settings.mcp.error.name": "Zadejte název serveru",
  "settings.mcp.error.command": "Zadejte příkaz",
  "settings.mcp.error.url": "Zadejte URL",
  ...
  "desktop.menu.documentation": "Koda Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka Koda",
  ...
  "desktop.recovery.loadFailed": "Koda se nepodařilo načíst",
  "desktop.recovery.terminated": "Koda okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "Koda nereaguje",
  ...
  "desktop.wsl.error.installOpencode": "Koda instalace se nezdařila",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Koda není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Koda aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v Koda.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen vám poskytuje přístup k upravené sadě spolehlivých optimalizovaných modelů pro kódovací agenty.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v Koda.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v Koda.",
  ...
  "dialog.server.description": "Přepněte, ke kterému Koda serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrola Koda...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrola Koda v {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizace Koda...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizace Koda v {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aktualizace Koda v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aktualizovat Koda",
  "wsl.onboarding.opencodeReadyIn": "Koda je připraveno v {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koda je připraven.",
  "wsl.onboarding.installOpencodeIn": "Nainstalujte Koda do {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalovat Koda",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než Koda může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "Koda nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete Koda.",
  ...
  "help.tabs.introduction": "Koda Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze Koda ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu Koda",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: Koda zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "Koda obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server Koda uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro Koda",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled Koda na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description": "Zvolte, zda bude Koda následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma Koda.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění Koda",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi Koda.",
