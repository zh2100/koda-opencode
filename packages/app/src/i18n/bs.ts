export const dict = {
  "desktop.menu.about": "O aplikaciji Koda",
  "desktop.about.title": "Koda Desktop v{{version}}",
  "desktop.about.detail": "Prilagođeno na osnovu OpenCodea\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "Dostupna je Koda v{{version}}. Otvoriti stranicu izdanja za nadogradnju?",
  "desktop.koda.update.open": "Otvori stranicu izdanja",
  "command.project.create": "Novi projekat",
  "command.project.openExisting": "Otvori postojeći projekat",
  "prompt.toast.projectRequired.title": "Odaberite projekat",
  "prompt.toast.projectRequired.description": "Kreirajte ili otvorite projekat prije slanja.",
  "prompt.approval.ask": "Traži odobrenje",
  "prompt.approval.auto": "Odobri umjesto mene",
  "prompt.approval.plan": "Potpuni pristup",
  "prompt.more": "Više",
  "dialog.project.create.title": "Novi projekat",
  "dialog.project.create.name": "Naziv",
  "dialog.project.create.location": "Lokacija",
  "dialog.project.create.browse": "Pregledaj",
  "dialog.project.create.path": "Putanja",
  "dialog.project.create.submit": "Kreiraj",
  "dialog.project.create.error.name": "Unesite naziv projekta",
  "dialog.project.create.error.invalid": "Ovaj naziv se ne može koristiti za fasciklu",
  "dialog.project.create.error.exists": "Ta fascikla već postoji. Otvorite je ili odaberite drugi naziv.",
  "dialog.project.create.error.failed": "Nije moguće kreirati fasciklu",
  "mcp.status.needs_client_registration": "potrebna je registracija klijenta",
  "home.welcome.title": "Kako mogu pomoći?",
  "home.project.create": "Novi projekat",
  "home.project.open": "Otvori postojeći projekat",
  "home.sessions.search.title": "Pretraži razgovore",
  "session.todo.empty": "Još nema zadataka",
  "session.panel.files": "Datoteke",
  "session.panel.changes": "Izmjene",
  "session.panel.tasks": "Zadaci",
  "session.panel.terminal": "Terminal",
  "session.panel.empty": "Odaberite projekat za pregled datoteka, izmjena, zadataka i terminala.",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "Bez izmjena",
  "session.panel.git.dirty.one": "{{count}} izmijenjena datoteka",
  "session.panel.git.dirty.few": "{{count}} izmijenjene datoteke",
  "session.panel.git.dirty.other": "{{count}} izmijenjenih datoteka",
  "session.task.waiting": "Čekanje na dozvolu",
  "session.task.failed": "Neuspjelo",
  "session.task.retry": "Pokušaj ponovo",
  "session.task.open": "Otvori u zasebnoj sesiji",
  "settings.skills.title": "Vještine",
  "settings.skills.description": "Vještine pronađene za ovaj projekat.",
  "settings.skills.empty": "Nisu pronađene vještine",
  "settings.skills.enabled": "Dostupno modelu",
  "settings.skills.disabled": "Zabranjeno modelu",
  "settings.skills.search": "Pretraži vještine",
  "settings.skills.emptySearch": "Nijedna vještina ne odgovara pretrazi",
  "settings.skills.details": "Detalji vještine",
  "settings.skills.noDescription": "Bez opisa",
  "settings.skills.source.project": "Projekat",
  "settings.skills.source.global": "Korisnik",
  "settings.skills.source.builtin": "Ugrađeno",
  "settings.skills.source.custom": "Dodano",
  "settings.scheduled.title": "Zakazani zadaci",
  "settings.scheduled.description": "Pokrenite upit u projektu jednom ili svaki dan.",
  "settings.scheduled.empty": "Nema zakazanih zadataka",
  "settings.scheduled.once": "Jednom",
  "settings.scheduled.daily": "Svaki dan",
  "settings.scheduled.add": "Dodaj zadatak",
  "settings.scheduled.field.name": "Naziv",
  "settings.scheduled.field.prompt": "Upit",
  "settings.scheduled.field.schedule": "Raspored",
  "settings.scheduled.field.time": "Vrijeme pokretanja",
  "settings.scheduled.error.name": "Unesite naziv",
  "settings.scheduled.error.prompt": "Unesite upit",
  "settings.scheduled.error.time": "Odaberite vrijeme",
  "settings.scheduled.error.model": "Prvo odaberite model",
  "session.new.project.open": "Otvori postojeći projekat",
  "common.pin": "Zakači",
  "common.unpin": "Otkači",
  "settings.relay.title": "Ključevi 智联AI",
  "settings.relay.getKey": "Nabavi API ključ",
  "settings.relay.getKey.description": "Kreirajte zasebne ključeve za ChatGPT, Grok i druge pružaoce usluga.",
  "settings.relay.upstream": "Nadređeni server",
  "settings.relay.unified": "Koristi zajednički API ključ",
  "settings.relay.unified.description": "Kada je uključeno, svi pružaoci koriste ovaj ključ.",
  "settings.relay.unified.key": "Zajednički API ključ",
  "settings.relay.unified.using": "Koristi se zajednički ključ",
  "settings.relay.key.set": "Ključ je sačuvan",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "Ostavite prazno da zadržite sačuvani ključ",
  "settings.relay.test": "Testiraj vezu",
  "settings.relay.testing": "Testiranje...",
  "settings.relay.fetch": "Dohvati modele",
  "settings.relay.fetching": "Dohvatanje...",
  "settings.relay.edit": "Uredi",
  "settings.relay.clearKey": "Obriši ključ",
  "settings.relay.add": "Dodaj pružaoca",
  "settings.relay.add.name": "Naziv pružaoca",
  "settings.relay.models.visible": "Vidljivi modeli: {{count}}",
  "settings.relay.connected": "Povezano · Modeli: {{count}}",
  "settings.relay.connectedEmpty": "Povezano, ali nijedan model nije vraćen",
  "settings.relay.test.ok": "Povezivanje je uspjelo",
  "settings.relay.test.empty": "Povezano, ali nijedan model nije vraćen",
  "settings.relay.models.title": "Modeli pružaoca {{vendor}}",
  "settings.relay.models.empty": "Još nema modela. Dohvatite listu nakon spremanja ključa.",
  "settings.relay.models.missing": "Više nije na nadređenom serveru",
  "settings.relay.saved": "Automatski sačuvano",
  "settings.relay.retry": "Pokušaj ponovo",
  "settings.relay.builtin": "Ugrađeno",
  "settings.relay.delete": "Obriši pružaoca",
  "settings.relay.rollback": "Poništi uvezene ključeve",
  "settings.relay.rollback.description": "Briše ključeve za Relay uvezene iz auth.json. Izvorni auth.json se zadržava.",
  "settings.relay.error.KEY_MISSING": "Prvo dodajte API ključ",
  "settings.relay.error.KEY_REJECTED": "Ključ je odbijen",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "Nadređeni server nije dostupan",
  "settings.relay.error.UPSTREAM_TIMEOUT": "Isteklo je vrijeme čekanja nadređenog servera",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "Nadređeni server ograničio je učestalost zahtjeva",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "Nadređeni server vratio je nevažeći odgovor",
  "settings.relay.error.REVISION_CONFLICT":
    "Ova postavka je promijenjena u drugom prozoru. Osvježite i pokušajte ponovo.",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "Nije moguće sačuvati API ključ na ovom uređaju.",
  "settings.mcp.add": "Dodaj MCP",
  "settings.mcp.edit": "Uredi",
  "settings.mcp.field.name": "Naziv",
  "settings.mcp.field.type": "Vrsta",
  "settings.mcp.field.command": "Naredba",
  ...
  "settings.mcp.error.name": "Unesite naziv servera",
  "settings.mcp.error.command": "Unesite naredbu",
  "settings.mcp.error.url": "Unesite URL",
  ...
  "desktop.menu.documentation": "Dokumentacija za Koda",
  ...
  "desktop.recovery.loadFailed": "Koda se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor Koda-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "Koda ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija Koda-a nije uspjela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Koda nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje Koda-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Koda",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Koda-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Koda-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Koda-u.",
  ...
  "dialog.server.description": "Promijeni na koji se Koda server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera Koda...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera Koda u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Koda...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Koda u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj Koda u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj Koda",
  "wsl.onboarding.opencodeReadyIn": "Koda je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koda je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj Koda u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj Koda",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Koda mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Koda nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Koda.",
  ...
  "help.tabs.introduction": "Koda Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Koda-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Koda timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Koda još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Koda uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Koda server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Koda-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Koda izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Koda prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Koda-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Koda pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Koda-a.",
