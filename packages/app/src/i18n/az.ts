export const dict = {
  "desktop.menu.about": "Koda haqqında",
  "desktop.about.title": "Koda masaüstü v{{version}}",
  "desktop.about.detail":
    "Əsas kimi OpenCode istifadə edilərək dəyişdirilib\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "Koda v{{version}} mövcuddur. Yeniləmək üçün buraxılış səhifəsi açılsın?",
  "desktop.koda.update.open": "Buraxılış səhifəsini aç",
  "command.project.create": "Yeni layihə",
  "command.project.openExisting": "Mövcud layihəni aç",
  "prompt.toast.projectRequired.title": "Layihə seçin",
  "prompt.toast.projectRequired.description": "Göndərməzdən əvvəl layihə yaradın və ya açın.",
  "prompt.approval.ask": "Təsdiq istə",
  "prompt.approval.auto": "Mənim əvəzimə təsdiqlə",
  "prompt.approval.plan": "Tam giriş",
  "prompt.more": "Daha çox",
  "dialog.project.create.title": "Yeni layihə",
  "dialog.project.create.name": "Ad",
  "dialog.project.create.location": "Yer",
  "dialog.project.create.browse": "Gözdən keçir",
  "dialog.project.create.path": "Yol",
  "dialog.project.create.submit": "Yarat",
  "dialog.project.create.error.name": "Layihə adını daxil edin",
  "dialog.project.create.error.invalid": "Bu ad qovluq üçün istifadə edilə bilməz",
  "dialog.project.create.error.exists": "Bu qovluq artıq mövcuddur. Onu açın və ya başqa ad seçin.",
  "dialog.project.create.error.failed": "Qovluq yaradıla bilmədi",
  "mcp.status.needs_client_registration": "müştəri qeydiyyatı tələb olunur",
  "home.welcome.title": "Nə ilə kömək edə bilərəm?",
  "home.project.create": "Yeni layihə",
  "home.project.open": "Mövcud layihəni aç",
  "home.sessions.search.title": "Söhbətləri axtar",
  "session.todo.empty": "Hələ tapşırıq yoxdur",
  "session.panel.files": "Fayllar",
  "session.panel.changes": "Dəyişikliklər",
  "session.panel.tasks": "Tapşırıqlar",
  "session.panel.terminal": "Terminal",
  "session.panel.empty": "Fayllara, dəyişikliklərə, tapşırıqlara və terminala baxmaq üçün layihə seçin.",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "Dəyişiklik yoxdur",
  "session.panel.git.dirty.one": "{{count}} dəyişdirilmiş fayl",
  "session.panel.git.dirty.other": "{{count}} dəyişdirilmiş fayl",
  "session.task.waiting": "İcazə gözlənilir",
  "session.task.failed": "Uğursuz oldu",
  "session.task.retry": "Yenidən cəhd et",
  "session.task.open": "Ayrıca sessiyada aç",
  "settings.skills.title": "Bacarıqlar",
  "settings.skills.description": "Bu layihə üçün aşkar edilmiş bacarıqlar.",
  "settings.skills.empty": "Bacarıq tapılmadı",
  "settings.skills.enabled": "Model üçün əlçatandır",
  "settings.skills.disabled": "Model üçün qadağandır",
  "settings.skills.search": "Bacarıqları axtar",
  "settings.skills.emptySearch": "Axtarışa uyğun bacarıq yoxdur",
  "settings.skills.details": "Bacarıq təfərrüatları",
  "settings.skills.noDescription": "Təsvir yoxdur",
  "settings.skills.source.project": "Layihə",
  "settings.skills.source.global": "İstifadəçi",
  "settings.skills.source.builtin": "Daxili",
  "settings.skills.source.custom": "Əlavə edilmiş",
  "settings.scheduled.title": "Planlaşdırılmış tapşırıqlar",
  "settings.scheduled.description": "Layihədə sorğunu bir dəfə və ya hər gün icra edin.",
  "settings.scheduled.empty": "Planlaşdırılmış tapşırıq yoxdur",
  "settings.scheduled.once": "Bir dəfə",
  "settings.scheduled.daily": "Hər gün",
  "settings.scheduled.add": "Tapşırıq əlavə et",
  "settings.scheduled.field.name": "Ad",
  "settings.scheduled.field.prompt": "Sorğu",
  "settings.scheduled.field.schedule": "Cədvəl",
  "settings.scheduled.field.time": "İcra vaxtı",
  "settings.scheduled.error.name": "Ad daxil edin",
  "settings.scheduled.error.prompt": "Sorğu daxil edin",
  "settings.scheduled.error.time": "Vaxt seçin",
  "settings.scheduled.error.model": "Əvvəlcə model seçin",
  "session.new.project.open": "Mövcud layihəni aç",
  "common.pin": "Bərkit",
  "common.unpin": "Bərkitməni ləğv et",
  "settings.relay.title": "智联AI açarları",
  "settings.relay.getKey": "API açarı al",
  "settings.relay.getKey.description": "ChatGPT, Grok və digər provayderlər üçün ayrı açarlar yaradın.",
  "settings.relay.upstream": "Yuxarı axın serveri",
  "settings.relay.unified": "Ortaq API açarından istifadə et",
  "settings.relay.unified.description": "Aktiv olduqda bütün təchizatçılar bu açardan istifadə edir.",
  "settings.relay.unified.key": "Ortaq API açarı",
  "settings.relay.unified.using": "Ortaq açar istifadə olunur",
  "settings.relay.key.set": "Açar saxlanıldı",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "Saxlanmış açarı qorumaq üçün boş buraxın",
  "settings.relay.test": "Bağlantını yoxla",
  "settings.relay.testing": "Yoxlanılır...",
  "settings.relay.fetch": "Modelləri al",
  "settings.relay.fetching": "Alınır...",
  "settings.relay.edit": "Düzəliş et",
  "settings.relay.clearKey": "Açarı təmizlə",
  "settings.relay.add": "Təchizatçı əlavə et",
  "settings.relay.add.name": "Təchizatçının adı",
  "settings.relay.models.visible": "{{count}} görünən model",
  "settings.relay.connected": "Qoşuldu · {{count}} model",
  "settings.relay.connectedEmpty": "Qoşuldu, lakin model qaytarılmadı",
  "settings.relay.test.ok": "Bağlantı uğurludur",
  "settings.relay.test.empty": "Qoşuldu, lakin model qaytarılmadı",
  "settings.relay.models.title": "{{vendor}} modelləri",
  "settings.relay.models.empty": "Hələ model yoxdur. Açarı saxladıqdan sonra siyahını alın.",
  "settings.relay.models.missing": "Artıq yuxarı axın serverində yoxdur",
  "settings.relay.saved": "Avtomatik saxlanıldı",
  "settings.relay.retry": "Yenidən cəhd et",
  "settings.relay.builtin": "Daxili",
  "settings.relay.delete": "Təchizatçını sil",
  "settings.relay.rollback": "İdxal edilmiş açarları sıfırla",
  "settings.relay.rollback.description":
    "auth.json faylından idxal edilmiş Relay açarlarını təmizləyir. Orijinal auth.json saxlanılır.",
  "settings.relay.error.KEY_MISSING": "Əvvəlcə API açarı əlavə edin",
  "settings.relay.error.KEY_REJECTED": "Açar rədd edildi",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "Yuxarı axın serveri əlçatmazdır",
  "settings.relay.error.UPSTREAM_TIMEOUT": "Yuxarı axın serverinin gözləmə vaxtı bitdi",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "Yuxarı axın serveri sorğunun sürətini məhdudlaşdırdı",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "Yuxarı axın serveri etibarsız cavab qaytardı",
  "settings.relay.error.REVISION_CONFLICT": "Bu parametr başqa pəncərədə dəyişib. Yeniləyin və təkrar cəhd edin.",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "API açarı bu cihazda saxlanıla bilmədi.",
  "settings.mcp.add": "MCP əlavə et",
  "settings.mcp.edit": "Düzəliş et",
  "settings.mcp.field.name": "Ad",
  "settings.mcp.field.type": "Növ",
  "settings.mcp.field.command": "Əmr",
  ...
  "settings.mcp.error.name": "Server adını daxil edin",
  "settings.mcp.error.command": "Əmr daxil edin",
  "settings.mcp.error.url": "URL daxil edin",
  ...
  "desktop.recovery.loadFailed": "Koda yüklənə bilmədi",
  "desktop.recovery.terminated": "Koda pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "Koda cavab vermir",
  ...
  "desktop.wsl.error.installOpencode": "Koda quraşdırılması uğursuz oldu",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Koda {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "Koda yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Koda tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və Koda-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen sizə kodlaşdırma agentləri üçün etibarlı optimallaşdırılmış seçilmiş modellər dəstinə giriş verir.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və Koda-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və Koda-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu Koda serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Koda yoxlanılır...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}-də Koda yoxlanılır...",
  "wsl.onboarding.updatingOpencode": "Koda yenilənir...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-də Koda yenilənir...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-də Koda-u yeniləyin.",
  "wsl.onboarding.updateOpencode": "Koda-u yeniləyin",
  "wsl.onboarding.opencodeReadyIn": "Koda {{distro}}-də hazırdır.",
  "wsl.onboarding.opencodeReady": "Koda hazırdır.",
  "wsl.onboarding.installOpencodeIn": "Koda-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOpencode": "Koda quraşdırın",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Koda WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "Koda bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra Koda-u yenidən açın.",
  ...
  "help.tabs.introduction": "Koda Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Koda-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı Koda komandasına",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" uğursuz oldu. Qeyd: Koda hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "Koda-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində Koda serverini işlət.",
  ...
  "settings.general.row.language.description": "Koda üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "Koda-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description": "Koda-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "Koda-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "Koda açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "Koda-un ən son versiyasından istifadə edirsiniz.",
