export const dict = {
  "desktop.menu.about": "Koda بارے",
  "desktop.about.title": "Koda ڈیسک ٹاپ v{{version}}",
  "desktop.about.detail":
    "OpenCode نوں بنیاد بنا کے بدلیا گیا\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "Koda v{{version}} دستیاب اے۔ اپ گریڈ لئی ریلیز دا صفحہ کھولنا اے؟",
  "desktop.koda.update.open": "ریلیز دا صفحہ کھولو",
  "command.project.create": "نواں پروجیکٹ",
  "command.project.openExisting": "موجودہ پروجیکٹ کھولو",
  "prompt.toast.projectRequired.title": "پروجیکٹ چُنو",
  "prompt.toast.projectRequired.description": "بھیجن توں پہلاں پروجیکٹ بناؤ یا کھولو۔",
  "prompt.approval.ask": "منظوری منگو",
  "prompt.approval.auto": "میرے ولوں منظوری دیو",
  "prompt.approval.plan": "پوری رسائی",
  "prompt.more": "ہور",
  "dialog.project.create.title": "نواں پروجیکٹ",
  "dialog.project.create.name": "ناں",
  "dialog.project.create.location": "تھاں",
  "dialog.project.create.browse": "براؤز کرو",
  "dialog.project.create.path": "راستہ",
  "dialog.project.create.submit": "بناؤ",
  "dialog.project.create.error.name": "پروجیکٹ دا ناں لکھو",
  "dialog.project.create.error.invalid": "ایہ ناں فولڈر لئی نہیں ورتیا جا سکدا",
  "dialog.project.create.error.exists": "ایہ فولڈر پہلاں ای موجود اے۔ اوہنوں کھولو یا ہور ناں چُنو۔",
  "dialog.project.create.error.failed": "فولڈر نہیں بن سکیا",
  "mcp.status.needs_client_registration": "کلائنٹ دی رجسٹریشن ضروری اے",
  "home.welcome.title": "میں کیہڑی مدد کر سکدا آں؟",
  "home.project.create": "نواں پروجیکٹ",
  "home.project.open": "موجودہ پروجیکٹ کھولو",
  "home.sessions.search.title": "گلاں باتاں لبھو",
  "session.todo.empty": "ہالے کوئی کم نہیں",
  "session.panel.files": "فائلاں",
  "session.panel.changes": "تبدیلیاں",
  "session.panel.tasks": "کم",
  "session.panel.terminal": "ٹرمینل",
  "session.panel.empty": "فائلاں، تبدیلیاں، کم تے ٹرمینل ویکھن لئی پروجیکٹ چُنو۔",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "کوئی تبدیلی نہیں",
  "session.panel.git.dirty.one": "{{count}} بدلی ہوئی فائل",
  "session.panel.git.dirty.other": "{{count}} بدلیاں ہوئیاں فائلاں",
  "session.task.waiting": "اجازت دی اُڈیک وچ",
  "session.task.failed": "ناکام ہو گیا",
  "session.task.retry": "فیر کوشش کرو",
  "session.task.open": "وکھرے سیشن وچ کھولو",
  "settings.skills.title": "ہنر",
  "settings.skills.description": "ایس پروجیکٹ لئی لبھے ہنر۔",
  "settings.skills.empty": "کوئی ہنر نہیں لبھیا",
  "settings.skills.enabled": "ماڈل لئی دستیاب",
  "settings.skills.disabled": "ماڈل لئی منع اے",
  "settings.skills.search": "ہنر لبھو",
  "settings.skills.emptySearch": "ایس کھوج نال کوئی ہنر میل نہیں کھاندا",
  "settings.skills.details": "ہنر دی تفصیل",
  "settings.skills.noDescription": "کوئی وضاحت نہیں",
  "settings.skills.source.project": "پروجیکٹ",
  "settings.skills.source.global": "ورتن والا",
  "settings.skills.source.builtin": "پہلاں توں شامل",
  "settings.skills.source.custom": "شامل کیتا",
  "settings.scheduled.title": "مقرر کیتے کم",
  "settings.scheduled.description": "پروجیکٹ وچ پرامپٹ اک واری یا ہر روز چلاؤ۔",
  "settings.scheduled.empty": "کوئی مقرر کیتا کم نہیں",
  "settings.scheduled.once": "اک واری",
  "settings.scheduled.daily": "ہر روز",
  "settings.scheduled.add": "کم شامل کرو",
  "settings.scheduled.field.name": "ناں",
  "settings.scheduled.field.prompt": "پرامپٹ",
  "settings.scheduled.field.schedule": "وقت دا جدول",
  "settings.scheduled.field.time": "چلاؤن دا ویلا",
  "settings.scheduled.error.name": "ناں لکھو",
  "settings.scheduled.error.prompt": "پرامپٹ لکھو",
  "settings.scheduled.error.time": "ویلا چُنو",
  "settings.scheduled.error.model": "پہلاں ماڈل چُنو",
  "session.new.project.open": "موجودہ پروجیکٹ کھولو",
  "common.pin": "پن کرو",
  "common.unpin": "پن ہٹاؤ",
  "settings.relay.title": "智联AI دیاں کُنجیاں",
  "settings.relay.getKey": "API کُنجی لو",
  "settings.relay.getKey.description": "ChatGPT، Grok تے ہور فراہم کرن والیاں لئی وکھ وکھ کُنجیاں بناؤ۔",
  "settings.relay.upstream": "اپ سٹریم",
  "settings.relay.unified": "سانجھی API کُنجی ورتو",
  "settings.relay.unified.description": "چالو ہون تے سارے وینڈر ایہ کُنجی ورتدے نیں۔",
  "settings.relay.unified.key": "سانجھی API کُنجی",
  "settings.relay.unified.using": "سانجھی کُنجی ورتی جا رہی اے",
  "settings.relay.key.set": "کُنجی محفوظ ہو گئی",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "محفوظ کُنجی رکھن لئی خالی چھڈو",
  "settings.relay.test": "کنکشن پرکھو",
  "settings.relay.testing": "پرکھیا جا رہیا اے...",
  "settings.relay.fetch": "ماڈل لیاؤ",
  "settings.relay.fetching": "لیاندا جا رہیا اے...",
  "settings.relay.edit": "ترمیم کرو",
  "settings.relay.clearKey": "کُنجی مٹاؤ",
  "settings.relay.add": "وینڈر شامل کرو",
  "settings.relay.add.name": "وینڈر دا ناں",
  "settings.relay.models.visible": "{{count}} نظر آؤن والے ماڈل",
  "settings.relay.connected": "جڑ گیا · {{count}} ماڈل",
  "settings.relay.connectedEmpty": "جڑ گیا، پر کوئی ماڈل واپس نہیں آیا",
  "settings.relay.test.ok": "کنکشن کامیاب ہو گیا",
  "settings.relay.test.empty": "جڑ گیا، پر کوئی ماڈل واپس نہیں آیا",
  "settings.relay.models.title": "{{vendor}} دے ماڈل",
  "settings.relay.models.empty": "ہالے کوئی ماڈل نہیں۔ کُنجی محفوظ کرن توں بعد فہرست لیاؤ۔",
  "settings.relay.models.missing": "ہُن اپ سٹریم اُتے نہیں اے",
  "settings.relay.saved": "اپنے آپ محفوظ ہو گیا",
  "settings.relay.retry": "فیر کوشش کرو",
  "settings.relay.builtin": "پہلاں توں شامل",
  "settings.relay.delete": "وینڈر مٹاؤ",
  "settings.relay.rollback": "درآمد کیتیاں کُنجیاں ری سیٹ کرو",
  "settings.relay.rollback.description":
    "auth.json توں درآمد کیتیاں Relay کُنجیاں مٹاؤندا اے۔ اصل auth.json رکھیا جاندا اے۔",
  "settings.relay.error.KEY_MISSING": "پہلاں API کُنجی شامل کرو",
  "settings.relay.error.KEY_REJECTED": "کُنجی رد ہو گئی",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "اپ سٹریم تک رسائی نہیں ہو رہی",
  "settings.relay.error.UPSTREAM_TIMEOUT": "اپ سٹریم دی اُڈیک دا ویلا مُک گیا",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "اپ سٹریم نے درخواستاں دی رفتار محدود کر دِتی",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "اپ سٹریم نے غلط جواب دِتا",
  "settings.relay.error.REVISION_CONFLICT": "ایہ ترتیب ہور ونڈو وچ بدل گئی اے۔ تازہ کرو تے فیر کوشش کرو۔",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "ایس آلے اُتے API کُنجی محفوظ نہیں ہو سکی۔",
  "settings.mcp.add": "MCP شامل کرو",
  "settings.mcp.edit": "ترمیم کرو",
  "settings.mcp.field.name": "ناں",
  ...
  "settings.mcp.type.remote": "دور دا",
  "settings.mcp.error.name": "سرور دا ناں لکھو",
  "settings.mcp.error.command": "کمانڈ لکھو",
  "settings.mcp.error.url": "URL لکھو",
  ...
  "desktop.menu.documentation": "Koda دیاں دستاویزاں",
  ...
  "desktop.recovery.loadFailed": "Koda لوڈ نئیں ہو سکیا",
  "desktop.recovery.terminated": "Koda دی ونڈو اچانک بند ہو گئی",
  "desktop.recovery.unresponsive": "Koda جواب نئیں دے رہیا",
  ...
  "desktop.wsl.error.installOpencode": "Koda دی تنصیب ناکام ہو گئی",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} وچ Koda انسٹال نئیں اے",
  "desktop.wsl.error.updateVersion":
    "Koda دی اپ ڈیٹ پوری ہو گئی پر {{distro}} ہلے وی {{installed}} دس رہیا اے؛ {{expected}} چاہیدا سی",
  ...
  "dialog.model.unpaid.freeModels.title": "Koda دے ذریعہ فراہم کردہ مفت ماڈل",
  ...
  "provider.connect.apiKey.description":
    "اپنے اکاؤنٹ نوں جوڑن لئی اپنی {{provider}} API کلید درج کرو تے Koda وچ {{provider}} ماڈل ورتو۔",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " اپنے اکاؤنٹ نوں جوڑن تے Koda وچ {{provider}} ماڈل ورتن لئی اپنا اجازت کوڈ حاصل کرن لئی۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " تے اپنے اکاؤنٹ نوں جوڑن تے Koda وچ {{provider}} ماڈل ورتن لئی تھلے دتا کوڈ درج کرو۔",
  ...
  "dialog.server.description": "ایہہ ایپ کس Koda سرور نال جڑدی اے، اس نوں سوئچ کرو۔",
  ...
  "wsl.onboarding.checkingOpencode": "Koda چیک کر رئے آں...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} چ Koda دی جانچ پڑتال...",
  "wsl.onboarding.updatingOpencode": "Koda نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} وچ Koda نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} وچ Koda نو اپ ڈیٹ کرو۔",
  "wsl.onboarding.updateOpencode": "Koda اپ ڈیٹ کرو",
  "wsl.onboarding.opencodeReadyIn": "Koda {{distro}} چ تیار اے۔",
  "wsl.onboarding.opencodeReady": "Koda تیار اے۔",
  "wsl.onboarding.installOpencodeIn": "{{distro}} وچ Koda انسٹال کرو۔",
  "wsl.onboarding.installOpencode": "Koda انسٹال کرو",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda انسٹال نئیں کیتا گیا",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Koda دے WSL سرور شامل کرن توں پہلاں WSL (Windows Subsystem for Linux) دی لوڑ اے",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نئیں",
  "wsl.onboarding.wslUnavailable.description": "Koda ایس مشین تے WSL دی تصدیق نئیں کر سکیا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کرو",
  "wsl.onboarding.windowsRestartRequired":
    "WSL دی تنصیب پوری کرن لئی Windows نوں دوبارہ شروع کرو، فیر Koda دوبارہ کھولو۔",
  ...
  "help.tabs.introduction": "Koda Desktop ہن ٹیباں دے گرد بنایا گیا اے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Koda ({{version}}) دا اک نواں ورژن ہن انسٹال کرن لئی دستیاب اے۔",
  ...
  "error.page.report.prefix": "مہربانی کر کے اس غلطی دی اطلاع Koda ٹیم نوں دیو",
  ...
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، Koda ہلے تک MCP تصدیق دی حمایت نئیں کردا۔',
  ...
  "sidebar.gettingStarted.line1": "Koda چ مفت ماڈل شامل نیں تاکہ تسی فوری طور تے شروع کر سکو۔",
  ...
  "settings.desktop.wsl.description": "Windows تے WSL دے اندر Koda سرور چلاؤ۔",
  ...
  "settings.general.row.language.description": "Koda لئی ڈسپلے دی بولی بدلو",
  ...
  "settings.general.row.appearance.description": "اپنے آلے تے Koda کیویں لگدا اے، اپنی مرضی دے مطابق بناؤ",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description": "چنو کہ آیا Koda سسٹم، لائٹ، یا ڈارک تھیم دی پیروی کردا اے",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "Koda نوں کس طرح تھیم کیتا گیا اے، اپنی مرضی دے مطابق بناؤ۔",
  ...
  "settings.updates.row.startup.description": "جدوں Koda لانچ ہوندا اے تے خودبخود اپ ڈیٹس چیک کرو",
  ...
  "settings.updates.toast.latest.description": "تسی Koda دا تازہ ترین ورژن چلا رئے او۔",
