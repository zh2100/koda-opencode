export const dict = {
  "desktop.menu.about": "O Koda",
  "desktop.about.title": "Koda Desktop v{{version}}",
  "desktop.about.detail": "Zmodyfikowano na bazie OpenCode\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "Dostępna jest Koda v{{version}}. Otworzyć stronę wydania, aby zaktualizować?",
  "desktop.koda.update.open": "Otwórz stronę wydania",
  "command.project.create": "Nowy projekt",
  "command.project.openExisting": "Otwórz istniejący projekt",
  "prompt.toast.projectRequired.title": "Wybierz projekt",
  "prompt.toast.projectRequired.description": "Utwórz lub otwórz projekt przed wysłaniem.",
  "prompt.approval.ask": "Pytaj o zgodę",
  "prompt.approval.auto": "Zatwierdzaj za mnie",
  "prompt.approval.plan": "Pełny dostęp",
  "prompt.more": "Więcej",
  "dialog.project.create.title": "Nowy projekt",
  "dialog.project.create.name": "Nazwa",
  "dialog.project.create.location": "Lokalizacja",
  "dialog.project.create.browse": "Przeglądaj",
  "dialog.project.create.path": "Ścieżka",
  "dialog.project.create.submit": "Utwórz",
  "dialog.project.create.error.name": "Wpisz nazwę projektu",
  "dialog.project.create.error.invalid": "Tej nazwy nie można użyć jako nazwy folderu",
  "dialog.project.create.error.exists": "Ten folder już istnieje. Otwórz go lub wybierz inną nazwę.",
  "dialog.project.create.error.failed": "Nie udało się utworzyć folderu",
  "mcp.status.needs_client_registration": "wymaga rejestracji klienta",
  "home.welcome.title": "W czym mogę pomóc?",
  "home.project.create": "Nowy projekt",
  "home.project.open": "Otwórz istniejący projekt",
  "home.sessions.search.title": "Szukaj czatów",
  "session.todo.empty": "Nie ma jeszcze zadań",
  "session.panel.files": "Pliki",
  "session.panel.changes": "Zmiany",
  "session.panel.tasks": "Zadania",
  "session.panel.terminal": "Terminal",
  "session.panel.empty": "Wybierz projekt, aby przeglądać pliki, zmiany, zadania i terminal.",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "Bez zmian",
  "session.panel.git.dirty.one": "{{count}} zmieniony plik",
  "session.panel.git.dirty.few": "{{count}} zmienione pliki",
  "session.panel.git.dirty.many": "{{count}} zmienionych plików",
  "session.panel.git.dirty.other": "{{count}} zmienionego pliku",
  "session.task.waiting": "Oczekiwanie na zgodę",
  "session.task.failed": "Niepowodzenie",
  "session.task.retry": "Ponów",
  "session.task.open": "Otwórz w osobnej sesji",
  "settings.skills.title": "Umiejętności",
  "settings.skills.description": "Umiejętności wykryte dla tego projektu.",
  "settings.skills.empty": "Nie znaleziono umiejętności",
  "settings.skills.enabled": "Dostępna dla modelu",
  "settings.skills.disabled": "Zabroniona dla modelu",
  "settings.skills.search": "Szukaj umiejętności",
  "settings.skills.emptySearch": "Żadne umiejętności nie pasują do wyszukiwania",
  "settings.skills.details": "Szczegóły umiejętności",
  "settings.skills.noDescription": "Brak opisu",
  "settings.skills.source.project": "Projekt",
  "settings.skills.source.global": "Użytkownik",
  "settings.skills.source.builtin": "Wbudowana",
  "settings.skills.source.custom": "Dodana",
  "settings.scheduled.title": "Zaplanowane zadania",
  "settings.scheduled.description": "Uruchamiaj polecenie w projekcie jednorazowo lub codziennie.",
  "settings.scheduled.empty": "Brak zaplanowanych zadań",
  "settings.scheduled.once": "Jednorazowo",
  "settings.scheduled.daily": "Codziennie",
  "settings.scheduled.add": "Dodaj zadanie",
  "settings.scheduled.field.name": "Nazwa",
  "settings.scheduled.field.prompt": "Polecenie dla modelu",
  "settings.scheduled.field.schedule": "Harmonogram",
  "settings.scheduled.field.time": "Czas uruchomienia",
  "settings.scheduled.error.name": "Wpisz nazwę",
  "settings.scheduled.error.prompt": "Wpisz polecenie dla modelu",
  "settings.scheduled.error.time": "Wybierz godzinę",
  "settings.scheduled.error.model": "Najpierw wybierz model",
  "session.new.project.open": "Otwórz istniejący projekt",
  "common.pin": "Przypnij",
  "common.unpin": "Odepnij",
  "settings.relay.title": "Klucze 智联AI",
  "settings.relay.getKey": "Uzyskaj klucz API",
  "settings.relay.getKey.description": "Twórz oddzielne klucze dla ChatGPT, Grok i innych dostawców.",
  "settings.relay.upstream": "Serwer dostawcy",
  "settings.relay.unified": "Używaj wspólnego klucza API",
  "settings.relay.unified.description": "Po włączeniu każdy dostawca używa tego klucza.",
  "settings.relay.unified.key": "Wspólny klucz API",
  "settings.relay.unified.using": "Używany jest wspólny klucz",
  "settings.relay.key.set": "Klucz zapisany",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "Pozostaw puste, aby zachować zapisany klucz",
  "settings.relay.test": "Sprawdź połączenie",
  "settings.relay.testing": "Sprawdzanie...",
  "settings.relay.fetch": "Pobierz modele",
  "settings.relay.fetching": "Pobieranie...",
  "settings.relay.edit": "Edytuj",
  "settings.relay.clearKey": "Usuń klucz",
  "settings.relay.add": "Dodaj dostawcę",
  "settings.relay.add.name": "Nazwa dostawcy",
  "settings.relay.models.visible": "Widoczne modele: {{count}}",
  "settings.relay.connected": "Połączono · Modele: {{count}}",
  "settings.relay.connectedEmpty": "Połączono, ale nie zwrócono żadnych modeli",
  "settings.relay.test.ok": "Połączenie udane",
  "settings.relay.test.empty": "Połączono, ale nie zwrócono żadnych modeli",
  "settings.relay.models.title": "Modele {{vendor}}",
  "settings.relay.models.empty": "Nie ma jeszcze modeli. Pobierz listę po zapisaniu klucza.",
  "settings.relay.models.missing": "Nie ma już na serwerze dostawcy",
  "settings.relay.saved": "Zapisano automatycznie",
  "settings.relay.retry": "Ponów",
  "settings.relay.builtin": "Wbudowany",
  "settings.relay.delete": "Usuń dostawcę",
  "settings.relay.rollback": "Zresetuj zaimportowane klucze",
  "settings.relay.rollback.description":
    "Usuwa klucze Relay zaimportowane z auth.json. Oryginalny auth.json zostaje zachowany.",
  "settings.relay.error.KEY_MISSING": "Najpierw dodaj klucz API",
  "settings.relay.error.KEY_REJECTED": "Klucz został odrzucony",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "Serwer dostawcy jest nieosiągalny",
  "settings.relay.error.UPSTREAM_TIMEOUT": "Upłynął limit czasu odpowiedzi serwera dostawcy",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "Serwer dostawcy ograniczył częstotliwość żądań",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "Serwer dostawcy zwrócił nieprawidłową odpowiedź",
  "settings.relay.error.REVISION_CONFLICT": "To ustawienie zmieniono w innym oknie. Odśwież i spróbuj ponownie.",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "Nie udało się zapisać klucza API na tym urządzeniu.",
  "settings.mcp.add": "Dodaj MCP",
  "settings.mcp.edit": "Edytuj",
  "settings.mcp.field.name": "Nazwa",
  "settings.mcp.field.type": "Typ",
  "settings.mcp.field.command": "Polecenie",
  ...
  "settings.mcp.error.name": "Wpisz nazwę serwera",
  "settings.mcp.error.command": "Wpisz polecenie",
  "settings.mcp.error.url": "Wpisz adres URL",
  ...
  "desktop.menu.documentation": "Dokumentacja Koda",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać Koda",
  "desktop.recovery.terminated": "Okno Koda zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "Koda nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować Koda",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Koda nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja Koda została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Koda",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Koda.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów programistycznych.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Koda.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Koda.",
  ...
  "dialog.server.description": "Przełącz serwer Koda, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie Koda...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie Koda w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie Koda...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie Koda w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj Koda w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj Koda",
  "wsl.onboarding.opencodeReadyIn": "Koda jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koda jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj Koda w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj Koda",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Koda będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Koda nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Koda.",
  ...
  "help.tabs.introduction": "Koda Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja Koda ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Koda",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Koda nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Koda zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Koda wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Koda",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Koda na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Koda ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Koda.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Koda",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Koda.",
