export const dict = {
  ...
  "desktop.about.detail":
    "Tilpasset med OpenCode som grundlag\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "Koda v{{version}} er tilgængelig. Åbn udgivelsessiden for at opdatere?",
  "desktop.koda.update.open": "Åbn udgivelsessiden",
  "command.project.create": "Nyt projekt",
  "command.project.openExisting": "Åbn eksisterende projekt",
  "prompt.toast.projectRequired.title": "Vælg et projekt",
  "prompt.toast.projectRequired.description": "Opret eller åbn et projekt, før du sender.",
  "prompt.approval.ask": "Bed om godkendelse",
  "prompt.approval.auto": "Godkend for mig",
  "prompt.approval.plan": "Fuld adgang",
  "prompt.more": "Mere",
  "dialog.project.create.title": "Nyt projekt",
  "dialog.project.create.name": "Navn",
  "dialog.project.create.location": "Placering",
  "dialog.project.create.browse": "Gennemse",
  "dialog.project.create.path": "Sti",
  "dialog.project.create.submit": "Opret",
  "dialog.project.create.error.name": "Indtast et projektnavn",
  "dialog.project.create.error.invalid": "Dette navn kan ikke bruges til en mappe",
  "dialog.project.create.error.exists": "Mappen findes allerede. Åbn den i stedet, eller vælg et andet navn.",
  "dialog.project.create.error.failed": "Kunne ikke oprette mappen",
  "mcp.status.needs_client_registration": "kræver klientregistrering",
  "home.welcome.title": "Hvad kan jeg hjælpe med?",
  "home.project.create": "Nyt projekt",
  "home.project.open": "Åbn eksisterende projekt",
  "home.sessions.search.title": "Søg i samtaler",
  "session.todo.empty": "Ingen opgaver endnu",
  "session.panel.files": "Filer",
  "session.panel.changes": "Ændringer",
  "session.panel.tasks": "Opgaver",
  "session.panel.terminal": "Terminal",
  "session.panel.empty": "Vælg et projekt for at se filer, ændringer, opgaver og terminalen.",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "Ingen ændringer",
  "session.panel.git.dirty.one": "{{count}} ændret fil",
  "session.panel.git.dirty.other": "{{count}} ændrede filer",
  "session.task.waiting": "Venter på tilladelse",
  "session.task.failed": "Mislykkedes",
  "session.task.retry": "Prøv igen",
  "session.task.open": "Åbn i sin egen session",
  "settings.skills.title": "Færdigheder",
  "settings.skills.description": "Færdigheder fundet til dette projekt.",
  "settings.skills.empty": "Ingen færdigheder fundet",
  "settings.skills.enabled": "Tilgængelig for modellen",
  "settings.skills.disabled": "Nægtet for modellen",
  "settings.skills.search": "Søg efter færdigheder",
  "settings.skills.emptySearch": "Ingen færdigheder matcher søgningen",
  "settings.skills.details": "Detaljer om færdigheden",
  "settings.skills.noDescription": "Ingen beskrivelse",
  "settings.skills.source.project": "Projekt",
  "settings.skills.source.global": "Bruger",
  "settings.skills.source.builtin": "Indbygget",
  "settings.skills.source.custom": "Tilføjet",
  "settings.scheduled.title": "Planlagte opgaver",
  "settings.scheduled.description": "Kør en prompt én gang eller hver dag i et projekt.",
  "settings.scheduled.empty": "Ingen planlagte opgaver",
  "settings.scheduled.once": "Én gang",
  "settings.scheduled.daily": "Hver dag",
  "settings.scheduled.add": "Tilføj opgave",
  "settings.scheduled.field.name": "Navn",
  "settings.scheduled.field.prompt": "Prompt",
  "settings.scheduled.field.schedule": "Tidsplan",
  "settings.scheduled.field.time": "Kør klokken",
  "settings.scheduled.error.name": "Indtast et navn",
  "settings.scheduled.error.prompt": "Indtast en prompt",
  "settings.scheduled.error.time": "Vælg et tidspunkt",
  "settings.scheduled.error.model": "Vælg først en model",
  "session.new.project.open": "Åbn eksisterende projekt",
  "common.pin": "Fastgør",
  "common.unpin": "Frigør",
  "settings.relay.title": "智联AI-nøgler",
  "settings.relay.getKey": "Hent API-nøgle",
  "settings.relay.getKey.description": "Opret separate nøgler til ChatGPT, Grok og andre udbydere.",
  "settings.relay.upstream": "Bagvedliggende tjeneste",
  "settings.relay.unified": "Brug en fælles API-nøgle",
  "settings.relay.unified.description": "Når dette er aktiveret, bruger alle udbydere denne nøgle.",
  "settings.relay.unified.key": "Fælles API-nøgle",
  "settings.relay.unified.using": "Bruger den fælles nøgle",
  "settings.relay.key.set": "Nøgle gemt",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "Lad feltet være tomt for at beholde den gemte nøgle",
  "settings.relay.test": "Test forbindelse",
  "settings.relay.testing": "Tester...",
  "settings.relay.fetch": "Hent modeller",
  "settings.relay.fetching": "Henter...",
  "settings.relay.edit": "Rediger",
  "settings.relay.clearKey": "Ryd nøgle",
  "settings.relay.add": "Tilføj udbyder",
  "settings.relay.add.name": "Udbydernavn",
  "settings.relay.models.visible": "{{count}} synlige modeller",
  "settings.relay.connected": "Forbundet · {{count}} modeller",
  "settings.relay.connectedEmpty": "Forbundet, men ingen modeller blev returneret",
  "settings.relay.test.ok": "Forbindelsen lykkedes",
  "settings.relay.test.empty": "Forbundet, men ingen modeller blev returneret",
  "settings.relay.models.title": "Modeller fra {{vendor}}",
  "settings.relay.models.empty": "Ingen modeller endnu. Hent listen, når du har gemt en nøgle.",
  "settings.relay.models.missing": "Findes ikke længere hos den bagvedliggende tjeneste",
  "settings.relay.saved": "Gemt automatisk",
  "settings.relay.retry": "Prøv igen",
  "settings.relay.builtin": "Indbygget",
  "settings.relay.delete": "Slet udbyder",
  "settings.relay.rollback": "Nulstil importerede nøgler",
  "settings.relay.rollback.description":
    "Rydder Relay-nøgler importeret fra auth.json. Den oprindelige auth.json bevares.",
  "settings.relay.error.KEY_MISSING": "Tilføj først en API-nøgle",
  "settings.relay.error.KEY_REJECTED": "Nøglen blev afvist",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "Den bagvedliggende tjeneste kan ikke nås",
  "settings.relay.error.UPSTREAM_TIMEOUT": "Den bagvedliggende tjeneste overskred tidsgrænsen",
  "settings.relay.error.UPSTREAM_RATE_LIMITED":
    "Den bagvedliggende tjeneste begrænsede anmodningen på grund af for mange forespørgsler",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "Den bagvedliggende tjeneste returnerede et ugyldigt svar",
  "settings.relay.error.REVISION_CONFLICT": "Denne indstilling er ændret i et andet vindue. Opdater og prøv igen.",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "Kunne ikke gemme API-nøglen på denne enhed.",
  "settings.mcp.add": "Tilføj MCP",
  ...
  "settings.mcp.error.name": "Indtast et servernavn",
  "settings.mcp.error.command": "Indtast en kommando",
  "settings.mcp.error.url": "Indtast en URL",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Koda",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i Koda.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i Koda.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i Koda.",
  ...
  "dialog.server.description": "Skift hvilken Koda-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker Koda...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker Koda i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer Koda...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer Koda i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater Koda i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater Koda",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Koda kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Koda kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Koda igen.",
  ...
  "toast.update.description": "En ny version af Koda ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Koda-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Koda understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Koda inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Koda-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Koda",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Koda ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om Koda skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas Kodas tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Koda starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Koda.",
  ...
  "desktop.recovery.loadFailed": "Koda kunne ikke indlæses",
  "desktop.recovery.terminated": "Koda-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af Koda mislykkedes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Koda er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af Koda er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "Koda Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
