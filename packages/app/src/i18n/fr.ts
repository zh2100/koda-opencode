export const dict = {
  "desktop.menu.about": "À propos de Koda",
  "desktop.about.title": "Koda Desktop v{{version}}",
  "desktop.about.detail":
    "Adapté à partir d’OpenCode comme base\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available":
    "Koda v{{version}} est disponible. Ouvrir la page des versions pour effectuer la mise à jour ?",
  "desktop.koda.update.open": "Ouvrir la page des versions",
  "command.project.create": "Nouveau projet",
  "command.project.openExisting": "Ouvrir un projet existant",
  "prompt.toast.projectRequired.title": "Choisissez un projet",
  "prompt.toast.projectRequired.description": "Créez ou ouvrez un projet avant l’envoi.",
  "prompt.approval.ask": "Demander une approbation",
  "prompt.approval.auto": "Approuver à ma place",
  "prompt.approval.plan": "Accès complet",
  "prompt.more": "Plus",
  "dialog.project.create.title": "Nouveau projet",
  "dialog.project.create.name": "Nom",
  "dialog.project.create.location": "Emplacement",
  "dialog.project.create.browse": "Parcourir",
  "dialog.project.create.path": "Chemin",
  "dialog.project.create.submit": "Créer",
  "dialog.project.create.error.name": "Saisissez un nom de projet",
  "dialog.project.create.error.invalid": "Ce nom ne peut pas être utilisé pour un dossier",
  "dialog.project.create.error.exists": "Ce dossier existe déjà. Ouvrez-le ou choisissez un autre nom.",
  "dialog.project.create.error.failed": "Impossible de créer le dossier",
  "mcp.status.needs_client_registration": "enregistrement du client requis",
  "home.welcome.title": "Comment puis-je vous aider ?",
  "home.project.create": "Nouveau projet",
  "home.project.open": "Ouvrir un projet existant",
  "home.sessions.search.title": "Rechercher des discussions",
  "session.todo.empty": "Aucune tâche pour le moment",
  "session.panel.files": "Fichiers",
  "session.panel.changes": "Modifications",
  "session.panel.tasks": "Tâches",
  "session.panel.terminal": "Terminal",
  "session.panel.empty":
    "Sélectionnez un projet pour parcourir les fichiers, les modifications, les tâches et le terminal.",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "Aucune modification",
  "session.panel.git.dirty.one": "{{count}} fichier modifié",
  "session.panel.git.dirty.other": "{{count}} fichiers modifiés",
  "session.panel.git.dirty.many": "{{count}} fichiers modifiés",
  "session.task.waiting": "En attente d’autorisation",
  "session.task.failed": "Échec",
  "session.task.retry": "Réessayer",
  "session.task.open": "Ouvrir dans une session distincte",
  "settings.skills.title": "Compétences",
  "settings.skills.description": "Compétences trouvées pour ce projet.",
  "settings.skills.empty": "Aucune compétence trouvée",
  "settings.skills.enabled": "Disponible pour le modèle",
  "settings.skills.disabled": "Interdite au modèle",
  "settings.skills.search": "Rechercher des compétences",
  "settings.skills.emptySearch": "Aucune compétence ne correspond à cette recherche",
  "settings.skills.details": "Détails de la compétence",
  "settings.skills.noDescription": "Aucune description",
  "settings.skills.source.project": "Projet",
  "settings.skills.source.global": "Utilisateur",
  "settings.skills.source.builtin": "Intégrée",
  "settings.skills.source.custom": "Ajoutée",
  "settings.scheduled.title": "Tâches planifiées",
  "settings.scheduled.description": "Exécutez une invite une fois ou chaque jour dans un projet.",
  "settings.scheduled.empty": "Aucune tâche planifiée",
  "settings.scheduled.once": "Une fois",
  "settings.scheduled.daily": "Chaque jour",
  "settings.scheduled.add": "Ajouter une tâche",
  "settings.scheduled.field.name": "Nom",
  "settings.scheduled.field.prompt": "Invite",
  "settings.scheduled.field.schedule": "Planification",
  "settings.scheduled.field.time": "Exécuter à",
  "settings.scheduled.error.name": "Saisissez un nom",
  "settings.scheduled.error.prompt": "Saisissez une invite",
  "settings.scheduled.error.time": "Choisissez une heure",
  "settings.scheduled.error.model": "Sélectionnez d’abord un modèle",
  "session.new.project.open": "Ouvrir un projet existant",
  "common.pin": "Épingler",
  "common.unpin": "Désépingler",
  "settings.relay.title": "Clés 智联AI",
  "settings.relay.getKey": "Obtenir une clé API",
  "settings.relay.getKey.description": "Créez des clés distinctes pour ChatGPT, Grok et les autres fournisseurs.",
  "settings.relay.upstream": "Service en amont",
  "settings.relay.unified": "Utiliser une clé API partagée",
  "settings.relay.unified.description": "Lorsque cette option est activée, tous les fournisseurs utilisent cette clé.",
  "settings.relay.unified.key": "Clé API partagée",
  "settings.relay.unified.using": "Utilisation de la clé partagée",
  "settings.relay.key.set": "Clé enregistrée",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "Laissez vide pour conserver la clé enregistrée",
  "settings.relay.test": "Tester la connexion",
  "settings.relay.testing": "Test en cours...",
  "settings.relay.fetch": "Récupérer les modèles",
  "settings.relay.fetching": "Récupération en cours...",
  "settings.relay.edit": "Modifier",
  "settings.relay.clearKey": "Effacer la clé",
  "settings.relay.add": "Ajouter un fournisseur",
  "settings.relay.add.name": "Nom du fournisseur",
  "settings.relay.models.visible": "{{count}} modèles visibles",
  "settings.relay.connected": "Connecté · {{count}} modèles",
  "settings.relay.connectedEmpty": "Connecté, mais aucun modèle n’a été renvoyé",
  "settings.relay.test.ok": "Connexion réussie",
  "settings.relay.test.empty": "Connecté, mais aucun modèle n’a été renvoyé",
  "settings.relay.models.title": "Modèles de {{vendor}}",
  "settings.relay.models.empty": "Aucun modèle pour le moment. Récupérez la liste après avoir enregistré une clé.",
  "settings.relay.models.missing": "N’est plus disponible sur le service en amont",
  "settings.relay.saved": "Enregistré automatiquement",
  "settings.relay.retry": "Réessayer",
  "settings.relay.builtin": "Intégré",
  "settings.relay.delete": "Supprimer le fournisseur",
  "settings.relay.rollback": "Réinitialiser les clés importées",
  "settings.relay.rollback.description":
    "Efface les clés Relay importées depuis auth.json. Le fichier auth.json d’origine est conservé.",
  "settings.relay.error.KEY_MISSING": "Ajoutez d’abord une clé API",
  "settings.relay.error.KEY_REJECTED": "La clé a été refusée",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "Le service en amont est inaccessible",
  "settings.relay.error.UPSTREAM_TIMEOUT": "Le délai d’attente du service en amont a été dépassé",
  "settings.relay.error.UPSTREAM_RATE_LIMITED":
    "Le service en amont a limité la requête en raison d’un trop grand nombre de demandes",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "Le service en amont a renvoyé une réponse non valide",
  "settings.relay.error.REVISION_CONFLICT":
    "Ce paramètre a été modifié dans une autre fenêtre. Actualisez et réessayez.",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "Impossible d’enregistrer la clé API sur cet appareil.",
  "settings.mcp.add": "Ajouter un MCP",
  ...
  "settings.mcp.error.name": "Saisissez un nom de serveur",
  "settings.mcp.error.command": "Saisissez une commande",
  "settings.mcp.error.url": "Saisissez une URL",
  ...
  "desktop.menu.documentation": "Documentation d'Koda",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'Koda",
  "desktop.recovery.terminated": "La fenêtre Koda s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "Koda ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'Koda",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Koda n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'Koda est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Koda",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Koda.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Koda.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Koda.",
  ...
  "dialog.server.description": "Changez le serveur Koda auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'Koda...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'Koda dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'Koda...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'Koda dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour Koda dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour Koda",
  "wsl.onboarding.opencodeReadyIn": "Koda est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koda est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez Koda dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer Koda",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Koda puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Koda n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired": "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Koda.",
  ...
  "help.tabs.introduction": "Koda Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Une nouvelle version d'Koda ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Koda",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Koda ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1": "Koda inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Koda dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Koda",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Koda sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Koda suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Koda.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Koda",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Koda.",
