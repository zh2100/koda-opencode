export const dict = {
  ...
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Koda.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Koda ({{version}}) est maintenant disponible pour installation.",
  ...
  "sidebar.gettingStarted.line1":
    "Koda inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
