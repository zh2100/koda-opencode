...
const desktop = [
  ...
  "Minimiziraj",
  "Maksimiziraj",
  "Dokumentacija za Koda",
  "Forum za podršku",
  "Pošalji povratne informacije",
  "O aplikaciji Koda",
  "Koda Desktop v{{version}}",
  "Prilagođeno na temelju OpenCodea\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "Dostupna je Koda v{{version}}. Otvoriti stranicu izdanja za nadogradnju?",
  "Otvori stranicu izdanja",
  "Prijavi pogrešku",
  "Izbornik Koda",
  ...
  "Nastavi čekati",
  "Izađi",
  "Koda se nije uspio učitati",
  "Prozor aplikacije Koda neočekivano je zatvoren",
  "Koda ne reagira",
  ...
  "Instalacija aplikacije Koda nije uspjela",
  ...
  "Koda nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije Koda je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  "command.project.create": "Novi projekt",
  "command.project.openExisting": "Otvori postojeći projekt",
  "prompt.toast.projectRequired.title": "Odaberite projekt",
  "prompt.toast.projectRequired.description": "Stvorite ili otvorite projekt prije slanja.",
  "prompt.approval.ask": "Zatraži odobrenje",
  "prompt.approval.auto": "Odobri umjesto mene",
  "prompt.approval.plan": "Potpuni pristup",
  "prompt.more": "Više",
  "dialog.project.create.title": "Novi projekt",
  ...
  "dialog.project.create.submit": "Stvori",
  "dialog.project.create.error.name": "Unesite naziv projekta",
  "dialog.project.create.error.invalid": "Ovaj se naziv ne može upotrijebiti za mapu",
  "dialog.project.create.error.exists": "Ta mapa već postoji. Otvorite je ili odaberite drugi naziv.",
  "dialog.project.create.error.failed": "Nije moguće stvoriti mapu",
  "mcp.status.needs_client_registration": "potrebna je registracija klijenta",
  "home.welcome.title": "Kako mogu pomoći?",
  "home.project.create": "Novi projekt",
  "home.project.open": "Otvori postojeći projekt",
  ...
  "session.panel.empty": "Odaberite projekt za pregled datoteka, promjena, zadataka i terminala.",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "Bez promjena",
  "session.panel.git.dirty.one": "{{count}} promijenjena datoteka",
  "session.panel.git.dirty.few": "{{count}} promijenjene datoteke",
  "session.panel.git.dirty.other": "{{count}} promijenjenih datoteka",
  "session.task.waiting": "Čekanje na dopuštenje",
  "session.task.failed": "Neuspjelo",
  "session.task.retry": "Pokušaj ponovno",
  "session.task.open": "Otvori u zasebnoj sesiji",
  "settings.skills.title": "Vještine",
  "settings.skills.description": "Vještine pronađene za ovaj projekt.",
  ...
  "settings.skills.emptySearch": "Nijedna vještina ne odgovara pretraživanju",
  "settings.skills.details": "Pojedinosti vještine",
  ...
  "settings.scheduled.error.model": "Najprije odaberite model",
  "session.new.project.open": "Otvori postojeći projekt",
  "common.pin": "Prikvači",
  "common.unpin": "Otkvači",
  "settings.relay.title": "Ključevi 智联AI",
  "settings.relay.getKey": "Nabavi API ključ",
  "settings.relay.getKey.description": "Stvorite zasebne ključeve za ChatGPT, Grok i druge pružatelje usluga.",
  "settings.relay.upstream": "Nadređeni poslužitelj",
  "settings.relay.unified": "Upotrebljavaj zajednički API ključ",
  "settings.relay.unified.description": "Kad je uključeno, svi pružatelji upotrebljavaju ovaj ključ.",
  "settings.relay.unified.key": "Zajednički API ključ",
  "settings.relay.unified.using": "Upotrebljava se zajednički ključ",
  "settings.relay.key.set": "Ključ je spremljen",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "Ostavite prazno za zadržavanje spremljenog ključa",
  "settings.relay.test": "Testiraj vezu",
  "settings.relay.testing": "Testiranje...",
  "settings.relay.fetch": "Dohvati modele",
  "settings.relay.fetching": "Dohvaćanje...",
  "settings.relay.edit": "Uredi",
  "settings.relay.clearKey": "Izbriši ključ",
  "settings.relay.add": "Dodaj pružatelja",
  "settings.relay.add.name": "Naziv pružatelja",
  ...
  "settings.relay.models.title": "Modeli pružatelja {{vendor}}",
  "settings.relay.models.empty": "Još nema modela. Dohvatite popis nakon spremanja ključa.",
  "settings.relay.models.missing": "Više nije na nadređenom poslužitelju",
  "settings.relay.saved": "Automatski spremljeno",
  "settings.relay.retry": "Pokušaj ponovno",
  "settings.relay.builtin": "Ugrađeno",
  "settings.relay.delete": "Izbriši pružatelja",
  ...
  "settings.relay.error.KEY_MISSING": "Najprije dodajte API ključ",
  "settings.relay.error.KEY_REJECTED": "Ključ je odbijen",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "Nadređeni poslužitelj nije dostupan",
  "settings.relay.error.UPSTREAM_TIMEOUT": "Isteklo je vrijeme čekanja nadređenog poslužitelja",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "Nadređeni poslužitelj ograničio je učestalost zahtjeva",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "Nadređeni poslužitelj vratio je nevaljan odgovor",
  "settings.relay.error.REVISION_CONFLICT":
    "Ova je postavka promijenjena u drugom prozoru. Osvježite i pokušajte ponovno.",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "Nije moguće spremiti API ključ na ovaj uređaj.",
  ...
  "settings.mcp.error.name": "Unesite naziv poslužitelja",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi Koda",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u Koda.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen vam daje pristup odabranom skupu pouzdanih optimiziranih modela za agente za kodiranje.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u Koda.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u Koda.",
  ...
  "dialog.server.description": "Promijenite na koji se Koda poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOpencodeIn": "Provjera Koda u {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Koda...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Koda u {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažurirajte Koda u {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažurirajte Koda",
  "wsl.onboarding.opencodeReadyIn": "Koda je spreman u {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koda je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instalirajte Koda u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte Koda",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što Koda može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "Koda nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite Koda.",
  ...
  "help.tabs.introduction": "Radna površina Koda sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Koda ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku Koda timu",
  ...
  "error.chain.mcpFailed": 'MCP poslužitelj "{{name}}" nije uspio. Napomena, Koda još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Koda uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "Koda Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite Koda poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za Koda",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako Koda izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description": "Odaberite hoće li Koda slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je Koda tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se Koda pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju Koda.",
