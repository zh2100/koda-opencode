...
export const dict = {
  "desktop.menu.about": "Über Koda",
  "desktop.about.title": "Koda Desktop v{{version}}",
  "desktop.about.detail": "Auf Basis von OpenCode angepasst\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "Koda v{{version}} ist verfügbar. Release-Seite zum Aktualisieren öffnen?",
  "desktop.koda.update.open": "Release-Seite öffnen",
  "command.project.create": "Neues Projekt",
  "command.project.openExisting": "Vorhandenes Projekt öffnen",
  "prompt.toast.projectRequired.title": "Projekt auswählen",
  "prompt.toast.projectRequired.description": "Vor dem Senden ein Projekt erstellen oder öffnen.",
  "prompt.approval.ask": "Genehmigung anfordern",
  "prompt.approval.auto": "Für mich genehmigen",
  "prompt.approval.plan": "Vollzugriff",
  "prompt.more": "Mehr",
  "dialog.project.create.title": "Neues Projekt",
  "dialog.project.create.name": "Name",
  "dialog.project.create.location": "Speicherort",
  "dialog.project.create.browse": "Durchsuchen",
  "dialog.project.create.path": "Pfad",
  "dialog.project.create.submit": "Erstellen",
  "dialog.project.create.error.name": "Projektnamen eingeben",
  "dialog.project.create.error.invalid": "Dieser Name kann nicht als Ordnername verwendet werden",
  "dialog.project.create.error.exists":
    "Dieser Ordner existiert bereits. Öffne ihn stattdessen oder wähle einen anderen Namen.",
  "dialog.project.create.error.failed": "Ordner konnte nicht erstellt werden",
  "mcp.status.needs_client_registration": "Client-Registrierung erforderlich",
  "home.welcome.title": "Wobei kann ich helfen?",
  "home.project.create": "Neues Projekt",
  "home.project.open": "Vorhandenes Projekt öffnen",
  "home.sessions.search.title": "Chats durchsuchen",
  "session.todo.empty": "Noch keine Aufgaben",
  "session.panel.files": "Dateien",
  "session.panel.changes": "Änderungen",
  "session.panel.tasks": "Aufgaben",
  "session.panel.terminal": "Terminal",
  "session.panel.empty": "Wähle ein Projekt aus, um Dateien, Änderungen, Aufgaben und das Terminal anzuzeigen.",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "Keine Änderungen",
  "session.panel.git.dirty.one": "{{count}} geänderte Datei",
  "session.panel.git.dirty.other": "{{count}} geänderte Dateien",
  "session.task.waiting": "Warten auf Berechtigung",
  "session.task.failed": "Fehlgeschlagen",
  "session.task.retry": "Erneut versuchen",
  "session.task.open": "In eigener Sitzung öffnen",
  "settings.skills.title": "Skills",
  "settings.skills.description": "Für dieses Projekt gefundene Skills.",
  "settings.skills.empty": "Keine Skills gefunden",
  "settings.skills.enabled": "Für das Modell verfügbar",
  "settings.skills.disabled": "Für das Modell gesperrt",
  "settings.skills.search": "Skills durchsuchen",
  "settings.skills.emptySearch": "Keine Skills entsprechen dieser Suche",
  "settings.skills.details": "Skill-Details",
  "settings.skills.noDescription": "Keine Beschreibung",
  "settings.skills.source.project": "Projekt",
  "settings.skills.source.global": "Benutzer",
  "settings.skills.source.builtin": "Integriert",
  "settings.skills.source.custom": "Hinzugefügt",
  "settings.scheduled.title": "Geplante Aufgaben",
  "settings.scheduled.description": "Einen Prompt einmalig oder täglich in einem Projekt ausführen.",
  "settings.scheduled.empty": "Keine geplanten Aufgaben",
  "settings.scheduled.once": "Einmalig",
  "settings.scheduled.daily": "Täglich",
  "settings.scheduled.add": "Aufgabe hinzufügen",
  "settings.scheduled.field.name": "Name",
  "settings.scheduled.field.prompt": "Prompt",
  "settings.scheduled.field.schedule": "Zeitplan",
  "settings.scheduled.field.time": "Ausführen um",
  "settings.scheduled.error.name": "Namen eingeben",
  "settings.scheduled.error.prompt": "Prompt eingeben",
  "settings.scheduled.error.time": "Uhrzeit auswählen",
  "settings.scheduled.error.model": "Zuerst ein Modell auswählen",
  "session.new.project.open": "Vorhandenes Projekt öffnen",
  "common.pin": "Anheften",
  "common.unpin": "Loslösen",
  "settings.relay.title": "智联AI-Schlüssel",
  "settings.relay.getKey": "API-Schlüssel abrufen",
  "settings.relay.getKey.description": "Separate Schlüssel für ChatGPT, Grok und andere Anbieter erstellen.",
  "settings.relay.upstream": "Vorgelagerter Dienst",
  "settings.relay.unified": "Gemeinsamen API-Schlüssel verwenden",
  "settings.relay.unified.description": "Wenn aktiviert, verwenden alle Anbieter diesen Schlüssel.",
  "settings.relay.unified.key": "Gemeinsamer API-Schlüssel",
  "settings.relay.unified.using": "Gemeinsamer Schlüssel wird verwendet",
  "settings.relay.key.set": "Schlüssel gespeichert",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "Leer lassen, um den gespeicherten Schlüssel beizubehalten",
  "settings.relay.test": "Verbindung testen",
  "settings.relay.testing": "Wird getestet...",
  "settings.relay.fetch": "Modelle abrufen",
  "settings.relay.fetching": "Wird abgerufen...",
  "settings.relay.edit": "Bearbeiten",
  "settings.relay.clearKey": "Schlüssel löschen",
  "settings.relay.add": "Anbieter hinzufügen",
  "settings.relay.add.name": "Anbietername",
  "settings.relay.models.visible": "{{count}} sichtbare Modelle",
  "settings.relay.connected": "Verbunden · {{count}} Modelle",
  "settings.relay.connectedEmpty": "Verbunden, aber es wurden keine Modelle zurückgegeben",
  "settings.relay.test.ok": "Verbindung erfolgreich",
  "settings.relay.test.empty": "Verbunden, aber es wurden keine Modelle zurückgegeben",
  "settings.relay.models.title": "Modelle von {{vendor}}",
  "settings.relay.models.empty": "Noch keine Modelle. Nach dem Speichern eines Schlüssels die Liste abrufen.",
  "settings.relay.models.missing": "Beim vorgelagerten Dienst nicht mehr verfügbar",
  "settings.relay.saved": "Automatisch gespeichert",
  "settings.relay.retry": "Erneut versuchen",
  "settings.relay.builtin": "Integriert",
  "settings.relay.delete": "Anbieter löschen",
  "settings.relay.rollback": "Importierte Schlüssel zurücksetzen",
  "settings.relay.rollback.description":
    "Löscht aus auth.json importierte Relay-Schlüssel. Die ursprüngliche auth.json bleibt erhalten.",
  "settings.relay.error.KEY_MISSING": "Zuerst einen API-Schlüssel hinzufügen",
  "settings.relay.error.KEY_REJECTED": "Der Schlüssel wurde abgelehnt",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "Der vorgelagerte Dienst ist nicht erreichbar",
  "settings.relay.error.UPSTREAM_TIMEOUT": "Zeitüberschreitung beim vorgelagerten Dienst",
  "settings.relay.error.UPSTREAM_RATE_LIMITED":
    "Der vorgelagerte Dienst hat die Anfrage wegen zu vieler Anfragen begrenzt",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "Der vorgelagerte Dienst hat eine ungültige Antwort zurückgegeben",
  "settings.relay.error.REVISION_CONFLICT":
    "Diese Einstellung wurde in einem anderen Fenster geändert. Aktualisieren und erneut versuchen.",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE":
    "Der API-Schlüssel konnte auf diesem Gerät nicht gespeichert werden.",
  "settings.mcp.add": "MCP hinzufügen",
  "settings.mcp.edit": "Bearbeiten",
  "settings.mcp.field.name": "Name",
  "settings.mcp.field.type": "Typ",
  ...
  "settings.mcp.error.name": "Servernamen eingeben",
  "settings.mcp.error.command": "Befehl eingeben",
  "settings.mcp.error.url": "URL eingeben",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Koda",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Koda zu nutzen.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in Koda zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Koda zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den Koda-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingOpencode": "Koda wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "Koda in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "Koda wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "Koda in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie Koda in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Koda aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "Koda ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "Koda ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie Koda in {{distro}}.",
  "wsl.onboarding.installOpencode": "Koda installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Koda einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Koda konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Koda erneut.",
  ...
  "toast.update.description": "Eine neue Version von Koda ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Koda-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Koda unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "Koda mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "Koda enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "Koda-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Koda ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Koda auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description": "Wählen Sie, ob Koda dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Koda anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Koda automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "Koda ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von Koda wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "Koda konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das Koda-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "Koda reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "Koda-Installation fehlgeschlagen",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Koda ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das Koda-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "Koda Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
