export const dict = {
  "desktop.menu.about": "Дар бораи Koda",
  "desktop.about.title": "Барномаи мизи кории Koda v{{version}}",
  "desktop.about.detail":
    "Бо истифода аз OpenCode ҳамчун асос тағйир дода шудааст\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "Koda v{{version}} дастрас аст. Саҳифаи нашр барои навсозӣ кушода шавад?",
  "desktop.koda.update.open": "Кушодани саҳифаи нашр",
  "command.project.create": "Лоиҳаи нав",
  "command.project.openExisting": "Кушодани лоиҳаи мавҷуда",
  "prompt.toast.projectRequired.title": "Лоиҳаро интихоб кунед",
  "prompt.toast.projectRequired.description": "Пеш аз фиристодан лоиҳа созед ё кушоед.",
  "prompt.approval.ask": "Дархости тасдиқ",
  "prompt.approval.auto": "Ба ҷойи ман тасдиқ кун",
  "prompt.approval.plan": "Дастрасии пурра",
  "prompt.more": "Бештар",
  "dialog.project.create.title": "Лоиҳаи нав",
  "dialog.project.create.name": "Ном",
  "dialog.project.create.location": "Ҷойгиршавӣ",
  "dialog.project.create.browse": "Мурур кардан",
  "dialog.project.create.path": "Масир",
  "dialog.project.create.submit": "Эҷод кардан",
  "dialog.project.create.error.name": "Номи лоиҳаро ворид кунед",
  "dialog.project.create.error.invalid": "Ин номро барои ҷузвдон истифода бурдан мумкин нест",
  "dialog.project.create.error.exists": "Ин ҷузвдон аллакай вуҷуд дорад. Онро кушоед ё номи дигар интихоб кунед.",
  "dialog.project.create.error.failed": "Ҷузвдонро эҷод карда нашуд",
  "mcp.status.needs_client_registration": "сабти муштарӣ лозим аст",
  "home.welcome.title": "Чӣ гуна кумак карда метавонам?",
  "home.project.create": "Лоиҳаи нав",
  "home.project.open": "Кушодани лоиҳаи мавҷуда",
  "home.sessions.search.title": "Ҷустуҷӯи суҳбатҳо",
  "session.todo.empty": "Ҳоло вазифаҳо нестанд",
  "session.panel.files": "Файлҳо",
  "session.panel.changes": "Тағйирот",
  "session.panel.tasks": "Вазифаҳо",
  "session.panel.terminal": "Терминал",
  "session.panel.empty": "Барои дидани файлҳо, тағйирот, вазифаҳо ва терминал лоиҳаро интихоб кунед.",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "Бе тағйирот",
  "session.panel.git.dirty.one": "{{count}} файли тағйирёфта",
  "session.panel.git.dirty.other": "{{count}} файли тағйирёфта",
  "session.task.waiting": "Дар интизори иҷозат",
  "session.task.failed": "Ноком шуд",
  "session.task.retry": "Аз нав кӯшидан",
  "session.task.open": "Кушодан дар нишасти алоҳида",
  "settings.skills.title": "Маҳоратҳо",
  "settings.skills.description": "Маҳоратҳои ёфтшуда барои ин лоиҳа.",
  "settings.skills.empty": "Маҳоратҳо ёфт нашуданд",
  "settings.skills.enabled": "Барои модел дастрас аст",
  "settings.skills.disabled": "Барои модел манъ аст",
  "settings.skills.search": "Ҷустуҷӯи маҳоратҳо",
  "settings.skills.emptySearch": "Маҳорате ба ин ҷустуҷӯ мувофиқ нест",
  "settings.skills.details": "Тафсилоти маҳорат",
  "settings.skills.noDescription": "Тавсиф нест",
  "settings.skills.source.project": "Лоиҳа",
  "settings.skills.source.global": "Корбар",
  "settings.skills.source.builtin": "Дарунсохт",
  "settings.skills.source.custom": "Иловашуда",
  "settings.scheduled.title": "Вазифаҳои банақшагирифташуда",
  "settings.scheduled.description": "Дархостро дар лоиҳа як бор ё ҳар рӯз иҷро кунед.",
  "settings.scheduled.empty": "Вазифаҳои банақшагирифташуда нестанд",
  "settings.scheduled.once": "Як бор",
  "settings.scheduled.daily": "Ҳар рӯз",
  "settings.scheduled.add": "Илова кардани вазифа",
  "settings.scheduled.field.name": "Ном",
  "settings.scheduled.field.prompt": "Дархост",
  "settings.scheduled.field.schedule": "Ҷадвал",
  "settings.scheduled.field.time": "Вақти иҷро",
  "settings.scheduled.error.name": "Номро ворид кунед",
  "settings.scheduled.error.prompt": "Дархостро ворид кунед",
  "settings.scheduled.error.time": "Вақтро интихоб кунед",
  "settings.scheduled.error.model": "Аввал моделро интихоб кунед",
  "session.new.project.open": "Кушодани лоиҳаи мавҷуда",
  "common.pin": "Санҷоқ кардан",
  "common.unpin": "Бардоштани санҷоқ",
  "settings.relay.title": "Калидҳои 智联AI",
  "settings.relay.getKey": "Гирифтани калиди API",
  "settings.relay.getKey.description": "Барои ChatGPT, Grok ва дигар таъминкунандагон калидҳои алоҳида созед.",
  "settings.relay.upstream": "Сервери болоӣ",
  "settings.relay.unified": "Истифодаи калиди умумии API",
  "settings.relay.unified.description": "Ҳангоми фаъол будан ҳамаи фурӯшандагон ин калидро истифода мебаранд.",
  "settings.relay.unified.key": "Калиди умумии API",
  "settings.relay.unified.using": "Калиди умумӣ истифода мешавад",
  "settings.relay.key.set": "Калид нигоҳ дошта шуд",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "Барои нигоҳ доштани калиди сабтшуда холӣ гузоред",
  "settings.relay.test": "Санҷиши пайвастшавӣ",
  "settings.relay.testing": "Санҷида мешавад...",
  "settings.relay.fetch": "Гирифтани моделҳо",
  "settings.relay.fetching": "Гирифта мешавад...",
  "settings.relay.edit": "Таҳрир кардан",
  "settings.relay.clearKey": "Пок кардани калид",
  "settings.relay.add": "Илова кардани фурӯшанда",
  "settings.relay.add.name": "Номи фурӯшанда",
  "settings.relay.models.visible": "{{count}} модели намоён",
  "settings.relay.connected": "Пайваст шуд · {{count}} модел",
  "settings.relay.connectedEmpty": "Пайваст шуд, аммо моделҳо баргардонида нашуданд",
  "settings.relay.test.ok": "Пайвастшавӣ муваффақ шуд",
  "settings.relay.test.empty": "Пайваст шуд, аммо моделҳо баргардонида нашуданд",
  "settings.relay.models.title": "Моделҳои {{vendor}}",
  "settings.relay.models.empty": "Ҳоло моделҳо нестанд. Пас аз нигоҳ доштани калид рӯйхатро гиред.",
  "settings.relay.models.missing": "Дигар дар сервери болоӣ нест",
  "settings.relay.saved": "Ба таври худкор нигоҳ дошта шуд",
  "settings.relay.retry": "Аз нав кӯшидан",
  "settings.relay.builtin": "Дарунсохт",
  "settings.relay.delete": "Нест кардани фурӯшанда",
  "settings.relay.rollback": "Бознишонии калидҳои воридшуда",
  "settings.relay.rollback.description":
    "Калидҳои Relay-и аз auth.json воридшударо пок мекунад. auth.json-и аслӣ нигоҳ дошта мешавад.",
  "settings.relay.error.KEY_MISSING": "Аввал калиди API илова кунед",
  "settings.relay.error.KEY_REJECTED": "Калид рад карда шуд",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "Сервери болоӣ дастнорас аст",
  "settings.relay.error.UPSTREAM_TIMEOUT": "Вақти интизории сервери болоӣ ба охир расид",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "Сервери болоӣ басомади дархостҳоро маҳдуд кард",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "Сервери болоӣ ҷавоби беэътибор баргардонд",
  "settings.relay.error.REVISION_CONFLICT":
    "Ин танзим дар равзанаи дигар тағйир ёфт. Навсозӣ кунед ва аз нав кӯшиш кунед.",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "Калиди API дар ин дастгоҳ нигоҳ дошта нашуд.",
  "settings.mcp.add": "Илова кардани MCP",
  "settings.mcp.edit": "Таҳрир кардан",
  "settings.mcp.field.name": "Ном",
  "settings.mcp.field.type": "Навъ",
  "settings.mcp.field.command": "Фармон",
  ...
  "settings.mcp.error.name": "Номи серверро ворид кунед",
  "settings.mcp.error.command": "Фармонро ворид кунед",
  "settings.mcp.error.url": "URL-ро ворид кунед",
  ...
  "desktop.menu.documentation": "Koda Ҳуҷҷатҳо",
  ...
  "desktop.menu.ariaLabel": "Koda меню",
  ...
  "desktop.recovery.loadFailed": "Koda бор карда натавонист",
  "desktop.recovery.terminated": "Koda тиреза ба таври ғайричашмдошт қатъ карда шуд",
  "desktop.recovery.unresponsive": "Koda ҷавоб намедиҳад",
  ...
  "desktop.wsl.error.installOpencode": "Koda насб карда нашуд",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Koda дар {{distro}} насб нашудааст",
  "desktop.wsl.error.updateVersion":
    "Koda навсозӣ анҷом ёфт, аммо {{distro}} то ҳол гузориш медиҳад {{installed}}; интизорӣ {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Моделҳои ройгон аз ҷониби Koda пешниҳодшуда",
  ...
  "provider.connect.apiKey.description":
    "Барои пайваст кардани ҳисоби худ калиди {{provider}} API-ро ворид кунед ва моделҳои {{provider}}-ро дар Koda истифода баред.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen ба шумо дастрасӣ ба маҷмӯи мураттабшудаи моделҳои боэътимоди оптимизатсияшуда барои агентҳои рамзгузориро медиҳад.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "Барои ҷамъ овардани рамзи иҷозати шумо барои пайваст кардани ҳисоби шумо ва истифода бурдани моделҳои {{provider}} дар Koda.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ва рамзи зерро ворид кунед, то ҳисоби худро пайваст кунед ва моделҳои {{provider}}-ро дар Koda истифода баред.",
  ...
  "dialog.server.description": "Гузариш кунед, ки ин барнома ба кадом сервери Koda пайваст мешавад.",
  ...
  "wsl.onboarding.checkingOpencode": "Санҷиш Koda...",
  "wsl.onboarding.checkingOpencodeIn": "Санҷиш Koda дар {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Навсозӣ Koda...",
  "wsl.onboarding.updatingOpencodeIn": "Навсозии Koda дар {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Навсозии Koda дар {{distro}}.",
  "wsl.onboarding.updateOpencode": "Навсозӣ Koda",
  "wsl.onboarding.opencodeReadyIn": "Koda дар {{distro}} тайёр аст.",
  "wsl.onboarding.opencodeReady": "Koda тайёр аст.",
  "wsl.onboarding.installOpencodeIn": "Koda дар {{distro}} насб кунед.",
  "wsl.onboarding.installOpencode": "Насб кунед Koda",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda насб нашудааст",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) лозим аст, то Koda сервери WSL илова карда шавад",
  "wsl.onboarding.wslUnavailable.title": "WSL дастрас нест",
  "wsl.onboarding.wslUnavailable.description": "Koda WSL-ро дар ин мошин тафтиш карда натавонист.",
  "wsl.onboarding.installWsl": "Насб кунед WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Барои анҷом додани насби WSL Windows-ро аз нав оғоз кунед, сипас Koda-ро боз кунед.",
  ...
  "help.tabs.introduction": "Koda Desktop ҳоло дар атрофи ҷадвалҳо сохта шудааст.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Версияи нави Koda ({{version}}) ҳоло барои насб дастрас аст.",
  ...
  "error.page.report.prefix": "Лутфан дар бораи ин хато ба дастаи Koda хабар диҳед",
  ...
  "error.chain.mcpFailed":
    'MCP сервери "{{name}}" ноком шуд. Дар хотир доред, ки Koda тасдиқи MCP-ро ҳанӯз дастгирӣ намекунад.',
  ...
  "sidebar.gettingStarted.line1": "Koda моделҳои ройгонро дар бар мегирад, то шумо метавонед фавран оғоз кунед.",
  ...
  "settings.desktop.wsl.description": "Сервери Koda-ро дар WSL дар Windows иҷро кунед.",
  ...
  "settings.general.row.language.description": "Забони намоишро барои Koda иваз кунед",
  ...
  "settings.general.row.appearance.description": "Фармоиш диҳед, ки чӣ гуна Koda дар дастгоҳи шумо намуди зоҳирӣ дорад",
  "settings.general.row.colorScheme.title": "Схемаи ранг",
  "settings.general.row.colorScheme.description":
    "Интихоб кунед, ки Koda аз рӯи система, равшанӣ ё мавзӯи торик пайравӣ мекунад",
  "settings.general.row.theme.title": "Мавзӯъ",
  "settings.general.row.theme.description": "Чӣ тавр Koda мавзӯъро танзим кунед.",
  ...
  "settings.updates.row.startup.description": "Ҳангоми оғоз кардани Koda навсозиҳо ба таври худкор санҷед",
  ...
  "settings.updates.toast.latest.description": "Шумо версияи охирини Koda-ро иҷро карда истодаед.",
