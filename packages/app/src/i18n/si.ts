export const dict: Record<string, string> = {
  "desktop.menu.about": "Koda පිළිබඳව",
  "desktop.about.title": "Koda වැඩතල යෙදුම v{{version}}",
  "desktop.about.detail": "OpenCode පදනම් කරගෙන වෙනස් කරන ලදී\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "Koda v{{version}} තිබේ. උත්ශ්‍රේණි කිරීමට නිකුතු පිටුව විවෘත කරන්නද?",
  "desktop.koda.update.open": "නිකුතු පිටුව විවෘත කරන්න",
  "command.project.create": "නව ව්‍යාපෘතිය",
  "command.project.openExisting": "පවතින ව්‍යාපෘතිය විවෘත කරන්න",
  "prompt.toast.projectRequired.title": "ව්‍යාපෘතියක් තෝරන්න",
  "prompt.toast.projectRequired.description": "යැවීමට පෙර ව්‍යාපෘතියක් සාදන්න හෝ විවෘත කරන්න.",
  "prompt.approval.ask": "අනුමැතිය ඉල්ලන්න",
  "prompt.approval.auto": "මා වෙනුවෙන් අනුමත කරන්න",
  "prompt.approval.plan": "සම්පූර්ණ ප්‍රවේශය",
  "prompt.more": "තවත්",
  "dialog.project.create.title": "නව ව්‍යාපෘතිය",
  "dialog.project.create.name": "නම",
  "dialog.project.create.location": "ස්ථානය",
  "dialog.project.create.browse": "පිරික්සන්න",
  "dialog.project.create.path": "මාර්ගය",
  "dialog.project.create.submit": "සාදන්න",
  "dialog.project.create.error.name": "ව්‍යාපෘතියේ නම ඇතුළත් කරන්න",
  "dialog.project.create.error.invalid": "මෙම නම බහාලුමක් සඳහා භාවිත කළ නොහැක",
  "dialog.project.create.error.exists": "එම බහාලුම දැනටමත් තිබේ. එය විවෘත කරන්න හෝ වෙනත් නමක් තෝරන්න.",
  "dialog.project.create.error.failed": "බහාලුම සෑදීමට නොහැකි විය",
  "mcp.status.needs_client_registration": "සේවාලාභී ලියාපදිංචිය අවශ්‍යයි",
  "home.welcome.title": "මට උදව් කළ හැක්කේ කුමකටද?",
  "home.project.create": "නව ව්‍යාපෘතිය",
  "home.project.open": "පවතින ව්‍යාපෘතිය විවෘත කරන්න",
  "home.sessions.search.title": "කතාබස් සොයන්න",
  "session.todo.empty": "තවම කාර්යයන් නැත",
  "session.panel.files": "ගොනු",
  "session.panel.changes": "වෙනස්කම්",
  "session.panel.tasks": "කාර්යයන්",
  "session.panel.terminal": "පර්යන්තය",
  "session.panel.empty": "ගොනු, වෙනස්කම්, කාර්යයන් සහ පර්යන්තය බැලීමට ව්‍යාපෘතියක් තෝරන්න.",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "වෙනස්කම් නැත",
  "session.panel.git.dirty.one": "වෙනස් කළ ගොනු {{count}}",
  "session.panel.git.dirty.other": "වෙනස් කළ ගොනු {{count}}",
  "session.task.waiting": "අවසරය බලාපොරොත්තුවෙන්",
  "session.task.failed": "අසාර්ථකයි",
  "session.task.retry": "නැවත උත්සාහ කරන්න",
  "session.task.open": "වෙනම සැසියක විවෘත කරන්න",
  "settings.skills.title": "කුසලතා",
  "settings.skills.description": "මෙම ව්‍යාපෘතිය සඳහා හමු වූ කුසලතා.",
  "settings.skills.empty": "කුසලතා හමු නොවිණි",
  "settings.skills.enabled": "මාදිලියට භාවිත කළ හැක",
  "settings.skills.disabled": "මාදිලියට අවසර නැත",
  "settings.skills.search": "කුසලතා සොයන්න",
  "settings.skills.emptySearch": "මෙම සෙවුමට ගැළපෙන කුසලතා නැත",
  "settings.skills.details": "කුසලතාවේ විස්තර",
  "settings.skills.noDescription": "විස්තරයක් නැත",
  "settings.skills.source.project": "ව්‍යාපෘතිය",
  "settings.skills.source.global": "පරිශීලකයා",
  "settings.skills.source.builtin": "තිළැලි",
  "settings.skills.source.custom": "එක් කළ",
  "settings.scheduled.title": "කාලසටහන්ගත කාර්යයන්",
  "settings.scheduled.description": "ව්‍යාපෘතියක විමසුමක් එක් වරක් හෝ දිනපතා ධාවනය කරන්න.",
  "settings.scheduled.empty": "කාලසටහන්ගත කාර්යයන් නැත",
  "settings.scheduled.once": "එක් වරක්",
  "settings.scheduled.daily": "දිනපතා",
  "settings.scheduled.add": "කාර්යයක් එක් කරන්න",
  "settings.scheduled.field.name": "නම",
  "settings.scheduled.field.prompt": "විමසුම",
  "settings.scheduled.field.schedule": "කාලසටහන",
  "settings.scheduled.field.time": "ධාවන වේලාව",
  "settings.scheduled.error.name": "නමක් ඇතුළත් කරන්න",
  "settings.scheduled.error.prompt": "විමසුමක් ඇතුළත් කරන්න",
  "settings.scheduled.error.time": "වේලාවක් තෝරන්න",
  "settings.scheduled.error.model": "පළමුව මාදිලියක් තෝරන්න",
  "session.new.project.open": "පවතින ව්‍යාපෘතිය විවෘත කරන්න",
  "common.pin": "අමුණන්න",
  "common.unpin": "ඇමිණීම ඉවත් කරන්න",
  "settings.relay.title": "智联AI යතුරු",
  "settings.relay.getKey": "API යතුර ලබා ගන්න",
  "settings.relay.getKey.description": "ChatGPT, Grok සහ වෙනත් සැපයුම්කරුවන් සඳහා වෙනම යතුරු සාදන්න.",
  "settings.relay.upstream": "ඉහළ සේවාදායකය",
  "settings.relay.unified": "පොදු API යතුරක් භාවිත කරන්න",
  "settings.relay.unified.description": "සබල කළ විට සියලු සැපයුම්කරුවන් මෙම යතුර භාවිත කරයි.",
  "settings.relay.unified.key": "පොදු API යතුර",
  "settings.relay.unified.using": "පොදු යතුර භාවිත වෙමින් පවතී",
  "settings.relay.key.set": "යතුර සුරකින ලදී",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "සුරැකි යතුර තබා ගැනීමට හිස්ව තබන්න",
  "settings.relay.test": "සම්බන්ධතාව පරීක්ෂා කරන්න",
  "settings.relay.testing": "පරීක්ෂා කරමින්...",
  "settings.relay.fetch": "මාදිලි ලබා ගන්න",
  "settings.relay.fetching": "ලබා ගනිමින්...",
  "settings.relay.edit": "සංස්කරණය කරන්න",
  "settings.relay.clearKey": "යතුර මකන්න",
  "settings.relay.add": "සැපයුම්කරුවෙකු එක් කරන්න",
  "settings.relay.add.name": "සැපයුම්කරුගේ නම",
  "settings.relay.models.visible": "පෙනෙන මාදිලි {{count}}",
  "settings.relay.connected": "සම්බන්ධයි · මාදිලි {{count}}",
  "settings.relay.connectedEmpty": "සම්බන්ධ විය, නමුත් මාදිලි ආපසු නොලැබිණි",
  "settings.relay.test.ok": "සම්බන්ධතාව සාර්ථකයි",
  "settings.relay.test.empty": "සම්බන්ධ විය, නමුත් මාදිලි ආපසු නොලැබිණි",
  "settings.relay.models.title": "{{vendor}} මාදිලි",
  "settings.relay.models.empty": "තවම මාදිලි නැත. යතුරක් සුරැකීමෙන් පසු ලැයිස්තුව ලබා ගන්න.",
  "settings.relay.models.missing": "ඉහළ සේවාදායකයේ තවදුරටත් නැත",
  "settings.relay.saved": "ස්වයංක්‍රීයව සුරකින ලදී",
  "settings.relay.retry": "නැවත උත්සාහ කරන්න",
  "settings.relay.builtin": "තිළැලි",
  "settings.relay.delete": "සැපයුම්කරු මකන්න",
  "settings.relay.rollback": "ආයාත කළ යතුරු යළි සකසන්න",
  "settings.relay.rollback.description": "auth.json වෙතින් ආයාත කළ Relay යතුරු මකයි. මුල් auth.json තබා ගනී.",
  "settings.relay.error.KEY_MISSING": "පළමුව API යතුරක් එක් කරන්න",
  "settings.relay.error.KEY_REJECTED": "යතුර ප්‍රතික්ෂේප විය",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "ඉහළ සේවාදායකයට ළඟා විය නොහැක",
  "settings.relay.error.UPSTREAM_TIMEOUT": "ඉහළ සේවාදායකයේ කාල සීමාව ඉක්මවිය",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "ඉහළ සේවාදායකය ඉල්ලීම් අනුපාතය සීමා කළේය",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "ඉහළ සේවාදායකයෙන් වලංගු නොවන ප්‍රතිචාරයක් ලැබිණි",
  "settings.relay.error.REVISION_CONFLICT": "මෙම සැකසුම වෙනත් කවුළුවක වෙනස් විය. නැවුම් කර නැවත උත්සාහ කරන්න.",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "මෙම උපාංගයේ API යතුර සුරැකීමට නොහැකි විය.",
  "settings.mcp.add": "MCP එක් කරන්න",
  "settings.mcp.edit": "සංස්කරණය කරන්න",
  "settings.mcp.field.name": "නම",
  "settings.mcp.field.type": "වර්ගය",
  "settings.mcp.field.command": "විධානය",
  ...
  "settings.mcp.type.local": "දේශීය",
  "settings.mcp.type.remote": "දුරස්ථ",
  "settings.mcp.error.name": "සේවාදායකයේ නම ඇතුළත් කරන්න",
  "settings.mcp.error.command": "විධානයක් ඇතුළත් කරන්න",
  "settings.mcp.error.url": "URL එකක් ඇතුළත් කරන්න",
  ...
  "desktop.menu.documentation": "Koda ලේඛනගත කිරීම",
  ...
  "desktop.menu.ariaLabel": "Koda මෙනුව",
  ...
  "desktop.recovery.loadFailed": "Koda පූරණය කිරීමට අසමත් විය",
  "desktop.recovery.terminated": "Koda කවුළුව අනපේක්ෂිත ලෙස අවසන් විය",
  "desktop.recovery.unresponsive": "Koda ප්‍රතිචාර නොදක්වයි",
  ...
  "desktop.wsl.error.installOpencode": "Koda ස්ථාපනය අසාර්ථක විය",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Koda {{distro}} හි ස්ථාපනය කර නැත",
  "desktop.wsl.error.updateVersion":
    "Koda යාවත්කාලීන කිරීම අවසන් නමුත් {{distro}} තවමත් වාර්තා කරන්නේ {{installed}}; අපේක්ෂිත {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Koda මඟින් සපයනු ලබන නිදහස් මාදිලි",
  ...
  "provider.connect.apiKey.description":
    "ඔබගේ ගිණුම සම්බන්ධ කිරීමට ඔබගේ {{provider}} API යතුර ඇතුලත් කරන්න සහ Koda හි {{provider}} මාදිලි භාවිතා කරන්න.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen ඔබට කේතීකරණ නියෝජිතයන් සඳහා විශ්වාසදායක ප්‍රශස්ත මාදිලි සමූහයකට ප්‍රවේශය ලබා දෙයි.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "ඔබගේ ගිණුම සම්බන්ධ කිරීමට සහ Koda හි {{provider}} මාදිලි භාවිතා කිරීමට ඔබගේ අවසර කේතය එකතු කිරීමට.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "සහ ඔබගේ ගිණුම සම්බන්ධ කිරීමට පහත කේතය ඇතුළු කර {{provider}} මාදිලි Koda තුළ භාවිතා කරන්න.",
  ...
  "dialog.server.description": "මෙම යෙදුම සම්බන්ධ වන්නේ කුමන Koda සේවාදායකයටද යන්න මාරු කරන්න.",
  ...
  "wsl.onboarding.checkingOpencode": "Koda පරීක්ෂා කරමින්...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} හි Koda පරීක්ෂා කරමින්...",
  "wsl.onboarding.updatingOpencode": "Koda යාවත්කාලීන කරමින්...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} හි Koda යාවත්කාලීන කරමින්...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} හි Koda යාවත්කාලීන කරන්න.",
  "wsl.onboarding.updateOpencode": "Koda යාවත්කාලීන කරන්න",
  "wsl.onboarding.opencodeReadyIn": "Koda {{distro}} හි සූදානම්ය.",
  "wsl.onboarding.opencodeReady": "Koda සූදානම්.",
  "wsl.onboarding.installOpencodeIn": "{{distro}} හි Koda ස්ථාපනය කරන්න.",
  "wsl.onboarding.installOpencode": "Koda ස්ථාපනය කරන්න",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda ස්ථාපනය කර නැත",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Linux සඳහා උප පද්ධතිය) Koda WSL සේවාදායකයක් එක් කිරීමට පෙර අවශ්‍ය වේ",
  "wsl.onboarding.wslUnavailable.title": "WSL නොමැත",
  "wsl.onboarding.wslUnavailable.description": "Koda හට මෙම යන්ත්‍රයේ WSL සත්‍යාපනය කළ නොහැක.",
  "wsl.onboarding.installWsl": "WSL ස්ථාපනය කරන්න",
  "wsl.onboarding.windowsRestartRequired": "WSL ස්ථාපනය අවසන් කිරීමට Windows නැවත අරඹන්න, පසුව Koda නැවත විවෘත කරන්න.",
  ...
  "help.tabs.introduction": "Koda ඩෙස්ක්ටොප් එක දැන් ටැබ් වටා ගොඩනගා ඇත.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Koda හි නව අනුවාදයක් ({{version}}) ස්ථාපනය කිරීමට දැන් තිබේ.",
  ...
  "error.page.report.prefix": "කරුණාකර මෙම දෝෂය Koda කණ්ඩායමට වාර්තා කරන්න",
  ...
  "error.chain.mcpFailed": 'MCP සේවාදායකය "{{name}}" අසාර්ථක විය. සටහන, Koda තවමත් MCP සත්‍යාපනයට සහය නොදක්වයි.',
  ...
  "sidebar.gettingStarted.line1": "Koda නොමිලේ ආකෘති ඇතුළත් වන නිසා ඔබට වහාම ආරම්භ කළ හැක.",
  ...
  "app.name.desktop": "Koda ඩෙස්ක්ටොප්",
  ...
  "settings.desktop.wsl.description": "Windows හි WSL තුළ Koda සේවාදායකය ධාවනය කරන්න.",
  ...
  "settings.general.row.language.description": "Koda සඳහා සංදර්ශක භාෂාව වෙනස් කරන්න",
  ...
  "settings.general.row.appearance.description": "ඔබගේ උපාංගයේ Koda පෙනෙන ආකාරය අභිරුචිකරණය කරන්න",
  "settings.general.row.colorScheme.title": "වර්ණ පටිපාටිය",
  "settings.general.row.colorScheme.description": "Koda පද්ධතිය, ආලෝකය හෝ අඳුරු තේමාව අනුගමනය කරන්නේද යන්න තෝරන්න",
  "settings.general.row.theme.title": "තේමාව",
  "settings.general.row.theme.description": "Koda තේමා කර ඇති ආකාරය අභිරුචිකරණය කරන්න.",
  ...
  "settings.updates.row.startup.description": "Koda දියත් කරන විට යාවත්කාලීන සඳහා ස්වයංක්‍රීයව පරීක්ෂා කරන්න",
  ...
  "settings.updates.toast.latest.description": "ඔබ Koda හි නවතම අනුවාදය ධාවනය කරයි.",
