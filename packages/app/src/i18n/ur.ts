export const dict = {
  "desktop.menu.about": "Koda کے بارے میں",
  "desktop.about.title": "Koda ڈیسک ٹاپ v{{version}}",
  "desktop.about.detail": "OpenCode کو بنیاد بنا کر ترمیم شدہ\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "Koda v{{version}} دستیاب ہے۔ اپ گریڈ کرنے کے لیے ریلیز کا صفحہ کھولیں؟",
  "desktop.koda.update.open": "ریلیز کا صفحہ کھولیں",
  "command.project.create": "نیا پروجیکٹ",
  "command.project.openExisting": "موجودہ پروجیکٹ کھولیں",
  "prompt.toast.projectRequired.title": "پروجیکٹ منتخب کریں",
  "prompt.toast.projectRequired.description": "بھیجنے سے پہلے پروجیکٹ بنائیں یا کھولیں۔",
  "prompt.approval.ask": "منظوری طلب کریں",
  "prompt.approval.auto": "میری طرف سے منظور کریں",
  "prompt.approval.plan": "مکمل رسائی",
  "prompt.more": "مزید",
  "dialog.project.create.title": "نیا پروجیکٹ",
  "dialog.project.create.name": "نام",
  "dialog.project.create.location": "مقام",
  "dialog.project.create.browse": "براؤز کریں",
  "dialog.project.create.path": "راستہ",
  "dialog.project.create.submit": "بنائیں",
  "dialog.project.create.error.name": "پروجیکٹ کا نام درج کریں",
  "dialog.project.create.error.invalid": "یہ نام فولڈر کے لیے استعمال نہیں کیا جا سکتا",
  "dialog.project.create.error.exists": "یہ فولڈر پہلے سے موجود ہے۔ اسے کھولیں یا دوسرا نام منتخب کریں۔",
  "dialog.project.create.error.failed": "فولڈر نہیں بنایا جا سکا",
  "mcp.status.needs_client_registration": "کلائنٹ کی رجسٹریشن درکار ہے",
  "home.welcome.title": "میں کس کام میں مدد کر سکتا ہوں؟",
  "home.project.create": "نیا پروجیکٹ",
  "home.project.open": "موجودہ پروجیکٹ کھولیں",
  "home.sessions.search.title": "گفتگو تلاش کریں",
  "session.todo.empty": "ابھی کوئی کام نہیں",
  "session.panel.files": "فائلیں",
  "session.panel.changes": "تبدیلیاں",
  "session.panel.tasks": "کام",
  "session.panel.terminal": "ٹرمینل",
  "session.panel.empty": "فائلیں، تبدیلیاں، کام اور ٹرمینل دیکھنے کے لیے پروجیکٹ منتخب کریں۔",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "کوئی تبدیلی نہیں",
  "session.panel.git.dirty.one": "{{count}} تبدیل شدہ فائل",
  "session.panel.git.dirty.other": "{{count}} تبدیل شدہ فائلیں",
  "session.task.waiting": "اجازت کا انتظار ہے",
  "session.task.failed": "ناکام",
  "session.task.retry": "دوبارہ کوشش کریں",
  "session.task.open": "الگ سیشن میں کھولیں",
  "settings.skills.title": "مہارتیں",
  "settings.skills.description": "اس پروجیکٹ کے لیے ملنے والی مہارتیں۔",
  "settings.skills.empty": "کوئی مہارت نہیں ملی",
  "settings.skills.enabled": "ماڈل کے لیے دستیاب",
  "settings.skills.disabled": "ماڈل کے لیے ممنوع",
  "settings.skills.search": "مہارتیں تلاش کریں",
  "settings.skills.emptySearch": "اس تلاش سے کوئی مہارت مطابقت نہیں رکھتی",
  "settings.skills.details": "مہارت کی تفصیلات",
  "settings.skills.noDescription": "کوئی تفصیل نہیں",
  "settings.skills.source.project": "پروجیکٹ",
  "settings.skills.source.global": "صارف",
  "settings.skills.source.builtin": "پہلے سے شامل",
  "settings.skills.source.custom": "شامل کردہ",
  "settings.scheduled.title": "طے شدہ کام",
  "settings.scheduled.description": "پروجیکٹ میں پرامپٹ ایک بار یا روزانہ چلائیں۔",
  "settings.scheduled.empty": "کوئی طے شدہ کام نہیں",
  "settings.scheduled.once": "ایک بار",
  "settings.scheduled.daily": "روزانہ",
  "settings.scheduled.add": "کام شامل کریں",
  "settings.scheduled.field.name": "نام",
  "settings.scheduled.field.prompt": "پرامپٹ",
  "settings.scheduled.field.schedule": "نظام الاوقات",
  "settings.scheduled.field.time": "چلانے کا وقت",
  "settings.scheduled.error.name": "نام درج کریں",
  "settings.scheduled.error.prompt": "پرامپٹ درج کریں",
  "settings.scheduled.error.time": "وقت منتخب کریں",
  "settings.scheduled.error.model": "پہلے ماڈل منتخب کریں",
  "session.new.project.open": "موجودہ پروجیکٹ کھولیں",
  "common.pin": "پن کریں",
  "common.unpin": "پن ہٹائیں",
  "settings.relay.title": "智联AI کلیدیں",
  "settings.relay.getKey": "API کلید حاصل کریں",
  "settings.relay.getKey.description": "ChatGPT، Grok اور دیگر فراہم کنندگان کے لیے الگ کلیدیں بنائیں۔",
  "settings.relay.upstream": "اپ اسٹریم",
  "settings.relay.unified": "مشترکہ API کلید استعمال کریں",
  "settings.relay.unified.description": "فعال ہونے پر تمام وینڈر یہ کلید استعمال کرتے ہیں۔",
  "settings.relay.unified.key": "مشترکہ API کلید",
  "settings.relay.unified.using": "مشترکہ کلید استعمال ہو رہی ہے",
  "settings.relay.key.set": "کلید محفوظ ہو گئی",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "محفوظ کلید برقرار رکھنے کے لیے خالی چھوڑیں",
  "settings.relay.test": "کنکشن جانچیں",
  "settings.relay.testing": "جانچ جاری ہے...",
  "settings.relay.fetch": "ماڈل حاصل کریں",
  "settings.relay.fetching": "حاصل کیے جا رہے ہیں...",
  "settings.relay.edit": "ترمیم کریں",
  "settings.relay.clearKey": "کلید صاف کریں",
  "settings.relay.add": "وینڈر شامل کریں",
  "settings.relay.add.name": "وینڈر کا نام",
  "settings.relay.models.visible": "{{count}} نظر آنے والے ماڈل",
  "settings.relay.connected": "منسلک · {{count}} ماڈل",
  "settings.relay.connectedEmpty": "کنکشن قائم ہے، لیکن کوئی ماڈل موصول نہیں ہوا",
  "settings.relay.test.ok": "کنکشن کامیاب رہا",
  "settings.relay.test.empty": "کنکشن قائم ہے، لیکن کوئی ماڈل موصول نہیں ہوا",
  "settings.relay.models.title": "{{vendor}} کے ماڈل",
  "settings.relay.models.empty": "ابھی کوئی ماڈل نہیں۔ کلید محفوظ کرنے کے بعد فہرست حاصل کریں۔",
  "settings.relay.models.missing": "اب اپ اسٹریم پر موجود نہیں",
  "settings.relay.saved": "خودکار طور پر محفوظ ہو گیا",
  "settings.relay.retry": "دوبارہ کوشش کریں",
  "settings.relay.builtin": "پہلے سے شامل",
  "settings.relay.delete": "وینڈر حذف کریں",
  "settings.relay.rollback": "درآمد کردہ کلیدیں ری سیٹ کریں",
  "settings.relay.rollback.description":
    "auth.json سے درآمد کردہ Relay کلیدیں صاف کرتا ہے۔ اصل auth.json برقرار رہتا ہے۔",
  "settings.relay.error.KEY_MISSING": "پہلے API کلید شامل کریں",
  "settings.relay.error.KEY_REJECTED": "کلید مسترد کر دی گئی",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "اپ اسٹریم تک رسائی ممکن نہیں",
  "settings.relay.error.UPSTREAM_TIMEOUT": "اپ اسٹریم کے انتظار کا وقت ختم ہو گیا",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "اپ اسٹریم نے درخواستوں کی شرح محدود کر دی",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "اپ اسٹریم نے غلط جواب دیا",
  "settings.relay.error.REVISION_CONFLICT": "یہ ترتیب دوسری ونڈو میں بدل گئی ہے۔ تازہ کریں اور دوبارہ کوشش کریں۔",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "اس آلے پر API کلید محفوظ نہیں کی جا سکی۔",
  "settings.mcp.add": "MCP شامل کریں",
  "settings.mcp.edit": "ترمیم کریں",
  "settings.mcp.field.name": "نام",
  "settings.mcp.field.type": "قسم",
  "settings.mcp.field.command": "کمانڈ",
  ...
  "settings.mcp.type.local": "مقامی",
  "settings.mcp.type.remote": "دور دراز",
  "settings.mcp.error.name": "سرور کا نام درج کریں",
  "settings.mcp.error.command": "کمانڈ درج کریں",
  "settings.mcp.error.url": "URL درج کریں",
  ...
  "desktop.menu.documentation": "Koda دستاویزات",
  ...
  "desktop.menu.ariaLabel": "Koda مینو",
  ...
  "desktop.recovery.loadFailed": "Koda لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "Koda ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "Koda جواب نہیں دے رہا",
  ...
  "desktop.wsl.error.installOpencode": "Koda کی تنصیب ناکام ہو گئی",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} میں Koda انسٹال نہیں ہے",
  "desktop.wsl.error.updateVersion":
    "Koda کی اپ ڈیٹ مکمل ہو گئی لیکن {{distro}} اب بھی {{installed}} کی اطلاع دے رہا ہے؛ متوقع ورژن {{expected}} ہے",
  ...
  "dialog.model.unpaid.freeModels.title": "Koda کے ذریعہ فراہم کردہ مفت ماڈلز",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور Koda میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen آپ کو کوڈنگ ایجنٹوں کے لیے قابل اعتماد اصلاح شدہ ماڈلز کے کیوریٹڈ سیٹ تک رسائی فراہم کرتا ہے۔",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور Koda میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور Koda میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس Koda سرور سے منسلک ہے۔",
  ...
  "wsl.onboarding.checkingOpencode": "Koda چیک کیا جا رہا ہے...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} میں Koda چیک کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencode": "Koda کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} میں Koda کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} میں Koda کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updateOpencode": "Koda کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.opencodeReadyIn": "Koda {{distro}} میں تیار ہے۔",
  "wsl.onboarding.opencodeReady": "Koda تیار ہے۔",
  "wsl.onboarding.installOpencodeIn": "{{distro}} میں Koda انسٹال کریں۔",
  "wsl.onboarding.installOpencode": "Koda انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ Koda WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "Koda اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر Koda کو دوبارہ کھولیں۔",
  ...
  "help.tabs.introduction": "Koda Desktop اب ٹیبز پر مبنی ہے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Koda ({{version}}) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.page.report.prefix": "براہ کرم Koda ٹیم کو اس غلطی کی اطلاع دیں۔",
  ...
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، Koda ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "sidebar.gettingStarted.line1": "Koda میں مفت ماڈل شامل ہیں لہذا آپ فوری طور پر شروع کر سکتے ہیں۔",
  ...
  "app.name.desktop": "Koda ڈیسک ٹاپ",
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر Koda سرور چلائیں۔",
  ...
  "settings.general.row.language.description": "Koda کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر Koda کیسا لگتا ہے۔",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description": "منتخب کریں کہ آیا Koda سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "Koda کی تھیم حسب ضرورت بنائیں۔",
  ...
  "settings.updates.row.startup.description": "Koda لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ Koda کا تازہ ترین ورژن چلا رہے ہیں۔",
