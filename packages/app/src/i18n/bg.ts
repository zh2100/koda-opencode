export const dict = {
  "desktop.menu.about": "За Koda",
  "desktop.about.title": "Koda Desktop v{{version}}",
  "desktop.about.detail":
    "Модифицирано на основата на OpenCode\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available":
    "Налична е Koda v{{version}}. Да се отвори ли страницата на изданието за обновяване?",
  "desktop.koda.update.open": "Отваряне на страницата на изданието",
  "command.project.create": "Нов проект",
  "command.project.openExisting": "Отваряне на съществуващ проект",
  "prompt.toast.projectRequired.title": "Изберете проект",
  "prompt.toast.projectRequired.description": "Създайте или отворете проект преди изпращане.",
  "prompt.approval.ask": "Искане на одобрение",
  "prompt.approval.auto": "Одобряване вместо мен",
  "prompt.approval.plan": "Пълен достъп",
  "prompt.more": "Още",
  "dialog.project.create.title": "Нов проект",
  "dialog.project.create.name": "Име",
  "dialog.project.create.location": "Местоположение",
  "dialog.project.create.browse": "Преглед",
  "dialog.project.create.path": "Път",
  "dialog.project.create.submit": "Създаване",
  "dialog.project.create.error.name": "Въведете име на проекта",
  "dialog.project.create.error.invalid": "Това име не може да се използва за папка",
  "dialog.project.create.error.exists": "Тази папка вече съществува. Отворете я или изберете друго име.",
  "dialog.project.create.error.failed": "Папката не може да бъде създадена",
  "mcp.status.needs_client_registration": "изисква регистрация на клиента",
  "home.welcome.title": "С какво мога да помогна?",
  "home.project.create": "Нов проект",
  "home.project.open": "Отваряне на съществуващ проект",
  "home.sessions.search.title": "Търсене в разговорите",
  "session.todo.empty": "Все още няма задачи",
  "session.panel.files": "Файлове",
  "session.panel.changes": "Промени",
  "session.panel.tasks": "Задачи",
  "session.panel.terminal": "Терминал",
  "session.panel.empty": "Изберете проект за преглед на файлове, промени, задачи и терминала.",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "Без промени",
  "session.panel.git.dirty.one": "{{count}} променен файл",
  "session.panel.git.dirty.other": "{{count}} променени файла",
  "session.task.waiting": "Изчакване на разрешение",
  "session.task.failed": "Неуспешно",
  "session.task.retry": "Повторен опит",
  "session.task.open": "Отваряне в отделна сесия",
  "settings.skills.title": "Умения",
  "settings.skills.description": "Умения, открити за този проект.",
  "settings.skills.empty": "Няма открити умения",
  "settings.skills.enabled": "Достъпно за модела",
  "settings.skills.disabled": "Забранено за модела",
  "settings.skills.search": "Търсене на умения",
  "settings.skills.emptySearch": "Няма умения, съответстващи на търсенето",
  "settings.skills.details": "Подробности за умението",
  "settings.skills.noDescription": "Няма описание",
  "settings.skills.source.project": "Проект",
  "settings.skills.source.global": "Потребител",
  "settings.skills.source.builtin": "Вградено",
  "settings.skills.source.custom": "Добавено",
  "settings.scheduled.title": "Планирани задачи",
  "settings.scheduled.description": "Изпълнявайте подкана в проект еднократно или всеки ден.",
  "settings.scheduled.empty": "Няма планирани задачи",
  "settings.scheduled.once": "Еднократно",
  "settings.scheduled.daily": "Всеки ден",
  "settings.scheduled.add": "Добавяне на задача",
  "settings.scheduled.field.name": "Име",
  "settings.scheduled.field.prompt": "Подкана",
  "settings.scheduled.field.schedule": "График",
  "settings.scheduled.field.time": "Час на изпълнение",
  "settings.scheduled.error.name": "Въведете име",
  "settings.scheduled.error.prompt": "Въведете подкана",
  "settings.scheduled.error.time": "Изберете час",
  "settings.scheduled.error.model": "Първо изберете модел",
  "session.new.project.open": "Отваряне на съществуващ проект",
  "common.pin": "Закачане",
  "common.unpin": "Откачане",
  "settings.relay.title": "Ключове за 智联AI",
  "settings.relay.getKey": "Получаване на API ключ",
  "settings.relay.getKey.description": "Създайте отделни ключове за ChatGPT, Grok и други доставчици.",
  "settings.relay.upstream": "Сървър на доставчика",
  "settings.relay.unified": "Използване на общ API ключ",
  "settings.relay.unified.description": "Когато е включено, всички доставчици използват този ключ.",
  "settings.relay.unified.key": "Общ API ключ",
  "settings.relay.unified.using": "Използва се общият ключ",
  "settings.relay.key.set": "Ключът е запазен",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "Оставете празно, за да запазите съхранения ключ",
  "settings.relay.test": "Проверка на връзката",
  "settings.relay.testing": "Проверяване...",
  "settings.relay.fetch": "Получаване на модели",
  "settings.relay.fetching": "Получаване...",
  "settings.relay.edit": "Редактиране",
  "settings.relay.clearKey": "Изтриване на ключа",
  "settings.relay.add": "Добавяне на доставчик",
  "settings.relay.add.name": "Име на доставчика",
  "settings.relay.models.visible": "Видими модели: {{count}}",
  "settings.relay.connected": "Свързано · Модели: {{count}}",
  "settings.relay.connectedEmpty": "Свързано, но не са върнати модели",
  "settings.relay.test.ok": "Успешна връзка",
  "settings.relay.test.empty": "Свързано, но не са върнати модели",
  "settings.relay.models.title": "Модели на {{vendor}}",
  "settings.relay.models.empty": "Все още няма модели. Получете списъка след запазване на ключа.",
  "settings.relay.models.missing": "Вече не е на сървъра на доставчика",
  "settings.relay.saved": "Автоматично запазено",
  "settings.relay.retry": "Повторен опит",
  "settings.relay.builtin": "Вграден",
  "settings.relay.delete": "Изтриване на доставчика",
  "settings.relay.rollback": "Нулиране на внесените ключове",
  "settings.relay.rollback.description":
    "Изтрива ключовете за Relay, внесени от auth.json. Оригиналният auth.json се запазва.",
  "settings.relay.error.KEY_MISSING": "Първо добавете API ключ",
  "settings.relay.error.KEY_REJECTED": "Ключът е отхвърлен",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "Сървърът на доставчика е недостъпен",
  "settings.relay.error.UPSTREAM_TIMEOUT": "Времето за изчакване на сървъра на доставчика изтече",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "Сървърът на доставчика ограничи честотата на заявките",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "Сървърът на доставчика върна невалиден отговор",
  "settings.relay.error.REVISION_CONFLICT": "Тази настройка е променена в друг прозорец. Опреснете и опитайте отново.",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "API ключът не може да бъде запазен на това устройство.",
  "settings.mcp.add": "Добавяне на MCP",
  "settings.mcp.edit": "Редактиране",
  "settings.mcp.field.name": "Име",
  "settings.mcp.field.type": "Тип",
  "settings.mcp.field.command": "Команда",
  ...
  "settings.mcp.error.name": "Въведете име на сървъра",
  "settings.mcp.error.command": "Въведете команда",
  "settings.mcp.error.url": "Въведете URL",
  ...
  "desktop.menu.documentation": "Koda Документация",
  ...
  "desktop.recovery.loadFailed": "Koda не успя да се зареди",
  "desktop.recovery.terminated": "Прозорецът Koda приключи неочаквано",
  "desktop.recovery.unresponsive": "Koda не отговаря",
  ...
  "desktop.wsl.error.installOpencode": "Инсталирането на Koda е неуспешно",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Koda не е инсталиран в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Koda актуализацията приключи, но {{distro}} все още съобщава {{installed}}; очаквано {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Безплатни модели, предоставени от Koda",
  ...
  "provider.connect.apiKey.description":
    "Въведете своя {{provider}} API ключ, за да свържете акаунта си и да използвате {{provider}} модели в Koda.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen ви дава достъп до подбран набор от надеждни оптимизирани модели за кодиращи агенти.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "за да вземете вашия код за оторизация, за да свържете акаунта си и да използвате {{provider}} модели в Koda.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "и въведете кода по-долу, за да свържете акаунта си и да използвате {{provider}} модели в Koda.",
  ...
  "dialog.server.description": "Превключете към кой Koda сървър се свързва това приложение.",
  ...
  "wsl.onboarding.checkingOpencode": "Проверява се Koda...",
  "wsl.onboarding.checkingOpencodeIn": "Проверява се Koda в {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Актуализиране на Koda...",
  "wsl.onboarding.updatingOpencodeIn": "Актуализиране на Koda в {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Актуализирайте Koda в {{distro}}.",
  "wsl.onboarding.updateOpencode": "Актуализация Koda",
  "wsl.onboarding.opencodeReadyIn": "Koda е готов в {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koda е готов.",
  "wsl.onboarding.installOpencodeIn": "Инсталирайте Koda в {{distro}}.",
  "wsl.onboarding.installOpencode": "Инсталирайте Koda",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda не е инсталиран",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) се изисква, преди Koda да може да добави WSL сървър",
  "wsl.onboarding.wslUnavailable.title": "WSL не е наличен",
  "wsl.onboarding.wslUnavailable.description": "Koda не можа да провери WSL на тази машина.",
  "wsl.onboarding.installWsl": "Инсталирайте WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Рестартирайте Windows, за да завършите инсталирането на WSL, след което отворете отново Koda.",
  ...
  "help.tabs.introduction": "Koda Desktop вече е изграден около раздели.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Вече е достъпна за инсталиране нова версия на Koda ({{version}}).",
  ...
  "error.page.report.prefix": "Моля, докладвайте тази грешка на екипа на Koda",
  ...
  "error.chain.mcpFailed":
    'MCP сървър "{{name}}" не успя. Имайте предвид, че Koda все още не поддържа MCP удостоверяване.',
  ...
  "sidebar.gettingStarted.line1": "Koda включва безплатни модели, така че можете да започнете веднага.",
  ...
  "settings.desktop.wsl.description": "Стартирайте сървъра Koda вътре в WSL на Windows.",
  ...
  "settings.general.row.language.description": "Променете езика на дисплея за Koda",
  ...
  "settings.general.row.appearance.description": "Персонализирайте как изглежда Koda на вашето устройство",
  "settings.general.row.colorScheme.title": "Цветова схема",
  "settings.general.row.colorScheme.description": "Изберете дали Koda следва системната, светла или тъмна тема",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Персонализирайте как е тематично Koda.",
  ...
  "settings.updates.row.startup.description": "Автоматично проверявайте за актуализации при стартиране на Koda",
  ...
  "settings.updates.toast.latest.description": "Вие използвате най-новата версия на Koda.",
