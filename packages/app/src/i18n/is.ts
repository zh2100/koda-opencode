...
const desktop = [
  ...
  "Aðlagað með OpenCode sem grunn\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "Koda v{{version}} er í boði. Opna útgáfusíðuna til að uppfæra?",
  "Opna útgáfusíðu",
  "Tilkynna villu",
  "Koda-valmynd",
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða Koda",
  "Koda-glugganum var óvænt lokað",
  "Koda svarar ekki",
  ...
  "Koda er ekki uppsett í {{distro}}",
  "Uppfærslu Koda lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "command.project.create": "Nýtt verkefni",
  "command.project.openExisting": "Opna fyrirliggjandi verkefni",
  "prompt.toast.projectRequired.title": "Veldu verkefni",
  "prompt.toast.projectRequired.description": "Búðu til eða opnaðu verkefni áður en þú sendir.",
  "prompt.approval.ask": "Biðja um samþykki",
  "prompt.approval.auto": "Samþykkja fyrir mig",
  "prompt.approval.plan": "Fullur aðgangur",
  "prompt.more": "Meira",
  "dialog.project.create.title": "Nýtt verkefni",
  "dialog.project.create.name": "Heiti",
  "dialog.project.create.location": "Staðsetning",
  "dialog.project.create.browse": "Fletta",
  "dialog.project.create.path": "Slóð",
  "dialog.project.create.submit": "Búa til",
  "dialog.project.create.error.name": "Sláðu inn heiti verkefnis",
  "dialog.project.create.error.invalid": "Ekki er hægt að nota þetta heiti fyrir möppu",
  "dialog.project.create.error.exists": "Mappan er þegar til. Opnaðu hana eða veldu annað heiti.",
  "dialog.project.create.error.failed": "Ekki tókst að búa til möppuna",
  "mcp.status.needs_client_registration": "skráning biðlara nauðsynleg",
  "home.welcome.title": "Hvernig get ég hjálpað?",
  "home.project.create": "Nýtt verkefni",
  "home.project.open": "Opna fyrirliggjandi verkefni",
  "home.sessions.search.title": "Leita í spjalli",
  "session.todo.empty": "Engin verk enn",
  "session.panel.files": "Skrár",
  "session.panel.changes": "Breytingar",
  "session.panel.tasks": "Verk",
  "session.panel.terminal": "Skjáhermir",
  "session.panel.empty": "Veldu verkefni til að skoða skrár, breytingar, verk og skjáherminn.",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "Engar breytingar",
  "session.panel.git.dirty.one": "{{count}} breytt skrá",
  "session.panel.git.dirty.other": "{{count}} breyttar skrár",
  "session.task.waiting": "Bíður eftir heimild",
  "session.task.failed": "Mistókst",
  "session.task.retry": "Reyna aftur",
  "session.task.open": "Opna í eigin setu",
  "settings.skills.title": "Færni",
  "settings.skills.description": "Færni sem fannst fyrir þetta verkefni.",
  "settings.skills.empty": "Engin færni fannst",
  "settings.skills.enabled": "Aðgengileg líkaninu",
  "settings.skills.disabled": "Óheimil fyrir líkanið",
  "settings.skills.search": "Leita að færni",
  "settings.skills.emptySearch": "Engin færni samsvarar leitinni",
  "settings.skills.details": "Upplýsingar um færni",
  "settings.skills.noDescription": "Engin lýsing",
  "settings.skills.source.project": "Verkefni",
  "settings.skills.source.global": "Notandi",
  "settings.skills.source.builtin": "Innbyggð",
  "settings.skills.source.custom": "Bætt við",
  "settings.scheduled.title": "Tímasett verk",
  "settings.scheduled.description": "Keyrðu fyrirmæli einu sinni eða daglega í verkefni.",
  "settings.scheduled.empty": "Engin tímasett verk",
  "settings.scheduled.once": "Einu sinni",
  "settings.scheduled.daily": "Daglega",
  "settings.scheduled.add": "Bæta við verki",
  "settings.scheduled.field.name": "Heiti",
  "settings.scheduled.field.prompt": "Fyrirmæli",
  "settings.scheduled.field.schedule": "Tímaáætlun",
  "settings.scheduled.field.time": "Keyra klukkan",
  "settings.scheduled.error.name": "Sláðu inn heiti",
  "settings.scheduled.error.prompt": "Sláðu inn fyrirmæli",
  "settings.scheduled.error.time": "Veldu tíma",
  "settings.scheduled.error.model": "Veldu fyrst líkan",
  "session.new.project.open": "Opna fyrirliggjandi verkefni",
  "common.pin": "Festa",
  "common.unpin": "Losa",
  "settings.relay.title": "智联AI-lyklar",
  "settings.relay.getKey": "Sækja API-lykil",
  "settings.relay.getKey.description": "Búðu til aðskilda lykla fyrir ChatGPT, Grok og aðrar þjónustuveitur.",
  "settings.relay.upstream": "Bakendaþjónusta",
  "settings.relay.unified": "Nota sameiginlegan API-lykil",
  "settings.relay.unified.description": "Þegar þetta er virkt nota allar þjónustuveitur þennan lykil.",
  "settings.relay.unified.key": "Sameiginlegur API-lykill",
  "settings.relay.unified.using": "Sameiginlegi lykillinn er í notkun",
  "settings.relay.key.set": "Lykill vistaður",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "Skildu eftir autt til að halda vistaða lyklinum",
  "settings.relay.test": "Prófa tengingu",
  "settings.relay.testing": "Prófa...",
  "settings.relay.fetch": "Sækja líkön",
  "settings.relay.fetching": "Sæki...",
  "settings.relay.edit": "Breyta",
  "settings.relay.clearKey": "Hreinsa lykil",
  "settings.relay.add": "Bæta við þjónustuveitu",
  "settings.relay.add.name": "Heiti þjónustuveitu",
  "settings.relay.models.visible": "Sýnileg líkön: {{count}}",
  "settings.relay.connected": "Tengt · Fjöldi líkana: {{count}}",
  "settings.relay.connectedEmpty": "Tengt, en engum líkönum var skilað",
  "settings.relay.test.ok": "Tenging tókst",
  "settings.relay.test.empty": "Tengt, en engum líkönum var skilað",
  "settings.relay.models.title": "Líkön frá {{vendor}}",
  "settings.relay.models.empty": "Engin líkön enn. Sæktu listann eftir að lykill hefur verið vistaður.",
  "settings.relay.models.missing": "Ekki lengur hjá bakendaþjónustunni",
  "settings.relay.saved": "Vistað sjálfkrafa",
  "settings.relay.retry": "Reyna aftur",
  "settings.relay.builtin": "Innbyggt",
  "settings.relay.delete": "Eyða þjónustuveitu",
  "settings.relay.rollback": "Endurstilla innflutta lykla",
  "settings.relay.rollback.description":
    "Hreinsar Relay-lykla sem voru fluttir inn úr auth.json. Upprunalega auth.json er varðveitt.",
  "settings.relay.error.KEY_MISSING": "Bættu fyrst við API-lykli",
  "settings.relay.error.KEY_REJECTED": "Lyklinum var hafnað",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "Ekki næst í bakendaþjónustuna",
  "settings.relay.error.UPSTREAM_TIMEOUT": "Tímamörk bakendaþjónustunnar runnu út",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "Bakendaþjónustan takmarkaði beiðnina vegna of margra beiðna",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "Bakendaþjónustan skilaði ógildu svari",
  "settings.relay.error.REVISION_CONFLICT": "Þessari stillingu var breytt í öðrum glugga. Endurhladdu og reyndu aftur.",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "Ekki tókst að vista API-lykilinn á þessu tæki.",
  "settings.mcp.add": "Bæta við MCP",
  "settings.mcp.edit": "Breyta",
  "settings.mcp.field.name": "Heiti",
  "settings.mcp.field.type": "Tegund",
  "settings.mcp.field.command": "Skipun",
  ...
  "settings.mcp.error.name": "Sláðu inn heiti þjóns",
  "settings.mcp.error.command": "Sláðu inn skipun",
  "settings.mcp.error.url": "Sláðu inn URL-slóð",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá Koda",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í Koda.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen veitir þér aðgang að safni af áreiðanlegum og fínstilltum gerðum fyrir kóðunarmiðla.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í Koda.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í Koda.",
  ...
  "dialog.server.description": "Skiptu um hvaða Koda miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingOpencode": "Athugar Koda...",
  "wsl.onboarding.checkingOpencodeIn": "Athugar Koda í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppfærir Koda...",
  "wsl.onboarding.updatingOpencodeIn": "Uppfærir Koda í {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppfærðu Koda í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppfærðu Koda",
  "wsl.onboarding.opencodeReadyIn": "Koda er tilbúið í {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koda er tilbúinn.",
  "wsl.onboarding.installOpencodeIn": "Settu upp Koda í {{distro}}.",
  "wsl.onboarding.installOpencode": "Settu upp Koda",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en Koda getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "Koda gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired": "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan Koda aftur.",
  ...
  "help.tabs.introduction": "Koda Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af Koda ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til Koda teymisins",
  ...
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, Koda styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "Koda inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "app.name.desktop": "Koda skjáborð",
  ...
  "settings.desktop.wsl.description": "Keyrðu Koda netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir Koda",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig Koda lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort Koda fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig Koda er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar Koda ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af Koda.",
