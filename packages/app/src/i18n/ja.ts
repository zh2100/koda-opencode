export const dict = {
  "desktop.menu.about": "Koda について",
  "desktop.about.title": "Koda Desktop v{{version}}",
  "desktop.about.detail": "OpenCode をコアとして改良\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "Koda v{{version}} が利用可能です。リリースページを開いて更新しますか？",
  "desktop.koda.update.open": "リリースページを開く",
  "command.project.create": "新しいプロジェクト",
  "command.project.openExisting": "既存のプロジェクトを開く",
  "prompt.toast.projectRequired.title": "プロジェクトを選択",
  "prompt.toast.projectRequired.description": "送信する前にプロジェクトを作成するか開いてください。",
  "prompt.approval.ask": "承認を求める",
  "prompt.approval.auto": "自動で承認",
  "prompt.approval.plan": "フルアクセス",
  "prompt.more": "その他",
  "dialog.project.create.title": "新しいプロジェクト",
  "dialog.project.create.name": "名前",
  "dialog.project.create.location": "場所",
  "dialog.project.create.browse": "参照",
  "dialog.project.create.path": "パス",
  "dialog.project.create.submit": "作成",
  "dialog.project.create.error.name": "プロジェクト名を入力してください",
  "dialog.project.create.error.invalid": "この名前はフォルダー名に使用できません",
  "dialog.project.create.error.exists":
    "そのフォルダーは既に存在します。既存のフォルダーを開くか、別の名前を選んでください。",
  "dialog.project.create.error.failed": "フォルダーを作成できませんでした",
  "mcp.status.needs_client_registration": "クライアント登録が必要",
  "home.welcome.title": "何をお手伝いしましょうか？",
  "home.project.create": "新しいプロジェクト",
  "home.project.open": "既存のプロジェクトを開く",
  "home.sessions.search.title": "チャットを検索",
  "session.todo.empty": "まだタスクはありません",
  "session.panel.files": "ファイル",
  "session.panel.changes": "変更",
  "session.panel.tasks": "タスク",
  "session.panel.terminal": "ターミナル",
  "session.panel.empty": "プロジェクトを選択すると、ファイル、変更、タスク、ターミナルを表示できます。",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "変更なし",
  "session.panel.git.dirty.one": "変更されたファイル {{count}} 個",
  "session.panel.git.dirty.other": "変更されたファイル {{count}} 個",
  "session.task.waiting": "許可を待っています",
  "session.task.failed": "失敗",
  "session.task.retry": "再試行",
  "session.task.open": "個別のセッションで開く",
  "settings.skills.title": "スキル",
  "settings.skills.description": "このプロジェクトで見つかったスキル。",
  "settings.skills.empty": "スキルが見つかりません",
  "settings.skills.enabled": "モデルで使用可能",
  "settings.skills.disabled": "モデルでの使用を拒否",
  "settings.skills.search": "スキルを検索",
  "settings.skills.emptySearch": "検索条件に一致するスキルはありません",
  "settings.skills.details": "スキルの詳細",
  "settings.skills.noDescription": "説明なし",
  "settings.skills.source.project": "プロジェクト",
  "settings.skills.source.global": "ユーザー",
  "settings.skills.source.builtin": "組み込み",
  "settings.skills.source.custom": "追加済み",
  "settings.scheduled.title": "スケジュール済みタスク",
  "settings.scheduled.description": "プロジェクトでプロンプトを一度だけ、または毎日実行します。",
  "settings.scheduled.empty": "スケジュール済みタスクはありません",
  "settings.scheduled.once": "一度だけ",
  "settings.scheduled.daily": "毎日",
  "settings.scheduled.add": "タスクを追加",
  "settings.scheduled.field.name": "名前",
  "settings.scheduled.field.prompt": "プロンプト",
  "settings.scheduled.field.schedule": "スケジュール",
  "settings.scheduled.field.time": "実行時刻",
  "settings.scheduled.error.name": "名前を入力してください",
  "settings.scheduled.error.prompt": "プロンプトを入力してください",
  "settings.scheduled.error.time": "時刻を選択してください",
  "settings.scheduled.error.model": "先にモデルを選択してください",
  "session.new.project.open": "既存のプロジェクトを開く",
  "common.pin": "ピン留め",
  "common.unpin": "ピン留めを解除",
  "settings.relay.title": "智联AI キー",
  "settings.relay.getKey": "API キーを取得",
  "settings.relay.getKey.description": "ChatGPT、Grok、その他のプロバイダー用に個別のキーを作成します。",
  "settings.relay.upstream": "上流サービス",
  "settings.relay.unified": "共通の API キーを使用",
  "settings.relay.unified.description": "有効にすると、すべてのベンダーでこのキーを使用します。",
  "settings.relay.unified.key": "共通の API キー",
  "settings.relay.unified.using": "共通キーを使用中",
  "settings.relay.key.set": "キーを保存しました",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "保存済みのキーを保持するには空欄にしてください",
  "settings.relay.test": "接続をテスト",
  "settings.relay.testing": "テスト中...",
  "settings.relay.fetch": "モデルを取得",
  "settings.relay.fetching": "取得中...",
  "settings.relay.edit": "編集",
  "settings.relay.clearKey": "キーを消去",
  "settings.relay.add": "ベンダーを追加",
  "settings.relay.add.name": "ベンダー名",
  "settings.relay.models.visible": "表示中のモデル {{count}} 個",
  "settings.relay.connected": "接続済み · モデル {{count}} 個",
  "settings.relay.connectedEmpty": "接続しましたが、モデルは返されませんでした",
  "settings.relay.test.ok": "接続に成功しました",
  "settings.relay.test.empty": "接続しましたが、モデルは返されませんでした",
  "settings.relay.models.title": "{{vendor}} のモデル",
  "settings.relay.models.empty": "まだモデルはありません。キーを保存してから一覧を取得してください。",
  "settings.relay.models.missing": "上流サービスでは提供されなくなりました",
  "settings.relay.saved": "自動保存しました",
  "settings.relay.retry": "再試行",
  "settings.relay.builtin": "組み込み",
  "settings.relay.delete": "ベンダーを削除",
  "settings.relay.rollback": "インポートしたキーをリセット",
  "settings.relay.rollback.description":
    "auth.json からインポートした Relay キーを消去します。元の auth.json は保持されます。",
  "settings.relay.error.KEY_MISSING": "先に API キーを追加してください",
  "settings.relay.error.KEY_REJECTED": "キーが拒否されました",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "上流サービスに接続できません",
  "settings.relay.error.UPSTREAM_TIMEOUT": "上流サービスがタイムアウトしました",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "上流サービスでリクエストのレート制限が適用されました",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "上流サービスから無効な応答が返されました",
  "settings.relay.error.REVISION_CONFLICT":
    "この設定は別のウィンドウで変更されました。再読み込みしてやり直してください。",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "このデバイスに API キーを保存できませんでした。",
  "settings.mcp.add": "MCP を追加",
  "settings.mcp.edit": "編集",
  "settings.mcp.field.name": "名前",
  "settings.mcp.field.type": "種類",
  "settings.mcp.field.command": "コマンド",
  ...
  "settings.mcp.error.name": "サーバー名を入力してください",
  "settings.mcp.error.command": "コマンドを入力してください",
  "settings.mcp.error.url": "URL を入力してください",
  ...
  "desktop.recovery.loadFailed": "Kodaを読み込めませんでした",
  "desktop.recovery.terminated": "Kodaのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "Kodaが応答していません",
  ...
  "desktop.wsl.error.installOpencode": "Kodaのインストールに失敗しました",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}にはKodaがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "Kodaのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.model.unpaid.freeModels.title": "Kodaが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Kodaで{{provider}}モデルを使用します。",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してKodaで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Kodaで{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続するKodaサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "Kodaを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のKodaを確認中...",
  "wsl.onboarding.updatingOpencode": "Kodaを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のKodaを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のKodaを更新してください。",
  "wsl.onboarding.updateOpencode": "Kodaを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のKodaの準備ができました。",
  "wsl.onboarding.opencodeReady": "Kodaの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にKodaをインストールしてください。",
  "wsl.onboarding.installOpencode": "Kodaをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kodaがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "KodaでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Kodaをもう一度開いてください。",
  ...
  "help.tabs.introduction": "Koda Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Kodaの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをKodaチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: KodaはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Kodaには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でKodaサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Kodaの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのKodaの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Kodaがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Kodaのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Koda の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Koda は最新バージョンです。",
