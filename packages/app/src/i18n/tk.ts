export const dict = {
  "desktop.menu.about": "Koda barada",
  "desktop.about.title": "Koda iş stoly programmasy v{{version}}",
  "desktop.about.detail":
    "OpenCode esas hökmünde ulanylyp üýtgedildi\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "Koda v{{version}} elýeterli. Täzelemek üçin goýberiliş sahypasyny açmalymy?",
  "desktop.koda.update.open": "Goýberiliş sahypasyny aç",
  "command.project.create": "Täze taslama",
  "command.project.openExisting": "Bar bolan taslamany aç",
  "prompt.toast.projectRequired.title": "Taslama saýlaň",
  "prompt.toast.projectRequired.description": "Ibermezden öň taslama dörediň ýa-da açyň.",
  "prompt.approval.ask": "Tassyklama sora",
  "prompt.approval.auto": "Meniň ýerime tassykla",
  "prompt.approval.plan": "Doly giriş",
  "prompt.more": "Has köp",
  "dialog.project.create.title": "Täze taslama",
  "dialog.project.create.name": "Ady",
  "dialog.project.create.location": "Ýerleşýän ýeri",
  "dialog.project.create.browse": "Göz aýla",
  "dialog.project.create.path": "Ýol",
  "dialog.project.create.submit": "Döret",
  "dialog.project.create.error.name": "Taslamanyň adyny giriziň",
  "dialog.project.create.error.invalid": "Bu ady bukja üçin ulanyp bolmaýar",
  "dialog.project.create.error.exists": "Bu bukja eýýäm bar. Ony açyň ýa-da başga at saýlaň.",
  "dialog.project.create.error.failed": "Bukjany döredip bolmady",
  "mcp.status.needs_client_registration": "müşderini bellige almak gerek",
  "home.welcome.title": "Näme kömek edip bilerin?",
  "home.project.create": "Täze taslama",
  "home.project.open": "Bar bolan taslamany aç",
  "home.sessions.search.title": "Söhbetleri gözle",
  "session.todo.empty": "Entek ýumuş ýok",
  "session.panel.files": "Faýllar",
  "session.panel.changes": "Üýtgeşmeler",
  "session.panel.tasks": "Ýumuşlar",
  "session.panel.terminal": "Terminal",
  "session.panel.empty": "Faýllara, üýtgeşmelere, ýumuşlara we terminala seretmek üçin taslama saýlaň.",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "Üýtgeşme ýok",
  "session.panel.git.dirty.one": "{{count}} üýtgedilen faýl",
  "session.panel.git.dirty.other": "{{count}} üýtgedilen faýl",
  "session.task.waiting": "Rugsada garaşylýar",
  "session.task.failed": "Şowsuz boldy",
  "session.task.retry": "Gaýtadan synanyş",
  "session.task.open": "Aýratyn sessiýada aç",
  "settings.skills.title": "Başarnyklar",
  "settings.skills.description": "Bu taslama üçin tapylan başarnyklar.",
  "settings.skills.empty": "Başarnyk tapylmady",
  "settings.skills.enabled": "Model üçin elýeterli",
  "settings.skills.disabled": "Model üçin gadagan",
  "settings.skills.search": "Başarnyklary gözle",
  "settings.skills.emptySearch": "Bu gözlege gabat gelýän başarnyk ýok",
  "settings.skills.details": "Başarnygyň jikme-jiklikleri",
  "settings.skills.noDescription": "Düşündiriş ýok",
  "settings.skills.source.project": "Taslama",
  "settings.skills.source.global": "Ulanyjy",
  "settings.skills.source.builtin": "Içine gurlan",
  "settings.skills.source.custom": "Goşulan",
  "settings.scheduled.title": "Meýilleşdirilen ýumuşlar",
  "settings.scheduled.description": "Taslamada soragy bir gezek ýa-da her gün işlediň.",
  "settings.scheduled.empty": "Meýilleşdirilen ýumuş ýok",
  "settings.scheduled.once": "Bir gezek",
  "settings.scheduled.daily": "Her gün",
  "settings.scheduled.add": "Ýumuş goş",
  "settings.scheduled.field.name": "Ady",
  "settings.scheduled.field.prompt": "Sorag",
  "settings.scheduled.field.schedule": "Meýilnama",
  "settings.scheduled.field.time": "Işlediljek wagty",
  "settings.scheduled.error.name": "At giriziň",
  "settings.scheduled.error.prompt": "Sorag giriziň",
  "settings.scheduled.error.time": "Wagt saýlaň",
  "settings.scheduled.error.model": "Ilki model saýlaň",
  "session.new.project.open": "Bar bolan taslamany aç",
  "common.pin": "Berkit",
  "common.unpin": "Berkitmäni aýyr",
  "settings.relay.title": "智联AI açarlary",
  "settings.relay.getKey": "API açaryny al",
  "settings.relay.getKey.description": "ChatGPT, Grok we beýleki üpjün edijiler üçin aýratyn açarlar dörediň.",
  "settings.relay.upstream": "Ýokarky serwer",
  "settings.relay.unified": "Umumy API açaryny ulan",
  "settings.relay.unified.description": "Işledilende ähli üpjün edijiler şu açary ulanýar.",
  "settings.relay.unified.key": "Umumy API açary",
  "settings.relay.unified.using": "Umumy açar ulanylýar",
  "settings.relay.key.set": "Açar ýatda saklandy",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "Ýatda saklanan açary saklamak üçin boş goýuň",
  "settings.relay.test": "Baglanyşygy barla",
  "settings.relay.testing": "Barlanýar...",
  "settings.relay.fetch": "Modelleri al",
  "settings.relay.fetching": "Alynýar...",
  "settings.relay.edit": "Üýtget",
  "settings.relay.clearKey": "Açary arassala",
  "settings.relay.add": "Üpjin ediji goş",
  "settings.relay.add.name": "Üpjin edijiniň ady",
  "settings.relay.models.visible": "{{count}} görünýän model",
  "settings.relay.connected": "Birikdirildi · {{count}} model",
  "settings.relay.connectedEmpty": "Birikdirildi, ýöne model gaýtarylmady",
  "settings.relay.test.ok": "Baglanyşyk üstünlikli boldy",
  "settings.relay.test.empty": "Birikdirildi, ýöne model gaýtarylmady",
  "settings.relay.models.title": "{{vendor}} modelleri",
  "settings.relay.models.empty": "Entek model ýok. Açary ýatda saklanyňyzdan soň sanawy alyň.",
  "settings.relay.models.missing": "Indi ýokarky serwerde ýok",
  "settings.relay.saved": "Awtomatik ýatda saklandy",
  "settings.relay.retry": "Gaýtadan synanyş",
  "settings.relay.builtin": "Içine gurlan",
  "settings.relay.delete": "Üpjin edijini poz",
  "settings.relay.rollback": "Import edilen açarlary täzeden düz",
  "settings.relay.rollback.description":
    "auth.json faýlyndan import edilen Relay açarlaryny arassalaýar. Asyl auth.json saklanýar.",
  "settings.relay.error.KEY_MISSING": "Ilki API açaryny goşuň",
  "settings.relay.error.KEY_REJECTED": "Açar ret edildi",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "Ýokarky serwere ýetip bolmaýar",
  "settings.relay.error.UPSTREAM_TIMEOUT": "Ýokarky serweriň garaşma wagty gutardy",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "Ýokarky serwer soraglaryň ýygylygyny çäklendirdi",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "Ýokarky serwer nädogry jogap gaýtardy",
  "settings.relay.error.REVISION_CONFLICT": "Bu sazlama başga penjirede üýtgedildi. Täzeläň we gaýtadan synanyşyň.",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "Bu enjamda API açaryny ýatda saklap bolmady.",
  "settings.mcp.add": "MCP goş",
  "settings.mcp.edit": "Üýtget",
  "settings.mcp.field.name": "Ady",
  "settings.mcp.field.type": "Görnüşi",
  "settings.mcp.field.command": "Buýruk",
  ...
  "settings.mcp.type.remote": "Uzakdaky",
  "settings.mcp.error.name": "Serweriň adyny giriziň",
  "settings.mcp.error.command": "Buýruk giriziň",
  "settings.mcp.error.url": "URL giriziň",
  ...
  "desktop.menu.documentation": "Koda Resminamalar",
  ...
  "desktop.menu.ariaLabel": "Koda menýusy",
  ...
  "desktop.recovery.loadFailed": "Koda ýükläp bilmedi",
  "desktop.recovery.terminated": "Koda penjiresi garaşylmadyk ýagdaýda bes edildi",
  "desktop.recovery.unresponsive": "Koda jogap berenok",
  ...
  "desktop.wsl.error.installOpencode": "Koda gurmak şowsuz",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Koda {{distro}} gurulmady",
  "desktop.wsl.error.updateVersion":
    "Koda täzelenmesi gutardy, ýöne {{distro}} henizem {{installed}} habar berýär; garaşylýan {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Koda tarapyndan mugt modeller",
  ...
  "provider.connect.apiKey.description":
    "Hasabyňyzy birikdirmek we Koda-da {{provider}} modellerini ulanmak üçin {{provider}} API açaryňyzy giriziň.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen kodlaşdyrmak serişdeleri üçin ygtybarly optimallaşdyrylan modelleriň toplumyna girmäge mümkinçilik berýär.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini Koda-de ulanmak üçin ygtyýarnama koduňyzy ýygnamak.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini Koda-de ulanmak üçin aşakdaky kody giriziň.",
  ...
  "dialog.server.description": "Bu programmanyň haýsy Koda serwerine birikýändigini üýtgediň.",
  ...
  "wsl.onboarding.checkingOpencode": "Koda barlamak ...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde Koda barlanýar...",
  "wsl.onboarding.updatingOpencode": "Koda täzelenmek ...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-de Koda täzelenmek ...",
  "wsl.onboarding.updateOpencodeIn": "Koda-ni {{distro}}-de täzeläň.",
  "wsl.onboarding.updateOpencode": "Koda täzeläň",
  "wsl.onboarding.opencodeReadyIn": "Koda {{distro}}-de taýýar.",
  "wsl.onboarding.opencodeReady": "Koda taýýar.",
  "wsl.onboarding.installOpencodeIn": "{{distro}}-de Koda guruň.",
  "wsl.onboarding.installOpencode": "Koda guruň",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda gurulmady",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux üçin Windows kiçi ulgamy) Koda WSL serwerini goşmazdan ozal talap edilýär",
  "wsl.onboarding.wslUnavailable.title": "WSL elýeterli däl",
  "wsl.onboarding.wslUnavailable.description": "Koda bu enjamda WSL barlap bilmedi.",
  "wsl.onboarding.installWsl": "WSL guruň",
  "wsl.onboarding.windowsRestartRequired": "WSL gurnamagy gutarmak üçin Windows-i täzeden açyň, soňra Koda açyň.",
  ...
  "help.tabs.introduction": "Koda Desktop indi goýmalaryň töwereginde guruldy.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Indi gurmak üçin Koda ({{version}}) -iň täze wersiýasy bar.",
  ...
  "error.page.report.prefix": "Bu ýalňyşlygy Koda toparyna habar bermegiňizi haýyş edýäris",
  ...
  "error.chain.mcpFailed": 'MCP serweri "{{name}}" şowsuz. Üns beriň, Koda entek MCP tassyklamasyny goldamaýar.',
  ...
  "sidebar.gettingStarted.line1": "Koda mugt modelleri öz içine alýar, derrew başlap bilersiňiz.",
  ...
  "settings.desktop.wsl.description": "Koda serwerini WSL-de Windows-de işlediň.",
  ...
  "settings.general.row.language.description": "Koda üçin displeý dilini üýtgediň",
  ...
  "settings.general.row.appearance.description": "Koda enjamyňyzda nähili görünýändigini düzüň",
  "settings.general.row.colorScheme.title": "Reňk shemasy",
  "settings.general.row.colorScheme.description": "Koda ulgamy, ýagtylygy ýa-da garaňky temany yzarlaýandygyny saýlaň",
  "settings.general.row.theme.title": "Mowzuk",
  "settings.general.row.theme.description": "Koda-iň mowzuklydygyny düzüň.",
  ...
  "settings.updates.row.startup.description": "Koda işe başlanda täzelenmeleri awtomatiki barlaň",
  ...
  "settings.updates.toast.latest.description": "Koda-iň iň soňky wersiýasyny işleýärsiňiz.",
