export const dict = {
  "desktop.menu.about": "O programu Koda",
  "desktop.about.title": "Koda Desktop v{{version}}",
  "desktop.about.detail": "Prilagojeno na osnovi OpenCode\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "Na voljo je Koda v{{version}}. Odprem stran izdaje za nadgradnjo?",
  "desktop.koda.update.open": "Odpri stran izdaje",
  "command.project.create": "Nov projekt",
  "command.project.openExisting": "Odpri obstoječi projekt",
  "prompt.toast.projectRequired.title": "Izberite projekt",
  "prompt.toast.projectRequired.description": "Pred pošiljanjem ustvarite ali odprite projekt.",
  "prompt.approval.ask": "Zahtevaj odobritev",
  "prompt.approval.auto": "Odobri namesto mene",
  "prompt.approval.plan": "Polni dostop",
  "prompt.more": "Več",
  "dialog.project.create.title": "Nov projekt",
  "dialog.project.create.name": "Ime",
  "dialog.project.create.location": "Mesto",
  "dialog.project.create.browse": "Prebrskaj",
  "dialog.project.create.path": "Pot",
  "dialog.project.create.submit": "Ustvari",
  "dialog.project.create.error.name": "Vnesite ime projekta",
  "dialog.project.create.error.invalid": "Tega imena ni mogoče uporabiti za mapo",
  "dialog.project.create.error.exists": "Ta mapa že obstaja. Odprite jo ali izberite drugo ime.",
  "dialog.project.create.error.failed": "Mape ni bilo mogoče ustvariti",
  "mcp.status.needs_client_registration": "potrebna je registracija odjemalca",
  "home.welcome.title": "Kako lahko pomagam?",
  "home.project.create": "Nov projekt",
  "home.project.open": "Odpri obstoječi projekt",
  "home.sessions.search.title": "Išči pogovore",
  "session.todo.empty": "Opravil še ni",
  "session.panel.files": "Datoteke",
  "session.panel.changes": "Spremembe",
  "session.panel.tasks": "Opravila",
  "session.panel.terminal": "Terminal",
  "session.panel.empty": "Izberite projekt za pregled datotek, sprememb, opravil in terminala.",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "Brez sprememb",
  "session.panel.git.dirty.one": "{{count}} spremenjena datoteka",
  "session.panel.git.dirty.two": "{{count}} spremenjeni datoteki",
  "session.panel.git.dirty.few": "{{count}} spremenjene datoteke",
  "session.panel.git.dirty.other": "{{count}} spremenjenih datotek",
  "session.task.waiting": "Čakanje na dovoljenje",
  "session.task.failed": "Neuspešno",
  "session.task.retry": "Poskusi znova",
  "session.task.open": "Odpri v ločeni seji",
  "settings.skills.title": "Veščine",
  "settings.skills.description": "Veščine, odkrite za ta projekt.",
  "settings.skills.empty": "Ni najdenih veščin",
  "settings.skills.enabled": "Na voljo modelu",
  "settings.skills.disabled": "Prepovedano za model",
  "settings.skills.search": "Išči veščine",
  "settings.skills.emptySearch": "Nobena veščina ne ustreza iskanju",
  "settings.skills.details": "Podrobnosti veščine",
  "settings.skills.noDescription": "Brez opisa",
  "settings.skills.source.project": "Projekt",
  "settings.skills.source.global": "Uporabnik",
  "settings.skills.source.builtin": "Vgrajeno",
  "settings.skills.source.custom": "Dodano",
  "settings.scheduled.title": "Načrtovana opravila",
  "settings.scheduled.description": "Zaženite poziv v projektu enkrat ali vsak dan.",
  "settings.scheduled.empty": "Ni načrtovanih opravil",
  "settings.scheduled.once": "Enkrat",
  "settings.scheduled.daily": "Vsak dan",
  "settings.scheduled.add": "Dodaj opravilo",
  "settings.scheduled.field.name": "Ime",
  "settings.scheduled.field.prompt": "Poziv",
  "settings.scheduled.field.schedule": "Urnik",
  "settings.scheduled.field.time": "Čas zagona",
  "settings.scheduled.error.name": "Vnesite ime",
  "settings.scheduled.error.prompt": "Vnesite poziv",
  "settings.scheduled.error.time": "Izberite čas",
  "settings.scheduled.error.model": "Najprej izberite model",
  "session.new.project.open": "Odpri obstoječi projekt",
  "common.pin": "Pripni",
  "common.unpin": "Odpni",
  "settings.relay.title": "Ključi 智联AI",
  "settings.relay.getKey": "Pridobi ključ API",
  "settings.relay.getKey.description": "Ustvarite ločene ključe za ChatGPT, Grok in druge ponudnike.",
  "settings.relay.upstream": "Nadrejeni strežnik",
  "settings.relay.unified": "Uporabi skupni ključ API",
  "settings.relay.unified.description": "Ko je omogočeno, vsi ponudniki uporabljajo ta ključ.",
  "settings.relay.unified.key": "Skupni ključ API",
  "settings.relay.unified.using": "Uporablja se skupni ključ",
  "settings.relay.key.set": "Ključ je shranjen",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "Pustite prazno, da ohranite shranjeni ključ",
  "settings.relay.test": "Preizkusi povezavo",
  "settings.relay.testing": "Preizkušanje...",
  "settings.relay.fetch": "Pridobi modele",
  "settings.relay.fetching": "Pridobivanje...",
  "settings.relay.edit": "Uredi",
  "settings.relay.clearKey": "Izbriši ključ",
  "settings.relay.add": "Dodaj ponudnika",
  "settings.relay.add.name": "Ime ponudnika",
  "settings.relay.models.visible": "Vidni modeli: {{count}}",
  "settings.relay.connected": "Povezano · Modeli: {{count}}",
  "settings.relay.connectedEmpty": "Povezano, vendar ni bilo vrnjenih modelov",
  "settings.relay.test.ok": "Povezava je uspela",
  "settings.relay.test.empty": "Povezano, vendar ni bilo vrnjenih modelov",
  "settings.relay.models.title": "Modeli ponudnika {{vendor}}",
  "settings.relay.models.empty": "Modelov še ni. Po shranjevanju ključa pridobite seznam.",
  "settings.relay.models.missing": "Ni več na nadrejenem strežniku",
  "settings.relay.saved": "Samodejno shranjeno",
  "settings.relay.retry": "Poskusi znova",
  "settings.relay.builtin": "Vgrajeno",
  "settings.relay.delete": "Izbriši ponudnika",
  "settings.relay.rollback": "Ponastavi uvožene ključe",
  "settings.relay.rollback.description": "Izbriše ključe Relay, uvožene iz auth.json. Izvirni auth.json se ohrani.",
  "settings.relay.error.KEY_MISSING": "Najprej dodajte ključ API",
  "settings.relay.error.KEY_REJECTED": "Ključ je bil zavrnjen",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "Nadrejeni strežnik ni dosegljiv",
  "settings.relay.error.UPSTREAM_TIMEOUT": "Čas čakanja na nadrejeni strežnik je potekel",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "Nadrejeni strežnik je omejil pogostost zahtev",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "Nadrejeni strežnik je vrnil neveljaven odgovor",
  "settings.relay.error.REVISION_CONFLICT":
    "Ta nastavitev se je spremenila v drugem oknu. Osvežite in poskusite znova.",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "Ključa API ni bilo mogoče shraniti v tej napravi.",
  "settings.mcp.add": "Dodaj MCP",
  "settings.mcp.edit": "Uredi",
  "settings.mcp.field.name": "Ime",
  "settings.mcp.field.type": "Vrsta",
  "settings.mcp.field.command": "Ukaz",
  ...
  "settings.mcp.type.local": "Krajevno",
  "settings.mcp.type.remote": "Oddaljeno",
  "settings.mcp.error.name": "Vnesite ime strežnika",
  "settings.mcp.error.command": "Vnesite ukaz",
  "settings.mcp.error.url": "Vnesite URL",
  ...
  "desktop.menu.ariaLabel": "Koda meni",
  ...
  "desktop.recovery.loadFailed": "Koda ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno Koda se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "Koda se ne odziva",
  ...
  "desktop.wsl.error.installOpencode": "Namestitev Koda ni uspela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Koda ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev Koda je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja Koda",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v Koda.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen vam omogoča dostop do izbranega nabora zanesljivih optimiziranih modelov za agente za kodiranje.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v Koda.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v Koda.",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom Koda se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingOpencode": "Preverjanje Koda ...",
  "wsl.onboarding.checkingOpencodeIn": "Preverjanje Koda v {{distro}} ...",
  "wsl.onboarding.updatingOpencode": "Posodabljanje Koda ...",
  "wsl.onboarding.updatingOpencodeIn": "Posodabljanje Koda v {{distro}} ...",
  "wsl.onboarding.updateOpencodeIn": "Posodobite Koda v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Posodobite Koda",
  "wsl.onboarding.opencodeReadyIn": "Koda je pripravljen v {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koda je pripravljen.",
  "wsl.onboarding.installOpencodeIn": "Namestite Koda v {{distro}}.",
  "wsl.onboarding.installOpencode": "Namestite Koda",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko Koda doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "Koda ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite Koda.",
  ...
  "help.tabs.introduction": "Koda Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica Koda ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi Koda",
  ...
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, Koda še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "Koda vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik Koda znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za Koda",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako Koda izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali Koda sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo Koda.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene Koda",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico Koda.",
