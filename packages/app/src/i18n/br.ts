export const dict = {
  "desktop.menu.about": "Sobre o Koda",
  "desktop.about.title": "Koda Desktop v{{version}}",
  "desktop.about.detail":
    "Modificado a partir do OpenCode como base\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "O Koda v{{version}} está disponível. Abrir a página de versões para atualizar?",
  "desktop.koda.update.open": "Abrir página de versões",
  "command.project.create": "Novo projeto",
  "command.project.openExisting": "Abrir projeto existente",
  "prompt.toast.projectRequired.title": "Escolha um projeto",
  "prompt.toast.projectRequired.description": "Crie ou abra um projeto antes de enviar.",
  "prompt.approval.ask": "Solicitar aprovação",
  "prompt.approval.auto": "Aprovar por mim",
  "prompt.approval.plan": "Acesso total",
  "prompt.more": "Mais",
  "dialog.project.create.title": "Novo projeto",
  "dialog.project.create.name": "Nome",
  "dialog.project.create.location": "Localização",
  "dialog.project.create.browse": "Procurar",
  "dialog.project.create.path": "Caminho",
  "dialog.project.create.submit": "Criar",
  "dialog.project.create.error.name": "Digite um nome para o projeto",
  "dialog.project.create.error.invalid": "Este nome não pode ser usado para uma pasta",
  "dialog.project.create.error.exists": "Essa pasta já existe. Abra-a ou escolha outro nome.",
  "dialog.project.create.error.failed": "Não foi possível criar a pasta",
  "mcp.status.needs_client_registration": "requer registro do cliente",
  "home.welcome.title": "Como posso ajudar?",
  "home.project.create": "Novo projeto",
  "home.project.open": "Abrir projeto existente",
  "home.sessions.search.title": "Pesquisar conversas",
  "session.todo.empty": "Ainda não há tarefas",
  "session.panel.files": "Arquivos",
  "session.panel.changes": "Alterações",
  "session.panel.tasks": "Tarefas",
  "session.panel.terminal": "Terminal",
  "session.panel.empty": "Selecione um projeto para explorar arquivos, alterações, tarefas e o terminal.",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "Sem alterações",
  "session.panel.git.dirty.one": "{{count}} arquivo alterado",
  "session.panel.git.dirty.other": "{{count}} arquivos alterados",
  "session.panel.git.dirty.many": "{{count}} arquivos alterados",
  "session.task.waiting": "Aguardando permissão",
  "session.task.failed": "Falhou",
  "session.task.retry": "Tentar novamente",
  "session.task.open": "Abrir em uma sessão própria",
  "settings.skills.title": "Habilidades",
  "settings.skills.description": "Habilidades encontradas para este projeto.",
  "settings.skills.empty": "Nenhuma habilidade encontrada",
  "settings.skills.enabled": "Disponível para o modelo",
  "settings.skills.disabled": "Negada para o modelo",
  "settings.skills.search": "Pesquisar habilidades",
  "settings.skills.emptySearch": "Nenhuma habilidade corresponde a esta pesquisa",
  "settings.skills.details": "Detalhes da habilidade",
  "settings.skills.noDescription": "Sem descrição",
  "settings.skills.source.project": "Projeto",
  "settings.skills.source.global": "Usuário",
  "settings.skills.source.builtin": "Integrada",
  "settings.skills.source.custom": "Adicionada",
  "settings.scheduled.title": "Tarefas agendadas",
  "settings.scheduled.description": "Execute um prompt uma vez ou todos os dias em um projeto.",
  "settings.scheduled.empty": "Nenhuma tarefa agendada",
  "settings.scheduled.once": "Uma vez",
  "settings.scheduled.daily": "Todos os dias",
  "settings.scheduled.add": "Adicionar tarefa",
  "settings.scheduled.field.name": "Nome",
  "settings.scheduled.field.prompt": "Prompt",
  "settings.scheduled.field.schedule": "Agendamento",
  "settings.scheduled.field.time": "Executar às",
  "settings.scheduled.error.name": "Digite um nome",
  "settings.scheduled.error.prompt": "Digite um prompt",
  "settings.scheduled.error.time": "Escolha um horário",
  "settings.scheduled.error.model": "Selecione um modelo primeiro",
  "session.new.project.open": "Abrir projeto existente",
  "common.pin": "Fixar",
  "common.unpin": "Desafixar",
  "settings.relay.title": "Chaves do 智联AI",
  "settings.relay.getKey": "Obter chave de API",
  "settings.relay.getKey.description": "Crie chaves separadas para ChatGPT, Grok e outros provedores.",
  "settings.relay.upstream": "Serviço de origem",
  "settings.relay.unified": "Usar uma chave de API compartilhada",
  "settings.relay.unified.description": "Quando ativado, todos os provedores usam esta chave.",
  "settings.relay.unified.key": "Chave de API compartilhada",
  "settings.relay.unified.using": "Usando a chave compartilhada",
  "settings.relay.key.set": "Chave salva",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "Deixe em branco para manter a chave salva",
  "settings.relay.test": "Testar conexão",
  "settings.relay.testing": "Testando...",
  "settings.relay.fetch": "Obter modelos",
  "settings.relay.fetching": "Obtendo...",
  "settings.relay.edit": "Editar",
  "settings.relay.clearKey": "Limpar chave",
  "settings.relay.add": "Adicionar provedor",
  "settings.relay.add.name": "Nome do provedor",
  "settings.relay.models.visible": "{{count}} modelos visíveis",
  "settings.relay.connected": "Conectado · {{count}} modelos",
  "settings.relay.connectedEmpty": "Conectado, mas nenhum modelo foi retornado",
  "settings.relay.test.ok": "Conexão bem-sucedida",
  "settings.relay.test.empty": "Conectado, mas nenhum modelo foi retornado",
  "settings.relay.models.title": "Modelos de {{vendor}}",
  "settings.relay.models.empty": "Ainda não há modelos. Obtenha a lista após salvar uma chave.",
  "settings.relay.models.missing": "Não está mais no serviço de origem",
  "settings.relay.saved": "Salvo automaticamente",
  "settings.relay.retry": "Tentar novamente",
  "settings.relay.builtin": "Integrado",
  "settings.relay.delete": "Excluir provedor",
  "settings.relay.rollback": "Redefinir chaves importadas",
  "settings.relay.rollback.description":
    "Limpa as chaves do Relay importadas de auth.json. O arquivo auth.json original é mantido.",
  "settings.relay.error.KEY_MISSING": "Adicione uma chave de API primeiro",
  "settings.relay.error.KEY_REJECTED": "A chave foi rejeitada",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "O serviço de origem está inacessível",
  "settings.relay.error.UPSTREAM_TIMEOUT": "O tempo limite do serviço de origem foi excedido",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "O serviço de origem limitou a solicitação por excesso de requisições",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "O serviço de origem retornou uma resposta inválida",
  "settings.relay.error.REVISION_CONFLICT": "Esta configuração mudou em outra janela. Atualize e tente novamente.",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "Não foi possível salvar a chave de API neste dispositivo.",
  "settings.mcp.add": "Adicionar MCP",
  ...
  "settings.mcp.error.name": "Digite um nome para o servidor",
  "settings.mcp.error.command": "Digite um comando",
  "settings.mcp.error.url": "Digite uma URL",
  ...
  "desktop.menu.documentation": "Documentação do Koda",
  ...
  "desktop.menu.ariaLabel": "Menu do Koda",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o Koda",
  "desktop.recovery.terminated": "A janela do Koda foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O Koda não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do Koda",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "O Koda não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do Koda foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Koda",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Koda.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Koda.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Koda.",
  ...
  "dialog.server.description": "Trocar para qual servidor Koda este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o Koda...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o Koda em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o Koda...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o Koda em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o Koda em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o Koda",
  "wsl.onboarding.opencodeReadyIn": "O Koda está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O Koda está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o Koda em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o Koda",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Koda possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Koda não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Koda novamente.",
  ...
  "help.tabs.introduction": "Agora, o Koda Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do Koda ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Koda",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Koda ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Koda inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Koda dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Koda",
  ...
  "settings.general.row.appearance.description": "Personalize como o Koda aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Koda segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Koda é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Koda iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Koda.",
