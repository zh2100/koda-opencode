export const dict = {
  "desktop.menu.about": "Rreth Koda",
  "desktop.about.title": "Koda Desktop v{{version}}",
  "desktop.about.detail": "Modifikuar mbi bazën e OpenCode\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "Koda v{{version}} është i disponueshëm. Të hapet faqja e versionit për përmirësim?",
  "desktop.koda.update.open": "Hap faqen e versionit",
  "command.project.create": "Projekt i ri",
  "command.project.openExisting": "Hap projekt ekzistues",
  "prompt.toast.projectRequired.title": "Zgjidhni një projekt",
  "prompt.toast.projectRequired.description": "Krijoni ose hapni një projekt para dërgimit.",
  "prompt.approval.ask": "Kërko miratim",
  "prompt.approval.auto": "Mirato në vendin tim",
  "prompt.approval.plan": "Qasje e plotë",
  "prompt.more": "Më tepër",
  "dialog.project.create.title": "Projekt i ri",
  "dialog.project.create.name": "Emri",
  "dialog.project.create.location": "Vendndodhja",
  "dialog.project.create.browse": "Shfleto",
  "dialog.project.create.path": "Shtegu",
  "dialog.project.create.submit": "Krijo",
  "dialog.project.create.error.name": "Jepni një emër projekti",
  "dialog.project.create.error.invalid": "Ky emër nuk mund të përdoret për një dosje",
  "dialog.project.create.error.exists": "Kjo dosje ekziston tashmë. Hapeni ose zgjidhni një emër tjetër.",
  "dialog.project.create.error.failed": "Dosja nuk u krijua dot",
  "mcp.status.needs_client_registration": "kërkon regjistrim të klientit",
  "home.welcome.title": "Si mund t’ju ndihmoj?",
  "home.project.create": "Projekt i ri",
  "home.project.open": "Hap projekt ekzistues",
  "home.sessions.search.title": "Kërko biseda",
  "session.todo.empty": "Ende s’ka detyra",
  "session.panel.files": "Skedarë",
  "session.panel.changes": "Ndryshime",
  "session.panel.tasks": "Detyra",
  "session.panel.terminal": "Terminal",
  "session.panel.empty": "Zgjidhni një projekt për të parë skedarët, ndryshimet, detyrat dhe terminalin.",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "Pa ndryshime",
  "session.panel.git.dirty.one": "{{count}} skedar i ndryshuar",
  "session.panel.git.dirty.other": "{{count}} skedarë të ndryshuar",
  "session.task.waiting": "Në pritje të lejes",
  "session.task.failed": "Dështoi",
  "session.task.retry": "Riprovo",
  "session.task.open": "Hape në një sesion më vete",
  "settings.skills.title": "Aftësi",
  "settings.skills.description": "Aftësitë e gjetura për këtë projekt.",
  "settings.skills.empty": "Nuk u gjetën aftësi",
  "settings.skills.enabled": "E disponueshme për modelin",
  "settings.skills.disabled": "E ndaluar për modelin",
  "settings.skills.search": "Kërko aftësi",
  "settings.skills.emptySearch": "Asnjë aftësi nuk përputhet me kërkimin",
  "settings.skills.details": "Hollësi të aftësisë",
  "settings.skills.noDescription": "Pa përshkrim",
  "settings.skills.source.project": "Projekt",
  "settings.skills.source.global": "Përdorues",
  "settings.skills.source.builtin": "E integruar",
  "settings.skills.source.custom": "E shtuar",
  "settings.scheduled.title": "Detyra të planifikuara",
  "settings.scheduled.description": "Ekzekutoni një udhëzim në një projekt një herë ose çdo ditë.",
  "settings.scheduled.empty": "S’ka detyra të planifikuara",
  "settings.scheduled.once": "Një herë",
  "settings.scheduled.daily": "Çdo ditë",
  "settings.scheduled.add": "Shto detyrë",
  "settings.scheduled.field.name": "Emri",
  "settings.scheduled.field.prompt": "Udhëzim",
  "settings.scheduled.field.schedule": "Orari",
  "settings.scheduled.field.time": "Koha e ekzekutimit",
  "settings.scheduled.error.name": "Jepni një emër",
  "settings.scheduled.error.prompt": "Jepni një udhëzim",
  "settings.scheduled.error.time": "Zgjidhni një orë",
  "settings.scheduled.error.model": "Zgjidhni fillimisht një model",
  "session.new.project.open": "Hap projekt ekzistues",
  "common.pin": "Fikso",
  "common.unpin": "Hiq fiksimin",
  "settings.relay.title": "Çelësa 智联AI",
  "settings.relay.getKey": "Merr çelës API",
  "settings.relay.getKey.description": "Krijoni çelësa të veçantë për ChatGPT, Grok dhe ofrues të tjerë.",
  "settings.relay.upstream": "Shërbyesi i ofruesit",
  "settings.relay.unified": "Përdor një çelës API të përbashkët",
  "settings.relay.unified.description": "Kur aktivizohet, çdo ofrues përdor këtë çelës.",
  "settings.relay.unified.key": "Çelës API i përbashkët",
  "settings.relay.unified.using": "Po përdoret çelësi i përbashkët",
  "settings.relay.key.set": "Çelësi u ruajt",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "Lëreni bosh për të mbajtur çelësin e ruajtur",
  "settings.relay.test": "Provo lidhjen",
  "settings.relay.testing": "Po provohet...",
  "settings.relay.fetch": "Merr modelet",
  "settings.relay.fetching": "Po merren...",
  "settings.relay.edit": "Përpuno",
  "settings.relay.clearKey": "Fshi çelësin",
  "settings.relay.add": "Shto ofrues",
  "settings.relay.add.name": "Emri i ofruesit",
  "settings.relay.models.visible": "Modele të dukshme: {{count}}",
  "settings.relay.connected": "U lidh · Modele: {{count}}",
  "settings.relay.connectedEmpty": "U lidh, por nuk u kthyen modele",
  "settings.relay.test.ok": "Lidhja u krye me sukses",
  "settings.relay.test.empty": "U lidh, por nuk u kthyen modele",
  "settings.relay.models.title": "Modelet e {{vendor}}",
  "settings.relay.models.empty": "Ende s’ka modele. Merrni listën pasi të ruani një çelës.",
  "settings.relay.models.missing": "Nuk gjendet më në shërbyesin e ofruesit",
  "settings.relay.saved": "U ruajt automatikisht",
  "settings.relay.retry": "Riprovo",
  "settings.relay.builtin": "I integruar",
  "settings.relay.delete": "Fshi ofruesin",
  "settings.relay.rollback": "Rivendos çelësat e importuar",
  "settings.relay.rollback.description":
    "Fshin çelësat Relay të importuar nga auth.json. Skedari origjinal auth.json ruhet.",
  "settings.relay.error.KEY_MISSING": "Shtoni fillimisht një çelës API",
  "settings.relay.error.KEY_REJECTED": "Çelësi u refuzua",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "Shërbyesi i ofruesit është i paarritshëm",
  "settings.relay.error.UPSTREAM_TIMEOUT": "Mbaroi koha e pritjes për shërbyesin e ofruesit",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "Shërbyesi i ofruesit kufizoi shpeshtësinë e kërkesave",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "Shërbyesi i ofruesit ktheu një përgjigje të pavlefshme",
  "settings.relay.error.REVISION_CONFLICT":
    "Ky rregullim ndryshoi në një dritare tjetër. Rifreskoni dhe provoni përsëri.",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "Çelësi API nuk u ruajt dot në këtë pajisje.",
  "settings.mcp.add": "Shto MCP",
  "settings.mcp.edit": "Përpuno",
  "settings.mcp.field.name": "Emri",
  "settings.mcp.field.type": "Lloji",
  "settings.mcp.field.command": "Komanda",
  ...
  "settings.mcp.type.local": "Vendor",
  "settings.mcp.type.remote": "I largët",
  "settings.mcp.error.name": "Jepni emrin e shërbyesit",
  "settings.mcp.error.command": "Jepni një komandë",
  "settings.mcp.error.url": "Jepni një URL",
  ...
  "desktop.menu.documentation": "Dokumentacioni Koda",
  ...
  "desktop.menu.ariaLabel": "Menuja Koda",
  ...
  "desktop.recovery.loadFailed": "Koda nuk u ngarkua",
  "desktop.recovery.terminated": "Dritarja Koda u mbyll papritur",
  "desktop.recovery.unresponsive": "Koda nuk po përgjigjet",
  ...
  "desktop.wsl.error.installOpencode": "Instalimi i Koda dështoi",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Koda nuk është i instaluar në {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Përditësimi i Koda përfundoi, por {{distro}} ende raporton {{installed}}; pritet {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele falas të ofruara nga Koda",
  ...
  "provider.connect.apiKey.description":
    "Futni çelësin API të {{provider}} për të lidhur llogarinë dhe për të përdorur modelet {{provider}} në Koda.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen ju jep akses në një grup të kuruar modelesh të optimizuara të besueshme për agjentët e kodimit.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " për të mbledhur kodin tuaj të autorizimit për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në Koda.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dhe futni kodin më poshtë për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në Koda.",
  ...
  "dialog.server.description": "Ndrysho me cilin server Koda lidhet ky aplikacion.",
  ...
  "wsl.onboarding.checkingOpencode": "Po kontrollon Koda...",
  "wsl.onboarding.checkingOpencodeIn": "Po kontrollon Koda në {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Koda po përditësohet...",
  "wsl.onboarding.updatingOpencodeIn": "Po përditëson Koda në {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Përditëso Koda në {{distro}}.",
  "wsl.onboarding.updateOpencode": "Përditëso Koda",
  "wsl.onboarding.opencodeReadyIn": "Koda është gati në {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koda është gati.",
  "wsl.onboarding.installOpencodeIn": "Instaloni Koda në {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaloni Koda",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda nuk është i instaluar",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Nënsistemi Windows për Linux) kërkohet përpara se Koda të shtojë një server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL i padisponueshëm",
  "wsl.onboarding.wslUnavailable.description": "Koda nuk mund ta verifikonte WSL në këtë makinë.",
  "wsl.onboarding.installWsl": "Instaloni WSL",
  "wsl.onboarding.windowsRestartRequired": "Rinis Windows për të përfunduar instalimin e WSL, më pas rihap Koda.",
  ...
  "help.tabs.introduction": "Koda Desktop tani është ndërtuar rreth skedave.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Një version i ri i Koda ({{version}}) është tani i disponueshëm për t'u instaluar.",
  ...
  "error.page.report.prefix": "Ju lutemi raportoni këtë gabim te ekipi i Koda",
  ...
  "error.chain.mcpFailed": 'Serveri MCP "{{name}}" dështoi. Shënim, Koda nuk e mbështet ende vërtetimin MCP.',
  ...
  "sidebar.gettingStarted.line1": "Koda përfshin modele falas, kështu që mund të filloni menjëherë.",
  ...
  "settings.desktop.wsl.description": "Ekzekutoni serverin Koda brenda WSL në Windows.",
  ...
  "settings.general.row.language.description": "Ndryshoni gjuhën e ekranit për Koda",
  ...
  "settings.general.row.appearance.description": "Personalizojeni se si duket Koda në pajisjen tuaj",
  "settings.general.row.colorScheme.title": "Skema e ngjyrave",
  "settings.general.row.colorScheme.description": "Zgjidhni nëse Koda ndjek temën e sistemit, të lehtë ose të errët",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizojeni se si është tema e Koda.",
  ...
  "settings.updates.row.startup.description": "Kontrolloni automatikisht për përditësime kur niset Koda",
  ...
  "settings.updates.toast.latest.description": "Ju jeni duke ekzekutuar versionin më të fundit të Koda.",
