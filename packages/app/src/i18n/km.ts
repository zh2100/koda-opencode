export const dict = {
  "desktop.menu.about": "អំពី Koda",
  "desktop.about.title": "Koda Desktop v{{version}}",
  "desktop.about.detail": "កែសម្រួលដោយប្រើ OpenCode ជាស្នូល\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "មាន Koda v{{version}} ហើយ។ បើកទំព័រចេញផ្សាយដើម្បីដំឡើងកំណែឬ?",
  "desktop.koda.update.open": "បើកទំព័រចេញផ្សាយ",
  "command.project.create": "គម្រោងថ្មី",
  "command.project.openExisting": "បើកគម្រោងដែលមានស្រាប់",
  "prompt.toast.projectRequired.title": "ជ្រើសរើសគម្រោង",
  "prompt.toast.projectRequired.description": "បង្កើតឬបើកគម្រោងមុនពេលផ្ញើ។",
  "prompt.approval.ask": "ស្នើសុំការអនុម័ត",
  "prompt.approval.auto": "អនុម័តជំនួសខ្ញុំ",
  "prompt.approval.plan": "សិទ្ធិចូលប្រើពេញលេញ",
  "prompt.more": "ច្រើនទៀត",
  "dialog.project.create.title": "គម្រោងថ្មី",
  "dialog.project.create.name": "ឈ្មោះ",
  "dialog.project.create.location": "ទីតាំង",
  "dialog.project.create.browse": "រកមើល",
  "dialog.project.create.path": "ផ្លូវ",
  "dialog.project.create.submit": "បង្កើត",
  "dialog.project.create.error.name": "បញ្ចូលឈ្មោះគម្រោង",
  "dialog.project.create.error.invalid": "មិនអាចប្រើឈ្មោះនេះសម្រាប់ថតបានទេ",
  "dialog.project.create.error.exists": "ថតនោះមានរួចហើយ។ សូមបើកវា ឬជ្រើសរើសឈ្មោះផ្សេង។",
  "dialog.project.create.error.failed": "មិនអាចបង្កើតថតបានទេ",
  "mcp.status.needs_client_registration": "ត្រូវការចុះឈ្មោះម៉ាស៊ីនភ្ញៀវ",
  "home.welcome.title": "តើខ្ញុំអាចជួយអ្វីបាន?",
  "home.project.create": "គម្រោងថ្មី",
  "home.project.open": "បើកគម្រោងដែលមានស្រាប់",
  "home.sessions.search.title": "ស្វែងរកការជជែក",
  "session.todo.empty": "មិនទាន់មានកិច្ចការ",
  "session.panel.files": "ឯកសារ",
  "session.panel.changes": "ការផ្លាស់ប្តូរ",
  "session.panel.tasks": "កិច្ចការ",
  "session.panel.terminal": "ស្ថានីយ",
  "session.panel.empty": "ជ្រើសរើសគម្រោងដើម្បីរកមើលឯកសារ ការផ្លាស់ប្តូរ កិច្ចការ និងស្ថានីយ។",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "គ្មានការផ្លាស់ប្តូរ",
  "session.panel.git.dirty.one": "ឯកសារបានផ្លាស់ប្តូរ {{count}}",
  "session.panel.git.dirty.other": "ឯកសារបានផ្លាស់ប្តូរ {{count}}",
  "session.task.waiting": "កំពុងរង់ចាំការអនុញ្ញាត",
  "session.task.failed": "បានបរាជ័យ",
  "session.task.retry": "ព្យាយាមម្តងទៀត",
  "session.task.open": "បើកក្នុងសម័យដាច់ដោយឡែក",
  "settings.skills.title": "ជំនាញ",
  "settings.skills.description": "ជំនាញដែលបានរកឃើញសម្រាប់គម្រោងនេះ។",
  "settings.skills.empty": "រកមិនឃើញជំនាញទេ",
  "settings.skills.enabled": "អនុញ្ញាតឱ្យម៉ូដែលប្រើ",
  "settings.skills.disabled": "មិនអនុញ្ញាតឱ្យម៉ូដែលប្រើ",
  "settings.skills.search": "ស្វែងរកជំនាញ",
  "settings.skills.emptySearch": "គ្មានជំនាញត្រូវនឹងការស្វែងរកនេះទេ",
  "settings.skills.details": "ព័ត៌មានលម្អិតអំពីជំនាញ",
  "settings.skills.noDescription": "គ្មានការពិពណ៌នា",
  "settings.skills.source.project": "គម្រោង",
  "settings.skills.source.global": "អ្នកប្រើប្រាស់",
  "settings.skills.source.builtin": "មានស្រាប់",
  "settings.skills.source.custom": "បានបន្ថែម",
  "settings.scheduled.title": "កិច្ចការដែលបានកំណត់ពេល",
  "settings.scheduled.description": "ដំណើរការសេចក្តីណែនាំម្តង ឬរាល់ថ្ងៃក្នុងគម្រោង។",
  "settings.scheduled.empty": "គ្មានកិច្ចការដែលបានកំណត់ពេល",
  "settings.scheduled.once": "ម្តង",
  "settings.scheduled.daily": "រាល់ថ្ងៃ",
  "settings.scheduled.add": "បន្ថែមកិច្ចការ",
  "settings.scheduled.field.name": "ឈ្មោះ",
  "settings.scheduled.field.prompt": "សេចក្តីណែនាំ",
  "settings.scheduled.field.schedule": "កាលវិភាគ",
  "settings.scheduled.field.time": "ដំណើរការនៅម៉ោង",
  "settings.scheduled.error.name": "បញ្ចូលឈ្មោះ",
  "settings.scheduled.error.prompt": "បញ្ចូលសេចក្តីណែនាំ",
  "settings.scheduled.error.time": "ជ្រើសរើសពេលវេលា",
  "settings.scheduled.error.model": "ជ្រើសរើសម៉ូដែលជាមុន",
  "session.new.project.open": "បើកគម្រោងដែលមានស្រាប់",
  "common.pin": "ខ្ទាស់",
  "common.unpin": "ដោះខ្ទាស់",
  "settings.relay.title": "សោ 智联AI",
  "settings.relay.getKey": "យកសោ API",
  "settings.relay.getKey.description": "បង្កើតសោដាច់ដោយឡែកសម្រាប់ ChatGPT, Grok និងអ្នកផ្តល់សេវាផ្សេងទៀត។",
  "settings.relay.upstream": "សេវាដើម",
  "settings.relay.unified": "ប្រើសោ API រួម",
  "settings.relay.unified.description": "នៅពេលបើក អ្នកផ្តល់សេវាទាំងអស់ប្រើសោនេះ។",
  "settings.relay.unified.key": "សោ API រួម",
  "settings.relay.unified.using": "កំពុងប្រើសោរួម",
  "settings.relay.key.set": "បានរក្សាទុកសោ",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "ទុកទទេដើម្បីរក្សាសោដែលបានរក្សាទុក",
  "settings.relay.test": "សាកល្បងការតភ្ជាប់",
  "settings.relay.testing": "កំពុងសាកល្បង...",
  "settings.relay.fetch": "យកម៉ូដែល",
  "settings.relay.fetching": "កំពុងទាញយក...",
  "settings.relay.edit": "កែសម្រួល",
  "settings.relay.clearKey": "សម្អាតសោ",
  "settings.relay.add": "បន្ថែមអ្នកផ្តល់សេវា",
  "settings.relay.add.name": "ឈ្មោះអ្នកផ្តល់សេវា",
  "settings.relay.models.visible": "ម៉ូដែលដែលអាចមើលឃើញ {{count}}",
  "settings.relay.connected": "បានតភ្ជាប់ · ម៉ូដែល {{count}}",
  "settings.relay.connectedEmpty": "បានតភ្ជាប់ ប៉ុន្តែគ្មានម៉ូដែលត្រូវបានបញ្ជូនត្រឡប់មកវិញទេ",
  "settings.relay.test.ok": "ការតភ្ជាប់បានជោគជ័យ",
  "settings.relay.test.empty": "បានតភ្ជាប់ ប៉ុន្តែគ្មានម៉ូដែលត្រូវបានបញ្ជូនត្រឡប់មកវិញទេ",
  "settings.relay.models.title": "ម៉ូដែលរបស់ {{vendor}}",
  "settings.relay.models.empty": "មិនទាន់មានម៉ូដែល។ ទាញយកបញ្ជីបន្ទាប់ពីរក្សាទុកសោ។",
  "settings.relay.models.missing": "លែងមាននៅសេវាដើម",
  "settings.relay.saved": "បានរក្សាទុកដោយស្វ័យប្រវត្តិ",
  "settings.relay.retry": "ព្យាយាមម្តងទៀត",
  "settings.relay.builtin": "មានស្រាប់",
  "settings.relay.delete": "លុបអ្នកផ្តល់សេវា",
  "settings.relay.rollback": "កំណត់សោដែលបាននាំចូលឡើងវិញ",
  "settings.relay.rollback.description": "សម្អាតសោ Relay ដែលបាននាំចូលពី auth.json។ រក្សាទុក auth.json ដើម។",
  "settings.relay.error.KEY_MISSING": "បន្ថែមសោ API ជាមុន",
  "settings.relay.error.KEY_REJECTED": "សោត្រូវបានបដិសេធ",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "មិនអាចទាក់ទងសេវាដើមបានទេ",
  "settings.relay.error.UPSTREAM_TIMEOUT": "សេវាដើមបានអស់ពេលរង់ចាំ",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "សេវាដើមបានកំណត់អត្រាសំណើ",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "សេវាដើមបានបញ្ជូនការឆ្លើយតបមិនត្រឹមត្រូវ",
  "settings.relay.error.REVISION_CONFLICT":
    "ការកំណត់នេះបានផ្លាស់ប្តូរនៅក្នុងបង្អួចផ្សេង។ ផ្ទុកឡើងវិញ ហើយព្យាយាមម្តងទៀត។",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "មិនអាចរក្សាទុកសោ API នៅលើឧបករណ៍នេះបានទេ។",
  "settings.mcp.add": "បន្ថែម MCP",
  "settings.mcp.edit": "កែសម្រួល",
  "settings.mcp.field.name": "ឈ្មោះ",
  "settings.mcp.field.type": "ប្រភេទ",
  "settings.mcp.field.command": "ពាក្យបញ្ជា",
  ...
  "settings.mcp.type.remote": "ពីចម្ងាយ",
  "settings.mcp.error.name": "បញ្ចូលឈ្មោះម៉ាស៊ីនមេ",
  "settings.mcp.error.command": "បញ្ចូលពាក្យបញ្ជា",
  "settings.mcp.error.url": "បញ្ចូល URL",
  ...
  "desktop.menu.documentation": "ឯកសារ Koda",
  ...
  "desktop.menu.ariaLabel": "ម៉ឺនុយ Koda",
  ...
  "desktop.recovery.loadFailed": "Koda បានបរាជ័យក្នុងការផ្ទុក",
  "desktop.recovery.terminated": "បង្អួច Koda ត្រូវបានបញ្ចប់ដោយមិននឹកស្មានដល់",
  "desktop.recovery.unresponsive": "Koda មិនឆ្លើយតបទេ។",
  ...
  "desktop.wsl.error.installOpencode": "ការដំឡើង Koda បានបរាជ័យ",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Koda មិនត្រូវបានដំឡើងនៅក្នុង {{distro}} ទេ។",
  "desktop.wsl.error.updateVersion":
    "ការធ្វើបច្ចុប្បន្នភាព Koda បានបញ្ចប់ ប៉ុន្តែ {{distro}} នៅតែរាយការណ៍ {{installed}}; {{expected}} រំពឹងទុក",
  ...
  "dialog.model.unpaid.freeModels.title": "ម៉ូដែលឥតគិតថ្លៃដែលផ្តល់ដោយ Koda",
  ...
  "provider.connect.apiKey.description":
    "បញ្ចូល {{provider}} API key របស់អ្នក ដើម្បីភ្ជាប់គណនីរបស់អ្នក ហើយប្រើម៉ូដែល {{provider}} នៅក្នុង Koda។",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen ផ្តល់ឱ្យអ្នកនូវម៉ូដែលដែលបានជ្រើសរើស និងកែលម្អសម្រាប់ភ្នាក់ងារសរសេរកូដ។",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "ដើម្បីប្រមូលលេខកូដអនុញ្ញាតរបស់អ្នកដើម្បីភ្ជាប់គណនីរបស់អ្នក និងប្រើម៉ូដែល {{provider}} នៅក្នុង Koda ។",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ហើយបញ្ចូលលេខកូដខាងក្រោមដើម្បីភ្ជាប់គណនីរបស់អ្នក ហើយប្រើម៉ូដែល {{provider}} នៅក្នុង Koda។",
  ...
  "dialog.server.description": "ប្តូរម៉ាស៊ីនមេ Koda ដែលកម្មវិធីនេះភ្ជាប់ទៅ។",
  ...
  "wsl.onboarding.checkingOpencode": "កំពុងពិនិត្យមើលកូដ Koda...",
  "wsl.onboarding.checkingOpencodeIn": "កំពុងពិនិត្យកូដ Koda ក្នុង {{distro}}...",
  "wsl.onboarding.updatingOpencode": "កំពុងអាប់ដេត Koda...",
  "wsl.onboarding.updatingOpencodeIn": "កំពុងអាប់ដេត Koda ក្នុង {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "ធ្វើបច្ចុប្បន្នភាព Koda ក្នុង {{distro}} ។",
  "wsl.onboarding.updateOpencode": "ធ្វើបច្ចុប្បន្នភាព Koda",
  "wsl.onboarding.opencodeReadyIn": "Koda គឺរួចរាល់នៅក្នុង {{distro}} ។",
  "wsl.onboarding.opencodeReady": "Koda គឺរួចរាល់។",
  "wsl.onboarding.installOpencodeIn": "ដំឡើង Koda ក្នុង {{distro}} ។",
  "wsl.onboarding.installOpencode": "ដំឡើង Koda",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda មិនត្រូវបានដំឡើងទេ។",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (ប្រព័ន្ធរងវីនដូសម្រាប់លីនុច) ត្រូវបានទាមទារ មុនពេល Koda អាចបន្ថែមម៉ាស៊ីនមេ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL មិនអាចប្រើបានទេ។",
  "wsl.onboarding.wslUnavailable.description": "Koda មិនអាចផ្ទៀងផ្ទាត់ WSL នៅលើម៉ាស៊ីននេះបានទេ។",
  "wsl.onboarding.installWsl": "ដំឡើង WSL",
  "wsl.onboarding.windowsRestartRequired":
    "ចាប់ផ្ដើម Windows ឡើងវិញ ដើម្បីបញ្ចប់ការដំឡើង WSL បន្ទាប់មកបើក Koda ឡើងវិញ។",
  ...
  "help.tabs.introduction": "Koda Desktop ឥឡូវនេះត្រូវបានបង្កើតឡើងនៅជុំវិញផ្ទាំង។",
  "help.tabs.sessions":
  ...
  "toast.update.description": "កំណែថ្មីនៃ Koda ({{version}}) ឥឡូវនេះមានសម្រាប់ដំឡើងហើយ។",
  ...
  "error.page.report.prefix": "សូមរាយការណ៍ពីកំហុសនេះទៅកាន់ក្រុម Koda",
  ...
  "error.chain.mcpFailed": 'ម៉ាស៊ីនមេ MCP "{{name}}" បានបរាជ័យ។ ចំណាំ Koda មិនគាំទ្រការផ្ទៀងផ្ទាត់ MCP នៅឡើយទេ។',
  ...
  "sidebar.gettingStarted.line1": "Koda រួមបញ្ចូលម៉ូដែលឥតគិតថ្លៃ ដូច្នេះអ្នកអាចចាប់ផ្តើមភ្លាមៗ។",
  ...
  "settings.desktop.wsl.description": "ដំណើរការម៉ាស៊ីនមេ Koda នៅខាងក្នុង WSL នៅលើ Windows ។",
  ...
  "settings.general.row.language.description": "ប្តូរភាសាបង្ហាញសម្រាប់ Koda",
  ...
  "settings.general.row.appearance.description": "ប្ដូរតាមបំណងពីរបៀបដែល Koda មើលទៅលើឧបករណ៍របស់អ្នក។",
  "settings.general.row.colorScheme.title": "ពណ៌ចម្រុះ",
  "settings.general.row.colorScheme.description": "ជ្រើសរើសថាតើ Koda ធ្វើតាមប្រព័ន្ធ ពន្លឺ ឬរូបរាងងងឹត",
  "settings.general.row.theme.title": "ស្បែក",
  "settings.general.row.theme.description": "ប្ដូរតាមបំណងពីរបៀបដែល Koda មានប្រធានបទ។",
  ...
  "settings.updates.row.startup.description": "ពិនិត្យមើលការអាប់ដេតដោយស្វ័យប្រវត្តិនៅពេលដែល Koda ចាប់ផ្តើម",
  ...
  "settings.updates.toast.latest.description": "អ្នកកំពុងដំណើរការកំណែចុងក្រោយបំផុតនៃ Koda ។",
