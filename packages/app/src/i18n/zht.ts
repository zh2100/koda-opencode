...
export const dict = {
  "desktop.menu.about": "關於 Koda",
  "desktop.about.title": "Koda Desktop v{{version}}",
  "desktop.about.detail": "以 OpenCode 為核心修改\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "Koda v{{version}} 已推出。要開啟發行頁面以升級嗎？",
  "desktop.koda.update.open": "開啟發行頁面",
  "command.project.create": "新增專案",
  "command.project.openExisting": "開啟現有專案",
  "prompt.toast.projectRequired.title": "選擇專案",
  "prompt.toast.projectRequired.description": "傳送前請先建立或開啟專案。",
  "prompt.approval.ask": "要求核准",
  "prompt.approval.auto": "代我核准",
  "prompt.approval.plan": "完整存取權限",
  "prompt.more": "更多",
  "dialog.project.create.title": "新增專案",
  "dialog.project.create.name": "名稱",
  "dialog.project.create.location": "位置",
  "dialog.project.create.browse": "瀏覽",
  "dialog.project.create.path": "路徑",
  "dialog.project.create.submit": "建立",
  "dialog.project.create.error.name": "請輸入專案名稱",
  "dialog.project.create.error.invalid": "此名稱無法用作資料夾名稱",
  "dialog.project.create.error.exists": "此資料夾已存在。請開啟現有資料夾，或選擇其他名稱。",
  "dialog.project.create.error.failed": "無法建立資料夾",
  "mcp.status.needs_client_registration": "需要註冊用戶端",
  "home.welcome.title": "有什麼可以幫忙的嗎？",
  "home.project.create": "新增專案",
  "home.project.open": "開啟現有專案",
  "session.todo.empty": "尚無任務",
  "session.panel.files": "檔案",
  "session.panel.changes": "變更",
  "session.panel.tasks": "任務",
  "session.panel.terminal": "終端機",
  "session.panel.empty": "選擇專案以瀏覽檔案、變更、任務及終端機。",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "無變更",
  "session.panel.git.dirty.one": "{{count}} 個已變更的檔案",
  "session.panel.git.dirty.other": "{{count}} 個已變更的檔案",
  "session.task.waiting": "等待授權",
  "session.task.failed": "失敗",
  "session.task.retry": "重試",
  "session.task.open": "在獨立工作階段中開啟",
  "settings.skills.title": "技能",
  "settings.skills.description": "在此專案中找到的技能。",
  "settings.skills.empty": "找不到技能",
  "settings.skills.enabled": "允許模型使用",
  "settings.skills.disabled": "禁止模型使用",
  "settings.skills.search": "搜尋技能",
  "settings.skills.emptySearch": "沒有符合搜尋條件的技能",
  "settings.skills.details": "技能詳細資訊",
  "settings.skills.noDescription": "無說明",
  "settings.skills.source.project": "專案",
  "settings.skills.source.global": "使用者",
  "settings.skills.source.builtin": "內建",
  "settings.skills.source.custom": "已新增",
  "settings.scheduled.title": "排程任務",
  "settings.scheduled.description": "在專案中執行一次提示詞，或每天執行。",
  "settings.scheduled.empty": "尚無排程任務",
  "settings.scheduled.once": "一次",
  "settings.scheduled.daily": "每天",
  "settings.scheduled.add": "新增任務",
  "settings.scheduled.field.name": "名稱",
  "settings.scheduled.field.prompt": "提示詞",
  "settings.scheduled.field.schedule": "排程",
  "settings.scheduled.field.time": "執行時間",
  "settings.scheduled.error.name": "請輸入名稱",
  "settings.scheduled.error.prompt": "請輸入提示詞",
  "settings.scheduled.error.time": "請選擇時間",
  "settings.scheduled.error.model": "請先選擇模型",
  "session.new.project.open": "開啟現有專案",
  "settings.relay.title": "智联AI 金鑰",
  "settings.relay.getKey": "取得 API 金鑰",
  "settings.relay.getKey.description": "為 ChatGPT、Grok 及其他提供者建立各自的金鑰。",
  "settings.relay.upstream": "上游服務",
  "settings.relay.unified": "使用共用 API 金鑰",
  "settings.relay.unified.description": "啟用後，所有廠商都會使用此金鑰。",
  "settings.relay.unified.key": "共用 API 金鑰",
  "settings.relay.unified.using": "正在使用共用金鑰",
  "settings.relay.key.set": "金鑰已儲存",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "留白以保留已儲存的金鑰",
  "settings.relay.test": "測試連線",
  "settings.relay.testing": "測試中...",
  "settings.relay.fetch": "取得模型",
  "settings.relay.fetching": "取得中...",
  "settings.relay.edit": "編輯",
  "settings.relay.clearKey": "清除金鑰",
  "settings.relay.add": "新增廠商",
  "settings.relay.add.name": "廠商名稱",
  "settings.relay.models.visible": "{{count}} 個可見模型",
  "settings.relay.connected": "已連線 · {{count}} 個模型",
  "settings.relay.connectedEmpty": "已連線，但未傳回任何模型",
  "settings.relay.test.ok": "連線成功",
  "settings.relay.test.empty": "已連線，但未傳回任何模型",
  "settings.relay.models.title": "{{vendor}} 的模型",
  "settings.relay.models.empty": "尚無模型。儲存金鑰後請取得清單。",
  "settings.relay.models.missing": "上游已不再提供",
  "settings.relay.saved": "已自動儲存",
  "settings.relay.retry": "重試",
  "settings.relay.builtin": "內建",
  "settings.relay.delete": "刪除廠商",
  "settings.relay.rollback": "重設匯入的金鑰",
  "settings.relay.rollback.description": "清除從 auth.json 匯入的 Relay 金鑰。原始 auth.json 會保留。",
  "settings.relay.error.KEY_MISSING": "請先新增 API 金鑰",
  "settings.relay.error.KEY_REJECTED": "金鑰遭到拒絕",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "無法連線至上游服務",
  "settings.relay.error.UPSTREAM_TIMEOUT": "上游服務連線逾時",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "上游服務限制了請求頻率",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "上游服務傳回無效的回應",
  "settings.relay.error.REVISION_CONFLICT": "此設定已在其他視窗變更。請重新整理後再試一次。",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "無法在此裝置儲存 API 金鑰。",
  "settings.mcp.add": "新增 MCP",
  "settings.mcp.edit": "編輯",
  "settings.mcp.field.name": "名稱",
  "settings.mcp.field.type": "類型",
  ...
  "settings.mcp.error.name": "請輸入伺服器名稱",
  "settings.mcp.error.command": "請輸入命令",
  "settings.mcp.error.url": "請輸入 URL",
  ...
  "desktop.recovery.loadFailed": "Koda 載入失敗",
  "desktop.recovery.terminated": "Koda 視窗意外終止",
  "desktop.recovery.unresponsive": "Koda 沒有回應",
  ...
  "desktop.wsl.error.installOpencode": "Koda 安裝失敗",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安裝 Koda",
  "desktop.wsl.error.updateVersion":
    "Koda 更新完成，但 {{distro}} 回報的版本仍為 {{installed}}；預期版本為 {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Koda 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 Koda 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "Koda Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 Koda 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 並輸入以下程式碼，以連線你的帳戶並在 Koda 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切換此應用程式連線的 Koda 伺服器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在檢查 Koda...",
  "wsl.onboarding.checkingOpencodeIn": "正在檢查 {{distro}} 中的 Koda...",
  "wsl.onboarding.updatingOpencode": "正在更新 Koda...",
  "wsl.onboarding.updatingOpencodeIn": "正在更新 {{distro}} 中的 Koda...",
  "wsl.onboarding.updateOpencodeIn": "更新 {{distro}} 中的 Koda。",
  "wsl.onboarding.updateOpencode": "更新 Koda",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 Koda 已就緒。",
  "wsl.onboarding.opencodeReady": "Koda 已就緒。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安裝 Koda。",
  "wsl.onboarding.installOpencode": "安裝 Koda",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安裝 Koda",
  ...
  "wsl.onboarding.wslUnavailable.description": "Koda 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 Koda。",
  ...
  "help.tabs.introduction": "Koda Desktop 現在以分頁為核心。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Koda 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 Koda 團隊",
  ...
  "error.chain.mcpFailed": "MCP 伺服器「{{name}}」啟動失敗。注意：Koda 尚不支援 MCP 驗證。",
  ...
  "home.sessions.search.title": "搜尋聊天",
  "home.sessions.search.placeholder": "搜尋聊天",
  "home.sessions.search.placeholder.scoped": "在 {{scope}} 中搜尋聊天",
  "home.sessions.search.sessions": "聊天",
  ...
  "sidebar.gettingStarted.line1": "Koda 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 Koda 伺服器。",
  ...
  "settings.general.row.language.description": "變更 Koda 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 Koda 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 Koda 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 Koda 的主題。",
  ...
  "settings.updates.row.startup.description": "在 Koda 啟動時自動檢查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Koda。",
