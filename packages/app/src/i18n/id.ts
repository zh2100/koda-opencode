export const dict = {
  "desktop.menu.about": "Tentang Koda",
  "desktop.about.title": "Koda Desktop v{{version}}",
  "desktop.about.detail":
    "Dimodifikasi dengan OpenCode sebagai inti\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "Koda v{{version}} tersedia. Buka halaman rilis untuk memperbarui?",
  "desktop.koda.update.open": "Buka halaman rilis",
  "command.project.create": "Proyek baru",
  "command.project.openExisting": "Buka proyek yang ada",
  "prompt.toast.projectRequired.title": "Pilih proyek",
  "prompt.toast.projectRequired.description": "Buat atau buka proyek sebelum mengirim.",
  "prompt.approval.ask": "Minta persetujuan",
  "prompt.approval.auto": "Setujui untuk saya",
  "prompt.approval.plan": "Akses penuh",
  "prompt.more": "Lainnya",
  "dialog.project.create.title": "Proyek baru",
  "dialog.project.create.name": "Nama",
  "dialog.project.create.location": "Lokasi",
  "dialog.project.create.browse": "Telusuri",
  "dialog.project.create.path": "Jalur",
  "dialog.project.create.submit": "Buat",
  "dialog.project.create.error.name": "Masukkan nama proyek",
  "dialog.project.create.error.invalid": "Nama ini tidak dapat digunakan untuk folder",
  "dialog.project.create.error.exists": "Folder itu sudah ada. Buka folder tersebut atau pilih nama lain.",
  "dialog.project.create.error.failed": "Tidak dapat membuat folder",
  "mcp.status.needs_client_registration": "perlu pendaftaran klien",
  "home.welcome.title": "Apa yang bisa saya bantu?",
  "home.project.create": "Proyek baru",
  "home.project.open": "Buka proyek yang ada",
  "home.sessions.search.title": "Cari percakapan",
  "session.todo.empty": "Belum ada tugas",
  "session.panel.files": "Berkas",
  "session.panel.changes": "Perubahan",
  "session.panel.tasks": "Tugas",
  "session.panel.terminal": "Terminal",
  "session.panel.empty": "Pilih proyek untuk menelusuri berkas, perubahan, tugas, dan terminal.",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "Tanpa perubahan",
  "session.panel.git.dirty.one": "{{count}} berkas berubah",
  "session.panel.git.dirty.other": "{{count}} berkas berubah",
  "session.task.waiting": "Menunggu izin",
  "session.task.failed": "Gagal",
  "session.task.retry": "Coba lagi",
  "session.task.open": "Buka dalam sesi tersendiri",
  "settings.skills.title": "Keterampilan",
  "settings.skills.description": "Keterampilan yang ditemukan untuk proyek ini.",
  "settings.skills.empty": "Tidak ada keterampilan ditemukan",
  "settings.skills.enabled": "Dapat digunakan oleh model",
  "settings.skills.disabled": "Tidak diizinkan untuk model",
  "settings.skills.search": "Cari keterampilan",
  "settings.skills.emptySearch": "Tidak ada keterampilan yang cocok dengan pencarian ini",
  "settings.skills.details": "Detail keterampilan",
  "settings.skills.noDescription": "Tanpa deskripsi",
  "settings.skills.source.project": "Proyek",
  "settings.skills.source.global": "Pengguna",
  "settings.skills.source.builtin": "Bawaan",
  "settings.skills.source.custom": "Ditambahkan",
  "settings.scheduled.title": "Tugas terjadwal",
  "settings.scheduled.description": "Jalankan prompt sekali atau setiap hari dalam proyek.",
  "settings.scheduled.empty": "Tidak ada tugas terjadwal",
  "settings.scheduled.once": "Sekali",
  "settings.scheduled.daily": "Setiap hari",
  "settings.scheduled.add": "Tambah tugas",
  "settings.scheduled.field.name": "Nama",
  "settings.scheduled.field.prompt": "Prompt",
  "settings.scheduled.field.schedule": "Jadwal",
  "settings.scheduled.field.time": "Jalankan pada",
  "settings.scheduled.error.name": "Masukkan nama",
  "settings.scheduled.error.prompt": "Masukkan prompt",
  "settings.scheduled.error.time": "Pilih waktu",
  "settings.scheduled.error.model": "Pilih model terlebih dahulu",
  "session.new.project.open": "Buka proyek yang ada",
  "common.pin": "Sematkan",
  "common.unpin": "Lepas sematan",
  "settings.relay.title": "Kunci 智联AI",
  "settings.relay.getKey": "Dapatkan kunci API",
  "settings.relay.getKey.description": "Buat kunci terpisah untuk ChatGPT, Grok, dan penyedia lainnya.",
  "settings.relay.upstream": "Layanan hulu",
  "settings.relay.unified": "Gunakan kunci API bersama",
  "settings.relay.unified.description": "Jika diaktifkan, semua vendor menggunakan kunci ini.",
  ...
  "settings.relay.key.keep": "Biarkan kosong untuk mempertahankan kunci tersimpan",
  "settings.relay.test": "Uji koneksi",
  "settings.relay.testing": "Menguji...",
  "settings.relay.fetch": "Ambil model",
  "settings.relay.fetching": "Mengambil...",
  "settings.relay.edit": "Edit",
  "settings.relay.clearKey": "Hapus kunci",
  "settings.relay.add": "Tambah vendor",
  "settings.relay.add.name": "Nama vendor",
  "settings.relay.models.visible": "{{count}} model terlihat",
  "settings.relay.connected": "Terhubung · {{count}} model",
  "settings.relay.connectedEmpty": "Terhubung, tetapi tidak ada model yang dikembalikan",
  "settings.relay.test.ok": "Koneksi berhasil",
  "settings.relay.test.empty": "Terhubung, tetapi tidak ada model yang dikembalikan",
  "settings.relay.models.title": "Model {{vendor}}",
  "settings.relay.models.empty": "Belum ada model. Ambil daftar setelah menyimpan kunci.",
  "settings.relay.models.missing": "Tidak lagi tersedia di layanan hulu",
  "settings.relay.saved": "Disimpan secara otomatis",
  "settings.relay.retry": "Coba lagi",
  "settings.relay.builtin": "Bawaan",
  "settings.relay.delete": "Hapus vendor",
  "settings.relay.rollback": "Atur ulang kunci yang diimpor",
  "settings.relay.rollback.description":
    "Menghapus kunci Relay yang diimpor dari auth.json. auth.json asli tetap disimpan.",
  "settings.relay.error.KEY_MISSING": "Tambahkan kunci API terlebih dahulu",
  "settings.relay.error.KEY_REJECTED": "Kunci ditolak",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "Layanan hulu tidak dapat dijangkau",
  "settings.relay.error.UPSTREAM_TIMEOUT": "Waktu tunggu layanan hulu habis",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "Layanan hulu membatasi laju permintaan",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "Layanan hulu mengembalikan respons yang tidak valid",
  "settings.relay.error.REVISION_CONFLICT": "Pengaturan ini berubah di jendela lain. Muat ulang dan coba lagi.",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "Tidak dapat menyimpan kunci API di perangkat ini.",
  "settings.mcp.add": "Tambah MCP",
  "settings.mcp.edit": "Edit",
  "settings.mcp.field.name": "Nama",
  "settings.mcp.field.type": "Jenis",
  "settings.mcp.field.command": "Perintah",
  ...
  "settings.mcp.error.name": "Masukkan nama server",
  "settings.mcp.error.command": "Masukkan perintah",
  ...
  "desktop.recovery.loadFailed": "Koda gagal dimuat",
  "desktop.recovery.terminated": "Jendela Koda berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "Koda tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi Koda gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Koda belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan Koda selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh Koda",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di Koda.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen memberi Anda akses ke serangkaian model andal yang dioptimalkan untuk agen pengodean.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di Koda.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di Koda.",
  ...
  "dialog.server.description": "Ganti server Koda mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa Koda...",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa Koda di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui Koda...",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui Koda di {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Perbarui Koda di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui Koda",
  "wsl.onboarding.opencodeReadyIn": "Koda siap di {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koda siap.",
  "wsl.onboarding.installOpencodeIn": "Instal Koda di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal Koda",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Koda dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Koda tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali Koda.",
  ...
  "help.tabs.introduction": "Koda Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru Koda ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim Koda",
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: Koda belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "Koda menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server Koda di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk Koda",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan Koda di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah Koda mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat Koda diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru Koda.",
