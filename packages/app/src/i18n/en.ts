...
export const dict = {
  ...
  "command.project.openExisting": "Open existing project",
  ...
  "dialog.provider.empty": "No providers configured. Add a provider in opencode.json.",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Koda",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Koda.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "Koda Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Koda.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Koda.",
  ...
  "prompt.toast.projectRequired.title": "Choose a project",
  "prompt.toast.projectRequired.description": "Create or open a project before sending.",
  "prompt.approval.ask": "Request approval",
  "prompt.approval.auto": "Approve for me",
  "prompt.approval.plan": "Full access",
  "prompt.more": "More",
  ...
  "dialog.project.create.path": "Path",
  "dialog.project.create.submit": "Create",
  "dialog.project.create.error.name": "Enter a project name",
  "dialog.project.create.error.invalid": "This name cannot be used as a folder",
  "dialog.project.create.error.exists": "That folder already exists. Open it instead, or choose another name.",
  "dialog.project.create.error.failed": "Could not create the folder",
  ...
  "dialog.server.description": "Switch which Koda server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Koda...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Koda in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Koda...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Koda in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Koda in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Koda",
  "wsl.onboarding.opencodeReadyIn": "Koda is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koda is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Koda in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Koda",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Koda can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Koda could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Koda.",
  ...
  "help.tabs.introduction": "Koda Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of Koda ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Koda team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Koda does not support MCP authentication yet.',
  ...
  "home.welcome.title": "What can I help with?",
  "home.title": "Home",
  "home.projects": "Projects",
  "home.project.add": "Add project",
  "home.project.create": "New project",
  "home.project.open": "Open existing project",
  ...
  "home.sessions.search.title": "Search chats",
  ...
  "session.todo.empty": "No tasks yet",
  "session.panel.files": "Files",
  "session.panel.changes": "Changes",
  "session.panel.tasks": "Tasks",
  "session.panel.terminal": "Terminal",
  "session.panel.empty": "Select a project to browse files, changes, tasks, and the terminal.",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "Clean",
  "session.panel.git.dirty.one": "{{count}} changed file",
  "session.panel.git.dirty.other": "{{count}} changed files",
  "session.task.waiting": "Waiting for permission",
  "session.task.failed": "Failed",
  "session.task.retry": "Retry",
  "session.task.open": "Open in its own session",
  "settings.skills.title": "Skills",
  "settings.skills.description": "Skills discovered for this project.",
  "settings.skills.empty": "No skills found",
  "settings.skills.enabled": "Available to the model",
  "settings.skills.disabled": "Denied for the model",
  "settings.skills.search": "Search skills",
  "settings.skills.emptySearch": "No skills match this search",
  "settings.skills.details": "Skill details",
  "settings.skills.noDescription": "No description",
  "settings.skills.source.project": "Project",
  "settings.skills.source.global": "User",
  "settings.skills.source.builtin": "Built-in",
  "settings.skills.source.custom": "Added",
  "settings.scheduled.title": "Scheduled tasks",
  "settings.scheduled.description": "Run a prompt once or every day in a project.",
  "settings.scheduled.empty": "No scheduled tasks",
  "settings.scheduled.once": "Once",
  "settings.scheduled.daily": "Every day",
  "settings.scheduled.add": "Add task",
  "settings.scheduled.field.name": "Name",
  "settings.scheduled.field.prompt": "Prompt",
  "settings.scheduled.field.schedule": "Schedule",
  "settings.scheduled.field.time": "Run at",
  "settings.scheduled.error.name": "Enter a name",
  "settings.scheduled.error.prompt": "Enter a prompt",
  "settings.scheduled.error.time": "Choose a time",
  "settings.scheduled.error.model": "Select a model first",
  ...
  "session.new.project.open": "Open existing project",
  ...
  "sidebar.gettingStarted.line1": "Koda includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Koda server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Koda",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Koda looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Koda follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Koda is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Koda launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Koda.",
  ...
  "settings.relay.title": "智联AI keys",
  "settings.relay.getKey": "Get API key",
  "settings.relay.getKey.description": "Create separate keys for ChatGPT, Grok, and other providers.",
  "settings.relay.upstream": "Upstream",
  "settings.relay.unified": "Use a shared API key",
  "settings.relay.unified.description": "When enabled, every vendor uses this key.",
  "settings.relay.unified.key": "Shared API key",
  "settings.relay.unified.using": "Using the shared key",
  "settings.relay.key.set": "Key saved",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "Leave blank to keep the saved key",
  "settings.relay.test": "Test connection",
  "settings.relay.testing": "Testing...",
  "settings.relay.fetch": "Get models",
  "settings.relay.fetching": "Fetching...",
  "settings.relay.edit": "Edit",
  "settings.relay.clearKey": "Clear key",
  "settings.relay.add": "Add vendor",
  "settings.relay.add.name": "Vendor name",
  "settings.relay.models.visible": "{{count}} visible models",
  "settings.relay.connected": "Connected · {{count}} models",
  "settings.relay.connectedEmpty": "Connected, but no models were returned",
  "settings.relay.test.ok": "Connection succeeded",
  "settings.relay.test.empty": "Connected, but no models were returned",
  "settings.relay.models.title": "{{vendor}} models",
  "settings.relay.models.empty": "No models yet. Fetch the list after saving a key.",
  "settings.relay.models.missing": "No longer on the upstream",
  "settings.relay.saved": "Saved automatically",
  "settings.relay.retry": "Retry",
  "settings.relay.builtin": "Built-in",
  "settings.relay.delete": "Delete vendor",
  "settings.relay.rollback": "Reset imported keys",
  "settings.relay.rollback.description": "Clears Relay keys imported from auth.json. The original auth.json is kept.",
  "settings.relay.error.KEY_MISSING": "Add an API key first",
  "settings.relay.error.KEY_REJECTED": "The key was rejected",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "The upstream is unreachable",
  "settings.relay.error.UPSTREAM_TIMEOUT": "The upstream timed out",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "The upstream rate-limited the request",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "The upstream returned an invalid response",
  "settings.relay.error.REVISION_CONFLICT": "This setting changed in another window. Refresh and try again.",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "Could not save the API key on this device.",
  ...
  "settings.mcp.description": "Connect, authenticate, and edit MCP servers for this project.",
  ...
  "settings.mcp.error.name": "Enter a server name",
  "settings.mcp.error.command": "Enter a command",
  "settings.mcp.error.url": "Enter a URL",
