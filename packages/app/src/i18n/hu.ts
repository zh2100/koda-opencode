...
const desktop = [
  ...
  "A Koda névjegye",
  "Koda Desktop v{{version}}",
  "Az OpenCode alapjaira épülő módosított változat\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "Elérhető a Koda v{{version}}. Megnyitja a kiadás oldalát a frissítéshez?",
  "Kiadás oldalának megnyitása",
  "Hiba jelentése",
  "Koda menü",
  ...
  "Kilépés",
  "Az Koda betöltése sikertelen",
  "Az Koda ablaka váratlanul leállt",
  "Az Koda nem válaszol",
  ...
  "Az Koda nincs telepítve ebben: {{distro}}",
  "Az Koda frissítése befejeződött, de a(z) {{distro}} továbbra is ezt jelenti: {{installed}}; a várt érték: {{expected}}",
  "nincs verzió",
...
export const dict = {
  "command.project.create": "Új projekt",
  "command.project.openExisting": "Meglévő projekt megnyitása",
  "prompt.toast.projectRequired.title": "Válasszon projektet",
  "prompt.toast.projectRequired.description": "Küldés előtt hozzon létre vagy nyisson meg egy projektet.",
  "prompt.approval.ask": "Jóváhagyás kérése",
  "prompt.approval.auto": "Jóváhagyás helyettem",
  "prompt.approval.plan": "Teljes hozzáférés",
  "prompt.more": "Továbbiak",
  "dialog.project.create.title": "Új projekt",
  "dialog.project.create.name": "Név",
  "dialog.project.create.location": "Hely",
  "dialog.project.create.browse": "Tallózás",
  "dialog.project.create.path": "Elérési út",
  "dialog.project.create.submit": "Létrehozás",
  "dialog.project.create.error.name": "Adja meg a projekt nevét",
  "dialog.project.create.error.invalid": "Ez a név nem használható mappanévként",
  "dialog.project.create.error.exists": "Ez a mappa már létezik. Nyissa meg, vagy válasszon másik nevet.",
  "dialog.project.create.error.failed": "Nem sikerült létrehozni a mappát",
  "mcp.status.needs_client_registration": "ügyfélregisztráció szükséges",
  "home.welcome.title": "Miben segíthetek?",
  "home.project.create": "Új projekt",
  "home.project.open": "Meglévő projekt megnyitása",
  "home.sessions.search.title": "Beszélgetések keresése",
  "session.todo.empty": "Még nincsenek feladatok",
  "session.panel.files": "Fájlok",
  "session.panel.changes": "Változások",
  "session.panel.tasks": "Feladatok",
  "session.panel.terminal": "Terminál",
  "session.panel.empty": "Válasszon projektet a fájlok, változások, feladatok és a terminál megtekintéséhez.",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "Nincs változás",
  "session.panel.git.dirty.one": "{{count}} módosított fájl",
  "session.panel.git.dirty.other": "{{count}} módosított fájl",
  "session.task.waiting": "Várakozás engedélyre",
  "session.task.failed": "Sikertelen",
  "session.task.retry": "Újrapróbálkozás",
  "session.task.open": "Megnyitás külön munkamenetben",
  "settings.skills.title": "Készségek",
  "settings.skills.description": "A projekthez talált készségek.",
  "settings.skills.empty": "Nem találhatók készségek",
  "settings.skills.enabled": "A modell számára elérhető",
  "settings.skills.disabled": "A modell számára tiltott",
  "settings.skills.search": "Készségek keresése",
  "settings.skills.emptySearch": "Nincs a keresésnek megfelelő készség",
  "settings.skills.details": "Készség részletei",
  "settings.skills.noDescription": "Nincs leírás",
  "settings.skills.source.project": "Projekt",
  "settings.skills.source.global": "Felhasználó",
  "settings.skills.source.builtin": "Beépített",
  "settings.skills.source.custom": "Hozzáadott",
  "settings.scheduled.title": "Ütemezett feladatok",
  "settings.scheduled.description": "Futtasson egy utasítást a projektben egyszer vagy naponta.",
  "settings.scheduled.empty": "Nincsenek ütemezett feladatok",
  "settings.scheduled.once": "Egyszer",
  "settings.scheduled.daily": "Naponta",
  "settings.scheduled.add": "Feladat hozzáadása",
  "settings.scheduled.field.name": "Név",
  "settings.scheduled.field.prompt": "Utasítás",
  "settings.scheduled.field.schedule": "Ütemezés",
  "settings.scheduled.field.time": "Futtatás időpontja",
  "settings.scheduled.error.name": "Adjon meg egy nevet",
  "settings.scheduled.error.prompt": "Adjon meg egy utasítást",
  "settings.scheduled.error.time": "Válasszon időpontot",
  "settings.scheduled.error.model": "Először válasszon modellt",
  "session.new.project.open": "Meglévő projekt megnyitása",
  "common.pin": "Rögzítés",
  "common.unpin": "Rögzítés feloldása",
  "settings.relay.title": "智联AI-kulcsok",
  "settings.relay.getKey": "API-kulcs beszerzése",
  "settings.relay.getKey.description": "Hozzon létre külön kulcsokat a ChatGPT, a Grok és más szolgáltatók számára.",
  "settings.relay.upstream": "Szolgáltatói kiszolgáló",
  "settings.relay.unified": "Közös API-kulcs használata",
  "settings.relay.unified.description": "Bekapcsolva minden szolgáltató ezt a kulcsot használja.",
  "settings.relay.unified.key": "Közös API-kulcs",
  "settings.relay.unified.using": "Közös kulcs használatban",
  "settings.relay.key.set": "Kulcs mentve",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "Hagyja üresen a mentett kulcs megtartásához",
  "settings.relay.test": "Kapcsolat tesztelése",
  "settings.relay.testing": "Tesztelés...",
  "settings.relay.fetch": "Modellek lekérése",
  "settings.relay.fetching": "Lekérés...",
  "settings.relay.edit": "Szerkesztés",
  "settings.relay.clearKey": "Kulcs törlése",
  "settings.relay.add": "Szolgáltató hozzáadása",
  "settings.relay.add.name": "Szolgáltató neve",
  "settings.relay.models.visible": "{{count}} látható modell",
  "settings.relay.connected": "Csatlakoztatva · {{count}} modell",
  "settings.relay.connectedEmpty": "Csatlakoztatva, de nem érkezett modell",
  "settings.relay.test.ok": "Sikeres kapcsolódás",
  "settings.relay.test.empty": "Csatlakoztatva, de nem érkezett modell",
  "settings.relay.models.title": "{{vendor}} modelljei",
  "settings.relay.models.empty": "Még nincsenek modellek. A kulcs mentése után kérje le a listát.",
  "settings.relay.models.missing": "Már nincs a szolgáltatói kiszolgálón",
  "settings.relay.saved": "Automatikusan mentve",
  "settings.relay.retry": "Újrapróbálkozás",
  "settings.relay.builtin": "Beépített",
  "settings.relay.delete": "Szolgáltató törlése",
  "settings.relay.rollback": "Importált kulcsok alaphelyzetbe állítása",
  "settings.relay.rollback.description":
    "Törli az auth.json fájlból importált Relay-kulcsokat. Az eredeti auth.json megmarad.",
  "settings.relay.error.KEY_MISSING": "Először adjon hozzá egy API-kulcsot",
  "settings.relay.error.KEY_REJECTED": "A kulcsot elutasították",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "A szolgáltatói kiszolgáló nem érhető el",
  "settings.relay.error.UPSTREAM_TIMEOUT": "A szolgáltatói kiszolgáló túllépte az időkorlátot",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "A szolgáltatói kiszolgáló korlátozta a kérések gyakoriságát",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "A szolgáltatói kiszolgáló érvénytelen választ adott",
  "settings.relay.error.REVISION_CONFLICT":
    "Ez a beállítás egy másik ablakban megváltozott. Frissítsen, majd próbálja újra.",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "Nem sikerült menteni az API-kulcsot ezen az eszközön.",
  "settings.mcp.add": "MCP hozzáadása",
  "settings.mcp.edit": "Szerkesztés",
  "settings.mcp.field.name": "Név",
  "settings.mcp.field.type": "Típus",
  "settings.mcp.field.command": "Parancs",
  ...
  "settings.mcp.error.name": "Adja meg a kiszolgáló nevét",
  "settings.mcp.error.command": "Adjon meg egy parancsot",
  "settings.mcp.error.url": "Adjon meg egy URL-t",
  ...
  "dialog.model.unpaid.freeModels.title": "A Koda ingyenes modelljei",
  ...
  "provider.connect.apiKey.description":
    "Enter az Ön {{provider}} API kulcsa fiókja összekapcsolásához és a {{provider}} modellek használatához a Koda-ben.",
  ...
  "provider.connect.opencodeZen.line1":
    "A Koda Zen hozzáférést biztosít a kódoló ügynökök számára megbízható, optimalizált modellek válogatott készletéhez.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "az engedélyezési kód összegyűjtéséhez fiókja összekapcsolásához és a {{provider}} modellek használatához a Koda-ben.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "és írja be az alábbi kódot fiókja összekapcsolásához, és használja a {{provider}} modelleket a Koda-ben.",
  ...
  "dialog.server.description": "Állítsa be, hogy ez az alkalmazás melyik Koda szerverhez csatlakozzon.",
  ...
  "wsl.onboarding.checkingOpencode": "Koda ellenőrzése...",
  "wsl.onboarding.checkingOpencodeIn": "Koda ellenőrzése a {{distro}}-ben...",
  "wsl.onboarding.updatingOpencode": "Koda frissítése...",
  "wsl.onboarding.updatingOpencodeIn": "Koda frissítése a {{distro}}-ben...",
  "wsl.onboarding.updateOpencodeIn": "Frissítse a Koda-t a {{distro}}-ben.",
  "wsl.onboarding.updateOpencode": "Frissítse a Koda-t",
  "wsl.onboarding.opencodeReadyIn": "A Koda készen áll a {{distro}}-ben.",
  "wsl.onboarding.opencodeReady": "A Koda készen áll.",
  "wsl.onboarding.installOpencodeIn": "Telepítse a Koda-t a {{distro}}-be.",
  "wsl.onboarding.installOpencode": "Telepítse a Koda-t",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "A Koda nincs telepítve",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "A WSL (Windows alrendszer a Linux számára) szükséges ahhoz, hogy a Koda hozzáadhasson egy WSL szervert",
  "wsl.onboarding.wslUnavailable.title": "A WSL nem elérhető",
  "wsl.onboarding.wslUnavailable.description": "A Koda nem tudta ellenőrizni a WSL jelet ezen a gépen.",
  "wsl.onboarding.installWsl": "Telepítse a WSL-t",
  "wsl.onboarding.windowsRestartRequired":
    "Indítsa újra a Windows programot a WSL telepítésének befejezéséhez, majd nyissa meg újra a Koda programot.",
  ...
  "help.tabs.introduction": "A Koda Desktop mostantól lapokra épül.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A Koda ({{version}}) új verziója már telepíthető.",
  ...
  "error.page.report.prefix": "Kérjük, jelentse ezt a hibát a Koda csapatának",
  ...
  "error.chain.mcpFailed":
    'A "{{name}}" MCP szerver meghibásodott. Megjegyzés: a Koda még nem támogatja a MCP hitelesítést.',
  ...
  "sidebar.gettingStarted.line1": "A Koda ingyenes modelleket tartalmaz, így azonnal elkezdheti.",
  ...
  "app.name.desktop": "Koda asztali számítógép",
  ...
  "settings.desktop.wsl.description": "Futtassa a Koda szervert a WSL belsejében a Windows rendszeren.",
  ...
  "settings.general.row.language.description": "Módosítsa a Koda kijelző nyelvét",
  ...
  "settings.general.row.appearance.description": "Szabja személyre, hogyan néz ki a Koda az eszközén",
  "settings.general.row.colorScheme.title": "Színséma",
  "settings.general.row.colorScheme.description":
    "Válassza ki, hogy a Koda a rendszer, a világos vagy a sötét témát követi-e",
  "settings.general.row.theme.title": "Téma",
  "settings.general.row.theme.description": "Szabja személyre a Koda témáját.",
  ...
  "settings.updates.row.startup.description": "A Koda indításakor automatikusan ellenőrizze a frissítéseket",
  ...
  "settings.updates.toast.latest.description": "Ön a Koda legújabb verzióját futtatja.",
