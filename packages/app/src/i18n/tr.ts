...
export const dict = {
  "desktop.menu.about": "Koda hakkında",
  "desktop.about.title": "Koda Desktop v{{version}}",
  "desktop.about.detail":
    "OpenCode temel alınarak değiştirilmiştir\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "Koda v{{version}} kullanılabilir. Yükseltmek için sürüm sayfası açılsın mı?",
  "desktop.koda.update.open": "Sürüm sayfasını aç",
  "command.project.create": "Yeni proje",
  "command.project.openExisting": "Mevcut projeyi aç",
  "prompt.toast.projectRequired.title": "Bir proje seçin",
  "prompt.toast.projectRequired.description": "Göndermeden önce bir proje oluşturun veya açın.",
  "prompt.approval.ask": "Onay iste",
  "prompt.approval.auto": "Benim yerime onayla",
  "prompt.approval.plan": "Tam erişim",
  "prompt.more": "Daha fazla",
  "dialog.project.create.title": "Yeni proje",
  "dialog.project.create.name": "Ad",
  "dialog.project.create.location": "Konum",
  "dialog.project.create.browse": "Göz at",
  "dialog.project.create.path": "Yol",
  "dialog.project.create.submit": "Oluştur",
  "dialog.project.create.error.name": "Bir proje adı girin",
  "dialog.project.create.error.invalid": "Bu ad klasör adı olarak kullanılamaz",
  "dialog.project.create.error.exists": "Bu klasör zaten var. Klasörü açın veya başka bir ad seçin.",
  "dialog.project.create.error.failed": "Klasör oluşturulamadı",
  "mcp.status.needs_client_registration": "istemci kaydı gerekiyor",
  "home.welcome.title": "Nasıl yardımcı olabilirim?",
  "home.project.create": "Yeni proje",
  "home.project.open": "Mevcut projeyi aç",
  "home.sessions.search.title": "Sohbetlerde ara",
  "session.todo.empty": "Henüz görev yok",
  "session.panel.files": "Dosyalar",
  "session.panel.changes": "Değişiklikler",
  "session.panel.tasks": "Görevler",
  "session.panel.terminal": "Terminal",
  "session.panel.empty": "Dosyaları, değişiklikleri, görevleri ve terminali görüntülemek için bir proje seçin.",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "Değişiklik yok",
  "session.panel.git.dirty.one": "{{count}} değiştirilmiş dosya",
  "session.panel.git.dirty.other": "{{count}} değiştirilmiş dosya",
  "session.task.waiting": "İzin bekleniyor",
  "session.task.failed": "Başarısız",
  "session.task.retry": "Yeniden dene",
  "session.task.open": "Ayrı bir oturumda aç",
  "settings.skills.title": "Beceriler",
  "settings.skills.description": "Bu proje için bulunan beceriler.",
  "settings.skills.empty": "Beceri bulunamadı",
  "settings.skills.enabled": "Model tarafından kullanılabilir",
  "settings.skills.disabled": "Modelin kullanması yasak",
  "settings.skills.search": "Becerilerde ara",
  "settings.skills.emptySearch": "Aramayla eşleşen beceri yok",
  "settings.skills.details": "Beceri ayrıntıları",
  "settings.skills.noDescription": "Açıklama yok",
  "settings.skills.source.project": "Proje",
  "settings.skills.source.global": "Kullanıcı",
  "settings.skills.source.builtin": "Yerleşik",
  "settings.skills.source.custom": "Eklenen",
  "settings.scheduled.title": "Zamanlanmış görevler",
  "settings.scheduled.description": "Bir projede bir istemi bir kez veya her gün çalıştırın.",
  "settings.scheduled.empty": "Zamanlanmış görev yok",
  "settings.scheduled.once": "Bir kez",
  "settings.scheduled.daily": "Her gün",
  "settings.scheduled.add": "Görev ekle",
  "settings.scheduled.field.name": "Ad",
  "settings.scheduled.field.prompt": "İstem",
  "settings.scheduled.field.schedule": "Zamanlama",
  "settings.scheduled.field.time": "Çalıştırma zamanı",
  "settings.scheduled.error.name": "Bir ad girin",
  "settings.scheduled.error.prompt": "Bir istem girin",
  "settings.scheduled.error.time": "Bir zaman seçin",
  "settings.scheduled.error.model": "Önce bir model seçin",
  "session.new.project.open": "Mevcut projeyi aç",
  "common.pin": "Sabitle",
  "common.unpin": "Sabitlemeyi kaldır",
  "settings.relay.title": "智联AI anahtarları",
  "settings.relay.getKey": "API anahtarı al",
  "settings.relay.getKey.description": "ChatGPT, Grok ve diğer sağlayıcılar için ayrı anahtarlar oluşturun.",
  "settings.relay.upstream": "Üst sunucu",
  "settings.relay.unified": "Ortak API anahtarı kullan",
  "settings.relay.unified.description": "Etkinleştirildiğinde tüm sağlayıcılar bu anahtarı kullanır.",
  "settings.relay.unified.key": "Ortak API anahtarı",
  "settings.relay.unified.using": "Ortak anahtar kullanılıyor",
  "settings.relay.key.set": "Anahtar kaydedildi",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "Kayıtlı anahtarı korumak için boş bırakın",
  "settings.relay.test": "Bağlantıyı test et",
  "settings.relay.testing": "Test ediliyor...",
  "settings.relay.fetch": "Modelleri al",
  "settings.relay.fetching": "Alınıyor...",
  "settings.relay.edit": "Düzenle",
  "settings.relay.clearKey": "Anahtarı sil",
  "settings.relay.add": "Sağlayıcı ekle",
  "settings.relay.add.name": "Sağlayıcı adı",
  "settings.relay.models.visible": "{{count}} görünür model",
  "settings.relay.connected": "Bağlandı · {{count}} model",
  "settings.relay.connectedEmpty": "Bağlandı ancak model döndürülmedi",
  "settings.relay.test.ok": "Bağlantı başarılı",
  "settings.relay.test.empty": "Bağlandı ancak model döndürülmedi",
  "settings.relay.models.title": "{{vendor}} modelleri",
  "settings.relay.models.empty": "Henüz model yok. Bir anahtar kaydettikten sonra listeyi alın.",
  "settings.relay.models.missing": "Artık üst sunucuda yok",
  "settings.relay.saved": "Otomatik kaydedildi",
  "settings.relay.retry": "Yeniden dene",
  "settings.relay.builtin": "Yerleşik",
  "settings.relay.delete": "Sağlayıcıyı sil",
  "settings.relay.rollback": "İçe aktarılan anahtarları sıfırla",
  "settings.relay.rollback.description":
    "auth.json dosyasından içe aktarılan Relay anahtarlarını temizler. Özgün auth.json korunur.",
  "settings.relay.error.KEY_MISSING": "Önce bir API anahtarı ekleyin",
  "settings.relay.error.KEY_REJECTED": "Anahtar reddedildi",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "Üst sunucuya ulaşılamıyor",
  "settings.relay.error.UPSTREAM_TIMEOUT": "Üst sunucu zaman aşımına uğradı",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "Üst sunucu istek sıklığını sınırladı",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "Üst sunucu geçersiz bir yanıt döndürdü",
  "settings.relay.error.REVISION_CONFLICT": "Bu ayar başka bir pencerede değişti. Yenileyip tekrar deneyin.",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "API anahtarı bu cihaza kaydedilemedi.",
  "settings.mcp.add": "MCP ekle",
  "settings.mcp.edit": "Düzenle",
  "settings.mcp.field.name": "Ad",
  "settings.mcp.field.type": "Tür",
  "settings.mcp.field.command": "Komut",
  ...
  "settings.mcp.error.name": "Bir sunucu adı girin",
  "settings.mcp.error.command": "Bir komut girin",
  "settings.mcp.error.url": "Bir URL girin",
  ...
  "desktop.recovery.loadFailed": "Koda yüklenemedi",
  "desktop.recovery.terminated": "Koda penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "Koda yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "Koda kurulamadı",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Koda, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "Koda güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Koda tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Koda'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Koda'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Koda'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Koda sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Koda kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde Koda kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "Koda güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde Koda güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki Koda'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "Koda'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde Koda hazır.",
  "wsl.onboarding.opencodeReady": "Koda hazır.",
  "wsl.onboarding.installOpencodeIn": "Koda'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "Koda'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Koda'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Koda bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Koda'u tekrar açın.",
  ...
  "help.tabs.introduction": "Koda Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Koda'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Koda ekibine",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: Koda henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Koda ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Koda Masaüstü",
  ...
  "settings.desktop.wsl.description": "Koda sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Koda'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Koda'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description": "Koda'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Koda'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Koda başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Koda'un en son sürümünü kullanıyorsunuz.",
