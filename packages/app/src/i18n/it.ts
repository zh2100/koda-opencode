export const dict = {
  "desktop.menu.about": "Informazioni su Koda",
  "desktop.about.title": "Koda Desktop v{{version}}",
  "desktop.about.detail":
    "Modificato a partire da OpenCode come base\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "Koda v{{version}} è disponibile. Aprire la pagina delle versioni per aggiornare?",
  "desktop.koda.update.open": "Apri pagina delle versioni",
  "command.project.create": "Nuovo progetto",
  "command.project.openExisting": "Apri progetto esistente",
  "prompt.toast.projectRequired.title": "Scegli un progetto",
  "prompt.toast.projectRequired.description": "Crea o apri un progetto prima di inviare.",
  "prompt.approval.ask": "Richiedi approvazione",
  "prompt.approval.auto": "Approva per me",
  "prompt.approval.plan": "Accesso completo",
  "prompt.more": "Altro",
  "dialog.project.create.title": "Nuovo progetto",
  "dialog.project.create.name": "Nome",
  "dialog.project.create.location": "Posizione",
  "dialog.project.create.browse": "Sfoglia",
  "dialog.project.create.path": "Percorso",
  "dialog.project.create.submit": "Crea",
  "dialog.project.create.error.name": "Inserisci un nome per il progetto",
  "dialog.project.create.error.invalid": "Questo nome non può essere usato per una cartella",
  "dialog.project.create.error.exists": "Questa cartella esiste già. Aprila oppure scegli un altro nome.",
  "dialog.project.create.error.failed": "Impossibile creare la cartella",
  "mcp.status.needs_client_registration": "registrazione del client necessaria",
  "home.welcome.title": "Come posso aiutarti?",
  "home.project.create": "Nuovo progetto",
  "home.project.open": "Apri progetto esistente",
  "home.sessions.search.title": "Cerca nelle chat",
  "session.todo.empty": "Nessuna attività per ora",
  "session.panel.files": "File",
  "session.panel.changes": "Modifiche",
  "session.panel.tasks": "Attività",
  "session.panel.terminal": "Terminale",
  "session.panel.empty": "Seleziona un progetto per esplorare file, modifiche, attività e terminale.",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "Nessuna modifica",
  "session.panel.git.dirty.one": "{{count}} file modificato",
  "session.panel.git.dirty.other": "{{count}} file modificati",
  "session.panel.git.dirty.many": "{{count}} file modificati",
  "session.task.waiting": "In attesa di autorizzazione",
  "session.task.failed": "Non riuscita",
  "session.task.retry": "Riprova",
  "session.task.open": "Apri in una sessione dedicata",
  "settings.skills.title": "Skill",
  "settings.skills.description": "Skill trovate per questo progetto.",
  "settings.skills.empty": "Nessuna skill trovata",
  "settings.skills.enabled": "Disponibile per il modello",
  "settings.skills.disabled": "Vietata al modello",
  "settings.skills.search": "Cerca skill",
  "settings.skills.emptySearch": "Nessuna skill corrisponde alla ricerca",
  "settings.skills.details": "Dettagli della skill",
  "settings.skills.noDescription": "Nessuna descrizione",
  "settings.skills.source.project": "Progetto",
  "settings.skills.source.global": "Utente",
  "settings.skills.source.builtin": "Integrata",
  "settings.skills.source.custom": "Aggiunta",
  "settings.scheduled.title": "Attività pianificate",
  "settings.scheduled.description": "Esegui un prompt una volta o ogni giorno in un progetto.",
  "settings.scheduled.empty": "Nessuna attività pianificata",
  "settings.scheduled.once": "Una volta",
  "settings.scheduled.daily": "Ogni giorno",
  "settings.scheduled.add": "Aggiungi attività",
  "settings.scheduled.field.name": "Nome",
  "settings.scheduled.field.prompt": "Prompt",
  "settings.scheduled.field.schedule": "Pianificazione",
  "settings.scheduled.field.time": "Esegui alle",
  "settings.scheduled.error.name": "Inserisci un nome",
  "settings.scheduled.error.prompt": "Inserisci un prompt",
  "settings.scheduled.error.time": "Scegli un orario",
  "settings.scheduled.error.model": "Seleziona prima un modello",
  "session.new.project.open": "Apri progetto esistente",
  "common.pin": "Fissa",
  "common.unpin": "Sblocca",
  "settings.relay.title": "Chiavi 智联AI",
  "settings.relay.getKey": "Ottieni chiave API",
  "settings.relay.getKey.description": "Crea chiavi separate per ChatGPT, Grok e altri fornitori.",
  "settings.relay.upstream": "Servizio a monte",
  "settings.relay.unified": "Usa una chiave API condivisa",
  "settings.relay.unified.description": "Se abilitato, tutti i fornitori usano questa chiave.",
  "settings.relay.unified.key": "Chiave API condivisa",
  "settings.relay.unified.using": "Chiave condivisa in uso",
  "settings.relay.key.set": "Chiave salvata",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "Lascia vuoto per mantenere la chiave salvata",
  "settings.relay.test": "Verifica connessione",
  "settings.relay.testing": "Verifica in corso...",
  "settings.relay.fetch": "Recupera modelli",
  "settings.relay.fetching": "Recupero in corso...",
  "settings.relay.edit": "Modifica",
  "settings.relay.clearKey": "Cancella chiave",
  "settings.relay.add": "Aggiungi fornitore",
  "settings.relay.add.name": "Nome del fornitore",
  "settings.relay.models.visible": "{{count}} modelli visibili",
  "settings.relay.connected": "Connesso · {{count}} modelli",
  "settings.relay.connectedEmpty": "Connesso, ma non è stato restituito alcun modello",
  "settings.relay.test.ok": "Connessione riuscita",
  "settings.relay.test.empty": "Connesso, ma non è stato restituito alcun modello",
  "settings.relay.models.title": "Modelli di {{vendor}}",
  "settings.relay.models.empty": "Nessun modello per ora. Recupera l’elenco dopo aver salvato una chiave.",
  "settings.relay.models.missing": "Non più disponibile nel servizio a monte",
  "settings.relay.saved": "Salvato automaticamente",
  "settings.relay.retry": "Riprova",
  "settings.relay.builtin": "Integrato",
  "settings.relay.delete": "Elimina fornitore",
  "settings.relay.rollback": "Reimposta chiavi importate",
  "settings.relay.rollback.description":
    "Cancella le chiavi Relay importate da auth.json. Il file auth.json originale viene conservato.",
  "settings.relay.error.KEY_MISSING": "Aggiungi prima una chiave API",
  "settings.relay.error.KEY_REJECTED": "La chiave è stata rifiutata",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "Il servizio a monte non è raggiungibile",
  "settings.relay.error.UPSTREAM_TIMEOUT": "Il servizio a monte ha superato il tempo limite",
  "settings.relay.error.UPSTREAM_RATE_LIMITED":
    "Il servizio a monte ha limitato la richiesta per il superamento della frequenza consentita",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "Il servizio a monte ha restituito una risposta non valida",
  "settings.relay.error.REVISION_CONFLICT": "Questa impostazione è cambiata in un’altra finestra. Aggiorna e riprova.",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "Impossibile salvare la chiave API su questo dispositivo.",
  "settings.mcp.add": "Aggiungi MCP",
  "settings.mcp.edit": "Modifica",
  "settings.mcp.field.name": "Nome",
  "settings.mcp.field.type": "Tipo",
  "settings.mcp.field.command": "Comando",
  ...
  "settings.mcp.error.name": "Inserisci un nome per il server",
  "settings.mcp.error.command": "Inserisci un comando",
  "settings.mcp.error.url": "Inserisci un URL",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da Koda",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in Koda.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen offre l'accesso a una selezione di modelli affidabili e ottimizzati per gli agenti di programmazione.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in Koda.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in Koda.",
  ...
  "dialog.server.description": "Cambia il server Koda a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpencode": "Controllo Koda...",
  "wsl.onboarding.checkingOpencodeIn": "Controllo Koda in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aggiornamento Koda...",
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento Koda in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aggiorna Koda in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna Koda",
  "wsl.onboarding.opencodeReadyIn": "Koda è pronto in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koda è pronto.",
  "wsl.onboarding.installOpencodeIn": "Installa Koda in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa Koda",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che Koda possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "Koda non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired": "Riavvia Windows per completare l'installazione WSL, quindi riapri Koda.",
  ...
  "help.tabs.introduction": "Koda Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di Koda ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team Koda",
  ...
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: Koda non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "Koda include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server Koda all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per Koda",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di Koda sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se Koda segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di Koda.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di Koda",
  ...
  "settings.updates.toast.latest.title": "Koda è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di Koda.",
  ...
  "desktop.menu.documentation": "Documentazione di Koda",
  ...
  "desktop.menu.ariaLabel": "Menu Koda",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare Koda",
  "desktop.recovery.terminated": "La finestra di Koda si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "Koda non risponde",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di Koda non riuscita",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Koda non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di Koda è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
