export const dict = {
  "desktop.menu.about": "О Koda",
  "desktop.about.title": "Koda Desktop v{{version}}",
  "desktop.about.detail": "Модификация на основе OpenCode\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "Доступна Koda v{{version}}. Открыть страницу выпуска для обновления?",
  "desktop.koda.update.open": "Открыть страницу выпуска",
  "command.project.create": "Новый проект",
  "command.project.openExisting": "Открыть существующий проект",
  "prompt.toast.projectRequired.title": "Выберите проект",
  "prompt.toast.projectRequired.description": "Создайте или откройте проект перед отправкой.",
  "prompt.approval.ask": "Запрашивать подтверждение",
  "prompt.approval.auto": "Подтверждать за меня",
  "prompt.approval.plan": "Полный доступ",
  "prompt.more": "Ещё",
  "dialog.project.create.title": "Новый проект",
  "dialog.project.create.name": "Имя",
  "dialog.project.create.location": "Расположение",
  "dialog.project.create.browse": "Обзор",
  "dialog.project.create.path": "Путь",
  "dialog.project.create.submit": "Создать",
  "dialog.project.create.error.name": "Введите имя проекта",
  "dialog.project.create.error.invalid": "Это имя нельзя использовать для папки",
  "dialog.project.create.error.exists": "Такая папка уже существует. Откройте её или выберите другое имя.",
  "dialog.project.create.error.failed": "Не удалось создать папку",
  "mcp.status.needs_client_registration": "требуется регистрация клиента",
  "home.welcome.title": "Чем могу помочь?",
  "home.project.create": "Новый проект",
  "home.project.open": "Открыть существующий проект",
  "home.sessions.search.title": "Поиск чатов",
  "session.todo.empty": "Задач пока нет",
  "session.panel.files": "Файлы",
  "session.panel.changes": "Изменения",
  "session.panel.tasks": "Задачи",
  "session.panel.terminal": "Терминал",
  "session.panel.empty": "Выберите проект для просмотра файлов, изменений, задач и терминала.",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "Без изменений",
  "session.panel.git.dirty.one": "{{count}} изменённый файл",
  "session.panel.git.dirty.few": "{{count}} изменённых файла",
  "session.panel.git.dirty.many": "{{count}} изменённых файлов",
  "session.panel.git.dirty.other": "{{count}} изменённого файла",
  "session.task.waiting": "Ожидание разрешения",
  "session.task.failed": "Сбой",
  "session.task.retry": "Повторить",
  "session.task.open": "Открыть в отдельной сессии",
  "settings.skills.title": "Навыки",
  "settings.skills.description": "Навыки, найденные для этого проекта.",
  "settings.skills.empty": "Навыки не найдены",
  "settings.skills.enabled": "Доступен модели",
  "settings.skills.disabled": "Запрещён для модели",
  "settings.skills.search": "Поиск навыков",
  "settings.skills.emptySearch": "Нет навыков, соответствующих запросу",
  "settings.skills.details": "Сведения о навыке",
  "settings.skills.noDescription": "Нет описания",
  "settings.skills.source.project": "Проект",
  "settings.skills.source.global": "Пользователь",
  "settings.skills.source.builtin": "Встроенный",
  "settings.skills.source.custom": "Добавленный",
  "settings.scheduled.title": "Задачи по расписанию",
  "settings.scheduled.description": "Выполняйте запрос в проекте однократно или ежедневно.",
  "settings.scheduled.empty": "Нет задач по расписанию",
  "settings.scheduled.once": "Однократно",
  "settings.scheduled.daily": "Ежедневно",
  "settings.scheduled.add": "Добавить задачу",
  "settings.scheduled.field.name": "Имя",
  "settings.scheduled.field.prompt": "Запрос",
  "settings.scheduled.field.schedule": "Расписание",
  "settings.scheduled.field.time": "Время запуска",
  "settings.scheduled.error.name": "Введите имя",
  "settings.scheduled.error.prompt": "Введите запрос",
  "settings.scheduled.error.time": "Выберите время",
  "settings.scheduled.error.model": "Сначала выберите модель",
  "session.new.project.open": "Открыть существующий проект",
  "common.pin": "Закрепить",
  "common.unpin": "Открепить",
  "settings.relay.title": "Ключи 智联AI",
  "settings.relay.getKey": "Получить ключ API",
  "settings.relay.getKey.description": "Создавайте отдельные ключи для ChatGPT, Grok и других провайдеров.",
  "settings.relay.upstream": "Вышестоящий сервер",
  "settings.relay.unified": "Использовать общий ключ API",
  "settings.relay.unified.description": "Если включено, все поставщики используют этот ключ.",
  "settings.relay.unified.key": "Общий ключ API",
  "settings.relay.unified.using": "Используется общий ключ",
  "settings.relay.key.set": "Ключ сохранён",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "Оставьте пустым, чтобы сохранить текущий ключ",
  "settings.relay.test": "Проверить подключение",
  "settings.relay.testing": "Проверка...",
  "settings.relay.fetch": "Получить модели",
  "settings.relay.fetching": "Получение...",
  "settings.relay.edit": "Изменить",
  "settings.relay.clearKey": "Удалить ключ",
  "settings.relay.add": "Добавить поставщика",
  "settings.relay.add.name": "Имя поставщика",
  "settings.relay.models.visible": "Видимых моделей: {{count}}",
  "settings.relay.connected": "Подключено · Моделей: {{count}}",
  "settings.relay.connectedEmpty": "Подключено, но модели не получены",
  "settings.relay.test.ok": "Подключение успешно",
  "settings.relay.test.empty": "Подключено, но модели не получены",
  "settings.relay.models.title": "Модели {{vendor}}",
  "settings.relay.models.empty": "Моделей пока нет. Получите список после сохранения ключа.",
  "settings.relay.models.missing": "Больше нет на вышестоящем сервере",
  "settings.relay.saved": "Сохранено автоматически",
  "settings.relay.retry": "Повторить",
  "settings.relay.builtin": "Встроенный",
  "settings.relay.delete": "Удалить поставщика",
  "settings.relay.rollback": "Сбросить импортированные ключи",
  "settings.relay.rollback.description":
    "Удаляет ключи Relay, импортированные из auth.json. Исходный auth.json сохраняется.",
  "settings.relay.error.KEY_MISSING": "Сначала добавьте ключ API",
  "settings.relay.error.KEY_REJECTED": "Ключ отклонён",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "Вышестоящий сервер недоступен",
  "settings.relay.error.UPSTREAM_TIMEOUT": "Время ожидания ответа вышестоящего сервера истекло",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "Вышестоящий сервер ограничил частоту запросов",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "Вышестоящий сервер вернул недопустимый ответ",
  "settings.relay.error.REVISION_CONFLICT": "Этот параметр изменён в другом окне. Обновите и повторите попытку.",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "Не удалось сохранить ключ API на этом устройстве.",
  "settings.mcp.add": "Добавить MCP",
  "settings.mcp.edit": "Изменить",
  "settings.mcp.field.name": "Имя",
  ...
  "settings.mcp.error.name": "Введите имя сервера",
  "settings.mcp.error.command": "Введите команду",
  "settings.mcp.error.url": "Введите URL",
  ...
  "desktop.menu.documentation": "Документация Koda",
  ...
  "desktop.recovery.loadFailed": "Не удалось загрузить Koda",
  "desktop.recovery.terminated": "Окно Koda неожиданно завершило работу",
  "desktop.recovery.unresponsive": "Koda не отвечает",
  ...
  "desktop.wsl.error.installOpencode": "Не удалось установить Koda",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Koda не установлен в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Обновление Koda завершено, но {{distro}} по-прежнему сообщает версию {{installed}}; ожидалась {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от Koda",
  ...
  "provider.connect.apiKey.description":
    "Введите ключ API {{provider}}, чтобы подключить аккаунт и использовать модели {{provider}} в Koda.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen даёт вам доступ к отобранным надёжным оптимизированным моделям для агентов программирования.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в Koda.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в Koda.",
  ...
  "dialog.server.description": "Выберите сервер Koda, к которому подключается приложение.",
  ...
  "wsl.onboarding.checkingOpencode": "Проверка Koda...",
  "wsl.onboarding.checkingOpencodeIn": "Проверка Koda в {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Обновление Koda...",
  "wsl.onboarding.updatingOpencodeIn": "Обновление Koda в {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Обновите Koda в {{distro}}.",
  "wsl.onboarding.updateOpencode": "Обновить Koda",
  "wsl.onboarding.opencodeReadyIn": "Koda в {{distro}} готов к работе.",
  "wsl.onboarding.opencodeReady": "Koda готов к работе.",
  "wsl.onboarding.installOpencodeIn": "Установите Koda в {{distro}}.",
  "wsl.onboarding.installOpencode": "Установить Koda",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda не установлен",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в Koda требуется WSL (Подсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "Koda не смог проверить WSL на этом компьютере.",
  "wsl.onboarding.installWsl": "Установить WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустите Windows, чтобы завершить установку WSL, затем снова откройте Koda.",
  ...
  "help.tabs.introduction": "Теперь работа в Koda Desktop организована с помощью вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Новая версия Koda ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде Koda",
  ...
  "error.chain.mcpFailed":
    'MCP-сервер "{{name}}" завершился с ошибкой. Обратите внимание: Koda пока не поддерживает MCP-авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "Koda включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.desktop.wsl.description": "Запускать сервер Koda внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения Koda",
  ...
  "settings.general.row.appearance.description": "Настройте внешний вид Koda на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли Koda системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление Koda.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске Koda",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию Koda.",
