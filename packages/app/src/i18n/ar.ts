export const dict = {
  "desktop.menu.about": "حول Koda",
  "desktop.about.title": "Koda Desktop v{{version}}",
  "desktop.about.detail": "نسخة معدلة تعتمد على OpenCode\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "يتوفر Koda v{{version}}. هل تريد فتح صفحة الإصدار للترقية؟",
  "desktop.koda.update.open": "فتح صفحة الإصدار",
  "command.project.create": "مشروع جديد",
  "command.project.openExisting": "فتح مشروع موجود",
  "prompt.toast.projectRequired.title": "اختر مشروعًا",
  "prompt.toast.projectRequired.description": "أنشئ مشروعًا أو افتح مشروعًا قبل الإرسال.",
  "prompt.approval.ask": "طلب الموافقة",
  "prompt.approval.auto": "الموافقة نيابة عني",
  "prompt.approval.plan": "وصول كامل",
  "prompt.more": "المزيد",
  "dialog.project.create.title": "مشروع جديد",
  "dialog.project.create.name": "الاسم",
  "dialog.project.create.location": "الموقع",
  "dialog.project.create.browse": "تصفح",
  "dialog.project.create.path": "المسار",
  "dialog.project.create.submit": "إنشاء",
  "dialog.project.create.error.name": "أدخل اسم المشروع",
  "dialog.project.create.error.invalid": "لا يمكن استخدام هذا الاسم لمجلد",
  "dialog.project.create.error.exists": "هذا المجلد موجود بالفعل. افتحه أو اختر اسمًا آخر.",
  "dialog.project.create.error.failed": "تعذر إنشاء المجلد",
  "mcp.status.needs_client_registration": "يتطلب تسجيل العميل",
  "home.welcome.title": "كيف يمكنني مساعدتك؟",
  "home.project.create": "مشروع جديد",
  "home.project.open": "فتح مشروع موجود",
  "home.sessions.search.title": "البحث في المحادثات",
  "session.todo.empty": "لا توجد مهام بعد",
  "session.panel.files": "الملفات",
  "session.panel.changes": "التغييرات",
  "session.panel.tasks": "المهام",
  "session.panel.terminal": "المحطة الطرفية",
  "session.panel.empty": "اختر مشروعًا لتصفح الملفات والتغييرات والمهام والمحطة الطرفية.",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "لا توجد تغييرات",
  "session.panel.git.dirty.zero": "عدد الملفات المعدلة: {{count}}",
  "session.panel.git.dirty.one": "ملف معدل واحد ({{count}})",
  "session.panel.git.dirty.two": "ملفان معدلان ({{count}})",
  "session.panel.git.dirty.few": "{{count}} ملفات معدلة",
  "session.panel.git.dirty.many": "{{count}} ملفًا معدلًا",
  "session.panel.git.dirty.other": "عدد الملفات المعدلة: {{count}}",
  "session.task.waiting": "في انتظار الإذن",
  "session.task.failed": "فشل",
  "session.task.retry": "إعادة المحاولة",
  "session.task.open": "فتح في جلسة مستقلة",
  "settings.skills.title": "المهارات",
  "settings.skills.description": "المهارات المكتشفة لهذا المشروع.",
  "settings.skills.empty": "لم يُعثر على مهارات",
  "settings.skills.enabled": "متاحة للنموذج",
  "settings.skills.disabled": "محظورة على النموذج",
  "settings.skills.search": "البحث عن مهارات",
  "settings.skills.emptySearch": "لا توجد مهارات تطابق هذا البحث",
  "settings.skills.details": "تفاصيل المهارة",
  "settings.skills.noDescription": "لا يوجد وصف",
  "settings.skills.source.project": "المشروع",
  "settings.skills.source.global": "المستخدم",
  "settings.skills.source.builtin": "مدمجة",
  "settings.skills.source.custom": "مضافة",
  "settings.scheduled.title": "المهام المجدولة",
  "settings.scheduled.description": "نفّذ مطالبة مرة واحدة أو كل يوم في مشروع.",
  "settings.scheduled.empty": "لا توجد مهام مجدولة",
  "settings.scheduled.once": "مرة واحدة",
  "settings.scheduled.daily": "كل يوم",
  "settings.scheduled.add": "إضافة مهمة",
  "settings.scheduled.field.name": "الاسم",
  "settings.scheduled.field.prompt": "المطالبة",
  "settings.scheduled.field.schedule": "الجدول الزمني",
  "settings.scheduled.field.time": "وقت التنفيذ",
  "settings.scheduled.error.name": "أدخل اسمًا",
  "settings.scheduled.error.prompt": "أدخل مطالبة",
  "settings.scheduled.error.time": "اختر وقتًا",
  "settings.scheduled.error.model": "اختر نموذجًا أولًا",
  "session.new.project.open": "فتح مشروع موجود",
  "common.pin": "تثبيت",
  "common.unpin": "إلغاء التثبيت",
  "settings.relay.title": "مفاتيح 智联AI",
  "settings.relay.getKey": "الحصول على مفتاح API",
  "settings.relay.getKey.description": "أنشئ مفاتيح منفصلة لـ ChatGPT وGrok والمزودين الآخرين.",
  "settings.relay.upstream": "خادم المزود",
  "settings.relay.unified": "استخدام مفتاح API مشترك",
  "settings.relay.unified.description": "عند التفعيل، يستخدم جميع المزودين هذا المفتاح.",
  "settings.relay.unified.key": "مفتاح API مشترك",
  "settings.relay.unified.using": "يُستخدم المفتاح المشترك",
  "settings.relay.key.set": "تم حفظ المفتاح",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "اتركه فارغًا للاحتفاظ بالمفتاح المحفوظ",
  "settings.relay.test": "اختبار الاتصال",
  "settings.relay.testing": "جارٍ الاختبار...",
  "settings.relay.fetch": "جلب النماذج",
  "settings.relay.fetching": "جارٍ الجلب...",
  "settings.relay.edit": "تحرير",
  "settings.relay.clearKey": "مسح المفتاح",
  "settings.relay.add": "إضافة مزود",
  "settings.relay.add.name": "اسم المزود",
  "settings.relay.models.visible": "عدد النماذج الظاهرة: {{count}}",
  "settings.relay.connected": "متصل · عدد النماذج: {{count}}",
  "settings.relay.connectedEmpty": "تم الاتصال، لكن لم تُرجع أي نماذج",
  "settings.relay.test.ok": "نجح الاتصال",
  "settings.relay.test.empty": "تم الاتصال، لكن لم تُرجع أي نماذج",
  "settings.relay.models.title": "نماذج {{vendor}}",
  "settings.relay.models.empty": "لا توجد نماذج بعد. اجلب القائمة بعد حفظ مفتاح.",
  "settings.relay.models.missing": "لم يعد متاحًا على خادم المزود",
  "settings.relay.saved": "تم الحفظ تلقائيًا",
  "settings.relay.retry": "إعادة المحاولة",
  "settings.relay.builtin": "مدمج",
  "settings.relay.delete": "حذف المزود",
  "settings.relay.rollback": "إعادة تعيين المفاتيح المستوردة",
  "settings.relay.rollback.description": "يمسح مفاتيح Relay المستوردة من auth.json. يُحتفظ بملف auth.json الأصلي.",
  "settings.relay.error.KEY_MISSING": "أضف مفتاح API أولًا",
  "settings.relay.error.KEY_REJECTED": "رُفض المفتاح",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "تعذر الوصول إلى خادم المزود",
  "settings.relay.error.UPSTREAM_TIMEOUT": "انتهت مهلة خادم المزود",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "قيّد خادم المزود معدل الطلبات",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "أرجع خادم المزود استجابة غير صالحة",
  "settings.relay.error.REVISION_CONFLICT": "تغير هذا الإعداد في نافذة أخرى. حدّث الصفحة وحاول مجددًا.",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "تعذر حفظ مفتاح API على هذا الجهاز.",
  "settings.mcp.add": "إضافة MCP",
  "settings.mcp.edit": "تحرير",
  "settings.mcp.field.name": "الاسم",
  "settings.mcp.field.type": "النوع",
  "settings.mcp.field.command": "الأمر",
  ...
  "settings.mcp.error.name": "أدخل اسم الخادم",
  "settings.mcp.error.command": "أدخل أمرًا",
  "settings.mcp.error.url": "أدخل عنوان URL",
  ...
  "desktop.recovery.loadFailed": "فشل تحميل Koda",
  "desktop.recovery.terminated": "توقفت نافذة Koda بشكل غير متوقع",
  "desktop.recovery.unresponsive": "Koda لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت Koda",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Koda غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث Koda، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Koda",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في Koda.",
  ...
  "provider.connect.opencodeZen.line1":
    "يمنحك Koda Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Koda.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Koda.",
  ...
  "dialog.server.description": "تبديل خادم Koda الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من Koda...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من Koda في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث Koda...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث Koda في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث Koda في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث Koda",
  "wsl.onboarding.opencodeReadyIn": "Koda جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koda جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت Koda في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت Koda",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Koda من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Koda التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Koda.",
  ...
  "help.tabs.introduction": "أصبح Koda Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من Koda ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Koda",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Koda لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Koda نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Koda داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Koda",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Koda على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Koda يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Koda.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Koda",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Koda.",
