export const dict = {
  "desktop.menu.about": "Koda-ի մասին",
  "desktop.about.title": "Koda աշխատասեղանի հավելված v{{version}}",
  "desktop.about.detail":
    "Փոփոխված է՝ հիմքում օգտագործելով OpenCode-ը\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "Koda v{{version}}-ը հասանելի է։ Բացե՞լ թողարկման էջը՝ թարմացնելու համար։",
  "desktop.koda.update.open": "Բացել թողարկման էջը",
  "command.project.create": "Նոր նախագիծ",
  "command.project.openExisting": "Բացել առկա նախագիծը",
  "prompt.toast.projectRequired.title": "Ընտրեք նախագիծ",
  "prompt.toast.projectRequired.description": "Ուղարկելուց առաջ ստեղծեք կամ բացեք նախագիծ։",
  "prompt.approval.ask": "Հաստատում պահանջել",
  "prompt.approval.auto": "Հաստատել իմ փոխարեն",
  "prompt.approval.plan": "Լրիվ հասանելիություն",
  "prompt.more": "Ավելին",
  "dialog.project.create.title": "Նոր նախագիծ",
  "dialog.project.create.name": "Անուն",
  "dialog.project.create.location": "Տեղադրություն",
  "dialog.project.create.browse": "Դիտարկել",
  "dialog.project.create.path": "Ուղի",
  "dialog.project.create.submit": "Ստեղծել",
  "dialog.project.create.error.name": "Մուտքագրեք նախագծի անունը",
  "dialog.project.create.error.invalid": "Այս անունը չի կարող օգտագործվել պանակի համար",
  "dialog.project.create.error.exists": "Այդ պանակն արդեն գոյություն ունի։ Բացեք այն կամ ընտրեք այլ անուն։",
  "dialog.project.create.error.failed": "Չհաջողվեց ստեղծել պանակը",
  "mcp.status.needs_client_registration": "պահանջվում է հաճախորդի գրանցում",
  "home.welcome.title": "Ինչո՞վ կարող եմ օգնել։",
  "home.project.create": "Նոր նախագիծ",
  "home.project.open": "Բացել առկա նախագիծը",
  "home.sessions.search.title": "Որոնել զրույցներ",
  "session.todo.empty": "Դեռ առաջադրանքներ չկան",
  "session.panel.files": "Ֆայլեր",
  "session.panel.changes": "Փոփոխություններ",
  "session.panel.tasks": "Առաջադրանքներ",
  "session.panel.terminal": "Տերմինալ",
  "session.panel.empty": "Ընտրեք նախագիծ՝ ֆայլերը, փոփոխությունները, առաջադրանքները և տերմինալը դիտելու համար։",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "Առանց փոփոխությունների",
  "session.panel.git.dirty.one": "{{count}} փոփոխված ֆայլ",
  "session.panel.git.dirty.other": "{{count}} փոփոխված ֆայլ",
  "session.task.waiting": "Սպասում է թույլտվության",
  "session.task.failed": "Ձախողվեց",
  "session.task.retry": "Կրկին փորձել",
  "session.task.open": "Բացել առանձին աշխատաշրջանում",
  "settings.skills.title": "Հմտություններ",
  "settings.skills.description": "Այս նախագծի համար հայտնաբերված հմտությունները։",
  "settings.skills.empty": "Հմտություններ չեն գտնվել",
  "settings.skills.enabled": "Հասանելի է մոդելին",
  "settings.skills.disabled": "Արգելված է մոդելի համար",
  "settings.skills.search": "Որոնել հմտություններ",
  "settings.skills.emptySearch": "Որոնմանը համապատասխան հմտություններ չկան",
  "settings.skills.details": "Հմտության մանրամասները",
  "settings.skills.noDescription": "Նկարագրություն չկա",
  "settings.skills.source.project": "Նախագիծ",
  "settings.skills.source.global": "Օգտվող",
  "settings.skills.source.builtin": "Ներկառուցված",
  "settings.skills.source.custom": "Ավելացված",
  "settings.scheduled.title": "Պլանավորված առաջադրանքներ",
  "settings.scheduled.description": "Նախագծում հարցումը կատարեք մեկ անգամ կամ ամեն օր։",
  "settings.scheduled.empty": "Պլանավորված առաջադրանքներ չկան",
  "settings.scheduled.once": "Մեկ անգամ",
  "settings.scheduled.daily": "Ամեն օր",
  "settings.scheduled.add": "Ավելացնել առաջադրանք",
  "settings.scheduled.field.name": "Անուն",
  "settings.scheduled.field.prompt": "Հարցում",
  "settings.scheduled.field.schedule": "Ժամանակացույց",
  "settings.scheduled.field.time": "Կատարման ժամը",
  "settings.scheduled.error.name": "Մուտքագրեք անուն",
  "settings.scheduled.error.prompt": "Մուտքագրեք հարցում",
  "settings.scheduled.error.time": "Ընտրեք ժամը",
  "settings.scheduled.error.model": "Նախ ընտրեք մոդել",
  "session.new.project.open": "Բացել առկա նախագիծը",
  "common.pin": "Ամրացնել",
  "common.unpin": "Ապամրացնել",
  "settings.relay.title": "智联AI բանալիներ",
  "settings.relay.getKey": "Ստանալ API բանալի",
  "settings.relay.getKey.description": "Ստեղծեք առանձին բանալիներ ChatGPT-ի, Grok-ի և այլ մատակարարների համար։",
  "settings.relay.upstream": "Վերադաս սերվեր",
  "settings.relay.unified": "Օգտագործել ընդհանուր API բանալի",
  "settings.relay.unified.description": "Միացված լինելու դեպքում բոլոր մատակարարներն օգտագործում են այս բանալին։",
  "settings.relay.unified.key": "Ընդհանուր API բանալի",
  "settings.relay.unified.using": "Օգտագործվում է ընդհանուր բանալին",
  "settings.relay.key.set": "Բանալին պահպանված է",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "Պահպանված բանալին պահելու համար թողեք դատարկ",
  "settings.relay.test": "Ստուգել կապը",
  "settings.relay.testing": "Ստուգվում է...",
  "settings.relay.fetch": "Ստանալ մոդելները",
  "settings.relay.fetching": "Ստացվում է...",
  "settings.relay.edit": "Խմբագրել",
  "settings.relay.clearKey": "Մաքրել բանալին",
  "settings.relay.add": "Ավելացնել մատակարար",
  "settings.relay.add.name": "Մատակարարի անունը",
  "settings.relay.models.visible": "{{count}} տեսանելի մոդել",
  "settings.relay.connected": "Միացված է · {{count}} մոդել",
  "settings.relay.connectedEmpty": "Միացված է, բայց մոդելներ չեն վերադարձվել",
  "settings.relay.test.ok": "Կապը հաջողվեց",
  "settings.relay.test.empty": "Միացված է, բայց մոդելներ չեն վերադարձվել",
  "settings.relay.models.title": "{{vendor}}-ի մոդելները",
  "settings.relay.models.empty": "Դեռ մոդելներ չկան։ Բանալին պահպանելուց հետո ստացեք ցանկը։",
  "settings.relay.models.missing": "Այլևս չկա վերադաս սերվերում",
  "settings.relay.saved": "Պահպանվել է ինքնաշխատ",
  "settings.relay.retry": "Կրկին փորձել",
  "settings.relay.builtin": "Ներկառուցված",
  "settings.relay.delete": "Ջնջել մատակարարին",
  "settings.relay.rollback": "Վերակայել ներմուծված բանալիները",
  "settings.relay.rollback.description":
    "Մաքրում է auth.json-ից ներմուծված Relay բանալիները։ Սկզբնական auth.json-ը պահպանվում է։",
  "settings.relay.error.KEY_MISSING": "Նախ ավելացրեք API բանալի",
  "settings.relay.error.KEY_REJECTED": "Բանալին մերժվել է",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "Վերադաս սերվերն անհասանելի է",
  "settings.relay.error.UPSTREAM_TIMEOUT": "Վերադաս սերվերի սպասման ժամանակը սպառվել է",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "Վերադաս սերվերը սահմանափակել է հարցումների հաճախականությունը",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "Վերադաս սերվերը վերադարձրել է անվավեր պատասխան",
  "settings.relay.error.REVISION_CONFLICT": "Այս կարգավորումը փոխվել է այլ պատուհանում։ Թարմացրեք և կրկին փորձեք։",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "Չհաջողվեց պահպանել API բանալին այս սարքում։",
  "settings.mcp.add": "Ավելացնել MCP",
  "settings.mcp.edit": "Խմբագրել",
  "settings.mcp.field.name": "Անուն",
  "settings.mcp.field.type": "Տեսակ",
  "settings.mcp.field.command": "Հրաման",
  ...
  "settings.mcp.type.local": "Տեղային",
  "settings.mcp.type.remote": "Հեռակա",
  "settings.mcp.error.name": "Մուտքագրեք սերվերի անունը",
  "settings.mcp.error.command": "Մուտքագրեք հրաման",
  "settings.mcp.error.url": "Մուտքագրեք URL",
  ...
  "desktop.menu.documentation": "Koda Փաստաթղթեր",
  ...
  "desktop.menu.ariaLabel": "Koda մենյու",
  ...
  "desktop.recovery.loadFailed": "Koda չհաջողվեց բեռնել",
  "desktop.recovery.terminated": "Koda պատուհանն անսպասելիորեն ավարտվեց",
  "desktop.recovery.unresponsive": "Koda-ը չի արձագանքում",
  ...
  "desktop.wsl.error.installOpencode": "Koda տեղադրումը ձախողվեց",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Koda տեղադրված չէ {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Koda թարմացումն ավարտված է, բայց {{distro}}-ը դեռ հայտնում է {{installed}}; սպասվում է {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Անվճար մոդելները տրամադրվում են Koda",
  ...
  "provider.connect.apiKey.description":
    "Մուտքագրեք ձեր {{provider}} API բանալին՝ ձեր հաշիվը միացնելու և Koda-ում {{provider}} մոդելներ օգտագործելու համար։",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen-ը թույլ է տալիս մուտք գործել կոդավորման գործակալների համար հուսալի օպտիմիզացված մոդելների հավաքածու։",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " հավաքել ձեր թույլտվության կոդը՝ ձեր հաշիվը միացնելու և Koda-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " և մուտքագրեք ստորև ծածկագիրը՝ ձեր հաշիվը միացնելու և Koda-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "dialog.server.description": "Փոխարկեք, թե որ Koda սերվերին է միանում այս հավելվածը։",
  ...
  "wsl.onboarding.checkingOpencode": "Ստուգում է Koda...",
  "wsl.onboarding.checkingOpencodeIn": "Ստուգում է Koda-ը {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Թարմացվում է Koda...",
  "wsl.onboarding.updatingOpencodeIn": "Թարմացվում է Koda-ը {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Թարմացնել Koda-ը {{distro}}-ում։",
  "wsl.onboarding.updateOpencode": "Թարմացնել Koda",
  "wsl.onboarding.opencodeReadyIn": "Koda պատրաստ է {{distro}}-ում։",
  "wsl.onboarding.opencodeReady": "Koda պատրաստ է։",
  "wsl.onboarding.installOpencodeIn": "Տեղադրեք Koda-ը {{distro}}-ում։",
  "wsl.onboarding.installOpencode": "Տեղադրեք Koda",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda տեղադրված չէ",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Ենթահամակարգը Linux-ի համար) անհրաժեշտ է, որպեսզի Koda-ը կարողանա ավելացնել WSL սերվեր",
  "wsl.onboarding.wslUnavailable.title": "WSL անհասանելի է",
  "wsl.onboarding.wslUnavailable.description": "Koda-ը չկարողացավ հաստատել WSL-ն այս մեքենայի վրա։",
  "wsl.onboarding.installWsl": "Տեղադրեք WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Վերագործարկեք Windows՝ WSL-ի տեղադրումն ավարտելու համար, այնուհետև նորից բացեք Koda։",
  ...
  "help.tabs.introduction": "Koda Desktop-ն այժմ կառուցված է ներդիրների շուրջ։",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Koda-ի ({{version}}) նոր տարբերակը այժմ հասանելի է տեղադրման համար:",
  ...
  "error.page.report.prefix": "Խնդրում ենք հայտնել այս սխալի մասին Koda թիմին",
  ...
  "error.chain.mcpFailed":
    "MCP «{{name}}» սերվերը ձախողվեց: Նկատի ունեցեք, որ Koda-ը դեռ չի աջակցում MCP նույնականացումը:",
  ...
  "sidebar.gettingStarted.line1": "Koda ներառում է անվճար մոդելներ, որպեսզի կարողանաք անմիջապես սկսել:",
  ...
  "settings.desktop.wsl.description": "Գործարկեք Koda սերվերը WSL-ի ներսում՝ Windows-ում։",
  ...
  "settings.general.row.language.description": "Փոխել ցուցադրման լեզուն Koda",
  ...
  "settings.general.row.appearance.description": "Անհատականացրեք, թե ինչպես է Koda տեսքը ձեր սարքում",
  "settings.general.row.colorScheme.title": "Գունային սխեման",
  "settings.general.row.colorScheme.description": "Ընտրեք՝ Koda-ը հետևում է համակարգին, թեթև թե մուգ թեմային",
  "settings.general.row.theme.title": "Թեմա",
  "settings.general.row.theme.description": "Անհատականացրեք, թե ինչպես է Koda-ի թեմատիկությունը։",
  ...
  "settings.updates.row.startup.description": "Ավտոմատ կերպով ստուգեք թարմացումների համար, երբ Koda-ը գործարկվի",
  ...
  "settings.updates.toast.latest.description": "Դուք օգտագործում եք Koda-ի վերջին տարբերակը։",
