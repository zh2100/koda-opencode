...
export const dict = {
  ...
  "desktop.about.detail":
    "Tilpasset med OpenCode som grunnlag\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "Koda v{{version}} er tilgjengelig. Åpne utgivelsessiden for å oppdatere?",
  "desktop.koda.update.open": "Åpne utgivelsessiden",
  "command.project.create": "Nytt prosjekt",
  "command.project.openExisting": "Åpne eksisterende prosjekt",
  "prompt.toast.projectRequired.title": "Velg et prosjekt",
  "prompt.toast.projectRequired.description": "Opprett eller åpne et prosjekt før du sender.",
  "prompt.approval.ask": "Be om godkjenning",
  "prompt.approval.auto": "Godkjenn for meg",
  "prompt.approval.plan": "Full tilgang",
  "prompt.more": "Mer",
  "dialog.project.create.title": "Nytt prosjekt",
  "dialog.project.create.name": "Navn",
  "dialog.project.create.location": "Plassering",
  "dialog.project.create.browse": "Bla gjennom",
  "dialog.project.create.path": "Sti",
  "dialog.project.create.submit": "Opprett",
  "dialog.project.create.error.name": "Skriv inn et prosjektnavn",
  "dialog.project.create.error.invalid": "Dette navnet kan ikke brukes på en mappe",
  "dialog.project.create.error.exists": "Mappen finnes allerede. Åpne den i stedet, eller velg et annet navn.",
  "dialog.project.create.error.failed": "Kunne ikke opprette mappen",
  "mcp.status.needs_client_registration": "krever klientregistrering",
  "home.welcome.title": "Hva kan jeg hjelpe med?",
  "home.project.create": "Nytt prosjekt",
  "home.project.open": "Åpne eksisterende prosjekt",
  "home.sessions.search.title": "Søk i samtaler",
  "session.todo.empty": "Ingen oppgaver ennå",
  "session.panel.files": "Filer",
  "session.panel.changes": "Endringer",
  "session.panel.tasks": "Oppgaver",
  "session.panel.terminal": "Terminal",
  "session.panel.empty": "Velg et prosjekt for å se filer, endringer, oppgaver og terminalen.",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "Ingen endringer",
  "session.panel.git.dirty.one": "{{count}} endret fil",
  "session.panel.git.dirty.other": "{{count}} endrede filer",
  "session.task.waiting": "Venter på tillatelse",
  "session.task.failed": "Mislyktes",
  "session.task.retry": "Prøv igjen",
  "session.task.open": "Åpne i en egen økt",
  "settings.skills.title": "Ferdigheter",
  "settings.skills.description": "Ferdigheter funnet for dette prosjektet.",
  "settings.skills.empty": "Ingen ferdigheter funnet",
  "settings.skills.enabled": "Tilgjengelig for modellen",
  "settings.skills.disabled": "Ikke tillatt for modellen",
  "settings.skills.search": "Søk etter ferdigheter",
  "settings.skills.emptySearch": "Ingen ferdigheter samsvarer med søket",
  "settings.skills.details": "Detaljer om ferdigheten",
  "settings.skills.noDescription": "Ingen beskrivelse",
  "settings.skills.source.project": "Prosjekt",
  "settings.skills.source.global": "Bruker",
  "settings.skills.source.builtin": "Innebygd",
  "settings.skills.source.custom": "Lagt til",
  "settings.scheduled.title": "Planlagte oppgaver",
  "settings.scheduled.description": "Kjør en instruksjon én gang eller hver dag i et prosjekt.",
  "settings.scheduled.empty": "Ingen planlagte oppgaver",
  "settings.scheduled.once": "Én gang",
  "settings.scheduled.daily": "Hver dag",
  "settings.scheduled.add": "Legg til oppgave",
  "settings.scheduled.field.name": "Navn",
  "settings.scheduled.field.prompt": "Instruksjon",
  "settings.scheduled.field.schedule": "Tidsplan",
  "settings.scheduled.field.time": "Kjør klokken",
  "settings.scheduled.error.name": "Skriv inn et navn",
  "settings.scheduled.error.prompt": "Skriv inn en instruksjon",
  "settings.scheduled.error.time": "Velg et tidspunkt",
  "settings.scheduled.error.model": "Velg en modell først",
  "session.new.project.open": "Åpne eksisterende prosjekt",
  "common.pin": "Fest",
  "common.unpin": "Løsne",
  "settings.relay.title": "智联AI-nøkler",
  "settings.relay.getKey": "Hent API-nøkkel",
  "settings.relay.getKey.description": "Opprett separate nøkler for ChatGPT, Grok og andre leverandører.",
  "settings.relay.upstream": "Bakenforliggende tjeneste",
  "settings.relay.unified": "Bruk en felles API-nøkkel",
  "settings.relay.unified.description": "Når dette er aktivert, bruker alle leverandører denne nøkkelen.",
  "settings.relay.unified.key": "Felles API-nøkkel",
  "settings.relay.unified.using": "Bruker den felles nøkkelen",
  "settings.relay.key.set": "Nøkkel lagret",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "La feltet stå tomt for å beholde den lagrede nøkkelen",
  "settings.relay.test": "Test tilkobling",
  "settings.relay.testing": "Tester...",
  "settings.relay.fetch": "Hent modeller",
  "settings.relay.fetching": "Henter...",
  "settings.relay.edit": "Rediger",
  "settings.relay.clearKey": "Tøm nøkkel",
  "settings.relay.add": "Legg til leverandør",
  "settings.relay.add.name": "Leverandørnavn",
  "settings.relay.models.visible": "{{count}} synlige modeller",
  "settings.relay.connected": "Tilkoblet · {{count}} modeller",
  "settings.relay.connectedEmpty": "Tilkoblet, men ingen modeller ble returnert",
  "settings.relay.test.ok": "Tilkoblingen lyktes",
  "settings.relay.test.empty": "Tilkoblet, men ingen modeller ble returnert",
  "settings.relay.models.title": "Modeller fra {{vendor}}",
  "settings.relay.models.empty": "Ingen modeller ennå. Hent listen etter at du har lagret en nøkkel.",
  "settings.relay.models.missing": "Finnes ikke lenger hos den bakenforliggende tjenesten",
  "settings.relay.saved": "Lagret automatisk",
  "settings.relay.retry": "Prøv igjen",
  "settings.relay.builtin": "Innebygd",
  "settings.relay.delete": "Slett leverandør",
  "settings.relay.rollback": "Tilbakestill importerte nøkler",
  "settings.relay.rollback.description":
    "Fjerner Relay-nøkler importert fra auth.json. Den opprinnelige auth.json beholdes.",
  "settings.relay.error.KEY_MISSING": "Legg til en API-nøkkel først",
  "settings.relay.error.KEY_REJECTED": "Nøkkelen ble avvist",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "Den bakenforliggende tjenesten kan ikke nås",
  "settings.relay.error.UPSTREAM_TIMEOUT": "Tidsavbrudd hos den bakenforliggende tjenesten",
  "settings.relay.error.UPSTREAM_RATE_LIMITED":
    "Den bakenforliggende tjenesten begrenset forespørselen på grunn av for mange forespørsler",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "Den bakenforliggende tjenesten returnerte et ugyldig svar",
  "settings.relay.error.REVISION_CONFLICT": "Denne innstillingen ble endret i et annet vindu. Oppdater og prøv igjen.",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "Kunne ikke lagre API-nøkkelen på denne enheten.",
  "settings.mcp.add": "Legg til MCP",
  "settings.mcp.edit": "Rediger",
  ...
  "settings.mcp.error.name": "Skriv inn et servernavn",
  "settings.mcp.error.command": "Skriv inn en kommando",
  "settings.mcp.error.url": "Skriv inn en URL",
  ...
  "desktop.menu.documentation": "Koda-dokumentasjon",
  ...
  "desktop.recovery.loadFailed": "Koda kunne ikke lastes inn",
  "desktop.recovery.terminated": "Koda-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "Koda svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av Koda mislyktes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Koda er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av Koda er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Koda",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i Koda.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Koda.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Koda.",
  ...
  "dialog.server.description": "Bytt hvilken Koda-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Koda ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Koda-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Koda ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Koda inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Koda-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Koda",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Koda ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om Koda skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i Koda.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Koda starter",
  ...
  "settings.updates.toast.latest.title": "Koda er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Koda.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker Koda...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker Koda i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer Koda...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer Koda i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater Koda i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater Koda",
  "wsl.onboarding.opencodeReadyIn": "Koda er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koda er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer Koda i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Koda kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Koda kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Koda på nytt.",
  ...
  "help.tabs.introduction": "Koda Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
