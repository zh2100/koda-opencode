export const dict = {
  "desktop.menu.about": "Koda के बारे में",
  "desktop.about.title": "Koda डेस्कटॉप v{{version}}",
  "desktop.about.detail": "OpenCode को आधार बनाकर संशोधित\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "Koda v{{version}} उपलब्ध है। अपग्रेड करने के लिए रिलीज़ पृष्ठ खोलें?",
  "desktop.koda.update.open": "रिलीज़ पृष्ठ खोलें",
  "command.project.create": "नया प्रोजेक्ट",
  "command.project.openExisting": "मौजूदा प्रोजेक्ट खोलें",
  "prompt.toast.projectRequired.title": "प्रोजेक्ट चुनें",
  "prompt.toast.projectRequired.description": "भेजने से पहले प्रोजेक्ट बनाएँ या खोलें।",
  "prompt.approval.ask": "अनुमोदन माँगें",
  "prompt.approval.auto": "मेरी ओर से अनुमोदन दें",
  "prompt.approval.plan": "पूर्ण पहुँच",
  "prompt.more": "और विकल्प",
  "dialog.project.create.title": "नया प्रोजेक्ट",
  "dialog.project.create.name": "नाम",
  "dialog.project.create.location": "स्थान",
  "dialog.project.create.browse": "ब्राउज़ करें",
  "dialog.project.create.path": "पथ",
  "dialog.project.create.submit": "बनाएँ",
  "dialog.project.create.error.name": "प्रोजेक्ट का नाम दर्ज करें",
  "dialog.project.create.error.invalid": "इस नाम का उपयोग फ़ोल्डर के लिए नहीं किया जा सकता",
  "dialog.project.create.error.exists": "वह फ़ोल्डर पहले से मौजूद है। उसे खोलें या दूसरा नाम चुनें।",
  "dialog.project.create.error.failed": "फ़ोल्डर नहीं बनाया जा सका",
  "mcp.status.needs_client_registration": "क्लाइंट पंजीकरण आवश्यक है",
  "home.welcome.title": "मैं किस काम में मदद कर सकता हूँ?",
  "home.project.create": "नया प्रोजेक्ट",
  "home.project.open": "मौजूदा प्रोजेक्ट खोलें",
  "home.sessions.search.title": "चैट खोजें",
  "session.todo.empty": "अभी कोई कार्य नहीं है",
  "session.panel.files": "फ़ाइलें",
  "session.panel.changes": "बदलाव",
  "session.panel.tasks": "कार्य",
  "session.panel.terminal": "टर्मिनल",
  "session.panel.empty": "फ़ाइलें, बदलाव, कार्य और टर्मिनल देखने के लिए प्रोजेक्ट चुनें।",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "कोई बदलाव नहीं",
  "session.panel.git.dirty.one": "{{count}} बदली हुई फ़ाइल",
  "session.panel.git.dirty.other": "{{count}} बदली हुई फ़ाइलें",
  "session.task.waiting": "अनुमति की प्रतीक्षा में",
  "session.task.failed": "विफल",
  "session.task.retry": "फिर कोशिश करें",
  "session.task.open": "अलग सत्र में खोलें",
  "settings.skills.title": "कौशल",
  "settings.skills.description": "इस प्रोजेक्ट के लिए मिले कौशल।",
  "settings.skills.empty": "कोई कौशल नहीं मिला",
  "settings.skills.enabled": "मॉडल के लिए उपलब्ध",
  "settings.skills.disabled": "मॉडल के लिए निषिद्ध",
  "settings.skills.search": "कौशल खोजें",
  "settings.skills.emptySearch": "इस खोज से कोई कौशल मेल नहीं खाता",
  "settings.skills.details": "कौशल का विवरण",
  "settings.skills.noDescription": "कोई विवरण नहीं",
  "settings.skills.source.project": "प्रोजेक्ट",
  "settings.skills.source.global": "उपयोगकर्ता",
  "settings.skills.source.builtin": "अंतर्निहित",
  "settings.skills.source.custom": "जोड़ा गया",
  "settings.scheduled.title": "निर्धारित कार्य",
  "settings.scheduled.description": "प्रोजेक्ट में एक बार या हर दिन प्रॉम्प्ट चलाएँ।",
  "settings.scheduled.empty": "कोई निर्धारित कार्य नहीं",
  "settings.scheduled.once": "एक बार",
  "settings.scheduled.daily": "हर दिन",
  "settings.scheduled.add": "कार्य जोड़ें",
  "settings.scheduled.field.name": "नाम",
  "settings.scheduled.field.prompt": "प्रॉम्प्ट",
  "settings.scheduled.field.schedule": "समय-सारणी",
  "settings.scheduled.field.time": "चलाने का समय",
  "settings.scheduled.error.name": "नाम दर्ज करें",
  "settings.scheduled.error.prompt": "प्रॉम्प्ट दर्ज करें",
  "settings.scheduled.error.time": "समय चुनें",
  "settings.scheduled.error.model": "पहले मॉडल चुनें",
  "session.new.project.open": "मौजूदा प्रोजेक्ट खोलें",
  "common.pin": "पिन करें",
  "common.unpin": "पिन हटाएँ",
  "settings.relay.title": "智联AI कुंजियाँ",
  "settings.relay.getKey": "API कुंजी प्राप्त करें",
  "settings.relay.getKey.description": "ChatGPT, Grok और अन्य प्रदाताओं के लिए अलग-अलग कुंजियाँ बनाएँ।",
  "settings.relay.upstream": "अपस्ट्रीम",
  "settings.relay.unified": "साझा API कुंजी इस्तेमाल करें",
  "settings.relay.unified.description": "सक्षम होने पर हर विक्रेता इस कुंजी का इस्तेमाल करता है।",
  "settings.relay.unified.key": "साझा API कुंजी",
  "settings.relay.unified.using": "साझा कुंजी का उपयोग हो रहा है",
  "settings.relay.key.set": "कुंजी सहेजी गई",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "सहेजी गई कुंजी रखने के लिए खाली छोड़ें",
  "settings.relay.test": "कनेक्शन जाँचें",
  "settings.relay.testing": "जाँच जारी है...",
  "settings.relay.fetch": "मॉडल प्राप्त करें",
  "settings.relay.fetching": "प्राप्त किए जा रहे हैं...",
  "settings.relay.edit": "संपादित करें",
  "settings.relay.clearKey": "कुंजी साफ़ करें",
  "settings.relay.add": "विक्रेता जोड़ें",
  "settings.relay.add.name": "विक्रेता का नाम",
  "settings.relay.models.visible": "{{count}} दृश्यमान मॉडल",
  "settings.relay.connected": "कनेक्ट हुआ · {{count}} मॉडल",
  "settings.relay.connectedEmpty": "कनेक्ट हुआ, लेकिन कोई मॉडल नहीं मिला",
  "settings.relay.test.ok": "कनेक्शन सफल रहा",
  "settings.relay.test.empty": "कनेक्ट हुआ, लेकिन कोई मॉडल नहीं मिला",
  "settings.relay.models.title": "{{vendor}} के मॉडल",
  "settings.relay.models.empty": "अभी कोई मॉडल नहीं है। कुंजी सहेजने के बाद सूची प्राप्त करें।",
  "settings.relay.models.missing": "अब अपस्ट्रीम पर उपलब्ध नहीं",
  "settings.relay.saved": "अपने आप सहेजा गया",
  "settings.relay.retry": "फिर कोशिश करें",
  "settings.relay.builtin": "अंतर्निहित",
  "settings.relay.delete": "विक्रेता हटाएँ",
  "settings.relay.rollback": "आयातित कुंजियाँ रीसेट करें",
  "settings.relay.rollback.description": "auth.json से आयातित Relay कुंजियाँ साफ़ करता है। मूल auth.json रखा जाता है।",
  "settings.relay.error.KEY_MISSING": "पहले API कुंजी जोड़ें",
  "settings.relay.error.KEY_REJECTED": "कुंजी अस्वीकार कर दी गई",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "अपस्ट्रीम तक पहुँचा नहीं जा सकता",
  "settings.relay.error.UPSTREAM_TIMEOUT": "अपस्ट्रीम की समय सीमा समाप्त हो गई",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "अपस्ट्रीम ने अनुरोध की दर सीमित कर दी",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "अपस्ट्रीम ने अमान्य प्रतिक्रिया लौटाई",
  "settings.relay.error.REVISION_CONFLICT": "यह सेटिंग दूसरी विंडो में बदल गई है। रीफ़्रेश करें और फिर कोशिश करें।",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "इस डिवाइस पर API कुंजी नहीं सहेजी जा सकी।",
  "settings.mcp.add": "MCP जोड़ें",
  "settings.mcp.edit": "संपादित करें",
  "settings.mcp.field.name": "नाम",
  "settings.mcp.field.type": "प्रकार",
  "settings.mcp.field.command": "कमांड",
  ...
  "settings.mcp.type.remote": "दूरस्थ",
  "settings.mcp.error.name": "सर्वर का नाम दर्ज करें",
  "settings.mcp.error.command": "कमांड दर्ज करें",
  "settings.mcp.error.url": "URL दर्ज करें",
  ...
  "desktop.menu.documentation": "Koda दस्तावेज़",
  ...
  "desktop.menu.ariaLabel": "Koda मेन्यू",
  ...
  "desktop.recovery.loadFailed": "Koda लोड नहीं हो सका",
  "desktop.recovery.terminated": "Koda विंडो अनपेक्षित रूप से बंद हो गई",
  "desktop.recovery.unresponsive": "Koda प्रतिसाद नहीं दे रहा है",
  ...
  "desktop.wsl.error.installOpencode": "Koda इंस्टॉल नहीं हो सका",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} में Koda इंस्टॉल नहीं है",
  "desktop.wsl.error.updateVersion":
    "Koda अपडेट पूरा हो गया, लेकिन {{distro}} अब भी {{installed}} रिपोर्ट कर रहा है; अपेक्षित संस्करण {{expected}} है",
  ...
  "dialog.model.unpaid.freeModels.title": "Koda द्वारा उपलब्ध निःशुल्क मॉडल",
  ...
  "provider.connect.apiKey.description":
    "अपने खाते को कनेक्ट करने के लिए अपनी {{provider}} API कुंजी दर्ज करें और Koda में {{provider}} मॉडल का उपयोग करें।",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen आपको कोडिंग एजेंटों के लिए चुने गए विश्वसनीय, अनुकूलित मॉडलों तक पहुँच देता है।",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " अपने खाते को कनेक्ट करने और Koda में {{provider}} मॉडल का उपयोग करने के लिए अपना प्राधिकरण कोड प्राप्त करें।",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " और अपने खाते को कनेक्ट करने तथा Koda में {{provider}} मॉडल का उपयोग करने के लिए नीचे दिया गया कोड दर्ज करें।",
  ...
  "dialog.server.description": "स्विच करें कि यह ऐप किस Koda सर्वर से कनेक्ट होता है।",
  ...
  "wsl.onboarding.checkingOpencode": "Koda की जाँच हो रही है...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} में Koda की जाँच हो रही है...",
  "wsl.onboarding.updatingOpencode": "Koda अपडेट हो रहा है...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} में Koda अपडेट हो रहा है...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} में Koda को अपडेट करें।",
  "wsl.onboarding.updateOpencode": "Koda को अपडेट करें",
  "wsl.onboarding.opencodeReadyIn": "Koda {{distro}} में तैयार है।",
  "wsl.onboarding.opencodeReady": "Koda तैयार है।",
  "wsl.onboarding.installOpencodeIn": "{{distro}} में Koda स्थापित करें।",
  "wsl.onboarding.installOpencode": "Koda स्थापित करें",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda स्थापित नहीं है",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Koda द्वारा WSL सर्वर जोड़ने से पहले WSL (Linux के लिए Windows सबसिस्टम) आवश्यक है",
  "wsl.onboarding.wslUnavailable.title": "WSL अनुपलब्ध है",
  "wsl.onboarding.wslUnavailable.description": "Koda इस मशीन पर WSL को सत्यापित नहीं कर सका।",
  "wsl.onboarding.installWsl": "WSL स्थापित करें",
  "wsl.onboarding.windowsRestartRequired":
    "WSL की स्थापना समाप्त करने के लिए Windows को पुनरारंभ करें, फिर Koda को फिर से खोलें।",
  ...
  "help.tabs.introduction": "Koda Desktop अब टैब पर आधारित है।",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Koda ({{version}}) का एक नया संस्करण अब इंस्टॉल करने के लिए उपलब्ध है।",
  ...
  "error.page.report.prefix": "कृपया इस त्रुटि की रिपोर्ट Koda टीम को करें",
  ...
  "error.chain.mcpFailed":
    'MCP सर्वर "{{name}}" विफल रहा। ध्यान दें, Koda अभी तक MCP प्रमाणीकरण का समर्थन नहीं करता है।',
  ...
  "sidebar.gettingStarted.line1": "Koda में निःशुल्क मॉडल शामिल है ताकि आप तुरंत शुरू कर सकें।",
  ...
  "settings.desktop.wsl.description": "Windows पर WSL के अंदर Koda सर्वर चलाएँ।",
  ...
  "settings.general.row.language.description": "Koda के लिए प्रदर्शन भाषा बदलें",
  ...
  "settings.general.row.appearance.description": "अनुकूलित करें कि Koda आपके डिवाइस पर कैसा दिखता है",
  "settings.general.row.colorScheme.title": "रंग योजना",
  "settings.general.row.colorScheme.description": "चुनें कि Koda सिस्टम, हल्की या गहरी थीम में से किसका उपयोग करे",
  "settings.general.row.theme.title": "थीम",
  "settings.general.row.theme.description": "अनुकूलित करें कि Koda की थीम कैसी है।",
  ...
  "settings.updates.row.startup.description": "Koda लॉन्च होने पर अपने-आप अपडेट की जाँच करें",
  ...
  "settings.updates.toast.latest.description": "आप Koda का नवीनतम संस्करण चला रहे हैं।",
