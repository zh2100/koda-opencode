export const dict = {
  "desktop.menu.about": "Perihal Koda",
  "desktop.about.title": "Koda Desktop v{{version}}",
  "desktop.about.detail":
    "Diubah suai dengan OpenCode sebagai teras\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "Koda v{{version}} tersedia. Buka halaman keluaran untuk menaik taraf?",
  "desktop.koda.update.open": "Buka halaman keluaran",
  "command.project.create": "Projek baharu",
  "command.project.openExisting": "Buka projek sedia ada",
  "prompt.toast.projectRequired.title": "Pilih projek",
  "prompt.toast.projectRequired.description": "Cipta atau buka projek sebelum menghantar.",
  "prompt.approval.ask": "Minta kelulusan",
  "prompt.approval.auto": "Luluskan bagi pihak saya",
  "prompt.approval.plan": "Akses penuh",
  "prompt.more": "Lagi",
  "dialog.project.create.title": "Projek baharu",
  "dialog.project.create.name": "Nama",
  "dialog.project.create.location": "Lokasi",
  "dialog.project.create.browse": "Semak imbas",
  "dialog.project.create.path": "Laluan",
  "dialog.project.create.submit": "Cipta",
  "dialog.project.create.error.name": "Masukkan nama projek",
  "dialog.project.create.error.invalid": "Nama ini tidak boleh digunakan untuk folder",
  "dialog.project.create.error.exists": "Folder itu sudah wujud. Buka folder tersebut atau pilih nama lain.",
  "dialog.project.create.error.failed": "Tidak dapat mencipta folder",
  "mcp.status.needs_client_registration": "memerlukan pendaftaran klien",
  "home.welcome.title": "Apa yang boleh saya bantu?",
  "home.project.create": "Projek baharu",
  "home.project.open": "Buka projek sedia ada",
  "home.sessions.search.title": "Cari perbualan",
  "session.todo.empty": "Belum ada tugasan",
  "session.panel.files": "Fail",
  "session.panel.changes": "Perubahan",
  "session.panel.tasks": "Tugasan",
  "session.panel.terminal": "Terminal",
  "session.panel.empty": "Pilih projek untuk menyemak imbas fail, perubahan, tugasan dan terminal.",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "Tiada perubahan",
  "session.panel.git.dirty.one": "{{count}} fail diubah",
  "session.panel.git.dirty.other": "{{count}} fail diubah",
  "session.task.waiting": "Menunggu kebenaran",
  "session.task.failed": "Gagal",
  "session.task.retry": "Cuba lagi",
  "session.task.open": "Buka dalam sesi tersendiri",
  "settings.skills.title": "Kemahiran",
  "settings.skills.description": "Kemahiran yang ditemui untuk projek ini.",
  "settings.skills.empty": "Tiada kemahiran ditemui",
  "settings.skills.enabled": "Boleh digunakan oleh model",
  "settings.skills.disabled": "Tidak dibenarkan untuk model",
  "settings.skills.search": "Cari kemahiran",
  "settings.skills.emptySearch": "Tiada kemahiran sepadan dengan carian ini",
  "settings.skills.details": "Butiran kemahiran",
  "settings.skills.noDescription": "Tiada penerangan",
  "settings.skills.source.project": "Projek",
  "settings.skills.source.global": "Pengguna",
  "settings.skills.source.builtin": "Terbina dalam",
  "settings.skills.source.custom": "Ditambah",
  "settings.scheduled.title": "Tugasan berjadual",
  "settings.scheduled.description": "Jalankan prom sekali atau setiap hari dalam projek.",
  "settings.scheduled.empty": "Tiada tugasan berjadual",
  "settings.scheduled.once": "Sekali",
  "settings.scheduled.daily": "Setiap hari",
  "settings.scheduled.add": "Tambah tugasan",
  "settings.scheduled.field.name": "Nama",
  "settings.scheduled.field.prompt": "Prom",
  "settings.scheduled.field.schedule": "Jadual",
  "settings.scheduled.field.time": "Jalankan pada",
  "settings.scheduled.error.name": "Masukkan nama",
  "settings.scheduled.error.prompt": "Masukkan prom",
  "settings.scheduled.error.time": "Pilih masa",
  "settings.scheduled.error.model": "Pilih model dahulu",
  "session.new.project.open": "Buka projek sedia ada",
  "common.pin": "Sematkan",
  "common.unpin": "Nyahsemat",
  "settings.relay.title": "Kunci 智联AI",
  "settings.relay.getKey": "Dapatkan kunci API",
  "settings.relay.getKey.description": "Cipta kunci berasingan untuk ChatGPT, Grok dan penyedia lain.",
  "settings.relay.upstream": "Perkhidmatan huluan",
  "settings.relay.unified": "Gunakan kunci API bersama",
  "settings.relay.unified.description": "Apabila didayakan, semua vendor menggunakan kunci ini.",
  "settings.relay.unified.key": "Kunci API bersama",
  "settings.relay.unified.using": "Menggunakan kunci bersama",
  "settings.relay.key.set": "Kunci disimpan",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "Biarkan kosong untuk mengekalkan kunci yang disimpan",
  "settings.relay.test": "Uji sambungan",
  "settings.relay.testing": "Sedang menguji...",
  "settings.relay.fetch": "Dapatkan model",
  "settings.relay.fetching": "Sedang mendapatkan...",
  "settings.relay.edit": "Sunting",
  "settings.relay.clearKey": "Kosongkan kunci",
  "settings.relay.add": "Tambah vendor",
  "settings.relay.add.name": "Nama vendor",
  "settings.relay.models.visible": "{{count}} model kelihatan",
  "settings.relay.connected": "Disambungkan · {{count}} model",
  "settings.relay.connectedEmpty": "Disambungkan, tetapi tiada model dikembalikan",
  "settings.relay.test.ok": "Sambungan berjaya",
  "settings.relay.test.empty": "Disambungkan, tetapi tiada model dikembalikan",
  "settings.relay.models.title": "Model {{vendor}}",
  "settings.relay.models.empty": "Belum ada model. Dapatkan senarai selepas menyimpan kunci.",
  "settings.relay.models.missing": "Tidak lagi tersedia pada perkhidmatan huluan",
  "settings.relay.saved": "Disimpan secara automatik",
  "settings.relay.retry": "Cuba lagi",
  "settings.relay.builtin": "Terbina dalam",
  "settings.relay.delete": "Padam vendor",
  "settings.relay.rollback": "Tetapkan semula kunci yang diimport",
  "settings.relay.rollback.description":
    "Mengosongkan kunci Relay yang diimport daripada auth.json. auth.json asal dikekalkan.",
  "settings.relay.error.KEY_MISSING": "Tambah kunci API dahulu",
  "settings.relay.error.KEY_REJECTED": "Kunci ditolak",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "Perkhidmatan huluan tidak dapat dicapai",
  "settings.relay.error.UPSTREAM_TIMEOUT": "Perkhidmatan huluan tamat masa",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "Perkhidmatan huluan mengehadkan kadar permintaan",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "Perkhidmatan huluan mengembalikan respons tidak sah",
  "settings.relay.error.REVISION_CONFLICT": "Tetapan ini berubah dalam tetingkap lain. Muat semula dan cuba lagi.",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "Tidak dapat menyimpan kunci API pada peranti ini.",
  "settings.mcp.add": "Tambah MCP",
  "settings.mcp.edit": "Sunting",
  "settings.mcp.field.name": "Nama",
  "settings.mcp.field.type": "Jenis",
  "settings.mcp.field.command": "Arahan",
  ...
  "settings.mcp.error.name": "Masukkan nama pelayan",
  "settings.mcp.error.command": "Masukkan arahan",
  "settings.mcp.error.url": "Masukkan URL",
  ...
  "desktop.menu.documentation": "Dokumentasi Koda",
  ...
  "desktop.recovery.loadFailed": "Koda gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap Koda ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "Koda tidak memberi respons",
  ...
  "desktop.wsl.error.installOpencode": "Pemasangan Koda gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Koda tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini Koda selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh Koda",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Koda.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen memberi anda akses kepada set model terpilih yang boleh dipercayai dan dioptimumkan untuk ejen pengekodan.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam Koda.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Koda.",
  ...
  "dialog.server.description": "Tukar pelayan Koda yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Sedang menyemak Koda...",
  "wsl.onboarding.checkingOpencodeIn": "Sedang menyemak Koda dalam {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Sedang mengemas kini Koda...",
  "wsl.onboarding.updatingOpencodeIn": "Sedang mengemas kini Koda dalam {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Kemas kini Koda dalam {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kemas kini Koda",
  "wsl.onboarding.opencodeReadyIn": "Koda sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koda sedia digunakan.",
  "wsl.onboarding.installOpencodeIn": "Pasang Koda dalam {{distro}}.",
  "wsl.onboarding.installOpencode": "Pasang Koda",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Koda boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Koda tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula Koda.",
  ...
  "help.tabs.introduction": "Koda Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu Koda ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan Koda",
  ...
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, Koda belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "Koda merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan Koda dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk Koda",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa Koda pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada Koda mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema Koda.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila Koda dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini Koda.",
