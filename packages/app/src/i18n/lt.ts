export const dict = {
  ...
  "desktop.menu.documentation": "Koda dokumentacija",
  ...
  "desktop.menu.ariaLabel": "Koda meniu",
  ...
  "desktop.updater.dialog.upToDate.message": "Naudojate naujausią versiją.",
  ...
  "desktop.recovery.loadFailed": "Koda įkelti nepavyko",
  "desktop.recovery.terminated": "Koda langas netikėtai užsidarė",
  "desktop.recovery.unresponsive": "Koda neatsako",
  ...
  "desktop.wsl.error.installOpencode": "Koda įdiegti nepavyko",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Koda neįdiegtas distributyve {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Koda naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  ...
  "desktop.menu.about": "Apie Koda",
  "desktop.about.title": "Koda darbalaukio programa v{{version}}",
  "desktop.about.detail":
    "Modifikuota naudojant OpenCode kaip pagrindą\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "Pasiekiama Koda v{{version}}. Atverti leidimo puslapį, kad atnaujintumėte?",
  "desktop.koda.update.open": "Atverti leidimo puslapį",
  "command.project.create": "Naujas projektas",
  "command.project.openExisting": "Atverti esamą projektą",
  "prompt.toast.projectRequired.title": "Pasirinkite projektą",
  "prompt.toast.projectRequired.description": "Prieš siųsdami sukurkite arba atverkite projektą.",
  "prompt.approval.ask": "Prašyti patvirtinimo",
  "prompt.approval.auto": "Patvirtinti už mane",
  "prompt.approval.plan": "Visiška prieiga",
  "prompt.more": "Daugiau",
  "dialog.project.create.title": "Naujas projektas",
  "dialog.project.create.name": "Pavadinimas",
  "dialog.project.create.location": "Vieta",
  "dialog.project.create.browse": "Naršyti",
  "dialog.project.create.path": "Kelias",
  "dialog.project.create.submit": "Sukurti",
  "dialog.project.create.error.name": "Įveskite projekto pavadinimą",
  "dialog.project.create.error.invalid": "Šio pavadinimo negalima naudoti aplankui",
  "dialog.project.create.error.exists": "Toks aplankas jau yra. Atverkite jį arba pasirinkite kitą pavadinimą.",
  "dialog.project.create.error.failed": "Nepavyko sukurti aplanko",
  "mcp.status.needs_client_registration": "reikia užregistruoti klientą",
  "home.welcome.title": "Kuo galiu padėti?",
  "home.project.create": "Naujas projektas",
  "home.project.open": "Atverti esamą projektą",
  "home.sessions.search.title": "Ieškoti pokalbių",
  "session.todo.empty": "Užduočių dar nėra",
  "session.panel.files": "Failai",
  "session.panel.changes": "Pakeitimai",
  "session.panel.tasks": "Užduotys",
  "session.panel.terminal": "Terminalas",
  "session.panel.empty": "Pasirinkite projektą, kad galėtumėte naršyti failus, pakeitimus, užduotis ir terminalą.",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "Be pakeitimų",
  "session.panel.git.dirty.one": "{{count}} pakeistas failas",
  "session.panel.git.dirty.few": "{{count}} pakeisti failai",
  "session.panel.git.dirty.many": "{{count}} pakeisto failo",
  "session.panel.git.dirty.other": "{{count}} pakeistų failų",
  "session.task.waiting": "Laukiama leidimo",
  "session.task.failed": "Nepavyko",
  "session.task.retry": "Bandyti dar kartą",
  "session.task.open": "Atverti atskirame seanse",
  "settings.skills.title": "Įgūdžiai",
  "settings.skills.description": "Šiam projektui rasti įgūdžiai.",
  "settings.skills.empty": "Įgūdžių nerasta",
  "settings.skills.enabled": "Pasiekiamas modeliui",
  "settings.skills.disabled": "Uždraustas modeliui",
  "settings.skills.search": "Ieškoti įgūdžių",
  "settings.skills.emptySearch": "Paiešką atitinkančių įgūdžių nėra",
  "settings.skills.details": "Įgūdžio informacija",
  "settings.skills.noDescription": "Aprašo nėra",
  "settings.skills.source.project": "Projektas",
  "settings.skills.source.global": "Naudotojas",
  "settings.skills.source.builtin": "Įtaisytas",
  "settings.skills.source.custom": "Pridėtas",
  "settings.scheduled.title": "Suplanuotos užduotys",
  "settings.scheduled.description": "Vykdykite užklausą projekte vieną kartą arba kasdien.",
  "settings.scheduled.empty": "Suplanuotų užduočių nėra",
  "settings.scheduled.once": "Vieną kartą",
  "settings.scheduled.daily": "Kasdien",
  "settings.scheduled.add": "Pridėti užduotį",
  "settings.scheduled.field.name": "Pavadinimas",
  "settings.scheduled.field.prompt": "Užklausa",
  "settings.scheduled.field.schedule": "Tvarkaraštis",
  "settings.scheduled.field.time": "Vykdymo laikas",
  "settings.scheduled.error.name": "Įveskite pavadinimą",
  "settings.scheduled.error.prompt": "Įveskite užklausą",
  "settings.scheduled.error.time": "Pasirinkite laiką",
  "settings.scheduled.error.model": "Pirmiausia pasirinkite modelį",
  "session.new.project.open": "Atverti esamą projektą",
  "common.pin": "Prisegti",
  "common.unpin": "Atsegti",
  "settings.relay.title": "智联AI raktai",
  "settings.relay.getKey": "Gauti API raktą",
  "settings.relay.getKey.description": "Sukurkite atskirus raktus ChatGPT, Grok ir kitiems teikėjams.",
  "settings.relay.upstream": "Aukštesnio lygio serveris",
  "settings.relay.unified": "Naudoti bendrą API raktą",
  "settings.relay.unified.description": "Įjungus visi teikėjai naudoja šį raktą.",
  "settings.relay.unified.key": "Bendras API raktas",
  "settings.relay.unified.using": "Naudojamas bendras raktas",
  "settings.relay.key.set": "Raktas įrašytas",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "Palikite tuščią, kad išsaugotumėte įrašytą raktą",
  "settings.relay.test": "Tikrinti ryšį",
  "settings.relay.testing": "Tikrinama...",
  "settings.relay.fetch": "Gauti modelius",
  "settings.relay.fetching": "Gaunama...",
  "settings.relay.edit": "Taisyti",
  "settings.relay.clearKey": "Išvalyti raktą",
  "settings.relay.add": "Pridėti teikėją",
  "settings.relay.add.name": "Teikėjo pavadinimas",
  "settings.relay.models.visible": "Matomų modelių: {{count}}",
  "settings.relay.connected": "Prisijungta · modelių: {{count}}",
  "settings.relay.connectedEmpty": "Prisijungta, bet modelių negrąžinta",
  "settings.relay.test.ok": "Ryšys užmegztas",
  "settings.relay.test.empty": "Prisijungta, bet modelių negrąžinta",
  "settings.relay.models.title": "{{vendor}} modeliai",
  "settings.relay.models.empty": "Modelių dar nėra. Įrašę raktą, gaukite sąrašą.",
  "settings.relay.models.missing": "Aukštesnio lygio serveryje nebėra",
  "settings.relay.saved": "Įrašyta automatiškai",
  "settings.relay.retry": "Bandyti dar kartą",
  "settings.relay.builtin": "Įtaisytas",
  "settings.relay.delete": "Pašalinti teikėją",
  "settings.relay.rollback": "Atkurti importuotus raktus",
  "settings.relay.rollback.description": "Išvalo iš auth.json importuotus Relay raktus. Pradinis auth.json išsaugomas.",
  "settings.relay.error.KEY_MISSING": "Pirmiausia pridėkite API raktą",
  "settings.relay.error.KEY_REJECTED": "Raktas atmestas",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "Aukštesnio lygio serveris nepasiekiamas",
  "settings.relay.error.UPSTREAM_TIMEOUT": "Baigėsi aukštesnio lygio serverio laukimo laikas",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "Aukštesnio lygio serveris apribojo užklausų dažnį",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "Aukštesnio lygio serveris grąžino netinkamą atsakymą",
  "settings.relay.error.REVISION_CONFLICT": "Ši nuostata pakeista kitame lange. Atnaujinkite ir bandykite dar kartą.",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "Nepavyko įrašyti API rakto šiame įrenginyje.",
  "settings.mcp.add": "Pridėti MCP",
  "settings.mcp.edit": "Taisyti",
  "settings.mcp.field.name": "Pavadinimas",
  "settings.mcp.field.type": "Tipas",
  ...
  "settings.mcp.error.name": "Įveskite serverio pavadinimą",
  "settings.mcp.error.command": "Įveskite komandą",
  "settings.mcp.error.url": "Įveskite URL",
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami Koda modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje Koda.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen suteikia prieigą prie kuruojamo patikimų optimizuotų kodavimo agentų modelių rinkinio.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius Koda.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius Koda.",
  ...
  "dialog.server.description": "Perjunkite, prie kurio Koda serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama Koda...",
  "wsl.onboarding.checkingOpencodeIn": "Tikrinama Koda {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atnaujinamas Koda...",
  "wsl.onboarding.updatingOpencodeIn": "Atnaujinamas Koda {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atnaujinkite Koda {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atnaujinkite Koda",
  "wsl.onboarding.opencodeReadyIn": "Koda yra paruoštas {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koda yra paruoštas.",
  "wsl.onboarding.installOpencodeIn": "Įdiekite Koda į {{distro}}.",
  "wsl.onboarding.installOpencode": "Įdiekite Koda",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad Koda galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "Koda nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite Koda.",
  ...
  "help.tabs.introduction": "Koda Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują Koda ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą Koda komandai",
  ...
  "error.chain.mcpFailed": "MCP serveris „{{name}}“ nepavyko. Atminkite, kad Koda dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "Koda apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "Koda darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite Koda serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite Koda ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip Koda atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar Koda seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite Koda temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas Koda",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią Koda versiją.",
