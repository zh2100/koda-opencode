...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "Koda įkelti nepavyko",
  "Koda langas netikėtai užsidarė",
  "Koda neatsako",
...
export const dict = {
  ...
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad Koda dar nepalaiko MCP autentifikavimo.",
