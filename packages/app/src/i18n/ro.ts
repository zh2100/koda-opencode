export const dict = {
  "desktop.menu.about": "Despre Koda",
  "desktop.about.title": "Koda Desktop v{{version}}",
  "desktop.about.detail": "Modificat pe baza OpenCode\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "Koda v{{version}} este disponibilă. Deschizi pagina versiunii pentru actualizare?",
  "desktop.koda.update.open": "Deschide pagina versiunii",
  "command.project.create": "Proiect nou",
  "command.project.openExisting": "Deschide un proiect existent",
  "prompt.toast.projectRequired.title": "Alege un proiect",
  "prompt.toast.projectRequired.description": "Creează sau deschide un proiect înainte de trimitere.",
  "prompt.approval.ask": "Solicită aprobare",
  "prompt.approval.auto": "Aprobă în locul meu",
  "prompt.approval.plan": "Acces complet",
  "prompt.more": "Mai multe",
  "dialog.project.create.title": "Proiect nou",
  "dialog.project.create.name": "Nume",
  "dialog.project.create.location": "Locație",
  "dialog.project.create.browse": "Răsfoiește",
  "dialog.project.create.path": "Cale",
  "dialog.project.create.submit": "Creează",
  "dialog.project.create.error.name": "Introdu numele proiectului",
  "dialog.project.create.error.invalid": "Acest nume nu poate fi folosit pentru un dosar",
  "dialog.project.create.error.exists": "Dosarul există deja. Deschide-l sau alege alt nume.",
  "dialog.project.create.error.failed": "Nu s-a putut crea dosarul",
  "mcp.status.needs_client_registration": "necesită înregistrarea clientului",
  "home.welcome.title": "Cu ce te pot ajuta?",
  "home.project.create": "Proiect nou",
  "home.project.open": "Deschide un proiect existent",
  "home.sessions.search.title": "Caută conversații",
  "session.todo.empty": "Încă nu există sarcini",
  "session.panel.files": "Fișiere",
  "session.panel.changes": "Modificări",
  "session.panel.tasks": "Sarcini",
  "session.panel.terminal": "Terminal",
  "session.panel.empty": "Selectează un proiect pentru a vedea fișierele, modificările, sarcinile și terminalul.",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "Fără modificări",
  "session.panel.git.dirty.one": "{{count}} fișier modificat",
  "session.panel.git.dirty.few": "{{count}} fișiere modificate",
  "session.panel.git.dirty.other": "{{count}} de fișiere modificate",
  "session.task.waiting": "Se așteaptă permisiunea",
  "session.task.failed": "Eșuat",
  "session.task.retry": "Reîncearcă",
  "session.task.open": "Deschide într-o sesiune separată",
  "settings.skills.title": "Abilități",
  "settings.skills.description": "Abilități descoperite pentru acest proiect.",
  "settings.skills.empty": "Nu s-au găsit abilități",
  "settings.skills.enabled": "Disponibilă modelului",
  "settings.skills.disabled": "Interzisă modelului",
  "settings.skills.search": "Caută abilități",
  "settings.skills.emptySearch": "Nicio abilitate nu corespunde căutării",
  "settings.skills.details": "Detaliile abilității",
  "settings.skills.noDescription": "Fără descriere",
  "settings.skills.source.project": "Proiect",
  "settings.skills.source.global": "Utilizator",
  "settings.skills.source.builtin": "Încorporată",
  "settings.skills.source.custom": "Adăugată",
  "settings.scheduled.title": "Sarcini programate",
  "settings.scheduled.description": "Execută o instrucțiune într-un proiect o singură dată sau zilnic.",
  "settings.scheduled.empty": "Nu există sarcini programate",
  "settings.scheduled.once": "O singură dată",
  "settings.scheduled.daily": "Zilnic",
  "settings.scheduled.add": "Adaugă o sarcină",
  "settings.scheduled.field.name": "Nume",
  "settings.scheduled.field.prompt": "Instrucțiune",
  "settings.scheduled.field.schedule": "Programare",
  "settings.scheduled.field.time": "Ora executării",
  "settings.scheduled.error.name": "Introdu un nume",
  "settings.scheduled.error.prompt": "Introdu o instrucțiune",
  "settings.scheduled.error.time": "Alege o oră",
  "settings.scheduled.error.model": "Selectează mai întâi un model",
  "session.new.project.open": "Deschide un proiect existent",
  "common.pin": "Fixează",
  "common.unpin": "Anulează fixarea",
  "settings.relay.title": "Chei 智联AI",
  "settings.relay.getKey": "Obține o cheie API",
  "settings.relay.getKey.description": "Creează chei separate pentru ChatGPT, Grok și alți furnizori.",
  "settings.relay.upstream": "Serverul furnizorului",
  "settings.relay.unified": "Folosește o cheie API comună",
  "settings.relay.unified.description": "Când este activată, toți furnizorii folosesc această cheie.",
  "settings.relay.unified.key": "Cheie API comună",
  "settings.relay.unified.using": "Se folosește cheia comună",
  "settings.relay.key.set": "Cheie salvată",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "Lasă necompletat pentru a păstra cheia salvată",
  "settings.relay.test": "Testează conexiunea",
  "settings.relay.testing": "Se testează...",
  "settings.relay.fetch": "Obține modelele",
  "settings.relay.fetching": "Se preiau...",
  "settings.relay.edit": "Editează",
  "settings.relay.clearKey": "Șterge cheia",
  "settings.relay.add": "Adaugă un furnizor",
  "settings.relay.add.name": "Numele furnizorului",
  "settings.relay.models.visible": "Modele vizibile: {{count}}",
  "settings.relay.connected": "Conectat · Modele: {{count}}",
  "settings.relay.connectedEmpty": "Conectat, dar nu au fost returnate modele",
  "settings.relay.test.ok": "Conectare reușită",
  "settings.relay.test.empty": "Conectat, dar nu au fost returnate modele",
  "settings.relay.models.title": "Modele {{vendor}}",
  "settings.relay.models.empty": "Încă nu există modele. Preia lista după salvarea unei chei.",
  "settings.relay.models.missing": "Nu mai este pe serverul furnizorului",
  "settings.relay.saved": "Salvat automat",
  "settings.relay.retry": "Reîncearcă",
  "settings.relay.builtin": "Încorporat",
  "settings.relay.delete": "Șterge furnizorul",
  "settings.relay.rollback": "Resetează cheile importate",
  "settings.relay.rollback.description":
    "Șterge cheile Relay importate din auth.json. Fișierul auth.json original este păstrat.",
  "settings.relay.error.KEY_MISSING": "Adaugă mai întâi o cheie API",
  "settings.relay.error.KEY_REJECTED": "Cheia a fost respinsă",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "Serverul furnizorului nu este accesibil",
  "settings.relay.error.UPSTREAM_TIMEOUT": "Timpul de așteptare pentru serverul furnizorului a expirat",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "Serverul furnizorului a limitat frecvența cererilor",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "Serverul furnizorului a returnat un răspuns nevalid",
  "settings.relay.error.REVISION_CONFLICT":
    "Această setare a fost modificată în altă fereastră. Reîmprospătează și încearcă din nou.",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "Nu s-a putut salva cheia API pe acest dispozitiv.",
  "settings.mcp.add": "Adaugă MCP",
  "settings.mcp.edit": "Editează",
  "settings.mcp.field.name": "Nume",
  "settings.mcp.field.type": "Tip",
  "settings.mcp.field.command": "Comandă",
  ...
  "settings.mcp.error.name": "Introdu numele serverului",
  "settings.mcp.error.command": "Introdu o comandă",
  "settings.mcp.error.url": "Introdu un URL",
  ...
  "desktop.menu.documentation": "Documentație Koda",
  ...
  "desktop.menu.ariaLabel": "Meniu Koda",
  ...
  "desktop.recovery.loadFailed": "Koda nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra Koda s-a închis neașteptat",
  "desktop.recovery.unresponsive": "Koda nu răspunde",
  ...
  "desktop.wsl.error.installOpencode": "Instalarea Koda a eșuat",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Koda nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea Koda s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de Koda",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în Koda.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen îți oferă acces la un set selectat de modele optimizate și fiabile pentru agenți de programare.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în Koda.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în Koda.",
  ...
  "dialog.server.description": "Schimbă serverul Koda la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingOpencode": "Se verifică Koda...",
  "wsl.onboarding.checkingOpencodeIn": "Se verifică Koda în {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Se actualizează Koda...",
  "wsl.onboarding.updatingOpencodeIn": "Se actualizează Koda în {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualizează Koda în {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizează Koda",
  "wsl.onboarding.opencodeReadyIn": "Koda este gata în {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koda este gata.",
  "wsl.onboarding.installOpencodeIn": "Instalează Koda în {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalează Koda",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca Koda să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "Koda nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired": "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide Koda.",
  ...
  "help.tabs.introduction": "Koda Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune Koda ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei Koda",
  ...
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, Koda nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "Koda include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul Koda în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru Koda",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul Koda pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă Koda urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema Koda.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea Koda",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune Koda.",
