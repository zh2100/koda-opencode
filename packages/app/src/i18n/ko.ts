export const dict = {
  "desktop.menu.about": "Koda 정보",
  "desktop.about.title": "Koda Desktop v{{version}}",
  "desktop.about.detail": "OpenCode를 기반으로 수정\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "Koda v{{version}}을 사용할 수 있습니다. 릴리스 페이지를 열어 업그레이드할까요?",
  "desktop.koda.update.open": "릴리스 페이지 열기",
  "command.project.create": "새 프로젝트",
  "command.project.openExisting": "기존 프로젝트 열기",
  "prompt.toast.projectRequired.title": "프로젝트 선택",
  "prompt.toast.projectRequired.description": "보내기 전에 프로젝트를 만들거나 여세요.",
  "prompt.approval.ask": "승인 요청",
  "prompt.approval.auto": "자동 승인",
  "prompt.approval.plan": "전체 액세스",
  "prompt.more": "더 보기",
  "dialog.project.create.title": "새 프로젝트",
  "dialog.project.create.name": "이름",
  "dialog.project.create.location": "위치",
  "dialog.project.create.browse": "찾아보기",
  "dialog.project.create.path": "경로",
  "dialog.project.create.submit": "만들기",
  "dialog.project.create.error.name": "프로젝트 이름을 입력하세요",
  "dialog.project.create.error.invalid": "이 이름은 폴더 이름으로 사용할 수 없습니다",
  "dialog.project.create.error.exists": "폴더가 이미 있습니다. 기존 폴더를 열거나 다른 이름을 선택하세요.",
  "dialog.project.create.error.failed": "폴더를 만들 수 없습니다",
  "mcp.status.needs_client_registration": "클라이언트 등록 필요",
  "home.welcome.title": "무엇을 도와드릴까요?",
  "home.project.create": "새 프로젝트",
  "home.project.open": "기존 프로젝트 열기",
  "home.sessions.search.title": "채팅 검색",
  "session.todo.empty": "아직 작업이 없습니다",
  "session.panel.files": "파일",
  "session.panel.changes": "변경 사항",
  "session.panel.tasks": "작업",
  "session.panel.terminal": "터미널",
  "session.panel.empty": "프로젝트를 선택하여 파일, 변경 사항, 작업, 터미널을 살펴보세요.",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "변경 사항 없음",
  "session.panel.git.dirty.one": "변경된 파일 {{count}}개",
  "session.panel.git.dirty.other": "변경된 파일 {{count}}개",
  "session.task.waiting": "권한 허용 대기 중",
  "session.task.failed": "실패",
  "session.task.retry": "다시 시도",
  "session.task.open": "별도 세션에서 열기",
  "settings.skills.title": "스킬",
  "settings.skills.description": "이 프로젝트에서 발견된 스킬입니다.",
  "settings.skills.empty": "스킬을 찾을 수 없습니다",
  "settings.skills.enabled": "모델에서 사용 가능",
  "settings.skills.disabled": "모델에서 사용 금지",
  "settings.skills.search": "스킬 검색",
  "settings.skills.emptySearch": "검색 조건에 맞는 스킬이 없습니다",
  "settings.skills.details": "스킬 세부 정보",
  "settings.skills.noDescription": "설명 없음",
  "settings.skills.source.project": "프로젝트",
  "settings.skills.source.global": "사용자",
  "settings.skills.source.builtin": "기본 제공",
  "settings.skills.source.custom": "추가됨",
  "settings.scheduled.title": "예약된 작업",
  "settings.scheduled.description": "프로젝트에서 프롬프트를 한 번 또는 매일 실행합니다.",
  "settings.scheduled.empty": "예약된 작업이 없습니다",
  "settings.scheduled.once": "한 번",
  "settings.scheduled.daily": "매일",
  "settings.scheduled.add": "작업 추가",
  "settings.scheduled.field.name": "이름",
  "settings.scheduled.field.prompt": "프롬프트",
  "settings.scheduled.field.schedule": "일정",
  "settings.scheduled.field.time": "실행 시간",
  "settings.scheduled.error.name": "이름을 입력하세요",
  "settings.scheduled.error.prompt": "프롬프트를 입력하세요",
  "settings.scheduled.error.time": "시간을 선택하세요",
  "settings.scheduled.error.model": "먼저 모델을 선택하세요",
  "session.new.project.open": "기존 프로젝트 열기",
  "common.pin": "고정",
  "common.unpin": "고정 해제",
  "settings.relay.title": "智联AI 키",
  "settings.relay.getKey": "API 키 받기",
  "settings.relay.getKey.description": "ChatGPT, Grok 및 기타 공급자용 키를 각각 만듭니다.",
  "settings.relay.upstream": "업스트림",
  "settings.relay.unified": "공유 API 키 사용",
  "settings.relay.unified.description": "활성화하면 모든 업체가 이 키를 사용합니다.",
  "settings.relay.unified.key": "공유 API 키",
  "settings.relay.unified.using": "공유 키 사용 중",
  "settings.relay.key.set": "키 저장됨",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "저장된 키를 유지하려면 비워 두세요",
  "settings.relay.test": "연결 테스트",
  "settings.relay.testing": "테스트 중...",
  "settings.relay.fetch": "모델 가져오기",
  "settings.relay.fetching": "가져오는 중...",
  "settings.relay.edit": "편집",
  "settings.relay.clearKey": "키 지우기",
  "settings.relay.add": "업체 추가",
  "settings.relay.add.name": "업체 이름",
  "settings.relay.models.visible": "표시되는 모델 {{count}}개",
  "settings.relay.connected": "연결됨 · 모델 {{count}}개",
  "settings.relay.connectedEmpty": "연결되었지만 반환된 모델이 없습니다",
  "settings.relay.test.ok": "연결 성공",
  "settings.relay.test.empty": "연결되었지만 반환된 모델이 없습니다",
  "settings.relay.models.title": "{{vendor}} 모델",
  "settings.relay.models.empty": "아직 모델이 없습니다. 키를 저장한 후 목록을 가져오세요.",
  "settings.relay.models.missing": "업스트림에서 더 이상 제공하지 않음",
  "settings.relay.saved": "자동 저장됨",
  "settings.relay.retry": "다시 시도",
  "settings.relay.builtin": "기본 제공",
  "settings.relay.delete": "업체 삭제",
  "settings.relay.rollback": "가져온 키 초기화",
  "settings.relay.rollback.description": "auth.json에서 가져온 Relay 키를 지웁니다. 원본 auth.json은 유지됩니다.",
  "settings.relay.error.KEY_MISSING": "먼저 API 키를 추가하세요",
  "settings.relay.error.KEY_REJECTED": "키가 거부되었습니다",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "업스트림에 연결할 수 없습니다",
  "settings.relay.error.UPSTREAM_TIMEOUT": "업스트림 응답 시간이 초과되었습니다",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "업스트림에서 요청 빈도를 제한했습니다",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "업스트림에서 잘못된 응답을 반환했습니다",
  "settings.relay.error.REVISION_CONFLICT": "다른 창에서 이 설정이 변경되었습니다. 새로 고친 후 다시 시도하세요.",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "이 기기에 API 키를 저장할 수 없습니다.",
  "settings.mcp.add": "MCP 추가",
  "settings.mcp.edit": "편집",
  "settings.mcp.field.name": "이름",
  "settings.mcp.field.type": "유형",
  "settings.mcp.field.command": "명령어",
  ...
  "settings.mcp.error.name": "서버 이름을 입력하세요",
  "settings.mcp.error.command": "명령어를 입력하세요",
  "settings.mcp.error.url": "URL을 입력하세요",
  ...
  "dialog.model.unpaid.freeModels.title": "Koda에서 제공하는 무료 모델",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} API 키를 입력하여 계정을 연결하고 Koda에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen은 코딩 에이전트를 위해 최적화된 신뢰할 수 있는 엄선된 모델에 대한 액세스를 제공합니다.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "를 방문하여 인증 코드를 받아 계정을 연결하고 Koda에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "를 방문하고 아래 코드를 입력하여 계정을 연결하고 Koda에서 {{provider}} 모델을 사용하세요.",
  ...
  "dialog.server.description": "이 앱이 연결할 Koda 서버를 전환합니다.",
  ...
  "toast.update.description": "Koda의 새 버전({{version}})을 설치할 수 있습니다.",
  ...
  "error.page.report.prefix": "이 오류를 Koda 팀에 제보해 주세요: ",
  ...
  "error.chain.mcpFailed": 'MCP 서버 "{{name}}" 실패. 참고: Koda는 아직 MCP 인증을 지원하지 않습니다.',
  ...
  "sidebar.gettingStarted.line1": "Koda에는 무료 모델이 포함되어 있어 즉시 시작할 수 있습니다.",
  ...
  "settings.desktop.wsl.description": "Windows의 WSL 내부에서 Koda 서버를 실행합니다.",
  ...
  "settings.general.row.language.description": "Koda 표시 언어 변경",
  "settings.general.row.appearance.title": "모양",
  "settings.general.row.appearance.description": "기기에서 Koda가 보이는 방식 사용자 지정",
  "settings.general.row.colorScheme.title": "색상 테마",
  "settings.general.row.colorScheme.description": "Koda가 시스템, 라이트 또는 다크 테마를 따를지 선택하세요",
  "settings.general.row.theme.title": "테마",
  "settings.general.row.theme.description": "Koda 테마 사용자 지정",
  ...
  "settings.updates.row.startup.description": "Koda를 실행할 때 업데이트를 자동으로 확인합니다",
  ...
  "settings.updates.toast.latest.description": "현재 최신 버전의 Koda를 사용 중입니다.",
  ...
  "wsl.onboarding.checkingOpencode": "Koda 확인 중...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}에서 Koda 확인 중...",
  "wsl.onboarding.updatingOpencode": "Koda 업데이트 중...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}에서 Koda 업데이트 중...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}에서 Koda를 업데이트하세요.",
  "wsl.onboarding.updateOpencode": "Koda 업데이트",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}에서 Koda를 사용할 준비가 되었습니다.",
  "wsl.onboarding.opencodeReady": "Koda가 준비되었습니다.",
  "wsl.onboarding.installOpencodeIn": "{{distro}}에 Koda를 설치하세요.",
  "wsl.onboarding.installOpencode": "Koda 설치",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda가 설치되지 않음",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Koda에서 WSL 서버를 추가하려면 WSL (Windows Subsystem for Linux)이 필요합니다",
  "wsl.onboarding.wslUnavailable.title": "WSL을 사용할 수 없음",
  "wsl.onboarding.wslUnavailable.description": "Koda에서 이 컴퓨터의 WSL을 확인할 수 없습니다.",
  "wsl.onboarding.installWsl": "WSL 설치",
  "wsl.onboarding.windowsRestartRequired": "WSL 설치를 완료하려면 Windows를 다시 시작한 다음 Koda를 다시 여세요.",
  ...
  "help.tabs.introduction": "이제 Koda Desktop은 탭을 중심으로 구성됩니다.",
  "help.tabs.sessions":
  ...
  "desktop.recovery.loadFailed": "Koda를 불러오지 못했습니다",
  "desktop.recovery.terminated": "Koda 윈도우가 예기치 않게 종료되었습니다",
  "desktop.recovery.unresponsive": "Koda가 응답하지 않습니다",
  ...
  "desktop.wsl.error.installOpencode": "Koda 설치 실패",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}에 Koda가 설치되어 있지 않습니다",
  "desktop.wsl.error.updateVersion":
    "Koda 업데이트가 완료되었지만 {{distro}}에서 여전히 {{installed}} 버전으로 표시됩니다. 예상 버전: {{expected}}",
