export const dict = {
  "desktop.menu.about": "دربارهٔ Koda",
  "desktop.about.title": "نسخهٔ رومیزی Koda v{{version}}",
  "desktop.about.detail":
    "با استفاده از OpenCode به‌عنوان هسته تغییر یافته است\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "Koda v{{version}} در دسترس است. صفحهٔ انتشار برای ارتقا باز شود؟",
  "desktop.koda.update.open": "باز کردن صفحهٔ انتشار",
  "command.project.create": "پروژهٔ جدید",
  "command.project.openExisting": "باز کردن پروژهٔ موجود",
  "prompt.toast.projectRequired.title": "یک پروژه انتخاب کنید",
  "prompt.toast.projectRequired.description": "پیش از ارسال، پروژه‌ای بسازید یا باز کنید.",
  "prompt.approval.ask": "درخواست تأیید",
  "prompt.approval.auto": "به‌جای من تأیید کن",
  "prompt.approval.plan": "دسترسی کامل",
  "prompt.more": "بیشتر",
  "dialog.project.create.title": "پروژهٔ جدید",
  "dialog.project.create.name": "نام",
  "dialog.project.create.location": "مکان",
  "dialog.project.create.browse": "مرور",
  "dialog.project.create.path": "مسیر",
  "dialog.project.create.submit": "ایجاد",
  "dialog.project.create.error.name": "نام پروژه را وارد کنید",
  "dialog.project.create.error.invalid": "این نام را نمی‌توان برای پوشه استفاده کرد",
  "dialog.project.create.error.exists": "این پوشه از قبل وجود دارد. آن را باز کنید یا نام دیگری انتخاب کنید.",
  "dialog.project.create.error.failed": "ایجاد پوشه ممکن نشد",
  "mcp.status.needs_client_registration": "نیازمند ثبت کارخواه",
  "home.welcome.title": "در چه کاری می‌توانم کمک کنم؟",
  "home.project.create": "پروژهٔ جدید",
  "home.project.open": "باز کردن پروژهٔ موجود",
  "home.sessions.search.title": "جست‌وجوی گفت‌وگوها",
  "session.todo.empty": "هنوز کاری وجود ندارد",
  "session.panel.files": "پرونده‌ها",
  "session.panel.changes": "تغییرات",
  "session.panel.tasks": "کارها",
  "session.panel.terminal": "پایانه",
  "session.panel.empty": "برای مرور پرونده‌ها، تغییرات، کارها و پایانه، پروژه‌ای انتخاب کنید.",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "بدون تغییر",
  "session.panel.git.dirty.one": "{{count}} پروندهٔ تغییرکرده",
  "session.panel.git.dirty.other": "{{count}} پروندهٔ تغییرکرده",
  "session.task.waiting": "در انتظار مجوز",
  "session.task.failed": "ناموفق",
  "session.task.retry": "تلاش دوباره",
  "session.task.open": "باز کردن در نشستی جداگانه",
  "settings.skills.title": "مهارت‌ها",
  "settings.skills.description": "مهارت‌های یافت‌شده برای این پروژه.",
  "settings.skills.empty": "مهارتی یافت نشد",
  "settings.skills.enabled": "در دسترس مدل",
  "settings.skills.disabled": "برای مدل ممنوع است",
  "settings.skills.search": "جست‌وجوی مهارت‌ها",
  "settings.skills.emptySearch": "هیچ مهارتی با این جست‌وجو مطابقت ندارد",
  "settings.skills.details": "جزئیات مهارت",
  "settings.skills.noDescription": "بدون توضیح",
  "settings.skills.source.project": "پروژه",
  "settings.skills.source.global": "کاربر",
  "settings.skills.source.builtin": "داخلی",
  "settings.skills.source.custom": "افزوده‌شده",
  "settings.scheduled.title": "کارهای زمان‌بندی‌شده",
  "settings.scheduled.description": "یک دستور را در پروژه یک‌بار یا هر روز اجرا کنید.",
  "settings.scheduled.empty": "کار زمان‌بندی‌شده‌ای وجود ندارد",
  "settings.scheduled.once": "یک‌بار",
  "settings.scheduled.daily": "هر روز",
  "settings.scheduled.add": "افزودن کار",
  "settings.scheduled.field.name": "نام",
  "settings.scheduled.field.prompt": "دستور",
  "settings.scheduled.field.schedule": "زمان‌بندی",
  "settings.scheduled.field.time": "زمان اجرا",
  "settings.scheduled.error.name": "نامی وارد کنید",
  "settings.scheduled.error.prompt": "دستوری وارد کنید",
  "settings.scheduled.error.time": "زمانی انتخاب کنید",
  "settings.scheduled.error.model": "ابتدا مدلی انتخاب کنید",
  "session.new.project.open": "باز کردن پروژهٔ موجود",
  "common.pin": "سنجاق کردن",
  "common.unpin": "برداشتن سنجاق",
  "settings.relay.title": "کلیدهای 智联AI",
  "settings.relay.getKey": "دریافت کلید API",
  "settings.relay.getKey.description": "برای ChatGPT، Grok و دیگر ارائه‌دهندگان کلیدهای جداگانه بسازید.",
  "settings.relay.upstream": "سرویس بالادستی",
  "settings.relay.unified": "استفاده از کلید API مشترک",
  "settings.relay.unified.description": "اگر فعال باشد، همهٔ عرضه‌کنندگان از این کلید استفاده می‌کنند.",
  "settings.relay.unified.key": "کلید API مشترک",
  "settings.relay.unified.using": "در حال استفاده از کلید مشترک",
  "settings.relay.key.set": "کلید ذخیره شد",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "برای حفظ کلید ذخیره‌شده خالی بگذارید",
  "settings.relay.test": "آزمایش اتصال",
  "settings.relay.testing": "در حال آزمایش...",
  "settings.relay.fetch": "دریافت مدل‌ها",
  "settings.relay.fetching": "در حال دریافت...",
  "settings.relay.edit": "ویرایش",
  "settings.relay.clearKey": "پاک کردن کلید",
  "settings.relay.add": "افزودن عرضه‌کننده",
  "settings.relay.add.name": "نام عرضه‌کننده",
  "settings.relay.models.visible": "{{count}} مدل قابل‌مشاهده",
  "settings.relay.connected": "متصل · {{count}} مدل",
  "settings.relay.connectedEmpty": "متصل شد، اما مدلی برگردانده نشد",
  "settings.relay.test.ok": "اتصال موفق بود",
  "settings.relay.test.empty": "متصل شد، اما مدلی برگردانده نشد",
  "settings.relay.models.title": "مدل‌های {{vendor}}",
  "settings.relay.models.empty": "هنوز مدلی وجود ندارد. پس از ذخیرهٔ کلید، فهرست را دریافت کنید.",
  "settings.relay.models.missing": "دیگر در سرویس بالادستی موجود نیست",
  "settings.relay.saved": "خودکار ذخیره شد",
  "settings.relay.retry": "تلاش دوباره",
  "settings.relay.builtin": "داخلی",
  "settings.relay.delete": "حذف عرضه‌کننده",
  "settings.relay.rollback": "بازنشانی کلیدهای واردشده",
  "settings.relay.rollback.description":
    "کلیدهای Relay واردشده از auth.json را پاک می‌کند. پروندهٔ اصلی auth.json حفظ می‌شود.",
  "settings.relay.error.KEY_MISSING": "ابتدا یک کلید API اضافه کنید",
  "settings.relay.error.KEY_REJECTED": "کلید رد شد",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "سرویس بالادستی در دسترس نیست",
  "settings.relay.error.UPSTREAM_TIMEOUT": "مهلت پاسخ‌گویی سرویس بالادستی تمام شد",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "سرویس بالادستی نرخ درخواست را محدود کرد",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "سرویس بالادستی پاسخی نامعتبر برگرداند",
  "settings.relay.error.REVISION_CONFLICT":
    "این تنظیم در پنجره‌ای دیگر تغییر کرده است. تازه‌سازی کنید و دوباره تلاش کنید.",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "ذخیرهٔ کلید API در این دستگاه ممکن نشد.",
  "settings.mcp.add": "افزودن MCP",
  "settings.mcp.edit": "ویرایش",
  "settings.mcp.field.name": "نام",
  "settings.mcp.field.type": "نوع",
  "settings.mcp.field.command": "فرمان",
  ...
  "settings.mcp.type.remote": "راه دور",
  "settings.mcp.error.name": "نام کارساز را وارد کنید",
  "settings.mcp.error.command": "فرمانی وارد کنید",
  "settings.mcp.error.url": "یک URL وارد کنید",
  ...
  "desktop.menu.documentation": "مستندات Koda",
  ...
  "desktop.menu.ariaLabel": "منوی Koda",
  ...
  "desktop.recovery.loadFailed": "Koda بارگیری نشد",
  "desktop.recovery.terminated": "پنجره Koda به طور غیرمنتظره ای خاتمه یافت",
  "desktop.recovery.unresponsive": "Koda پاسخ نمی دهد",
  ...
  "desktop.wsl.error.installOpencode": "نصب Koda انجام نشد",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Koda در {{distro}} نصب نشده است",
  "desktop.wsl.error.updateVersion":
    "به‌روزرسانی Koda به پایان رسید، اما {{distro}} همچنان {{installed}} را گزارش می‌کند. مورد انتظار {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "مدل های رایگان ارائه شده توسط Koda",
  ...
  "provider.connect.apiKey.description":
    "کلید API سرویس {{provider}} را وارد کنید تا حساب شما متصل شود و بتوانید از مدل‌های {{provider}} در Koda استفاده کنید.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen به شما امکان دسترسی به مجموعه‌ای از مدل‌های بهینه‌شده قابل اعتماد را برای عوامل کدنویسی می‌دهد.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " برای جمع آوری کد مجوز برای اتصال حساب خود و استفاده از مدل های {{provider}} در Koda.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " و کد زیر را برای اتصال اکانت خود وارد کنید و از مدل های {{provider}} در Koda استفاده کنید.",
  ...
  "dialog.server.description": "این برنامه به کدام سرور Koda متصل است، تغییر دهید.",
  ...
  "wsl.onboarding.checkingOpencode": "در حال بررسی Koda...",
  "wsl.onboarding.checkingOpencodeIn": "بررسی Koda در {{distro}}...",
  "wsl.onboarding.updatingOpencode": "در حال به روز رسانی Koda...",
  "wsl.onboarding.updatingOpencodeIn": "به روز رسانی Koda در {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Koda را در {{distro}} به روز کنید.",
  "wsl.onboarding.updateOpencode": "Koda را به روز کنید",
  "wsl.onboarding.opencodeReadyIn": "Koda در {{distro}} آماده است.",
  "wsl.onboarding.opencodeReady": "Koda آماده است.",
  "wsl.onboarding.installOpencodeIn": "Koda را در {{distro}} نصب کنید.",
  "wsl.onboarding.installOpencode": "Koda را نصب کنید",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda نصب نشده است",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (زیر سیستم Windows برای Linux) قبل از اینکه Koda بتواند یک سرور WSL اضافه کند لازم است",
  "wsl.onboarding.wslUnavailable.title": "WSL در دسترس نیست",
  "wsl.onboarding.wslUnavailable.description": "Koda نتوانست WSL را در این دستگاه تأیید کند.",
  "wsl.onboarding.installWsl": "WSL را نصب کنید",
  "wsl.onboarding.windowsRestartRequired":
    "Windows را مجددا راه اندازی کنید تا نصب WSL به پایان برسد، سپس Koda را دوباره باز کنید.",
  ...
  "help.tabs.introduction": "Koda Desktop اکنون در اطراف زبانه ها ساخته شده است.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "نسخه جدیدی از Koda ({{version}}) اکنون برای نصب در دسترس است.",
  ...
  "error.page.report.prefix": "لطفاً این خطا را به تیم Koda گزارش دهید",
  ...
  "error.chain.mcpFailed":
    'سرور MCP "{{name}}" ناموفق بود. توجه داشته باشید، Koda هنوز از احراز هویت MCP پشتیبانی نمی کند.',
  ...
  "sidebar.gettingStarted.line1": "Koda شامل مدل های رایگان است، بنابراین می توانید بلافاصله شروع کنید.",
  ...
  "settings.desktop.wsl.description": "سرور Koda را در داخل WSL روی Windows اجرا کنید.",
  ...
  "settings.general.row.language.description": "زبان نمایش را برای Koda تغییر دهید",
  ...
  "settings.general.row.appearance.description": "نحوه ظاهر Koda را در دستگاه خود سفارشی کنید",
  "settings.general.row.colorScheme.title": "طرح رنگ",
  "settings.general.row.colorScheme.description": "انتخاب کنید که آیا Koda از تم سیستمی، روشن یا تیره پیروی می کند",
  "settings.general.row.theme.title": "موضوع",
  "settings.general.row.theme.description": "نحوه مضمون سازی Koda را سفارشی کنید.",
  ...
  "settings.updates.row.startup.description": "هنگام راه‌اندازی Koda، به‌روزرسانی‌ها را به‌طور خودکار بررسی کنید",
  ...
  "settings.updates.toast.latest.description": "شما آخرین نسخه Koda را اجرا می کنید.",
