export const dict: Record<string, string> = {
  "desktop.menu.about": "Koda को बारेमा",
  "desktop.about.title": "Koda डेस्कटप v{{version}}",
  "desktop.about.detail": "OpenCode लाई आधार बनाएर परिमार्जित\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "Koda v{{version}} उपलब्ध छ। अद्यावधिक गर्न विमोचन पृष्ठ खोल्ने?",
  "desktop.koda.update.open": "विमोचन पृष्ठ खोल्नुहोस्",
  "command.project.create": "नयाँ परियोजना",
  "command.project.openExisting": "अवस्थित परियोजना खोल्नुहोस्",
  "prompt.toast.projectRequired.title": "परियोजना छान्नुहोस्",
  "prompt.toast.projectRequired.description": "पठाउनुअघि परियोजना सिर्जना गर्नुहोस् वा खोल्नुहोस्।",
  "prompt.approval.ask": "स्वीकृति माग्नुहोस्",
  "prompt.approval.auto": "मेरो तर्फबाट स्वीकृत गर्नुहोस्",
  "prompt.approval.plan": "पूर्ण पहुँच",
  "prompt.more": "थप",
  "dialog.project.create.title": "नयाँ परियोजना",
  "dialog.project.create.name": "नाम",
  "dialog.project.create.location": "स्थान",
  "dialog.project.create.browse": "ब्राउज गर्नुहोस्",
  "dialog.project.create.path": "पथ",
  "dialog.project.create.submit": "सिर्जना गर्नुहोस्",
  "dialog.project.create.error.name": "परियोजनाको नाम लेख्नुहोस्",
  "dialog.project.create.error.invalid": "यो नाम फोल्डरका लागि प्रयोग गर्न सकिँदैन",
  "dialog.project.create.error.exists": "त्यो फोल्डर पहिले नै छ। त्यसलाई खोल्नुहोस् वा अर्को नाम छान्नुहोस्।",
  "dialog.project.create.error.failed": "फोल्डर सिर्जना गर्न सकिएन",
  "mcp.status.needs_client_registration": "क्लाइन्ट दर्ता आवश्यक छ",
  "home.welcome.title": "म केमा मद्दत गर्न सक्छु?",
  "home.project.create": "नयाँ परियोजना",
  "home.project.open": "अवस्थित परियोजना खोल्नुहोस्",
  "home.sessions.search.title": "कुराकानी खोज्नुहोस्",
  "session.todo.empty": "अहिलेसम्म कुनै कार्य छैन",
  "session.panel.files": "फाइलहरू",
  "session.panel.changes": "परिवर्तनहरू",
  "session.panel.tasks": "कार्यहरू",
  "session.panel.terminal": "टर्मिनल",
  "session.panel.empty": "फाइल, परिवर्तन, कार्य र टर्मिनल हेर्न परियोजना छान्नुहोस्।",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "कुनै परिवर्तन छैन",
  "session.panel.git.dirty.one": "{{count}} परिवर्तन गरिएको फाइल",
  "session.panel.git.dirty.other": "{{count}} परिवर्तन गरिएका फाइलहरू",
  "session.task.waiting": "अनुमतिको प्रतीक्षामा",
  "session.task.failed": "असफल भयो",
  "session.task.retry": "फेरि प्रयास गर्नुहोस्",
  "session.task.open": "छुट्टै सत्रमा खोल्नुहोस्",
  "settings.skills.title": "सीपहरू",
  "settings.skills.description": "यस परियोजनाका लागि भेटिएका सीपहरू।",
  "settings.skills.empty": "कुनै सीप भेटिएन",
  "settings.skills.enabled": "मोडेलका लागि उपलब्ध",
  "settings.skills.disabled": "मोडेलका लागि निषेधित",
  "settings.skills.search": "सीप खोज्नुहोस्",
  "settings.skills.emptySearch": "यस खोजसँग मिल्ने सीप छैन",
  "settings.skills.details": "सीपको विवरण",
  "settings.skills.noDescription": "विवरण छैन",
  "settings.skills.source.project": "परियोजना",
  "settings.skills.source.global": "प्रयोगकर्ता",
  "settings.skills.source.builtin": "अन्तर्निर्मित",
  "settings.skills.source.custom": "थपिएको",
  "settings.scheduled.title": "निर्धारित कार्यहरू",
  "settings.scheduled.description": "परियोजनामा एक पटक वा हरेक दिन प्रम्प्ट चलाउनुहोस्।",
  "settings.scheduled.empty": "निर्धारित कार्य छैन",
  "settings.scheduled.once": "एक पटक",
  "settings.scheduled.daily": "हरेक दिन",
  "settings.scheduled.add": "कार्य थप्नुहोस्",
  "settings.scheduled.field.name": "नाम",
  "settings.scheduled.field.prompt": "प्रम्प्ट",
  "settings.scheduled.field.schedule": "समयतालिका",
  "settings.scheduled.field.time": "चलाउने समय",
  "settings.scheduled.error.name": "नाम लेख्नुहोस्",
  "settings.scheduled.error.prompt": "प्रम्प्ट लेख्नुहोस्",
  "settings.scheduled.error.time": "समय छान्नुहोस्",
  "settings.scheduled.error.model": "पहिले मोडेल छान्नुहोस्",
  "session.new.project.open": "अवस्थित परियोजना खोल्नुहोस्",
  "common.pin": "पिन गर्नुहोस्",
  "common.unpin": "पिन हटाउनुहोस्",
  "settings.relay.title": "智联AI कुञ्जीहरू",
  "settings.relay.getKey": "API कुञ्जी प्राप्त गर्नुहोस्",
  "settings.relay.getKey.description": "ChatGPT, Grok र अन्य प्रदायकका लागि छुट्टाछुट्टै कुञ्जी सिर्जना गर्नुहोस्।",
  "settings.relay.upstream": "अपस्ट्रिम",
  "settings.relay.unified": "साझा API कुञ्जी प्रयोग गर्नुहोस्",
  "settings.relay.unified.description": "सक्षम हुँदा सबै विक्रेताले यो कुञ्जी प्रयोग गर्छन्।",
  "settings.relay.unified.key": "साझा API कुञ्जी",
  "settings.relay.unified.using": "साझा कुञ्जी प्रयोग हुँदैछ",
  "settings.relay.key.set": "कुञ्जी सुरक्षित गरियो",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "सुरक्षित गरिएको कुञ्जी राख्न खाली छोड्नुहोस्",
  "settings.relay.test": "जडान जाँच्नुहोस्",
  "settings.relay.testing": "जाँच हुँदैछ...",
  "settings.relay.fetch": "मोडेल प्राप्त गर्नुहोस्",
  "settings.relay.fetching": "प्राप्त हुँदैछ...",
  "settings.relay.edit": "सम्पादन गर्नुहोस्",
  "settings.relay.clearKey": "कुञ्जी मेटाउनुहोस्",
  "settings.relay.add": "विक्रेता थप्नुहोस्",
  "settings.relay.add.name": "विक्रेताको नाम",
  "settings.relay.models.visible": "{{count}} देखिने मोडेल",
  "settings.relay.connected": "जडान भयो · {{count}} मोडेल",
  "settings.relay.connectedEmpty": "जडान भयो, तर कुनै मोडेल फर्किएन",
  "settings.relay.test.ok": "जडान सफल भयो",
  "settings.relay.test.empty": "जडान भयो, तर कुनै मोडेल फर्किएन",
  "settings.relay.models.title": "{{vendor}} का मोडेलहरू",
  "settings.relay.models.empty": "अहिलेसम्म मोडेल छैन। कुञ्जी सुरक्षित गरेपछि सूची प्राप्त गर्नुहोस्।",
  "settings.relay.models.missing": "अब अपस्ट्रिममा छैन",
  "settings.relay.saved": "स्वतः सुरक्षित गरियो",
  "settings.relay.retry": "फेरि प्रयास गर्नुहोस्",
  "settings.relay.builtin": "अन्तर्निर्मित",
  "settings.relay.delete": "विक्रेता हटाउनुहोस्",
  "settings.relay.rollback": "आयात गरिएका कुञ्जी रिसेट गर्नुहोस्",
  "settings.relay.rollback.description": "auth.json बाट आयात गरिएका Relay कुञ्जी मेटाउँछ। मूल auth.json राखिन्छ।",
  "settings.relay.error.KEY_MISSING": "पहिले API कुञ्जी थप्नुहोस्",
  "settings.relay.error.KEY_REJECTED": "कुञ्जी अस्वीकार गरियो",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "अपस्ट्रिममा पुग्न सकिँदैन",
  "settings.relay.error.UPSTREAM_TIMEOUT": "अपस्ट्रिमको समय सीमा सकियो",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "अपस्ट्रिमले अनुरोधको दर सीमित गर्‍यो",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "अपस्ट्रिमले अमान्य प्रतिक्रिया फर्कायो",
  "settings.relay.error.REVISION_CONFLICT": "यो सेटिङ अर्को सञ्झ्यालमा बदलिएको छ। ताजा गरेर फेरि प्रयास गर्नुहोस्।",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "यस उपकरणमा API कुञ्जी सुरक्षित गर्न सकिएन।",
  "settings.mcp.add": "MCP थप्नुहोस्",
  "settings.mcp.edit": "सम्पादन गर्नुहोस्",
  "settings.mcp.field.name": "नाम",
  "settings.mcp.field.type": "प्रकार",
  "settings.mcp.field.command": "आदेश",
  ...
  "settings.mcp.type.remote": "टाढाको",
  "settings.mcp.error.name": "सर्भरको नाम लेख्नुहोस्",
  "settings.mcp.error.command": "आदेश लेख्नुहोस्",
  "settings.mcp.error.url": "URL लेख्नुहोस्",
  ...
  "desktop.menu.documentation": "Koda कागजात",
  ...
  "desktop.menu.ariaLabel": "Koda मेनु",
  ...
  "desktop.recovery.loadFailed": "Koda लोड हुन सकेन",
  "desktop.recovery.terminated": "Koda विन्डो अप्रत्याशित रूपमा समाप्त भयो",
  "desktop.recovery.unresponsive": "Koda ले प्रतिक्रिया दिइरहेको छैन",
  ...
  "desktop.wsl.error.installOpencode": "Koda स्थापना असफल भयो",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Koda {{distro}} मा स्थापित छैन",
  "desktop.wsl.error.updateVersion":
    "Koda अद्यावधिक समाप्त भयो तर {{distro}} ले अझै पनि रिपोर्ट गर्छ {{installed}}; अपेक्षित {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Koda द्वारा प्रदान गरिएको नि:शुल्क मोडेलहरू",
  ...
  "provider.connect.apiKey.description":
    "आफ्नो खाता जडान गर्न आफ्नो {{provider}} API कुञ्जी प्रविष्ट गर्नुहोस् र Koda मा {{provider}} मोडेलहरू प्रयोग गर्नुहोस्।",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen ले तपाईंलाई कोडिङ एजेन्टहरूका लागि भरपर्दो अनुकूलित मोडेलहरूको क्युरेट गरिएको सेटमा पहुँच दिन्छ।",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "आफ्नो खाता जडान गर्न र Koda मा {{provider}} मोडेलहरू प्रयोग गर्न आफ्नो प्राधिकरण कोड सङ्कलन गर्न।",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "र आफ्नो खाता जडान गर्न तलको कोड प्रविष्ट गर्नुहोस् र {{provider}} मोडेलहरू Koda मा प्रयोग गर्नुहोस्।",
  ...
  "dialog.server.description": "यो एप जडान भएको Koda सर्भरलाई स्विच गर्नुहोस्।",
  ...
  "wsl.onboarding.checkingOpencode": "Koda जाँच गर्दै...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} मा Koda जाँच गर्दै...",
  "wsl.onboarding.updatingOpencode": "अद्यावधिक गर्दै Koda...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} मा Koda अद्यावधिक गर्दै...",
  "wsl.onboarding.updateOpencodeIn": "अपडेट गर्नुहोस् Koda {{distro}} मा।",
  "wsl.onboarding.updateOpencode": "अपडेट गर्नुहोस् Koda",
  "wsl.onboarding.opencodeReadyIn": "Koda {{distro}} मा तयार छ।",
  "wsl.onboarding.opencodeReady": "Koda तयार छ।",
  "wsl.onboarding.installOpencodeIn": "{{distro}} मा Koda स्थापना गर्नुहोस्।",
  "wsl.onboarding.installOpencode": "Koda स्थापना गर्नुहोस्",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda स्थापित छैन",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Linux को लागि सबसिस्टम) Koda ले WSL सर्भर थप्न अघि आवश्यक छ।",
  "wsl.onboarding.wslUnavailable.title": "WSL उपलब्ध छैन",
  "wsl.onboarding.wslUnavailable.description": "Koda ले यो मेसिनमा WSL प्रमाणित गर्न सकेन।",
  "wsl.onboarding.installWsl": "WSL स्थापना गर्नुहोस्",
  "wsl.onboarding.windowsRestartRequired":
    "WSL स्थापना पूरा गर्न Windows पुन: सुरु गर्नुहोस्, त्यसपछि Koda पुन: खोल्नुहोस्।",
  ...
  "help.tabs.introduction": "Koda डेस्कटप अब ट्याब वरिपरि बनाइएको छ।",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Koda ({{version}}) को नयाँ संस्करण अब स्थापना गर्न उपलब्ध छ।",
  ...
  "error.page.report.prefix": "कृपया यो त्रुटि Koda टोलीलाई रिपोर्ट गर्नुहोस्",
  ...
  "error.chain.mcpFailed":
    'MCP सर्भर "{{name}}" असफल भयो। नोट गर्नुहोस्, Koda ले अझै पनि MCP प्रमाणीकरणलाई समर्थन गर्दैन।',
  ...
  "sidebar.gettingStarted.line1": "Koda मा नि:शुल्क मोडेलहरू समावेश छन् ताकि तपाईं तुरुन्तै सुरु गर्न सक्नुहुन्छ।",
  ...
  "settings.desktop.wsl.description": "Koda सर्भर भित्र WSL Windows मा चलाउनुहोस्।",
  ...
  "settings.general.row.language.description": "Koda को लागि प्रदर्शन भाषा परिवर्तन गर्नुहोस्",
  ...
  "settings.general.row.appearance.description": "आफ्नो यन्त्रमा Koda कस्तो देखिन्छ अनुकूलित गर्नुहोस्",
  "settings.general.row.colorScheme.title": "रंग योजना",
  "settings.general.row.colorScheme.description":
    "Koda ले प्रणाली, उज्यालो वा गाढा विषयवस्तुलाई फलो गर्छ कि गर्दैन भन्ने छनौट गर्नुहोस्",
  "settings.general.row.theme.title": "विषयवस्तु",
  "settings.general.row.theme.description": "कसरी Koda विषयवस्तुलाई अनुकूलित गर्नुहोस्।",
  ...
  "settings.updates.row.startup.description": "Koda सुरु हुँदा अद्यावधिकहरूको लागि स्वचालित रूपमा जाँच गर्नुहोस्",
  ...
  "settings.updates.toast.latest.description": "तपाईं Koda को नवीनतम संस्करण चलाइरहनुभएको छ।",
