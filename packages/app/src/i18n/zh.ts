...
export const dict = {
  ...
  "desktop.menu.documentation": "Koda 文档",
  ...
  "desktop.about.detail": "基于opencode为内核修改\nGitHub地址：https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "发现新版本 Koda v{{version}}，是否打开发布页升级？",
  "desktop.koda.update.open": "前往升级",
  "desktop.menu.reportBug": "报告错误",
  "desktop.menu.ariaLabel": "Koda 菜单",
  ...
  "desktop.recovery.loadFailed": "Koda 加载失败",
  "desktop.recovery.terminated": "Koda 窗口意外终止",
  "desktop.recovery.unresponsive": "Koda 未响应",
  ...
  "desktop.wsl.error.installOpencode": "Koda 安装失败",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安装 Koda",
  "desktop.wsl.error.updateVersion":
    "Koda 更新已完成，但 {{distro}} 仍报告版本 {{installed}}；预期版本为 {{expected}}",
  ...
  "command.project.openExisting": "打开已有项目",
  ...
  "dialog.model.unpaid.freeModels.title": "Koda 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接账户，并在 Koda 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "Koda Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的账户并在 Koda 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的账户并在 Koda 中使用 {{provider}} 模型。",
  ...
  "prompt.toast.projectRequired.title": "请选择项目",
  "prompt.toast.projectRequired.description": "发送前请先新建或打开项目。",
  "prompt.approval.ask": "请求批准",
  "prompt.approval.auto": "帮我批准",
  "prompt.approval.plan": "完全访问权限",
  "prompt.more": "更多",
  "dialog.project.create.title": "新建项目",
  "dialog.project.create.name": "名称",
  "dialog.project.create.location": "位置",
  "dialog.project.create.browse": "浏览",
  "dialog.project.create.path": "路径",
  "dialog.project.create.submit": "创建",
  "dialog.project.create.error.name": "请输入项目名称",
  "dialog.project.create.error.invalid": "该名称不能用作文件夹",
  "dialog.project.create.error.exists": "该文件夹已存在。请改用「打开已有项目」，或换一个名称。",
  "dialog.project.create.error.failed": "无法创建文件夹",
  ...
  "dialog.server.description": "切换此应用连接的 Koda 服务器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在检查 Koda...",
  "wsl.onboarding.checkingOpencodeIn": "正在检查 {{distro}} 中的 Koda...",
  ...
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 Koda 已就绪。",
  "wsl.onboarding.opencodeReady": "Koda 已就绪。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安装 Koda。",
  "wsl.onboarding.installOpencode": "安装 Koda",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安装 Koda",
  ...
  "wsl.onboarding.wslNotInstalled.description": "Koda 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "Koda 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 Koda。",
  ...
  "help.tabs.introduction": "Koda Desktop 现已采用以标签页为核心的设计。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Koda 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Koda 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意：Koda 暂不支持 MCP 认证。',
  ...
  "home.welcome.title": "有什么可以帮忙的？",
  "home.title": "主页",
  "home.projects": "项目",
  "home.project.add": "添加项目",
  "home.project.create": "新建项目",
  "home.project.open": "打开已有项目",
  "home.recentlyClosed": "最近关闭",
  "home.server.collapse": "折叠服务器项目",
  "home.server.expand": "展开服务器项目",
  "home.sessions.search.title": "搜索聊天",
  "home.sessions.search.placeholder": "搜索聊天",
  "home.sessions.search.placeholder.scoped": "在 {{scope}} 中搜索聊天",
  ...
  "session.new.project.open": "打开已有项目",
  ...
  "sidebar.gettingStarted.line1": "Koda 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 Koda 服务器。",
  ...
  "settings.general.row.language.description": "更改 Koda 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 Koda 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 Koda 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Koda 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Koda 启动时自动检查更新",
  ...
  "settings.relay.title": "智联AI密钥",
  "settings.relay.getKey": "获取密钥",
  "settings.relay.getKey.description": "ChatGPT和Grok等需要单独新建密钥",
  "settings.relay.upstream": "上游",
  "settings.relay.unified": "使用统一 API KEY",
  "settings.relay.unified.description": "勾选后，所有厂商共用下面这一把 Key。",
  "settings.relay.unified.key": "统一 API KEY",
  "settings.relay.unified.using": "使用统一密钥",
  "settings.relay.key.set": "已设置",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "留空表示保持原密钥",
  "settings.relay.test": "测试连通",
  "settings.relay.testing": "测试中…",
  "settings.relay.fetch": "获取模型列表",
  "settings.relay.fetching": "获取中…",
  "settings.relay.edit": "编辑",
  "settings.relay.clearKey": "清除密钥",
  "settings.relay.add": "添加厂商",
  "settings.relay.add.name": "厂商名称",
  "settings.relay.models.visible": "{{count}} 个可见模型",
  "settings.relay.connected": "已连通 · {{count}} 个模型",
  "settings.relay.connectedEmpty": "已连通，但未返回模型",
  "settings.relay.test.ok": "连通成功",
  "settings.relay.test.empty": "已连通，但未返回模型",
  "settings.relay.models.title": "{{vendor}} · 模型列表",
  "settings.relay.models.empty": "还没有模型。保存密钥后再获取列表。",
  "settings.relay.models.missing": "已不在上游",
  "settings.relay.saved": "已自动保存",
  "settings.relay.retry": "重试",
  "settings.relay.builtin": "内置",
  "settings.relay.delete": "删除厂商",
  "settings.relay.rollback": "重置已导入密钥",
  "settings.relay.rollback.description": "清除从 auth.json 导入的中转站密钥。原始 auth.json 会保留。",
  "settings.relay.error.KEY_MISSING": "请先填写 API KEY",
  "settings.relay.error.KEY_REJECTED": "密钥无效",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "网络不可达",
  "settings.relay.error.UPSTREAM_TIMEOUT": "上游超时",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "上游限流",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "上游返回无效数据",
  "settings.relay.error.REVISION_CONFLICT": "设置已在其他窗口更改，请刷新后再试。",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "无法在此设备上保存 API KEY。",
  ...
  "settings.mcp.description": "为此项目连接、授权并编辑 MCP 服务器。",
  ...
  "settings.mcp.error.name": "请输入服务器名称",
  "settings.mcp.error.command": "请输入命令",
  "settings.mcp.error.url": "请输入 URL",
  "settings.skills.title": "技能",
  "settings.skills.description": "此项目已发现的技能。",
  "settings.skills.empty": "未找到技能",
  "settings.skills.enabled": "模型可用",
  "settings.skills.disabled": "已对模型拒绝",
  "settings.skills.search": "搜索技能",
  "settings.skills.emptySearch": "没有匹配的技能",
  "settings.skills.details": "技能详情",
  "settings.skills.noDescription": "没有描述",
  "settings.skills.source.project": "项目",
  "settings.skills.source.global": "用户",
  "settings.skills.source.builtin": "内置",
  "settings.skills.source.custom": "手动添加",
  "settings.scheduled.title": "已安排任务",
  "settings.scheduled.description": "在项目中一次性或每天运行一条提示。",
  "settings.scheduled.empty": "没有已安排任务",
  "settings.scheduled.once": "一次性",
  "settings.scheduled.daily": "每天",
  "settings.scheduled.add": "添加任务",
  "settings.scheduled.field.name": "名称",
  "settings.scheduled.field.prompt": "提示",
  "settings.scheduled.field.schedule": "计划",
  "settings.scheduled.field.time": "运行时间",
  "settings.scheduled.error.name": "请输入名称",
  "settings.scheduled.error.prompt": "请输入提示",
  "settings.scheduled.error.time": "请选择时间",
  "settings.scheduled.error.model": "请先选择模型",
  ...
  "session.todo.empty": "还没有任务",
  "session.panel.files": "文件",
  "session.panel.changes": "变更",
  "session.panel.tasks": "任务",
  "session.panel.terminal": "终端",
  "session.panel.empty": "请先选择项目，再浏览文件、变更、任务和终端。",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "工作区干净",
  "session.panel.git.dirty.one": "{{count}} 个已更改文件",
  "session.panel.git.dirty.other": "{{count}} 个已更改文件",
  "session.task.waiting": "等待权限",
  "session.task.failed": "失败",
  "session.task.retry": "重试",
  "session.task.open": "在独立会话中打开",
