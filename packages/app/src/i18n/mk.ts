export const dict = {
  ...
  "desktop.about.title": "Koda за работна површина v{{version}}",
  "desktop.about.detail": "Изменето со OpenCode како основа\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "Достапна е Koda v{{version}}. Да се отвори страницата на изданието за надградба?",
  "desktop.koda.update.open": "Отвори ја страницата на изданието",
  "command.project.create": "Нов проект",
  "command.project.openExisting": "Отвори постоечки проект",
  "prompt.toast.projectRequired.title": "Изберете проект",
  "prompt.toast.projectRequired.description": "Создајте или отворете проект пред испраќање.",
  "prompt.approval.ask": "Побарај одобрување",
  "prompt.approval.auto": "Одобри во мое име",
  "prompt.approval.plan": "Целосен пристап",
  "prompt.more": "Повеќе",
  "dialog.project.create.title": "Нов проект",
  "dialog.project.create.name": "Име",
  "dialog.project.create.location": "Локација",
  "dialog.project.create.browse": "Прелистај",
  "dialog.project.create.path": "Патека",
  "dialog.project.create.submit": "Создај",
  "dialog.project.create.error.name": "Внесете име на проектот",
  "dialog.project.create.error.invalid": "Ова име не може да се користи за папка",
  "dialog.project.create.error.exists": "Таа папка веќе постои. Отворете ја или изберете друго име.",
  "dialog.project.create.error.failed": "Не може да се создаде папката",
  "mcp.status.needs_client_registration": "потребна е регистрација на клиентот",
  "home.welcome.title": "Како можам да помогнам?",
  "home.project.create": "Нов проект",
  "home.project.open": "Отвори постоечки проект",
  "home.sessions.search.title": "Пребарај разговори",
  "session.todo.empty": "Сè уште нема задачи",
  "session.panel.files": "Датотеки",
  "session.panel.changes": "Промени",
  "session.panel.tasks": "Задачи",
  "session.panel.terminal": "Терминал",
  "session.panel.empty": "Изберете проект за да ги разгледате датотеките, промените, задачите и терминалот.",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "Без промени",
  "session.panel.git.dirty.one": "{{count}} изменета датотека",
  "session.panel.git.dirty.other": "{{count}} изменети датотеки",
  "session.task.waiting": "Се чека дозвола",
  "session.task.failed": "Неуспешно",
  "session.task.retry": "Обиди се повторно",
  "session.task.open": "Отвори во посебна сесија",
  "settings.skills.title": "Вештини",
  "settings.skills.description": "Вештини откриени за овој проект.",
  "settings.skills.empty": "Не се пронајдени вештини",
  "settings.skills.enabled": "Достапна за моделот",
  "settings.skills.disabled": "Забранета за моделот",
  "settings.skills.search": "Пребарај вештини",
  "settings.skills.emptySearch": "Нема вештини што одговараат на пребарувањето",
  "settings.skills.details": "Детали за вештината",
  "settings.skills.noDescription": "Нема опис",
  "settings.skills.source.project": "Проект",
  "settings.skills.source.global": "Корисник",
  "settings.skills.source.builtin": "Вградена",
  "settings.skills.source.custom": "Додадена",
  "settings.scheduled.title": "Закажани задачи",
  "settings.scheduled.description": "Извршете барање во проектот еднаш или секој ден.",
  "settings.scheduled.empty": "Нема закажани задачи",
  "settings.scheduled.once": "Еднаш",
  "settings.scheduled.daily": "Секој ден",
  "settings.scheduled.add": "Додај задача",
  "settings.scheduled.field.name": "Име",
  "settings.scheduled.field.prompt": "Барање",
  "settings.scheduled.field.schedule": "Распоред",
  "settings.scheduled.field.time": "Време на извршување",
  "settings.scheduled.error.name": "Внесете име",
  "settings.scheduled.error.prompt": "Внесете барање",
  "settings.scheduled.error.time": "Изберете време",
  "settings.scheduled.error.model": "Прво изберете модел",
  "session.new.project.open": "Отвори постоечки проект",
  "common.pin": "Прикачи",
  "common.unpin": "Откачи",
  "settings.relay.title": "Клучеви за 智联AI",
  "settings.relay.getKey": "Добиј API клуч",
  "settings.relay.getKey.description": "Создајте посебни клучеви за ChatGPT, Grok и други даватели.",
  "settings.relay.upstream": "Надреден сервер",
  "settings.relay.unified": "Користи заеднички API клуч",
  "settings.relay.unified.description": "Кога е овозможено, сите добавувачи го користат овој клуч.",
  "settings.relay.unified.key": "Заеднички API клуч",
  "settings.relay.unified.using": "Се користи заедничкиот клуч",
  "settings.relay.key.set": "Клучот е зачуван",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "Оставете празно за да го задржите зачуваниот клуч",
  "settings.relay.test": "Провери ја врската",
  "settings.relay.testing": "Се проверува...",
  "settings.relay.fetch": "Преземи модели",
  "settings.relay.fetching": "Се презема...",
  "settings.relay.edit": "Уреди",
  "settings.relay.clearKey": "Исчисти го клучот",
  "settings.relay.add": "Додај добавувач",
  "settings.relay.add.name": "Име на добавувачот",
  "settings.relay.models.visible": "Видливи модели: {{count}}",
  "settings.relay.connected": "Поврзано · модели: {{count}}",
  "settings.relay.connectedEmpty": "Поврзано, но не се вратени модели",
  "settings.relay.test.ok": "Поврзувањето успеа",
  "settings.relay.test.empty": "Поврзано, но не се вратени модели",
  "settings.relay.models.title": "Модели од {{vendor}}",
  "settings.relay.models.empty": "Сè уште нема модели. Преземете го списокот откако ќе зачувате клуч.",
  "settings.relay.models.missing": "Повеќе не е на надредениот сервер",
  "settings.relay.saved": "Зачувано автоматски",
  "settings.relay.retry": "Обиди се повторно",
  "settings.relay.builtin": "Вграден",
  "settings.relay.delete": "Избриши добавувач",
  "settings.relay.rollback": "Ресетирај увезени клучеви",
  "settings.relay.rollback.description":
    "Ги чисти Relay клучевите увезени од auth.json. Оригиналниот auth.json се задржува.",
  "settings.relay.error.KEY_MISSING": "Прво додајте API клуч",
  "settings.relay.error.KEY_REJECTED": "Клучот е одбиен",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "Надредениот сервер е недостапен",
  "settings.relay.error.UPSTREAM_TIMEOUT": "Истече времето за чекање на надредениот сервер",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "Надредениот сервер ја ограничи стапката на барања",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "Надредениот сервер врати неважечки одговор",
  "settings.relay.error.REVISION_CONFLICT": "Оваа поставка е сменета во друг прозорец. Освежете и обидете се повторно.",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "Не може да се зачува API клучот на овој уред.",
  "settings.mcp.add": "Додај MCP",
  "settings.mcp.edit": "Уреди",
  ...
  "settings.mcp.error.name": "Внесете име на серверот",
  "settings.mcp.error.command": "Внесете команда",
  "settings.mcp.error.url": "Внесете URL",
  ...
  "desktop.menu.documentation": "Koda Документација",
  ...
  "desktop.menu.ariaLabel": "Koda мени",
  ...
  "desktop.recovery.loadFailed": "Koda не успеа да се вчита",
  "desktop.recovery.terminated": "Прозорецот Koda неочекувано заврши",
  "desktop.recovery.unresponsive": "Koda не реагира",
  ...
  "desktop.wsl.error.installOpencode": "инсталацијата Koda не успеа",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Koda не е инсталиран во {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Koda ажурирањето е завршено, но {{distro}} сè уште известува {{installed}}; се очекува {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатни модели обезбедени од Koda",
  ...
  "provider.connect.apiKey.description":
    "Внесете го вашиот клуч {{provider}} API за да ја поврзете вашата сметка и да користите {{provider}} модели во Koda.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen ви дава пристап до куриран сет на сигурни оптимизирани модели за агенти за кодирање.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "да го соберете вашиот код за авторизација за да ја поврзете вашата сметка и да користите {{provider}} модели во Koda.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "и внесете го кодот подолу за да ја поврзете вашата сметка и да користите {{provider}} модели во Koda.",
  ...
  "dialog.server.description": "Променете на кој Koda сервер се поврзува оваа апликација.",
  ...
  "wsl.onboarding.checkingOpencode": "Се проверува Koda...",
  "wsl.onboarding.checkingOpencodeIn": "Се проверува Koda во {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Се ажурира Koda...",
  "wsl.onboarding.updatingOpencodeIn": "Се ажурира Koda во {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ажурирајте Koda во {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ажурирај Koda",
  "wsl.onboarding.opencodeReadyIn": "Koda е подготвен во {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koda е подготвен.",
  "wsl.onboarding.installOpencodeIn": "Инсталирајте Koda во {{distro}}.",
  "wsl.onboarding.installOpencode": "Инсталирај Koda",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) е потребно пред Koda да може да додаде WSL сервер",
  "wsl.onboarding.wslUnavailable.title": "WSL недостапен",
  "wsl.onboarding.wslUnavailable.description": "Koda не можеше да го потврди WSL на оваа машина.",
  "wsl.onboarding.installWsl": "Инсталирај WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Рестартирајте го Windows за да завршите со инсталирањето WSL, а потоа повторно отворете Koda.",
  ...
  "help.tabs.introduction": "Koda Desktop сега е изграден околу картичките.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Новата верзија на Koda ({{version}}) сега е достапна за инсталирање.",
  ...
  "error.page.report.prefix": "Ве молиме пријавете ја оваа грешка на тимот Koda",
  ...
  "error.chain.mcpFailed": "MCP серверот „{{name}}“ не успеа. Забелешка, Koda сè уште не поддржува автентикација MCP.",
  ...
  "sidebar.gettingStarted.line1": "Koda вклучува бесплатни модели за да можете веднаш да започнете.",
  ...
  "settings.desktop.wsl.description": "Стартувај го серверот Koda во WSL на Windows.",
  ...
  "settings.general.row.language.description": "Променете го јазикот на прикажување за Koda",
  ...
  "settings.general.row.appearance.description": "Приспособете како изгледа Koda на вашиот уред",
  "settings.general.row.colorScheme.title": "Шема на бои",
  "settings.general.row.colorScheme.description": "Изберете дали Koda ја следи системската, светла или темна тема",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Приспособете како Koda е тематизирана.",
  ...
  "settings.updates.row.startup.description": "Автоматски проверувајте дали има ажурирања кога ќе се стартува Koda",
  ...
  "settings.updates.toast.latest.description": "Ја извршувате најновата верзија на Koda.",
