export const dict = {
  "desktop.menu.about": "Koda haqida",
  "desktop.about.title": "Koda ish stoli ilovasi v{{version}}",
  "desktop.about.detail": "OpenCode asosida o‘zgartirilgan\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "Koda v{{version}} mavjud. Yangilash uchun reliz sahifasi ochilsinmi?",
  "desktop.koda.update.open": "Reliz sahifasini ochish",
  "command.project.create": "Yangi loyiha",
  "command.project.openExisting": "Mavjud loyihani ochish",
  "prompt.toast.projectRequired.title": "Loyiha tanlang",
  "prompt.toast.projectRequired.description": "Yuborishdan oldin loyiha yarating yoki oching.",
  "prompt.approval.ask": "Tasdiq so‘rash",
  "prompt.approval.auto": "Men uchun tasdiqlash",
  "prompt.approval.plan": "To‘liq kirish",
  "prompt.more": "Yana",
  "dialog.project.create.title": "Yangi loyiha",
  "dialog.project.create.name": "Nomi",
  "dialog.project.create.location": "Joylashuvi",
  "dialog.project.create.browse": "Ko‘rib chiqish",
  "dialog.project.create.path": "Yo‘l",
  "dialog.project.create.submit": "Yaratish",
  "dialog.project.create.error.name": "Loyiha nomini kiriting",
  "dialog.project.create.error.invalid": "Bu nomdan jild uchun foydalanib bo‘lmaydi",
  "dialog.project.create.error.exists": "Bu jild allaqachon mavjud. Uni oching yoki boshqa nom tanlang.",
  "dialog.project.create.error.failed": "Jild yaratilmadi",
  "mcp.status.needs_client_registration": "mijozni ro‘yxatdan o‘tkazish kerak",
  "home.welcome.title": "Qanday yordam bera olaman?",
  "home.project.create": "Yangi loyiha",
  "home.project.open": "Mavjud loyihani ochish",
  "home.sessions.search.title": "Suhbatlarni qidirish",
  "session.todo.empty": "Hali vazifalar yo‘q",
  "session.panel.files": "Fayllar",
  "session.panel.changes": "O‘zgarishlar",
  "session.panel.tasks": "Vazifalar",
  "session.panel.terminal": "Terminal",
  "session.panel.empty": "Fayllar, o‘zgarishlar, vazifalar va terminalni ko‘rish uchun loyiha tanlang.",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "O‘zgarishsiz",
  "session.panel.git.dirty.one": "{{count}} ta o‘zgartirilgan fayl",
  "session.panel.git.dirty.other": "{{count}} ta o‘zgartirilgan fayl",
  "session.task.waiting": "Ruxsat kutilmoqda",
  "session.task.failed": "Bajarilmadi",
  "session.task.retry": "Qayta urinish",
  "session.task.open": "Alohida seansda ochish",
  "settings.skills.title": "Ko‘nikmalar",
  "settings.skills.description": "Ushbu loyiha uchun topilgan ko‘nikmalar.",
  "settings.skills.empty": "Ko‘nikmalar topilmadi",
  "settings.skills.enabled": "Model uchun mavjud",
  "settings.skills.disabled": "Model uchun taqiqlangan",
  "settings.skills.search": "Ko‘nikmalarni qidirish",
  "settings.skills.emptySearch": "Qidiruvga mos ko‘nikmalar yo‘q",
  "settings.skills.details": "Ko‘nikma tafsilotlari",
  "settings.skills.noDescription": "Tavsif yo‘q",
  "settings.skills.source.project": "Loyiha",
  "settings.skills.source.global": "Foydalanuvchi",
  "settings.skills.source.builtin": "Ichki",
  "settings.skills.source.custom": "Qo‘shilgan",
  "settings.scheduled.title": "Rejalashtirilgan vazifalar",
  "settings.scheduled.description": "Loyihada so‘rovni bir marta yoki har kuni bajaring.",
  "settings.scheduled.empty": "Rejalashtirilgan vazifalar yo‘q",
  "settings.scheduled.once": "Bir marta",
  "settings.scheduled.daily": "Har kuni",
  "settings.scheduled.add": "Vazifa qo‘shish",
  "settings.scheduled.field.name": "Nomi",
  "settings.scheduled.field.prompt": "So‘rov",
  "settings.scheduled.field.schedule": "Jadval",
  "settings.scheduled.field.time": "Bajarish vaqti",
  "settings.scheduled.error.name": "Nom kiriting",
  "settings.scheduled.error.prompt": "So‘rov kiriting",
  "settings.scheduled.error.time": "Vaqt tanlang",
  "settings.scheduled.error.model": "Avval model tanlang",
  "session.new.project.open": "Mavjud loyihani ochish",
  "common.pin": "Mahkamlash",
  "common.unpin": "Mahkamlashni bekor qilish",
  "settings.relay.title": "智联AI kalitlari",
  "settings.relay.getKey": "API kalitini olish",
  "settings.relay.getKey.description": "ChatGPT, Grok va boshqa provayderlar uchun alohida kalitlar yarating.",
  "settings.relay.upstream": "Yuqori server",
  "settings.relay.unified": "Umumiy API kalitidan foydalanish",
  "settings.relay.unified.description": "Yoqilganda barcha ta’minotchilar shu kalitdan foydalanadi.",
  "settings.relay.unified.key": "Umumiy API kaliti",
  "settings.relay.unified.using": "Umumiy kalit ishlatilmoqda",
  "settings.relay.key.set": "Kalit saqlandi",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "Saqlangan kalitni saqlab qolish uchun bo‘sh qoldiring",
  "settings.relay.test": "Ulanishni tekshirish",
  "settings.relay.testing": "Tekshirilmoqda...",
  "settings.relay.fetch": "Modellarni olish",
  "settings.relay.fetching": "Olinmoqda...",
  "settings.relay.edit": "Tahrirlash",
  "settings.relay.clearKey": "Kalitni tozalash",
  "settings.relay.add": "Ta’minotchi qo‘shish",
  "settings.relay.add.name": "Ta’minotchi nomi",
  "settings.relay.models.visible": "{{count}} ta ko‘rinadigan model",
  "settings.relay.connected": "Ulandi · {{count}} ta model",
  "settings.relay.connectedEmpty": "Ulandi, ammo modellar qaytarilmadi",
  "settings.relay.test.ok": "Ulanish muvaffaqiyatli",
  "settings.relay.test.empty": "Ulandi, ammo modellar qaytarilmadi",
  "settings.relay.models.title": "{{vendor}} modellari",
  "settings.relay.models.empty": "Hali modellar yo‘q. Kalitni saqlagach, ro‘yxatni oling.",
  "settings.relay.models.missing": "Yuqori serverda endi mavjud emas",
  "settings.relay.saved": "Avtomatik saqlandi",
  "settings.relay.retry": "Qayta urinish",
  "settings.relay.builtin": "Ichki",
  "settings.relay.delete": "Ta’minotchini o‘chirish",
  "settings.relay.rollback": "Import qilingan kalitlarni tiklash",
  "settings.relay.rollback.description":
    "auth.json faylidan import qilingan Relay kalitlarini tozalaydi. Asl auth.json saqlanadi.",
  "settings.relay.error.KEY_MISSING": "Avval API kalitini qo‘shing",
  "settings.relay.error.KEY_REJECTED": "Kalit rad etildi",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "Yuqori serverga ulanib bo‘lmaydi",
  "settings.relay.error.UPSTREAM_TIMEOUT": "Yuqori serverning kutish vaqti tugadi",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "Yuqori server so‘rovlar tezligini chekladi",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "Yuqori server yaroqsiz javob qaytardi",
  "settings.relay.error.REVISION_CONFLICT":
    "Bu sozlama boshqa oynada o‘zgartirilgan. Yangilang va qayta urinib ko‘ring.",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "API kalitini bu qurilmada saqlab bo‘lmadi.",
  "settings.mcp.add": "MCP qo‘shish",
  "settings.mcp.edit": "Tahrirlash",
  "settings.mcp.field.name": "Nomi",
  "settings.mcp.field.type": "Turi",
  "settings.mcp.field.command": "Buyruq",
  ...
  "settings.mcp.type.local": "Mahalliy",
  "settings.mcp.type.remote": "Masofaviy",
  "settings.mcp.error.name": "Server nomini kiriting",
  "settings.mcp.error.command": "Buyruq kiriting",
  "settings.mcp.error.url": "URL kiriting",
  ...
  "desktop.menu.documentation": "Koda hujjatlari",
  ...
  "desktop.menu.ariaLabel": "Koda menyusi",
  ...
  "desktop.recovery.loadFailed": "Koda yuklanmadi",
  "desktop.recovery.terminated": "Koda oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "Koda javob bermayapti",
  ...
  "desktop.wsl.error.installOpencode": "Koda oʻrnatilmadi",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Koda {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "Koda yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Koda tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va Koda’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen sizga kodlash agentlari uchun ishonchli optimallashtirilgan modellar to'plamiga kirish imkonini beradi.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va Koda da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va Koda da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.server.description": "Ushbu ilova qaysi Koda serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingOpencode": "Koda tekshirilmoqda...",
  "wsl.onboarding.checkingOpencodeIn": "Koda {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingOpencode": "Koda yangilanmoqda...",
  "wsl.onboarding.updatingOpencodeIn": "Koda {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateOpencodeIn": "Koda-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateOpencode": "Koda-ni yangilang",
  "wsl.onboarding.opencodeReadyIn": "Koda {{distro}} da tayyor.",
  "wsl.onboarding.opencodeReady": "Koda tayyor.",
  "wsl.onboarding.installOpencodeIn": "Koda-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installOpencode": "Koda-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Koda WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "Koda WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra Koda-ni qayta oching.",
  ...
  "help.tabs.introduction": "Koda Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Koda ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida Koda jamoasiga xabar bering",
  ...
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, Koda hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "Koda bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi Koda serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "Koda uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "Koda qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "Koda tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "Koda mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "Koda ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz Koda oxirgi versiyasini ishga tushiryapsiz.",
