export const dict = {
  "desktop.menu.about": "Om Koda",
  "desktop.about.title": "Koda Desktop v{{version}}",
  "desktop.about.detail": "Anpassad med OpenCode som grund\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "Koda v{{version}} är tillgänglig. Öppna versionssidan för att uppdatera?",
  "desktop.koda.update.open": "Öppna versionssidan",
  "command.project.create": "Nytt projekt",
  "command.project.openExisting": "Öppna befintligt projekt",
  "prompt.toast.projectRequired.title": "Välj ett projekt",
  "prompt.toast.projectRequired.description": "Skapa eller öppna ett projekt innan du skickar.",
  "prompt.approval.ask": "Begär godkännande",
  "prompt.approval.auto": "Godkänn åt mig",
  "prompt.approval.plan": "Fullständig åtkomst",
  "prompt.more": "Mer",
  "dialog.project.create.title": "Nytt projekt",
  "dialog.project.create.name": "Namn",
  "dialog.project.create.location": "Plats",
  "dialog.project.create.browse": "Bläddra",
  "dialog.project.create.path": "Sökväg",
  "dialog.project.create.submit": "Skapa",
  "dialog.project.create.error.name": "Ange ett projektnamn",
  "dialog.project.create.error.invalid": "Det här namnet kan inte användas för en mapp",
  "dialog.project.create.error.exists": "Mappen finns redan. Öppna den i stället eller välj ett annat namn.",
  "dialog.project.create.error.failed": "Det gick inte att skapa mappen",
  "mcp.status.needs_client_registration": "kräver klientregistrering",
  "home.welcome.title": "Vad kan jag hjälpa till med?",
  "home.project.create": "Nytt projekt",
  "home.project.open": "Öppna befintligt projekt",
  "home.sessions.search.title": "Sök i chattar",
  "session.todo.empty": "Inga uppgifter ännu",
  "session.panel.files": "Filer",
  "session.panel.changes": "Ändringar",
  "session.panel.tasks": "Uppgifter",
  "session.panel.terminal": "Terminal",
  "session.panel.empty": "Välj ett projekt för att se filer, ändringar, uppgifter och terminalen.",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "Inga ändringar",
  "session.panel.git.dirty.one": "{{count}} ändrad fil",
  "session.panel.git.dirty.other": "{{count}} ändrade filer",
  "session.task.waiting": "Väntar på tillstånd",
  "session.task.failed": "Misslyckades",
  "session.task.retry": "Försök igen",
  "session.task.open": "Öppna i en egen session",
  "settings.skills.title": "Färdigheter",
  "settings.skills.description": "Färdigheter som hittats för det här projektet.",
  "settings.skills.empty": "Inga färdigheter hittades",
  "settings.skills.enabled": "Tillgänglig för modellen",
  "settings.skills.disabled": "Nekad för modellen",
  "settings.skills.search": "Sök efter färdigheter",
  "settings.skills.emptySearch": "Inga färdigheter matchar sökningen",
  "settings.skills.details": "Färdighetsinformation",
  "settings.skills.noDescription": "Ingen beskrivning",
  "settings.skills.source.project": "Projekt",
  "settings.skills.source.global": "Användare",
  "settings.skills.source.builtin": "Inbyggd",
  "settings.skills.source.custom": "Tillagd",
  "settings.scheduled.title": "Schemalagda uppgifter",
  "settings.scheduled.description": "Kör en instruktion en gång eller varje dag i ett projekt.",
  "settings.scheduled.empty": "Inga schemalagda uppgifter",
  "settings.scheduled.once": "En gång",
  "settings.scheduled.daily": "Varje dag",
  "settings.scheduled.add": "Lägg till uppgift",
  "settings.scheduled.field.name": "Namn",
  "settings.scheduled.field.prompt": "Instruktion",
  "settings.scheduled.field.schedule": "Schema",
  "settings.scheduled.field.time": "Kör klockan",
  "settings.scheduled.error.name": "Ange ett namn",
  "settings.scheduled.error.prompt": "Ange en instruktion",
  "settings.scheduled.error.time": "Välj en tid",
  "settings.scheduled.error.model": "Välj en modell först",
  "session.new.project.open": "Öppna befintligt projekt",
  "common.pin": "Fäst",
  "common.unpin": "Lossa",
  "settings.relay.title": "智联AI-nycklar",
  "settings.relay.getKey": "Hämta API-nyckel",
  "settings.relay.getKey.description": "Skapa separata nycklar för ChatGPT, Grok och andra leverantörer.",
  "settings.relay.upstream": "Bakomliggande tjänst",
  "settings.relay.unified": "Använd en gemensam API-nyckel",
  "settings.relay.unified.description": "När detta är aktiverat använder alla leverantörer den här nyckeln.",
  "settings.relay.unified.key": "Gemensam API-nyckel",
  "settings.relay.unified.using": "Använder den gemensamma nyckeln",
  "settings.relay.key.set": "Nyckeln har sparats",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "Lämna tomt för att behålla den sparade nyckeln",
  "settings.relay.test": "Testa anslutningen",
  "settings.relay.testing": "Testar...",
  "settings.relay.fetch": "Hämta modeller",
  "settings.relay.fetching": "Hämtar...",
  "settings.relay.edit": "Redigera",
  "settings.relay.clearKey": "Rensa nyckel",
  "settings.relay.add": "Lägg till leverantör",
  "settings.relay.add.name": "Leverantörsnamn",
  "settings.relay.models.visible": "{{count}} synliga modeller",
  "settings.relay.connected": "Ansluten · {{count}} modeller",
  "settings.relay.connectedEmpty": "Ansluten, men inga modeller returnerades",
  "settings.relay.test.ok": "Anslutningen lyckades",
  "settings.relay.test.empty": "Ansluten, men inga modeller returnerades",
  "settings.relay.models.title": "Modeller från {{vendor}}",
  "settings.relay.models.empty": "Inga modeller ännu. Hämta listan när du har sparat en nyckel.",
  "settings.relay.models.missing": "Finns inte längre hos den bakomliggande tjänsten",
  "settings.relay.saved": "Sparat automatiskt",
  "settings.relay.retry": "Försök igen",
  "settings.relay.builtin": "Inbyggd",
  "settings.relay.delete": "Ta bort leverantör",
  "settings.relay.rollback": "Återställ importerade nycklar",
  "settings.relay.rollback.description":
    "Rensar Relay-nycklar som importerats från auth.json. Den ursprungliga auth.json behålls.",
  "settings.relay.error.KEY_MISSING": "Lägg till en API-nyckel först",
  "settings.relay.error.KEY_REJECTED": "Nyckeln avvisades",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "Den bakomliggande tjänsten kan inte nås",
  "settings.relay.error.UPSTREAM_TIMEOUT": "Tidsgränsen för den bakomliggande tjänsten överskreds",
  "settings.relay.error.UPSTREAM_RATE_LIMITED":
    "Den bakomliggande tjänsten begränsade begäran på grund av för många förfrågningar",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "Den bakomliggande tjänsten returnerade ett ogiltigt svar",
  "settings.relay.error.REVISION_CONFLICT":
    "Den här inställningen ändrades i ett annat fönster. Uppdatera och försök igen.",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "Det gick inte att spara API-nyckeln på den här enheten.",
  "settings.mcp.add": "Lägg till MCP",
  "settings.mcp.edit": "Redigera",
  "settings.mcp.field.name": "Namn",
  "settings.mcp.field.type": "Typ",
  "settings.mcp.field.command": "Kommando",
  ...
  "settings.mcp.error.name": "Ange ett servernamn",
  "settings.mcp.error.command": "Ange ett kommando",
  "settings.mcp.error.url": "Ange en URL",
  ...
  "desktop.menu.ariaLabel": "Koda-meny",
  ...
  "desktop.recovery.loadFailed": "Koda kunde inte läsas in",
  "desktop.recovery.terminated": "Koda-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "Koda svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av Koda misslyckades",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Koda är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Koda-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av Koda",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i Koda.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i Koda.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i Koda.",
  ...
  "dialog.server.description": "Växla vilken Koda-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar Koda...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar Koda i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar Koda...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar Koda i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera Koda i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera Koda",
  "wsl.onboarding.opencodeReadyIn": "Koda är redo i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koda är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera Koda i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera Koda",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan Koda kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "Koda kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan Koda igen.",
  ...
  "help.tabs.introduction": "Koda Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av Koda ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till Koda-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, Koda stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "Koda innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör Koda-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för Koda",
  ...
  "settings.general.row.appearance.description": "Anpassa hur Koda ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om Koda följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa Kodas tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när Koda startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av Koda.",
