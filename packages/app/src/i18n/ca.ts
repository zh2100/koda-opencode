export const dict = {
  "desktop.menu.about": "Quant al Koda",
  "desktop.about.title": "Koda Desktop v{{version}}",
  "desktop.about.detail":
    "Modificat a partir de l’OpenCode com a base\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available":
    "El Koda v{{version}} està disponible. Voleu obrir la pàgina de versions per actualitzar-lo?",
  "desktop.koda.update.open": "Obre la pàgina de versions",
  "command.project.create": "Projecte nou",
  "command.project.openExisting": "Obre un projecte existent",
  "prompt.toast.projectRequired.title": "Trieu un projecte",
  "prompt.toast.projectRequired.description": "Creeu o obriu un projecte abans d’enviar.",
  "prompt.approval.ask": "Demana aprovació",
  "prompt.approval.auto": "Aprova per mi",
  "prompt.approval.plan": "Accés complet",
  "prompt.more": "Més",
  "dialog.project.create.title": "Projecte nou",
  "dialog.project.create.name": "Nom",
  "dialog.project.create.location": "Ubicació",
  "dialog.project.create.browse": "Navega",
  "dialog.project.create.path": "Camí",
  "dialog.project.create.submit": "Crea",
  "dialog.project.create.error.name": "Introduïu un nom de projecte",
  "dialog.project.create.error.invalid": "Aquest nom no es pot utilitzar per a una carpeta",
  "dialog.project.create.error.exists": "Aquesta carpeta ja existeix. Obriu-la o trieu un altre nom.",
  "dialog.project.create.error.failed": "No s’ha pogut crear la carpeta",
  "mcp.status.needs_client_registration": "cal registrar el client",
  "home.welcome.title": "En què us puc ajudar?",
  "home.project.create": "Projecte nou",
  "home.project.open": "Obre un projecte existent",
  "home.sessions.search.title": "Cerca converses",
  "session.todo.empty": "Encara no hi ha tasques",
  "session.panel.files": "Fitxers",
  "session.panel.changes": "Canvis",
  "session.panel.tasks": "Tasques",
  "session.panel.terminal": "Terminal",
  "session.panel.empty": "Seleccioneu un projecte per explorar els fitxers, els canvis, les tasques i el terminal.",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "Sense canvis",
  "session.panel.git.dirty.one": "{{count}} fitxer modificat",
  "session.panel.git.dirty.other": "{{count}} fitxers modificats",
  "session.panel.git.dirty.many": "{{count}} fitxers modificats",
  "session.task.waiting": "S’està esperant el permís",
  "session.task.failed": "Ha fallat",
  "session.task.retry": "Torna-ho a provar",
  "session.task.open": "Obre en una sessió pròpia",
  "settings.skills.title": "Habilitats",
  "settings.skills.description": "Habilitats trobades per a aquest projecte.",
  "settings.skills.empty": "No s’ha trobat cap habilitat",
  "settings.skills.enabled": "Disponible per al model",
  "settings.skills.disabled": "Denegada al model",
  "settings.skills.search": "Cerca habilitats",
  "settings.skills.emptySearch": "Cap habilitat coincideix amb aquesta cerca",
  "settings.skills.details": "Detalls de l’habilitat",
  "settings.skills.noDescription": "Sense descripció",
  "settings.skills.source.project": "Projecte",
  "settings.skills.source.global": "Usuari",
  "settings.skills.source.builtin": "Integrada",
  "settings.skills.source.custom": "Afegida",
  "settings.scheduled.title": "Tasques programades",
  "settings.scheduled.description": "Executeu una instrucció una vegada o cada dia en un projecte.",
  "settings.scheduled.empty": "No hi ha tasques programades",
  "settings.scheduled.once": "Una vegada",
  "settings.scheduled.daily": "Cada dia",
  "settings.scheduled.add": "Afegeix una tasca",
  "settings.scheduled.field.name": "Nom",
  "settings.scheduled.field.prompt": "Instrucció",
  "settings.scheduled.field.schedule": "Programació",
  "settings.scheduled.field.time": "Executa a les",
  "settings.scheduled.error.name": "Introduïu un nom",
  "settings.scheduled.error.prompt": "Introduïu una instrucció",
  "settings.scheduled.error.time": "Trieu una hora",
  "settings.scheduled.error.model": "Seleccioneu primer un model",
  "session.new.project.open": "Obre un projecte existent",
  "common.pin": "Fixa",
  "common.unpin": "Desfixa",
  "settings.relay.title": "Claus de 智联AI",
  "settings.relay.getKey": "Obtén una clau d’API",
  "settings.relay.getKey.description": "Creeu claus separades per al ChatGPT, el Grok i altres proveïdors.",
  "settings.relay.upstream": "Servei d’origen",
  "settings.relay.unified": "Utilitza una clau d’API compartida",
  "settings.relay.unified.description": "Quan s’activa, tots els proveïdors utilitzen aquesta clau.",
  "settings.relay.unified.key": "Clau d’API compartida",
  "settings.relay.unified.using": "S’utilitza la clau compartida",
  "settings.relay.key.set": "Clau desada",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "Deixeu-ho en blanc per conservar la clau desada",
  "settings.relay.test": "Prova la connexió",
  "settings.relay.testing": "S’està provant...",
  "settings.relay.fetch": "Obtén els models",
  "settings.relay.fetching": "S’estan obtenint...",
  "settings.relay.edit": "Edita",
  "settings.relay.clearKey": "Esborra la clau",
  "settings.relay.add": "Afegeix un proveïdor",
  "settings.relay.add.name": "Nom del proveïdor",
  "settings.relay.models.visible": "{{count}} models visibles",
  "settings.relay.connected": "Connectat · {{count}} models",
  "settings.relay.connectedEmpty": "Connectat, però no s’ha retornat cap model",
  "settings.relay.test.ok": "Connexió correcta",
  "settings.relay.test.empty": "Connectat, però no s’ha retornat cap model",
  "settings.relay.models.title": "Models de {{vendor}}",
  "settings.relay.models.empty": "Encara no hi ha models. Obteniu la llista després de desar una clau.",
  "settings.relay.models.missing": "Ja no és al servei d’origen",
  "settings.relay.saved": "Desat automàticament",
  "settings.relay.retry": "Torna-ho a provar",
  "settings.relay.builtin": "Integrat",
  "settings.relay.delete": "Suprimeix el proveïdor",
  "settings.relay.rollback": "Restableix les claus importades",
  "settings.relay.rollback.description":
    "Esborra les claus del Relay importades d’auth.json. Es conserva el fitxer auth.json original.",
  "settings.relay.error.KEY_MISSING": "Afegiu primer una clau d’API",
  "settings.relay.error.KEY_REJECTED": "S’ha rebutjat la clau",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "No es pot accedir al servei d’origen",
  "settings.relay.error.UPSTREAM_TIMEOUT": "S’ha esgotat el temps d’espera del servei d’origen",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "El servei d’origen ha limitat la petició per un excés de sol·licituds",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "El servei d’origen ha retornat una resposta no vàlida",
  "settings.relay.error.REVISION_CONFLICT":
    "Aquest paràmetre ha canviat en una altra finestra. Actualitzeu i torneu-ho a provar.",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "No s’ha pogut desar la clau d’API en aquest dispositiu.",
  "settings.mcp.add": "Afegeix un MCP",
  "settings.mcp.edit": "Edita",
  "settings.mcp.field.name": "Nom",
  "settings.mcp.field.type": "Tipus",
  "settings.mcp.field.command": "Ordre",
  ...
  "settings.mcp.error.name": "Introduïu un nom de servidor",
  "settings.mcp.error.command": "Introduïu una ordre",
  "settings.mcp.error.url": "Introduïu un URL",
  ...
  "desktop.menu.documentation": "Koda Documentació",
  ...
  "desktop.menu.ariaLabel": "menú Koda.",
  ...
  "desktop.recovery.loadFailed": "Koda no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra Koda s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "Koda no respon",
  ...
  "desktop.wsl.error.installOpencode": "La instal·lació de Koda ha fallat",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Koda no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Koda actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per Koda",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a Koda.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen us ofereix accés a un conjunt seleccionat de models optimitzats fiables per a agents de codificació.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a Koda.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a Koda.",
  ...
  "dialog.server.description": "Canvia a quin Koda servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingOpencode": "S'està comprovant Koda...",
  "wsl.onboarding.checkingOpencodeIn": "S'està registrant Koda a {{distro}}...",
  "wsl.onboarding.updatingOpencode": "S'està actualitzant Koda...",
  "wsl.onboarding.updatingOpencodeIn": "S'està actualitzant Koda a {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualitza Koda a {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualització Koda",
  "wsl.onboarding.opencodeReadyIn": "Koda està llest a {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koda està llest.",
  "wsl.onboarding.installOpencodeIn": "Instal·leu Koda a {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal·la Koda",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que Koda pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Koda no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir Koda.",
  ...
  "help.tabs.introduction": "Koda L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de Koda ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip Koda.",
  ...
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que Koda encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "Koda inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "app.name.desktop": "Koda Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor Koda dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a Koda",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu Koda al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si Koda segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de Koda.",
  ...
  "settings.updates.row.startup.description": "Comprova automàticament si hi ha actualitzacions quan s'iniciï Koda.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de Koda.",
