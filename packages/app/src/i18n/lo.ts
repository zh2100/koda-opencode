export const dict = {
  "desktop.menu.about": "ກ່ຽວກັບ Koda",
  "desktop.about.title": "Koda Desktop v{{version}}",
  "desktop.about.detail": "ດັດແປງໂດຍໃຊ້ OpenCode ເປັນແກນຫຼັກ\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "ມີ Koda v{{version}} ແລ້ວ. ເປີດໜ້າລຸ້ນເພື່ອອັບເກຣດບໍ?",
  "desktop.koda.update.open": "ເປີດໜ້າລຸ້ນ",
  "command.project.create": "ໂຄງການໃໝ່",
  "command.project.openExisting": "ເປີດໂຄງການທີ່ມີຢູ່",
  "prompt.toast.projectRequired.title": "ເລືອກໂຄງການ",
  "prompt.toast.projectRequired.description": "ສ້າງ ຫຼື ເປີດໂຄງການກ່ອນສົ່ງ.",
  "prompt.approval.ask": "ຂໍການອະນຸມັດ",
  "prompt.approval.auto": "ອະນຸມັດແທນຂ້ອຍ",
  "prompt.approval.plan": "ເຂົ້າເຖິງໄດ້ເຕັມຮູບແບບ",
  "prompt.more": "ເພີ່ມເຕີມ",
  "dialog.project.create.title": "ໂຄງການໃໝ່",
  "dialog.project.create.name": "ຊື່",
  "dialog.project.create.location": "ທີ່ຕັ້ງ",
  "dialog.project.create.browse": "ຊອກຫາ",
  "dialog.project.create.path": "ເສັ້ນທາງ",
  "dialog.project.create.submit": "ສ້າງ",
  "dialog.project.create.error.name": "ປ້ອນຊື່ໂຄງການ",
  "dialog.project.create.error.invalid": "ຊື່ນີ້ໃຊ້ເປັນຊື່ໂຟນເດີບໍ່ໄດ້",
  "dialog.project.create.error.exists": "ມີໂຟນເດີນີ້ຢູ່ແລ້ວ. ເປີດມັນ ຫຼື ເລືອກຊື່ອື່ນ.",
  "dialog.project.create.error.failed": "ສ້າງໂຟນເດີບໍ່ໄດ້",
  "mcp.status.needs_client_registration": "ຕ້ອງລົງທະບຽນໄຄລເອັນ",
  "home.welcome.title": "ມີຫຍັງໃຫ້ຊ່ວຍບໍ?",
  "home.project.create": "ໂຄງການໃໝ່",
  "home.project.open": "ເປີດໂຄງການທີ່ມີຢູ່",
  "home.sessions.search.title": "ຄົ້ນຫາການສົນທະນາ",
  "session.todo.empty": "ຍັງບໍ່ມີວຽກ",
  "session.panel.files": "ໄຟລ໌",
  "session.panel.changes": "ການປ່ຽນແປງ",
  "session.panel.tasks": "ວຽກ",
  "session.panel.terminal": "ເທີມິນັລ",
  "session.panel.empty": "ເລືອກໂຄງການເພື່ອເບິ່ງໄຟລ໌, ການປ່ຽນແປງ, ວຽກ ແລະ ເທີມິນັລ.",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "ບໍ່ມີການປ່ຽນແປງ",
  "session.panel.git.dirty.one": "ປ່ຽນແປງ {{count}} ໄຟລ໌",
  "session.panel.git.dirty.other": "ປ່ຽນແປງ {{count}} ໄຟລ໌",
  "session.task.waiting": "ກຳລັງລໍຖ້າການອະນຸຍາດ",
  "session.task.failed": "ລົ້ມເຫຼວ",
  "session.task.retry": "ລອງໃໝ່",
  "session.task.open": "ເປີດໃນເຊດຊັນແຍກ",
  "settings.skills.title": "ທັກສະ",
  "settings.skills.description": "ທັກສະທີ່ພົບສຳລັບໂຄງການນີ້.",
  "settings.skills.empty": "ບໍ່ພົບທັກສະ",
  "settings.skills.enabled": "ອະນຸຍາດໃຫ້ຕົວແບບໃຊ້",
  "settings.skills.disabled": "ບໍ່ອະນຸຍາດໃຫ້ຕົວແບບໃຊ້",
  "settings.skills.search": "ຄົ້ນຫາທັກສະ",
  "settings.skills.emptySearch": "ບໍ່ມີທັກສະທີ່ກົງກັບການຄົ້ນຫານີ້",
  "settings.skills.details": "ລາຍລະອຽດທັກສະ",
  "settings.skills.noDescription": "ບໍ່ມີຄຳອະທິບາຍ",
  "settings.skills.source.project": "ໂຄງການ",
  "settings.skills.source.global": "ຜູ້ໃຊ້",
  "settings.skills.source.builtin": "ມີໃນຕົວ",
  "settings.skills.source.custom": "ເພີ່ມແລ້ວ",
  "settings.scheduled.title": "ວຽກທີ່ຕັ້ງເວລາໄວ້",
  "settings.scheduled.description": "ແລ່ນຄຳສັ່ງໃຫ້ AI ໃນໂຄງການຄັ້ງດຽວ ຫຼື ທຸກມື້.",
  "settings.scheduled.empty": "ບໍ່ມີວຽກທີ່ຕັ້ງເວລາໄວ້",
  "settings.scheduled.once": "ຄັ້ງດຽວ",
  "settings.scheduled.daily": "ທຸກມື້",
  "settings.scheduled.add": "ເພີ່ມວຽກ",
  "settings.scheduled.field.name": "ຊື່",
  "settings.scheduled.field.prompt": "ຄຳສັ່ງໃຫ້ AI",
  "settings.scheduled.field.schedule": "ຕາຕະລາງ",
  "settings.scheduled.field.time": "ແລ່ນເວລາ",
  "settings.scheduled.error.name": "ປ້ອນຊື່",
  "settings.scheduled.error.prompt": "ປ້ອນຄຳສັ່ງໃຫ້ AI",
  "settings.scheduled.error.time": "ເລືອກເວລາ",
  "settings.scheduled.error.model": "ເລືອກຕົວແບບກ່ອນ",
  "session.new.project.open": "ເປີດໂຄງການທີ່ມີຢູ່",
  "common.pin": "ປັກໝຸດ",
  "common.unpin": "ຖອນໝຸດ",
  "settings.relay.title": "ຄີ 智联AI",
  "settings.relay.getKey": "ຮັບຄີ API",
  "settings.relay.getKey.description": "ສ້າງຄີແຍກສຳລັບ ChatGPT, Grok ແລະ ຜູ້ໃຫ້ບໍລິການອື່ນໆ.",
  "settings.relay.upstream": "ບໍລິການຕົ້ນທາງ",
  "settings.relay.unified": "ໃຊ້ຄີ API ຮ່ວມກັນ",
  "settings.relay.unified.description": "ເມື່ອເປີດໃຊ້, ຜູ້ໃຫ້ບໍລິການທຸກລາຍຈະໃຊ້ຄີນີ້.",
  "settings.relay.unified.key": "ຄີ API ທີ່ໃຊ້ຮ່ວມກັນ",
  "settings.relay.unified.using": "ກຳລັງໃຊ້ຄີຮ່ວມກັນ",
  "settings.relay.key.set": "ບັນທຶກຄີແລ້ວ",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "ປ່ອຍວ່າງເພື່ອເກັບຄີທີ່ບັນທຶກໄວ້",
  "settings.relay.test": "ທົດສອບການເຊື່ອມຕໍ່",
  "settings.relay.testing": "ກຳລັງທົດສອບ...",
  "settings.relay.fetch": "ຮັບຕົວແບບ",
  "settings.relay.fetching": "ກຳລັງດຶງຂໍ້ມູນ...",
  "settings.relay.edit": "ແກ້ໄຂ",
  "settings.relay.clearKey": "ລ້າງຄີ",
  "settings.relay.add": "ເພີ່ມຜູ້ໃຫ້ບໍລິການ",
  "settings.relay.add.name": "ຊື່ຜູ້ໃຫ້ບໍລິການ",
  "settings.relay.models.visible": "ຕົວແບບທີ່ສະແດງ {{count}} ລາຍການ",
  "settings.relay.connected": "ເຊື່ອມຕໍ່ແລ້ວ · {{count}} ຕົວແບບ",
  "settings.relay.connectedEmpty": "ເຊື່ອມຕໍ່ແລ້ວ ແຕ່ບໍ່ມີຕົວແບບສົ່ງກັບມາ",
  "settings.relay.test.ok": "ເຊື່ອມຕໍ່ສຳເລັດ",
  "settings.relay.test.empty": "ເຊື່ອມຕໍ່ແລ້ວ ແຕ່ບໍ່ມີຕົວແບບສົ່ງກັບມາ",
  "settings.relay.models.title": "ຕົວແບບຂອງ {{vendor}}",
  "settings.relay.models.empty": "ຍັງບໍ່ມີຕົວແບບ. ດຶງລາຍການຫຼັງຈາກບັນທຶກຄີ.",
  "settings.relay.models.missing": "ບໍ່ມີຢູ່ໃນບໍລິການຕົ້ນທາງແລ້ວ",
  "settings.relay.saved": "ບັນທຶກອັດຕະໂນມັດແລ້ວ",
  "settings.relay.retry": "ລອງໃໝ່",
  "settings.relay.builtin": "ມີໃນຕົວ",
  "settings.relay.delete": "ລຶບຜູ້ໃຫ້ບໍລິການ",
  "settings.relay.rollback": "ຕັ້ງຄີທີ່ນຳເຂົ້າໃໝ່",
  "settings.relay.rollback.description": "ລ້າງຄີ Relay ທີ່ນຳເຂົ້າຈາກ auth.json. ເກັບ auth.json ຕົ້ນສະບັບໄວ້.",
  "settings.relay.error.KEY_MISSING": "ເພີ່ມຄີ API ກ່ອນ",
  "settings.relay.error.KEY_REJECTED": "ຄີຖືກປະຕິເສດ",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "ເຂົ້າເຖິງບໍລິການຕົ້ນທາງບໍ່ໄດ້",
  "settings.relay.error.UPSTREAM_TIMEOUT": "ບໍລິການຕົ້ນທາງໝົດເວລາລໍຖ້າ",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "ບໍລິການຕົ້ນທາງຈຳກັດອັດຕາຄຳຂໍ",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "ບໍລິການຕົ້ນທາງສົ່ງຄຳຕອບທີ່ບໍ່ຖືກຕ້ອງ",
  "settings.relay.error.REVISION_CONFLICT": "ການຕັ້ງຄ່ານີ້ປ່ຽນໄປໃນໜ້າຕ່າງອື່ນ. ໂຫຼດໃໝ່ແລ້ວລອງອີກຄັ້ງ.",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "ບັນທຶກຄີ API ໃນອຸປະກອນນີ້ບໍ່ໄດ້.",
  "settings.mcp.add": "ເພີ່ມ MCP",
  "settings.mcp.edit": "ແກ້ໄຂ",
  "settings.mcp.field.name": "ຊື່",
  "settings.mcp.field.type": "ປະເພດ",
  "settings.mcp.field.command": "ຄຳສັ່ງ",
  ...
  "settings.mcp.type.local": "ໃນເຄື່ອງ",
  "settings.mcp.type.remote": "ທາງໄກ",
  "settings.mcp.error.name": "ປ້ອນຊື່ເຊີບເວີ",
  "settings.mcp.error.command": "ປ້ອນຄຳສັ່ງ",
  "settings.mcp.error.url": "ປ້ອນ URL",
  ...
  "desktop.menu.documentation": "ເອກະສານ Koda",
  ...
  "desktop.menu.ariaLabel": "ເມນູ Koda",
  ...
  "desktop.recovery.loadFailed": "Koda ລົ້ມເຫລວໃນການໂຫລດ",
  "desktop.recovery.terminated": "ປ່ອງຢ້ຽມ Koda ຖືກປິດໂດຍບໍ່ຄາດຄິດ",
  "desktop.recovery.unresponsive": "Koda ບໍ່ຕອບສະໜອງ",
  ...
  "desktop.wsl.error.installOpencode": "ການຕິດຕັ້ງ Koda ລົ້ມເຫລວ",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Koda ບໍ່ໄດ້ຕິດຕັ້ງຢູ່ໃນ {{distro}}",
  "desktop.wsl.error.updateVersion":
    "ການປັບປຸງ Koda ສໍາເລັດແລ້ວແຕ່ {{distro}} ຍັງລາຍງານ {{installed}}; ຄາດວ່າ {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "ແບບຟຣີສະໜອງໃຫ້ໂດຍ Koda",
  ...
  "provider.connect.apiKey.description":
    "ໃສ່ລະຫັດ API {{provider}} ຂອງທ່ານເພື່ອເຊື່ອມຕໍ່ບັນຊີຂອງທ່ານ ແລະໃຊ້ຕົວແບບ {{provider}} ໃນ Koda.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen ໃຫ້ທ່ານເຂົ້າເຖິງຊຸດຮູບແບບການປັບແຕ່ງທີ່ໜ້າເຊື່ອຖືໄດ້ສຳລັບຕົວແທນການເຂົ້າລະຫັດ.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "ເພື່ອເກັບກຳລະຫັດການອະນຸຍາດຂອງທ່ານເພື່ອເຊື່ອມຕໍ່ບັນຊີຂອງທ່ານ ແລະໃຊ້ຕົວແບບ {{provider}} ໃນ Koda.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ແລະໃສ່ລະຫັດຂ້າງລຸ່ມນີ້ເພື່ອເຊື່ອມຕໍ່ບັນຊີຂອງທ່ານ ແລະໃຊ້ຕົວແບບ {{provider}} ໃນ Koda.",
  ...
  "dialog.server.description": "ສະຫຼັບເຊີບເວີ Koda ທີ່ແອັບຯນີ້ເຊື່ອມຕໍ່ກັບ.",
  ...
  "wsl.onboarding.checkingOpencode": "ກຳລັງກວດສອບ Koda...",
  "wsl.onboarding.checkingOpencodeIn": "ກຳລັງກວດສອບ Koda ໃນ {{distro}}...",
  "wsl.onboarding.updatingOpencode": "ກຳລັງອັບເດດ Koda...",
  "wsl.onboarding.updatingOpencodeIn": "ກຳລັງອັບເດດ Koda ໃນ {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "ອັບເດດ Koda ໃນ {{distro}}.",
  "wsl.onboarding.updateOpencode": "ອັບເດດ Koda",
  "wsl.onboarding.opencodeReadyIn": "Koda ແມ່ນພ້ອມແລ້ວໃນ {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koda ພ້ອມແລ້ວ.",
  "wsl.onboarding.installOpencodeIn": "ຕິດຕັ້ງ Koda ໃນ {{distro}}.",
  "wsl.onboarding.installOpencode": "ຕິດຕັ້ງ Koda",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda ບໍ່ໄດ້ຕິດຕັ້ງ",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (ລະບົບຍ່ອຍຂອງ Windows ສໍາລັບ Linux) ກ່ອນທີ່ Koda ສາມາດເພີ່ມເຄື່ອງແມ່ຂ່າຍ WSL ໄດ້",
  "wsl.onboarding.wslUnavailable.title": "WSL ບໍ່ສາມາດໃຊ້ໄດ້",
  "wsl.onboarding.wslUnavailable.description": "Koda ບໍ່ສາມາດກວດສອບ WSL ໃນເຄື່ອງນີ້ໄດ້.",
  "wsl.onboarding.installWsl": "ຕິດຕັ້ງ WSL",
  "wsl.onboarding.windowsRestartRequired": "ຣີສະຕາດ Windows ເພື່ອສຳເລັດການຕິດຕັ້ງ WSL, ຈາກນັ້ນເປີດ Koda ຄືນໃໝ່.",
  ...
  "help.tabs.introduction": "Koda Desktop ຕອນນີ້ຖືກສ້າງຂຶ້ນໃນແຖບຕ່າງໆ.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "ເວີຊັນໃໝ່ຂອງ Koda ({{version}}) ມີໃຫ້ຕິດຕັ້ງແລ້ວ.",
  ...
  "error.page.report.prefix": "ກະລຸນາລາຍງານຄວາມຜິດພາດນີ້ໃຫ້ທີມງານ Koda",
  ...
  "error.chain.mcpFailed": 'ເຊີບເວີ MCP "{{name}}" ລົ້ມເຫລວ. ໝາຍເຫດ, Koda ບໍ່ຮອງຮັບການພິສູດຢືນຢັນ MCP ເທື່ອ.',
  ...
  "sidebar.gettingStarted.line1": "Koda ປະກອບມີຮູບແບບຟຣີເພື່ອໃຫ້ທ່ານສາມາດເລີ່ມຕົ້ນໄດ້ທັນທີ.",
  ...
  "settings.desktop.wsl.description": "ແລ່ນເຊີບເວີ Koda ພາຍໃນ WSL ໃນ Windows.",
  ...
  "settings.general.row.language.description": "ປ່ຽນພາສາສະແດງສໍາລັບ Koda",
  ...
  "settings.general.row.appearance.description": "ປັບແຕ່ງວິທີ Koda ເບິ່ງຢູ່ໃນອຸປະກອນຂອງທ່ານ",
  "settings.general.row.colorScheme.title": "ຮູບແບບສີ",
  "settings.general.row.colorScheme.description": "ເລືອກວ່າ Koda ປະຕິບັດຕາມລະບົບ, ແສງສະຫວ່າງ, ຫຼືຮູບແບບຊ້ໍາ",
  "settings.general.row.theme.title": "ຫົວຂໍ້",
  "settings.general.row.theme.description": "ປັບແຕ່ງວິທີ Koda ເປັນຫົວຂໍ້.",
  ...
  "settings.updates.row.startup.description": "ກວດສອບການອັບເດດໂດຍອັດຕະໂນມັດເມື່ອ Koda ເປີດ",
  ...
  "settings.updates.toast.latest.description": "ທ່ານກຳລັງໃຊ້ Koda ເວີຊັນຫຼ້າສຸດ.",
