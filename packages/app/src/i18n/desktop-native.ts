...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.menu.documentation": "Koda Documentation",
  "desktop.menu.supportForum": "Support Forum",
  "desktop.menu.shareFeedback": "Share Feedback",
  "desktop.menu.about": "About Koda",
  "desktop.about.title": "Koda Desktop v{{version}}",
  "desktop.about.detail": "Modified from OpenCode as its core\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "Koda v{{version}} is available. Open the release page to upgrade?",
  "desktop.koda.update.open": "Open release page",
  "desktop.menu.reportBug": "Report a Bug",
  "desktop.menu.ariaLabel": "Koda menu",
  ...
  "desktop.recovery.loadFailed": "Koda failed to load",
  "desktop.recovery.terminated": "Koda window terminated unexpectedly",
  "desktop.recovery.unresponsive": "Koda is not responding",
  ...
  "desktop.wsl.error.installOpencode": "Koda installation failed",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Koda is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Koda update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
