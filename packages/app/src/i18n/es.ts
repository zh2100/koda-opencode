export const dict = {
  "desktop.menu.about": "Acerca de Koda",
  "desktop.about.title": "Koda Desktop v{{version}}",
  "desktop.about.detail":
    "Modificado a partir de OpenCode como núcleo\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "Koda v{{version}} está disponible. ¿Abrir la página de versiones para actualizar?",
  "desktop.koda.update.open": "Abrir página de versiones",
  "command.project.create": "Nuevo proyecto",
  "command.project.openExisting": "Abrir proyecto existente",
  "prompt.toast.projectRequired.title": "Elige un proyecto",
  "prompt.toast.projectRequired.description": "Crea o abre un proyecto antes de enviar.",
  "prompt.approval.ask": "Solicitar aprobación",
  "prompt.approval.auto": "Aprobar por mí",
  "prompt.approval.plan": "Acceso completo",
  "prompt.more": "Más",
  "dialog.project.create.title": "Nuevo proyecto",
  "dialog.project.create.name": "Nombre",
  "dialog.project.create.location": "Ubicación",
  "dialog.project.create.browse": "Examinar",
  "dialog.project.create.path": "Ruta",
  "dialog.project.create.submit": "Crear",
  "dialog.project.create.error.name": "Introduce un nombre de proyecto",
  "dialog.project.create.error.invalid": "Este nombre no se puede usar para una carpeta",
  "dialog.project.create.error.exists": "Esa carpeta ya existe. Ábrela o elige otro nombre.",
  "dialog.project.create.error.failed": "No se pudo crear la carpeta",
  "mcp.status.needs_client_registration": "requiere registro del cliente",
  "home.welcome.title": "¿En qué puedo ayudarte?",
  "home.project.create": "Nuevo proyecto",
  "home.project.open": "Abrir proyecto existente",
  "home.sessions.search.title": "Buscar chats",
  "session.todo.empty": "Aún no hay tareas",
  "session.panel.files": "Archivos",
  "session.panel.changes": "Cambios",
  "session.panel.tasks": "Tareas",
  "session.panel.terminal": "Terminal",
  "session.panel.empty": "Selecciona un proyecto para explorar archivos, cambios, tareas y la terminal.",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "Sin cambios",
  "session.panel.git.dirty.one": "{{count}} archivo modificado",
  "session.panel.git.dirty.other": "{{count}} archivos modificados",
  "session.panel.git.dirty.many": "{{count}} archivos modificados",
  "session.task.waiting": "Esperando permiso",
  "session.task.failed": "Error",
  "session.task.retry": "Reintentar",
  "session.task.open": "Abrir en su propia sesión",
  "settings.skills.title": "Habilidades",
  "settings.skills.description": "Habilidades encontradas para este proyecto.",
  "settings.skills.empty": "No se encontraron habilidades",
  "settings.skills.enabled": "Disponible para el modelo",
  "settings.skills.disabled": "Denegada para el modelo",
  "settings.skills.search": "Buscar habilidades",
  "settings.skills.emptySearch": "Ninguna habilidad coincide con esta búsqueda",
  "settings.skills.details": "Detalles de la habilidad",
  "settings.skills.noDescription": "Sin descripción",
  "settings.skills.source.project": "Proyecto",
  "settings.skills.source.global": "Usuario",
  "settings.skills.source.builtin": "Integrada",
  "settings.skills.source.custom": "Añadida",
  "settings.scheduled.title": "Tareas programadas",
  "settings.scheduled.description": "Ejecuta una instrucción una vez o cada día en un proyecto.",
  "settings.scheduled.empty": "No hay tareas programadas",
  "settings.scheduled.once": "Una vez",
  "settings.scheduled.daily": "Cada día",
  "settings.scheduled.add": "Añadir tarea",
  "settings.scheduled.field.name": "Nombre",
  "settings.scheduled.field.prompt": "Instrucción",
  "settings.scheduled.field.schedule": "Programación",
  "settings.scheduled.field.time": "Ejecutar a las",
  "settings.scheduled.error.name": "Introduce un nombre",
  "settings.scheduled.error.prompt": "Introduce una instrucción",
  "settings.scheduled.error.time": "Elige una hora",
  "settings.scheduled.error.model": "Selecciona primero un modelo",
  "session.new.project.open": "Abrir proyecto existente",
  "common.pin": "Fijar",
  "common.unpin": "Desfijar",
  "settings.relay.title": "Claves de 智联AI",
  "settings.relay.getKey": "Obtener clave de API",
  "settings.relay.getKey.description": "Crea claves independientes para ChatGPT, Grok y otros proveedores.",
  "settings.relay.upstream": "Servicio de origen",
  "settings.relay.unified": "Usar una clave de API compartida",
  "settings.relay.unified.description": "Si se activa, todos los proveedores usan esta clave.",
  "settings.relay.unified.key": "Clave de API compartida",
  "settings.relay.unified.using": "Se está usando la clave compartida",
  "settings.relay.key.set": "Clave guardada",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "Déjalo en blanco para conservar la clave guardada",
  "settings.relay.test": "Probar conexión",
  "settings.relay.testing": "Probando...",
  "settings.relay.fetch": "Obtener modelos",
  "settings.relay.fetching": "Obteniendo...",
  "settings.relay.edit": "Editar",
  "settings.relay.clearKey": "Borrar clave",
  "settings.relay.add": "Añadir proveedor",
  "settings.relay.add.name": "Nombre del proveedor",
  "settings.relay.models.visible": "{{count}} modelos visibles",
  "settings.relay.connected": "Conectado · {{count}} modelos",
  "settings.relay.connectedEmpty": "Conectado, pero no se devolvió ningún modelo",
  "settings.relay.test.ok": "Conexión correcta",
  "settings.relay.test.empty": "Conectado, pero no se devolvió ningún modelo",
  "settings.relay.models.title": "Modelos de {{vendor}}",
  "settings.relay.models.empty": "Aún no hay modelos. Obtén la lista después de guardar una clave.",
  "settings.relay.models.missing": "Ya no está en el servicio de origen",
  "settings.relay.saved": "Guardado automáticamente",
  "settings.relay.retry": "Reintentar",
  "settings.relay.builtin": "Integrado",
  "settings.relay.delete": "Eliminar proveedor",
  "settings.relay.rollback": "Restablecer claves importadas",
  "settings.relay.rollback.description":
    "Borra las claves de Relay importadas de auth.json. Se conserva el archivo auth.json original.",
  "settings.relay.error.KEY_MISSING": "Añade primero una clave de API",
  "settings.relay.error.KEY_REJECTED": "Se rechazó la clave",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "No se puede acceder al servicio de origen",
  "settings.relay.error.UPSTREAM_TIMEOUT": "Se agotó el tiempo de espera del servicio de origen",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "El servicio de origen limitó la solicitud por exceso de peticiones",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "El servicio de origen devolvió una respuesta no válida",
  "settings.relay.error.REVISION_CONFLICT": "Este ajuste cambió en otra ventana. Actualiza e inténtalo de nuevo.",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "No se pudo guardar la clave de API en este dispositivo.",
  "settings.mcp.add": "Añadir MCP",
  ...
  "settings.mcp.error.name": "Introduce un nombre de servidor",
  "settings.mcp.error.command": "Introduce un comando",
  "settings.mcp.error.url": "Introduce una URL",
  ...
  "desktop.menu.documentation": "Documentación de Koda",
  ...
  "desktop.menu.ariaLabel": "Menú de Koda",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar Koda",
  "desktop.recovery.terminated": "La ventana de Koda se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "Koda no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar Koda",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Koda no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de Koda finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Koda",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Koda.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Koda.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Koda.",
  ...
  "dialog.server.description": "Cambiar el servidor de Koda al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando Koda...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando Koda en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando Koda...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando Koda en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza Koda en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar Koda",
  "wsl.onboarding.opencodeReadyIn": "Koda está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koda está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala Koda en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar Koda",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Koda pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Koda no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Koda.",
  ...
  "help.tabs.introduction": "Koda Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de Koda ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de Koda",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: Koda aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "Koda incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Koda dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Koda",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Koda en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Koda sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Koda.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Koda",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Koda.",
