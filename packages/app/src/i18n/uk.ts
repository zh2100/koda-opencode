export const dict = {
  "desktop.menu.about": "Про Koda",
  "desktop.about.title": "Koda Desktop v{{version}}",
  "desktop.about.detail": "Модифікація на основі OpenCode\nGitHub: https://github.com/zh2100/koda-opencode\n数元AI",
  "desktop.koda.update.available": "Доступна Koda v{{version}}. Відкрити сторінку випуску для оновлення?",
  "desktop.koda.update.open": "Відкрити сторінку випуску",
  "command.project.create": "Новий проєкт",
  "command.project.openExisting": "Відкрити наявний проєкт",
  "prompt.toast.projectRequired.title": "Виберіть проєкт",
  "prompt.toast.projectRequired.description": "Створіть або відкрийте проєкт перед надсиланням.",
  "prompt.approval.ask": "Запитувати схвалення",
  "prompt.approval.auto": "Схвалювати за мене",
  "prompt.approval.plan": "Повний доступ",
  "prompt.more": "Більше",
  "dialog.project.create.title": "Новий проєкт",
  "dialog.project.create.name": "Назва",
  "dialog.project.create.location": "Розташування",
  "dialog.project.create.browse": "Огляд",
  "dialog.project.create.path": "Шлях",
  "dialog.project.create.submit": "Створити",
  "dialog.project.create.error.name": "Введіть назву проєкту",
  "dialog.project.create.error.invalid": "Цю назву не можна використати для теки",
  "dialog.project.create.error.exists": "Така тека вже існує. Відкрийте її або виберіть іншу назву.",
  "dialog.project.create.error.failed": "Не вдалося створити теку",
  "mcp.status.needs_client_registration": "потрібна реєстрація клієнта",
  "home.welcome.title": "Чим можу допомогти?",
  "home.project.create": "Новий проєкт",
  "home.project.open": "Відкрити наявний проєкт",
  "home.sessions.search.title": "Пошук чатів",
  "session.todo.empty": "Завдань поки немає",
  "session.panel.files": "Файли",
  "session.panel.changes": "Зміни",
  "session.panel.tasks": "Завдання",
  "session.panel.terminal": "Термінал",
  "session.panel.empty": "Виберіть проєкт для перегляду файлів, змін, завдань і термінала.",
  "session.panel.git.unknown": "Git",
  "session.panel.git.clean": "Без змін",
  "session.panel.git.dirty.one": "{{count}} змінений файл",
  "session.panel.git.dirty.few": "{{count}} змінені файли",
  "session.panel.git.dirty.many": "{{count}} змінених файлів",
  "session.panel.git.dirty.other": "{{count}} зміненого файла",
  "session.task.waiting": "Очікування дозволу",
  "session.task.failed": "Збій",
  "session.task.retry": "Повторити",
  "session.task.open": "Відкрити в окремій сесії",
  "settings.skills.title": "Навички",
  "settings.skills.description": "Навички, знайдені для цього проєкту.",
  "settings.skills.empty": "Навичок не знайдено",
  "settings.skills.enabled": "Доступна моделі",
  "settings.skills.disabled": "Заборонена для моделі",
  "settings.skills.search": "Пошук навичок",
  "settings.skills.emptySearch": "Немає навичок, що відповідають запиту",
  "settings.skills.details": "Відомості про навичку",
  "settings.skills.noDescription": "Без опису",
  "settings.skills.source.project": "Проєкт",
  "settings.skills.source.global": "Користувач",
  "settings.skills.source.builtin": "Вбудована",
  "settings.skills.source.custom": "Додана",
  "settings.scheduled.title": "Заплановані завдання",
  "settings.scheduled.description": "Виконуйте запит у проєкті одноразово або щодня.",
  "settings.scheduled.empty": "Немає запланованих завдань",
  "settings.scheduled.once": "Одноразово",
  "settings.scheduled.daily": "Щодня",
  "settings.scheduled.add": "Додати завдання",
  "settings.scheduled.field.name": "Назва",
  "settings.scheduled.field.prompt": "Запит",
  "settings.scheduled.field.schedule": "Розклад",
  "settings.scheduled.field.time": "Час запуску",
  "settings.scheduled.error.name": "Введіть назву",
  "settings.scheduled.error.prompt": "Введіть запит",
  "settings.scheduled.error.time": "Виберіть час",
  "settings.scheduled.error.model": "Спочатку виберіть модель",
  "session.new.project.open": "Відкрити наявний проєкт",
  "common.pin": "Закріпити",
  "common.unpin": "Відкріпити",
  "settings.relay.title": "Ключі 智联AI",
  "settings.relay.getKey": "Отримати ключ API",
  "settings.relay.getKey.description": "Створюйте окремі ключі для ChatGPT, Grok та інших провайдерів.",
  "settings.relay.upstream": "Сервер постачальника",
  "settings.relay.unified": "Використовувати спільний ключ API",
  "settings.relay.unified.description": "Якщо ввімкнено, усі постачальники використовують цей ключ.",
  "settings.relay.unified.key": "Спільний ключ API",
  "settings.relay.unified.using": "Використовується спільний ключ",
  "settings.relay.key.set": "Ключ збережено",
  "settings.relay.key.placeholder": "sk-xxxxxx",
  "settings.relay.key.keep": "Залиште порожнім, щоб зберегти поточний ключ",
  "settings.relay.test": "Перевірити з’єднання",
  "settings.relay.testing": "Перевірка...",
  "settings.relay.fetch": "Отримати моделі",
  "settings.relay.fetching": "Отримання...",
  "settings.relay.edit": "Змінити",
  "settings.relay.clearKey": "Видалити ключ",
  "settings.relay.add": "Додати постачальника",
  "settings.relay.add.name": "Назва постачальника",
  "settings.relay.models.visible": "Видимих моделей: {{count}}",
  "settings.relay.connected": "Підключено · Моделей: {{count}}",
  "settings.relay.connectedEmpty": "Підключено, але моделей не отримано",
  "settings.relay.test.ok": "З’єднання успішне",
  "settings.relay.test.empty": "Підключено, але моделей не отримано",
  "settings.relay.models.title": "Моделі {{vendor}}",
  "settings.relay.models.empty": "Моделей поки немає. Отримайте список після збереження ключа.",
  "settings.relay.models.missing": "Більше немає на сервері постачальника",
  "settings.relay.saved": "Збережено автоматично",
  "settings.relay.retry": "Повторити",
  "settings.relay.builtin": "Вбудований",
  "settings.relay.delete": "Видалити постачальника",
  "settings.relay.rollback": "Скинути імпортовані ключі",
  "settings.relay.rollback.description":
    "Видаляє ключі Relay, імпортовані з auth.json. Початковий auth.json зберігається.",
  "settings.relay.error.KEY_MISSING": "Спочатку додайте ключ API",
  "settings.relay.error.KEY_REJECTED": "Ключ відхилено",
  "settings.relay.error.UPSTREAM_UNREACHABLE": "Сервер постачальника недоступний",
  "settings.relay.error.UPSTREAM_TIMEOUT": "Час очікування відповіді сервера постачальника вичерпано",
  "settings.relay.error.UPSTREAM_RATE_LIMITED": "Сервер постачальника обмежив частоту запитів",
  "settings.relay.error.UPSTREAM_INVALID_RESPONSE": "Сервер постачальника повернув недійсну відповідь",
  "settings.relay.error.REVISION_CONFLICT": "Цей параметр змінено в іншому вікні. Оновіть і спробуйте знову.",
  "settings.relay.error.SECRET_STORE_UNAVAILABLE": "Не вдалося зберегти ключ API на цьому пристрої.",
  "settings.mcp.add": "Додати MCP",
  "settings.mcp.edit": "Змінити",
  "settings.mcp.field.name": "Назва",
  ...
  "settings.mcp.error.name": "Введіть назву сервера",
  "settings.mcp.error.command": "Введіть команду",
  "settings.mcp.error.url": "Введіть URL",
  ...
  "desktop.menu.documentation": "Документація Koda",
  ...
  "desktop.menu.ariaLabel": "Меню Koda",
  ...
  "desktop.recovery.loadFailed": "Не вдалося завантажити Koda",
  "desktop.recovery.terminated": "Роботу вікна Koda несподівано завершено",
  "desktop.recovery.unresponsive": "Koda не відповідає",
  ...
  "desktop.wsl.error.installOpencode": "Не вдалося встановити Koda",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Koda не встановлено в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Оновлення Koda завершено, але {{distro}} усе ще повідомляє про версію {{installed}}; очікувалася {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від Koda",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у Koda.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koda Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у Koda.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у Koda.",
  ...
  "dialog.server.description": "Перемкніть сервер Koda, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingOpencode": "Перевірка Koda...",
  "wsl.onboarding.checkingOpencodeIn": "Перевірка Koda у {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Оновлення Koda...",
  "wsl.onboarding.updatingOpencodeIn": "Оновлення Koda у {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Оновіть Koda у {{distro}}.",
  "wsl.onboarding.updateOpencode": "Оновити Koda",
  "wsl.onboarding.opencodeReadyIn": "Koda готовий до роботи у {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koda готовий до роботи.",
  "wsl.onboarding.installOpencodeIn": "Встановіть Koda у {{distro}}.",
  "wsl.onboarding.installOpencode": "Встановити Koda",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koda не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в Koda потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "Koda не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте Koda.",
  ...
  "help.tabs.introduction": "Koda Desktop тепер побудовано навколо вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Нова версія Koda ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді Koda",
  ...
  "error.chain.mcpFailed": 'Сервер MCP "{{name}}" не працює. Зверніть увагу, Koda ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "Koda містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер Koda всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу Koda",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд Koda на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи Koda використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему Koda.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску Koda",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію Koda.",
