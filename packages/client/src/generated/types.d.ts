...
export declare const isScheduledTaskNotFoundError: (value: unknown) => value is ScheduledTaskNotFoundError;
...
export type ServerRelayProbeOutput = {
...
export type ServerScheduledTaskRunsInput = {
    readonly taskID: {
        readonly taskID: string;
    }["taskID"];
};
export type ServerScheduledTaskRunsOutput = ReadonlyArray<{
    ...
    readonly error?: {
        readonly code: "KEY_MISSING" | "KEY_REJECTED" | "UPSTREAM_UNREACHABLE" | "UPSTREAM_TIMEOUT" | "UPSTREAM_RATE_LIMITED" | "UPSTREAM_INVALID_RESPONSE" | "MODEL_UNAVAILABLE" | "MODEL_VENDOR_MISMATCH" | "MODEL_VENDOR_CONFLICT" | "PROVIDER_DISABLED" | "PROJECT_INVALID" | "REVISION_CONFLICT" | "REQUEST_CONFLICT" | "SECRET_STORE_UNAVAILABLE";
        readonly retryable: boolean;
        readonly requestId: string;
        readonly details?: string;
    };
}>;
export type ServerScheduledTaskRunInput = {
    readonly taskID: {
        readonly taskID: string;
    }["taskID"];
};
