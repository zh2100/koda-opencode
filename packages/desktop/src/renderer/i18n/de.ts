export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Koda",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Koda wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
