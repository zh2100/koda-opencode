export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Koda",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Koda er lastet ned. Vil du installere den og starte på nytt?",
