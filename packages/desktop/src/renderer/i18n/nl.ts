export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van Koda",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van Koda is gedownload. Wil je deze installeren en Koda opnieuw starten?",
