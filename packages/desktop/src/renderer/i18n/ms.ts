export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terkini Koda",
  ...
  "desktop.updater.downloaded.prompt":
    "Versi {{version}} Koda telah dimuat turun, adakah anda ingin memasangnya dan melancarkan semula?",
