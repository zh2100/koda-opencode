export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse Koda uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "Koda'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
