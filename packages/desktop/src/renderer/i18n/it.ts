export const dict = {
  ...
  "desktop.updater.none.message": "Stai già utilizzando l'ultima versione di Koda",
  ...
  "desktop.updater.downloaded.prompt":
    "La versione {{version}} di Koda è stata scaricata. Vuoi installarla e riavviare l'app?",
