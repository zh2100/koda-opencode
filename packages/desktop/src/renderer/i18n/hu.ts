export const dict = {
  ...
  "desktop.updater.none.message": "Már az Koda legújabb verzióját használja",
  ...
  "desktop.updater.downloaded.prompt":
    "Az Koda {{version}} verziója letöltődött. Szeretné telepíteni és újraindítani az alkalmazást?",
