export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Koda",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Koda. ¿Quieres instalarla y reiniciar?",
