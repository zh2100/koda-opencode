export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju Koda-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} Koda-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
