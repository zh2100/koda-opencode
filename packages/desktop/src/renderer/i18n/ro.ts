export const dict = {
  ...
  "desktop.updater.none.message": "Folosești deja cea mai recentă versiune Koda",
  ...
  "desktop.updater.downloaded.prompt":
    "Versiunea {{version}} Koda a fost descărcată. Vrei să o instalezi și să repornești?",
