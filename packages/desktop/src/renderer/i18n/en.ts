export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of Koda",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of Koda has been downloaded, would you like to install it and relaunch?",
