export const dict = {
  ...
  "desktop.updater.none.message": "Du använder redan den senaste versionen av Koda",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} av Koda har laddats ned. Vill du installera den och starta om programmet?",
