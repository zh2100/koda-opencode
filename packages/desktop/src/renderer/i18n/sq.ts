export const dict = {
  ...
  "desktop.updater.none.message": "Ju tashmë po përdorni versionin më të fundit të Koda",
  ...
  "desktop.updater.downloaded.prompt":
    "Versioni {{version}} i Koda është shkarkuar, dëshironi ta instaloni dhe rinisni?",
