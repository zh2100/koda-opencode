export const dict = {
  ...
  "desktop.updater.none.message": "Jūs jau izmantojat jaunāko Koda versiju",
  ...
  "desktop.updater.downloaded.prompt":
    "Koda versija {{version}} ir lejupielādēta. Vai vēlaties to instalēt un palaist no jauna?",
