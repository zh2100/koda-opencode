export const dict = {
  ...
  "desktop.updater.none.message": "Već koristite najnoviju verziju Koda",
  ...
  "desktop.updater.downloaded.prompt":
    "Preuzeta je verzija {{version}} aplikacije Koda. Želite li je instalirati i ponovno pokrenuti aplikaciju?",
