export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Koda",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Koda er blevet downloadet. Vil du installere den og genstarte?",
