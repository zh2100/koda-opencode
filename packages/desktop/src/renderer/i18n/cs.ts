export const dict = {
  ...
  "desktop.updater.none.message": "Již používáte nejnovější verzi Koda",
  ...
  "desktop.updater.downloaded.prompt":
    "Byla stažena verze {{version}} aplikace Koda. Chcete ji nainstalovat a aplikaci znovu spustit?",
